...
**This package knows no language.** It imports no `org.eclipse.daanse.board.app.lib.lsp.lang.*` and has
...
and the results grid are XMLA-shaped, and they live in `packages/app/default`.
