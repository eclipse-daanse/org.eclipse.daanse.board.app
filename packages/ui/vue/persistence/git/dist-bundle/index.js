...
const { isRef, shallowRef, ref, watchEffect, computed, withCtx, h, Text, createBlock, isVNode, getCurrentInstance, inject: inject$1, normalizeClass, normalizeStyle, shallowReadonly, unref, reactive, capitalize: capitalize$1, defineComponent, useAttrs, openBlock, resolveDynamicComponent, mergeProps, renderSlot, createElementBlock, createCommentVNode, Fragment, createTextVNode, toDisplayString, onMounted, onBeforeUnmount, Transition, withDirectives, createElementVNode, vShow, createVNode, withKeys, withModifiers, render, resolveComponent, Teleport, watch } = __tsm__.require("vue");
...
function activate$1({ services }) {
  services.getRequired("RepositoryRegistry").registerViewForRepoType(type, GitRepositoryV);
}
