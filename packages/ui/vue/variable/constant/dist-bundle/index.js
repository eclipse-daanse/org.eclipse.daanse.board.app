  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createVNode(_component_VaInput, {
          modelValue: variableSettings.value.value,
          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => variableSettings.value.value = $event),
          label: "Value",
          placeholder: "Enter variable name"
        }, null, 8, ["modelValue"])
      ]);
...
function activate$1({ services }) {
  services.getRequired(VARIABLE_REPOSITORY).registerVariableType(CONSTANT_VARIABLE, {
    Variable: ConstantVariableSymbol,
    Settings: _sfc_main
  });
}
function deactivate$1({ services }) {
  services.getRequired(VARIABLE_REPOSITORY).unregisterVariableType(CONSTANT_VARIABLE);
}
...
const LIBRARY_ID = "org.eclipse.daanse.board.app.ui.vue.variable.constant";
...
async function activate(context) {
  ...
  runtime.register(LIBRARY_ID, library, VERSION, "ui.vue.variable.constant");
