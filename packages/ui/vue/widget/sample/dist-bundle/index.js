...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, toDisplayString(data.value ?? "Data do not created"), 33);
    };
  }
});
...
const SampleWidgetSettings = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
const SampleWidgetEvents = [
  { name: "Sample Clicked", type: "click", description: "Triggered when the sample widget is clicked", payloadType: Payload },
  { name: "Sample Right Clicked", type: "right_click", description: "Triggered when the sample widget is right-clicked", payloadType: Payload }
];
...
let SampleWidgetProvider = class {
  constructor(events) {
    this.events = events;
  }
  type = WIDGET_TYPE;
...
__decorateClass([
  activate()
], SampleWidgetProvider.prototype, "register", 1);
__decorateClass([
  deactivate()
], SampleWidgetProvider.prototype, "unregister", 1);
SampleWidgetProvider = __decorateClass([
  component({
    service: [WIDGET_SERVICE],
    properties: { "widget.type": WIDGET_TYPE }
  }),
  __decorateParam(0, inject("EventRegistry"))
], SampleWidgetProvider);
export {
  SampleWidget,
  SampleWidgetProvider,
