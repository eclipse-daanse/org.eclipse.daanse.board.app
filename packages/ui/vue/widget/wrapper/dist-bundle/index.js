(function(){var i="ui.vue.widget.wrapper",d=document,s=d.querySelector('style[data-tsm-bundle="'+i+'"]');if(!s){s=d.createElement('style');s.setAttribute('data-tsm-bundle',i);d.head.appendChild(s);}s.textContent="\n.absolute[data-v-5997b91d] {\n  position: absolute;\n}\n.wrapper-container[data-v-5997b91d] {\n\n  background-color: var(--v64e71a02);\n  border-color: var(--v245d32f5);\n  border-width: var(--v3d80bd9e);\n  border-style: solid;\n\n\n  width: 100%;\n  height: 100%;\n  box-Shadow: var(--v16c27018);\n  border-radius: var(--v3691df6d);\n  backdrop-filter: blur(var(--blur-amount));\n}\n.sub[data-v-5997b91d] {\n  border-radius: var(--v3691df6d);\n  padding: var(--v3594dfa0);\n}\n.wrapper-container:hover .hover[data-v-5997b91d] {\n  display: block;\n}\n.wrapper-container .hover[data-v-5997b91d] {\n  display: none;\n}\n.hightz[data-v-5997b91d] {\n  z-index: 3000;\n}\n\n.settings-container[data-v-b90249f7] {\n  display: flex;\n  flex-direction: column;\n  align-items: stretch;\n  gap: 1rem;\n}\n.pad_bottom[data-v-b90249f7] {\n  padding-top: 30px;\n  padding-bottom: 10px;\n}\n";})();
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    useCssVars((_ctx) => ({
      "v64e71a02": getBackground.value,
      "v245d32f5": borderColor.value,
      "v3d80bd9e": borderSize.value + "px",
      "v16c27018": getShadow.value,
      "v3691df6d": borderRadius.value + "px",
      "v3594dfa0": getpadding.value + "px"
    }));
    const emit = __emit;
...
const WidgetWrapper = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5997b91d"]]);
