...
const be = {
  ...
  setup(u, { emit: e }) {
    re((g) => ({
      v360f3c5d: s.value,
      b35f9fe0: d.value,
      v1eca3a79: E.value + "px",
      v24576062: V.value,
      v2920dcf0: ae.value + "px",
      v7301e5ea: Z.value + "px"
    }));
  ...
  for (const [l, m] of e)
    a[l] = m;
  return a;
}, _e = /* @__PURE__ */ te(me, [["__scopeId", "data-v-a1cdbc32"]]), ve = { class: "settings-container" }, Ae = { class: "px-2" }, Oe = { class: "px-2" }, De = { class: "px-2" }, Le = { class: "px-2" }, Pe = { class: "px-2" }, ye = { class: "px-2" }, Be = /* @__PURE__ */ J({
