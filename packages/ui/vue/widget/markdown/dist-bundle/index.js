...
const cu = /* @__PURE__ */ If(Vf), ec = /* @__PURE__ */ ru({
  ...
  setup(ae, { expose: le }) {
    const D = nu(ae, "configv"), P = ae, { id: S } = bf(P), N = Sl(Af.TINY_EMITTER), O = Sl(pf), B = Ff().params.pageid || "", _ = ba(null);
    class ee extends en {
      refresh() {
        if (pe) {
