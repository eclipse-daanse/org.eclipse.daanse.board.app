...
class MarkdownWidgetInterface extends WidgetActionInterface {
  scrollToTop() {
...
], MarkdownWidgetInterface.prototype, "scrollToTop");
__decorateClass$1([
  WidgetAction({ eventType: "markdown.scrollToHash" })
], MarkdownWidgetInterface.prototype, "scrollToHash");
__decorateClass$1([
  WidgetAction({ eventType: "markdown.refresh" })
], MarkdownWidgetInterface.prototype, "refresh");
__decorateClass$1([
...
var tablist = {};
var hasRequiredTablist;
function requireTablist() {
  if (hasRequiredTablist) return tablist;
  hasRequiredTablist = 1;
  var CodeMirror = requireCodemirror();
...
function requireFullscreen() {
  if (hasRequiredFullscreen) return fullscreen.exports;
...
function requireOverlay() {
  ...
  (function(module, exports$1) {
    (function(mod) {
      ...
      CodeMirror.overlayMode = function(base, overlay2, combine) {
        return {
          startState: function() {
            return {
              base: CodeMirror.startState(base),
              overlay: CodeMirror.startState(overlay2),
              basePos: 0,
              baseCur: null,
              overlayPos: 0,
              overlayCur: null,
          ...
          copyState: function(state) {
            return {
              ...
              overlay: CodeMirror.copyState(overlay2, state.overlay),
...
var markSelection = { exports: {} };
var hasRequiredMarkSelection;
function requireMarkSelection() {
  if (hasRequiredMarkSelection) return markSelection.exports;
  hasRequiredMarkSelection = 1;
  (function(module, exports$1) {
    (function(mod) {
      mod(requireCodemirror());
    })(function(CodeMirror) {
...
function requireGfm() {
  ...
  (function(module, exports$1) {
    (function(mod) {
      mod(requireCodemirror(), requireMarkdown(), requireOverlay());
    })(function(CodeMirror) {
...
var hasRequiredTypo;
function requireTypo() {
  if (hasRequiredTypo) return typo.exports;
  hasRequiredTypo = 1;
  (function(module) {
    var Typo;
    (function() {
...
var spellChecker;
var hasRequiredSpellChecker;
function requireSpellChecker() {
  if (hasRequiredSpellChecker) return spellChecker;
  hasRequiredSpellChecker = 1;
  var Typo = requireTypo();
  ...
  spellChecker = CodeMirrorSpellChecker;
  return spellChecker;
}
var marked = {};
...
var easymde;
var hasRequiredEasymde;
function requireEasymde() {
  if (hasRequiredEasymde) return easymde;
  hasRequiredEasymde = 1;
  var CodeMirror = requireCodemirror();
  requireContinuelist();
  requireTablist();
  requireFullscreen();
  ...
  requirePlaceholder();
  requireAutorefresh();
  requireMarkSelection();
  requireSearchcursor();
  requireGfm();
  requireXml();
  var CodeMirrorSpellChecker = requireSpellChecker();
  var marked2 = requireMarked().marked;
  ...
  EasyMDE2.prototype.markdown = function(text) {
    if (marked2) {
      ...
      marked2.use(markedOptions);
      var htmlText = marked2.parse(text);
...
var easymdeExports = requireEasymde();
const EasyMDE = /* @__PURE__ */ getDefaultExportFromCjs(easymdeExports);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("textarea", {
          ref_key: "container",
          ref: container$1
        }, "            " + toDisplayString(config.value.value) + "\n        ", 513)
      ], 544);
    };
  }
});
...
const MarkdownWidget = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-851c01f5"]]);
const _hoisted_1 = { class: "settings_container" };
...
const MarkdownWidgetSettings = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-23d61fea"]]);
const MarkdownWidgetEvents = [
  {
...
let MarkdownWidgetProvider = class {
...
__decorateClass([
  activate()
], MarkdownWidgetProvider.prototype, "register", 1);
__decorateClass([
  deactivate()
], MarkdownWidgetProvider.prototype, "unregister", 1);
MarkdownWidgetProvider = __decorateClass([
  component({
