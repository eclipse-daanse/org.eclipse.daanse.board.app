(function(){var i="ui.vue.widget.image",d=document,s=d.querySelector('style[data-tsm-bundle="'+i+'"]');if(!s){s=d.createElement('style');s.setAttribute('data-tsm-bundle',i);d.head.appendChild(s);}s.textContent=".slideshow-container[data-v-d3a211cd]{width:100%;height:100%;overflow:hidden;position:relative}.slideshow-track[data-v-d3a211cd]{width:100%;height:100%;overflow:visible;position:relative;transition:transform .3s ease-in-out}.slideshow-slide[data-v-d3a211cd]{width:100%;height:100%;position:absolute;top:0;left:0}.slideshow-nav[data-v-d3a211cd]{position:absolute;top:50%;width:32px;height:32px;transform:translateY(-50%);z-index:10;background:#0009;border-radius:50%;display:flex;align-items:center;justify-content:center}.slideshow-nav--prev[data-v-d3a211cd]{left:40px}.slideshow-nav--next[data-v-d3a211cd]{right:40px}.image-settings-container[data-v-e2074a09]{display:flex;flex-direction:row;align-items:flex-end;gap:1rem;padding:.5rem;border-radius:.25rem}.image-settings-remove-button[data-v-e2074a09]{margin-bottom:.25rem}.image-settings-remove-input[data-v-e2074a09]{flex-grow:1}.settings-container[data-v-e2074a09]{display:flex;flex-direction:column;gap:1rem}.image-list-container[data-v-e2074a09]{display:flex;flex-direction:column;gap:.5rem;height:500px;overflow:auto;padding:.5rem;border-radius:.5rem}.loading[data-v-e2074a09]{height:100%;padding:50px;border-radius:4px;margin-bottom:1rem;background-color:var(--app-response-background)}\n";})();
...
const ye = ["src"], be = {
  ...
  for (const [e, l] of i)
    a[e] = l;
  return a;
}, De = /* @__PURE__ */ ee(xe, [["__scopeId", "data-v-d3a211cd"]]), s = [];
for (let t = 0; t < 256; ++t)
