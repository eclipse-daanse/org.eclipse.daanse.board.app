(function(){var i="ui.vue.widget.svg.base",d=document,s=d.querySelector('style[data-tsm-bundle="'+i+'"]');if(!s){s=d.createElement('style');s.setAttribute('data-tsm-bundle',i);d.head.appendChild(s);}s.textContent=".svg[data-v-3b218091]{width:100%;height:100%}.fallback[data-v-3b218091]{width:100%;height:100%;display:flex;align-items:center;justify-content:center;color:#666;font-style:italic}\n";})();
import { WidgetActionInterfaceImpl as ie, EVENT_ACTIONS_REGISTRY as re, PayloadImpl as x, EVENT_REGISTRY_ID as ae, EVENT_ACTIONS_REGISTRY_ID as ne } from "org.eclipse.daanse.board.app.lib.api.events";
import { activate as oe, deactivate as le, component as ce, inject as U } from "@eclipse-daanse/tsm";
import { defineComponent as ue, mergeModels as he, toRefs as de, useModel as ge, inject as P, ref as y, getCurrentInstance as Ce, onMounted as pe, onUnmounted as fe, watch as Se, computed as K, createElementBlock as B, openBlock as Y, Fragment as Ee, createElementVNode as H, createCommentVNode as _e, mergeProps as me, withModifiers as X } from "vue";
import { BasicEObject as b, BasicEFactory as ve, BasicEPackage as Ne, EPackageRegistry as q, BasicEClass as V, BasicEReference as m, BasicEAttribute as $, getEcorePackage as Z, createContainmentEList as Ie } from "@emfts/core";
import { useRoute as Te } from "vue-router";
import { plainSettings as j, VariableWrapper as w } from "org.eclipse.daanse.board.app.ui.vue.composables";
...
function L(l) {
  const e = q.INSTANCE.getEPackage(l);
  if (!e)
...
class i extends Ne {
   ...
   */
  init() {
    q.INSTANCE.set(i.eNS_URI, this), this.setEFactoryInstance(A.eINSTANCE);
    const e = new V();
...
class g extends b {
  ...
  get classesConfig() {
    return this._classesConfig || (this._classesConfig = Ie(this, this.eClass().getEStructuralFeature("classesConfig"))), this._classesConfig;
  }
  // Reflective API
  /**
   * Returns the value of the given feature
...
var Fe = Object.defineProperty, Ge = Object.getOwnPropertyDescriptor, Q = (l, e, t, r) => {
  for (var s = Ge(e, t), c = l.length - 1, u; c >= 0; c--)
    (u = l[c]) && (s = u(e, t, s) || s);
  return s && Fe(e, t, s), s;
};
class G extends ie {
...
Q([
  J({ eventType: "svg.zoom" })
], G.prototype, "zoom");
Q([
  J({ eventType: "svg.resetZoom" })
], G.prototype, "resetZoom");
const ye = ["innerHTML"], Ve = ["innerHTML"], be = /* @__PURE__ */ ue({
  __name: "SvgWidget",
  props: /* @__PURE__ */ he({
    datasourceId: {},
    id: {}
  ...
  setup(l, { expose: e }) {
    const t = l, { id: r } = de(t), s = ge(l, "configv"), c = P(we.TINY_EMITTER), u = P(re), E = Te().params.pageid || "", p = y(1), f = y(null);
    class _ extends G {
      zoom(o) {
    ...
    }, N = y(""), ee = (Ce()?.type).__scopeId, te = new g(), M = async (n) => {
      const o = n?.value || n;
    ...
    pe(async () => {
      r?.value && u.registerInstance(r.value, D, "SVGWidget", E), s.value && (Object.assign(s.value, {
        ...j(te),
        ...j(s.value)
    ...
    return (n, o) => (Y(), B(Ee, null, [
      H("div", { innerHTML: se.value }, null, 8, ye),
      H("div", me(n.$attrs, {
        class: "svg",
        innerHTML: W.value,
        onClick: R,
...
`;
var xe = Object.defineProperty, Ue = Object.getOwnPropertyDescriptor, O = (l, e, t, r) => {
  for (var s = r > 1 ? void 0 : r ? Ue(e, t) : e, c = l.length - 1, u; c >= 0; c--)
...
let F = class {
  ...
  settingsForm = {
    ...
    entryForms: [
      ...
      { xmi: We, uri: "/svg-rule.ui.xmi" }
    ]
  };
  register() {
    this.events.registerWidget(v, Re), this.actions.registerWidgetType(v, G, "widget");
  }
  unregister() {
