...
import { WidgetActionInterfaceImpl as v2, EVENT_ACTIONS_REGISTRY as g2, PayloadImpl as Q, EVENT_REGISTRY_ID as p2, EVENT_ACTIONS_REGISTRY_ID as f2 } from "org.eclipse.daanse.board.app.lib.api.events";
import { activate as m2, deactivate as C2, component as h2, inject as X } from "@eclipse-daanse/tsm";
import { defineComponent as o2, mergeModels as _2, toRefs as S2, useModel as l2, inject as Z, ref as T, getCurrentInstance as w2, onMounted as V2, onUnmounted as y2, watch as a2, computed as e2, createElementBlock as j, openBlock as O, Fragment as n2, createElementVNode as _, createCommentVNode as W2, mergeProps as b2, withModifiers as t2, resolveComponent as R, createBlock as k2, withCtx as V, createVNode as f, unref as x, createTextVNode as I2, toDisplayString as G2, renderList as T2, markRaw as h } from "vue";
...
import { useRoute as O2 } from "vue-router";
import { WidgetAction as r2 } from "org.eclipse.daanse.board.app.lib.events";
...
const { identifiers: E2 } = __tsm__.require("org.eclipse.daanse.board.app.lib.core");
...
const R2 = ["innerHTML"], x2 = ["innerHTML"], L2 = /* @__PURE__ */ o2({
  ...
  setup(a, { expose: s }) {
    const o = a, { id: t } = S2(o), e = l2(a, "configv"), r = Z(E2.TINY_EMITTER), n = Z(g2), H = O2().params.pageid || "", l = T(1), v = T(null);
    class b extends U {
      zoom(c) {
    ...
    }, d = T(""), g = (w2()?.type).__scopeId, w = new E(), J = async (i) => {
      const c = i?.value || i;
...
const z2 = { class: "settings-container" }, A2 = { class: "class-config-header" }, q2 = { class: "class-list" }, F2 = { class: "class-item-header" }, Y2 = { class: "class-item-properties" }, J2 = /* @__PURE__ */ o2({
          ...
          _("div", z2, [
            ...
            _("div", A2, [
              ...
              f(k, {
                ...
                default: V(() => [
                  I2(G2(o("svgBase:SvgWidget.addButton")), 1)
                ]),
                _: 1
              })
            ]),
            _("div", q2, [
              (O(!0), j(n2, null, T2(n.value, (d, G) => (O(), j("div", {
                key: G,
                class: "class-item"
              }, [
                _("div", F2, [
  ...
  { name: "SVG Clicked", type: "click", description: "Triggered when the SVG widget is clicked", payloadType: Q },
  { name: "SVG Right Clicked", type: "right_click", description: "Triggered when the SVG widget is right-clicked", payloadType: Q }
];
