...
const _sfc_main$1$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const currentlyDisplayedValues = computed(() => {
      ...
      let rightIndex = props2.totalContentSize.xAxis.items.findIndex((e) => {
        const rightCoord = xScrollPosition.value + container2.value.clientWidth;
      ...
      let bottomIndex = props2.totalContentSize.yAxis.items.findIndex((e) => {
        const bottomCoord = yScrollPosition.value + container2.value.clientHeight;
...
const PivotTableWidget = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-52dbd660"]]);
