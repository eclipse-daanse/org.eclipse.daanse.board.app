...
import { Reference, Attribute, ModelClass, Documentation } from "org.eclipse.daanse.board.app.lib.annotations";
...
let HeaderExpandedPayload = class {
  uniqueName;
};
__decorateClass$3([
...
let HeaderClickedPayload = class {
  uniqueName;
};
__decorateClass$2([
  Documentation("Header Unique Name."),
