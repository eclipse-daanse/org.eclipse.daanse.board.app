import { _ as w, aV as _, aW as Y, aX as F, aY as j, l as r, c as H, aZ as V, a_ as $, ag as Q, aQ as U, ah as P, af as W, a$ as Z, b0 as q, b1 as z } from "./index-DYXa-Aya.js";
import { i as N, G as B } from "./graph-BRoPeNF3.js";
import { b as K, m as R, l as I } from "./layout-D9EpM4Fg.js";
var ee = 4;
function ne(e) {
  return K(e, ee);
}
...
Parent cluster`,
      ...
      if (r.info("(Insert) Node XXX" + f + ": " + JSON.stringify(t.node(f))), s?.clusterNode) {
        ...
        t.children(f).length > 0 ? (r.trace(
          ...
          "Graph:",
          t
        ), r.trace(C(s.id, t)), d.set(s.id, { id: C(s.id, t), node: s })) : (r.trace("Node - the non recursive path XAX", f, v, t.node(f), l), await Q(v, t.node(f), { config: o, dir: l }));
    })
  ...
  return await Promise.all(
    ce(t).map(async function(f) {
      ...
      if (r.info(
        ...
        r.debug("OffsetY", p, "labelHeight", E, "halfPadding", g), await W(c, s), d.get(s.id).node = s;
      } else {
  ...
  _(a, e.markers, e.type, e.diagramId), Y(), F(), j(), re(), e.nodes.forEach((o) => {
