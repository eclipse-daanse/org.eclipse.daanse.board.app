...
var wv = function(e, t, a, n, i, s, o) {
  ...
  var u = 1 * a * a - 4 * a * i + 2 * a * o + 4 * i * i - 4 * i * o + o * o + n * n - 4 * n * s + 2 * n * l + 4 * s * s - 4 * s * l + l * l, v = 9 * a * i - 3 * a * a - 3 * a * o - 6 * i * i + 3 * i * o + 9 * n * s - 3 * n * n - 3 * n * l - 6 * s * s + 3 * s * l, f = 3 * a * a - 6 * a * i + a * o - a * e + 2 * i * i + 2 * i * e - o * e + 3 * n * n - 6 * n * s + n * l - n * t + 2 * s * s + 2 * s * t - l * t, c = 1 * a * i - a * a + a * e - i * e + n * s - n * n + n * t - s * t, h = [];
  Id(u, v, f, c, h);
...
var Ar = function(e) {
  ...
  if (!(a === 0 || n <= 0 || i === "inside")) {
    var o = t.cy(), l = o.renderer(), u = l.nodeShapes[l.getNodeShape(t)];
    if (u) {
  ...
  for (f = 0; f < o.length; f++) {
    ...
    if (h.isEdge()) {
      for (var m = h, b = ["source", "target"], w = b.length, E = !1, C = 0; C < w; C++) {
        var x = b[C], T = y[x];
        ae(T) && (T = y[x] = "" + y[x]), T == null || T === "" ? ($e("Can not create edge `" + g + "` with unspecified " + x), E = !0) : a.hasElementWithId(T) || ($e("Can not create edge `" + g + "` with nonexistent " + x + " `" + T + "`"), E = !0);
      }
      if (E) {
        c();
        continue;
    ...
    */
    ...
    value: function(t, a, n) {
      ...
      if (this._isVisible(t, i)) {
        ...
        qt(a, c);
        var h = this.renderTarget.picking ? 1 : t.pstyle(s.opacity).value, d = t.pstyle(s.color).value, y = this.colorBuffer.getView(l);
        xt(d, h, y);
