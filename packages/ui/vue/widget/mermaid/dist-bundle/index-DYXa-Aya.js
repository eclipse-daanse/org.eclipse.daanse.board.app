...
Bc([
  _c({ eventType: "mermaid.refresh" })
], ns.prototype, "refresh");
Bc([
  _c({ eventType: "mermaid.zoom" })
], ns.prototype, "zoom");
function S0(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var fo = { exports: {} }, _0 = fo.exports, Nl;
function v0() {
...
const ri = Ft(Array.prototype.forEach), q0 = Ft(Array.prototype.lastIndexOf), Wl = Ft(Array.prototype.pop), ii = Ft(Array.prototype.push), W0 = Ft(Array.prototype.splice), Ut = Array.isArray, gi = Ft(String.prototype.toLowerCase), zs = Ft(String.prototype.toString), zl = Ft(String.prototype.match), Br = Ft(String.prototype.replace), Hl = Ft(String.prototype.indexOf), z0 = Ft(String.prototype.trim), H0 = Ft(Number.prototype.toString), Y0 = Ft(Boolean.prototype.toString), Yl = typeof BigInt > "u" ? null : Ft(BigInt.prototype.toString), Ul = typeof Symbol > "u" ? null : Ft(Symbol.prototype.toString), St = Ft(Object.prototype.hasOwnProperty), oi = Ft(Object.prototype.toString), Dt = Ft(RegExp.prototype.test), to = U0(TypeError);
function Ft(e) {
  return function(t) {
...
function Oc() {
  ...
  const ut = lt({}, [...Gl, ...Hs, ...Ys, ...Us, ...jl]);
  let et = null;
  const dt = lt({}, [...Xl, ...Gs, ...Vl, ...eo]);
  ...
  let xt = !0, Ct = !0, vt = !1, he = !0, re = !1, $e = !0, or = !1, Bs = !1, Ls = !1, Tr = !1, Zi = !1, Ki = !1, fl = !0, gl = !1;
  ...
  let Ms = null;
  const xl = lt({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), Qi = "http://www.w3.org/1998/Math/MathML", Ji = "http://www.w3.org/2000/svg", Te = "http://www.w3.org/1999/xhtml";
  ...
  let At = null, vr = null;
  const r0 = r.createElement("form"), bl = function(w) {
    ...
    t0.indexOf(w.PARSER_MEDIA_TYPE) === -1 ? e0 : w.PARSER_MEDIA_TYPE, At = ei === "application/xhtml+xml" ? zs : gi, Q = St(w, "ALLOWED_TAGS") && Ut(w.ALLOWED_TAGS) ? lt({}, w.ALLOWED_TAGS, At) : ut, et = St(w, "ALLOWED_ATTR") && Ut(w.ALLOWED_ATTR) ? lt({}, w.ALLOWED_ATTR, At) : dt, $s = St(w, "ALLOWED_NAMESPACES") && Ut(w.ALLOWED_NAMESPACES) ? lt({}, w.ALLOWED_NAMESPACES, zs) : Qm, Ms = St(w, "ADD_URI_SAFE_ATTR") && Ut(w.ADD_URI_SAFE_ATTR) ? lt(Qt(xl), w.ADD_URI_SAFE_ATTR, At) : xl, yl = St(w, "ADD_DATA_URI_TAGS") && Ut(w.ADD_DATA_URI_TAGS) ? lt(Qt(Cl), w.ADD_DATA_URI_TAGS, At) : Cl, we = St(w, "FORBID_CONTENTS") && Ut(w.FORBID_CONTENTS) ? lt({}, w.FORBID_CONTENTS, At) : As, rt = St(w, "FORBID_TAGS") && Ut(w.FORBID_TAGS) ? lt({}, w.FORBID_TAGS, At) : Qt({}), ht = St(w, "FORBID_ATTR") && Ut(w.FORBID_ATTR) ? lt({}, w.FORBID_ATTR, At) : Qt({}), Sr = St(w, "USE_PROFILES") ? w.USE_PROFILES && typeof w.USE_PROFILES == "object" ? Qt(w.USE_PROFILES) : w.USE_PROFILES : !1, xt = w.ALLOW_ARIA_ATTR !== !1, Ct = w.ALLOW_DATA_ATTR !== !1, vt = w.ALLOW_UNKNOWN_PROTOCOLS || !1, he = w.ALLOW_SELF_CLOSE_IN_ATTR !== !1, re = w.SAFE_FOR_TEMPLATES || !1, $e = w.SAFE_FOR_XML !== !1, or = w.WHOLE_DOCUMENT || !1, Tr = w.RETURN_DOM || !1, Zi = w.RETURN_DOM_FRAGMENT || !1, Ki = w.RETURN_TRUSTED_TYPE || !1, Ls = w.FORCE_BODY || !1, fl = w.SANITIZE_DOM !== !1, gl = w.SANITIZE_NAMED_PROPS || !1, Fs = w.KEEP_CONTENT !== !1, ti = w.IN_PLACE || !1, Y = X0(w.ALLOWED_URI_REGEXP) ? w.ALLOWED_URI_REGEXP : Ec, _r = typeof w.NAMESPACE == "string" ? w.NAMESPACE : Te, Os = St(w, "MATHML_TEXT_INTEGRATION_POINTS") && w.MATHML_TEXT_INTEGRATION_POINTS && typeof w.MATHML_TEXT_INTEGRATION_POINTS == "object" ? Qt(w.MATHML_TEXT_INTEGRATION_POINTS) : lt({}, ["mi", "mo", "mn", "ms", "mtext"]), Is = St(w, "HTML_INTEGRATION_POINTS") && w.HTML_INTEGRATION_POINTS && typeof w.HTML_INTEGRATION_POINTS == "object" ? Qt(w.HTML_INTEGRATION_POINTS) : lt({}, ["annotation-xml"]);
    ...
    if (it = Mr(null), St(q, "tagNameCheck") && bl(q.tagNameCheck) && (it.tagNameCheck = q.tagNameCheck), St(q, "attributeNameCheck") && bl(q.attributeNameCheck) && (it.attributeNameCheck = q.attributeNameCheck), St(q, "allowCustomizedBuiltInElements") && typeof q.allowCustomizedBuiltInElements == "boolean" && (it.allowCustomizedBuiltInElements = q.allowCustomizedBuiltInElements), re && (Ct = !1), Zi && (Tr = !0), Sr && (Q = lt({}, jl), et = Mr(null), Sr.html === !0 && (lt(Q, Gl), lt(et, Xl)), Sr.svg === !0 && (lt(Q, Hs), lt(et, Gs), lt(et, eo)), Sr.svgFilters === !0 && (lt(Q, Ys), lt(et, Gs), lt(et, eo)), Sr.mathMl === !0 && (lt(Q, Us), lt(et, Vl), lt(et, eo))), ft.tagCheck = null, ft.attributeCheck = null, St(w, "ADD_TAGS") && (typeof w.ADD_TAGS == "function" ? ft.tagCheck = w.ADD_TAGS : Ut(w.ADD_TAGS) && (Q === ut && (Q = Qt(Q)), lt(Q, w.ADD_TAGS, At))), St(w, "ADD_ATTR") && (typeof w.ADD_ATTR == "function" ? ft.attributeCheck = w.ADD_ATTR : Ut(w.ADD_ATTR) && (et === dt && (et = Qt(et)), lt(et, w.ADD_ATTR, At))), St(w, "ADD_URI_SAFE_ATTR") && Ut(w.ADD_URI_SAFE_ATTR) && lt(Ms, w.ADD_URI_SAFE_ATTR, At), St(w, "FORBID_CONTENTS") && Ut(w.FORBID_CONTENTS) && (we === As && (we = Qt(we)), lt(we, w.FORBID_CONTENTS, At)), St(w, "ADD_FORBID_CONTENTS") && Ut(w.ADD_FORBID_CONTENTS) && (we === As && (we = Qt(we)), lt(we, w.ADD_FORBID_CONTENTS, At)), Fs && (Q["#text"] = !0), or && lt(Q, ["html", "head", "body"]), Q.table && (lt(Q, ["tbody"]), delete rt.tbody), w.TRUSTED_TYPES_POLICY) {
    ...
    Xt && Xt(w), vr = w;
  }, kl = lt({}, [...Hs, ...Ys, ...V0]), wl = lt({}, [...Us, ...Z0]), i0 = function(w) {
    let q = k(w);
    (!q || !q.tagName) && (q = {
      namespaceURI: _r,
      tagName: "template"
    ...
    return $s[w.namespaceURI] ? w.namespaceURI === Ji ? q.namespaceURI === Te ? X === "svg" : q.namespaceURI === Qi ? X === "svg" && (bt === "annotation-xml" || Os[bt]) : !!kl[X] : w.namespaceURI === Qi ? q.namespaceURI === Te ? X === "math" : q.namespaceURI === Ji ? X === "math" && Is[bt] : !!wl[X] : w.namespaceURI === Te ? q.namespaceURI === Ji && !Is[bt] || q.namespaceURI === Qi && !Os[bt] ? !1 : !wl[X] && (Jm[X] || !kl[X]) : !!(ei === "application/xhtml+xml" && $s[w.namespaceURI]) : !1;
  }, ce = function(w) {
    ii(t.removed, {
      element: w
    });
  ...
  const _l = function(w) {
    ...
    if (ht[q] || fl && (q === "id" || q === "name") && (X in r || X in r0))
      return !1;
    if (!(Ct && !ht[q] && Dt(F, q))) {
      if (!(xt && Dt(L, q))) {
        if (!(ft.attributeCheck instanceof Function && ft.attributeCheck(q, w))) {
          if (!et[q] || ht[q]) {
            ...
            if (!Dt(Y, Br(X, R, ""))) {
              if (!((q === "src" || q === "xlink:href" || q === "href") && w !== "script" && Hl(X, "data:") === 0 && yl[w])) {
                if (!(vt && !Dt(E, Br(X, R, "")))) {
                  if (X)
                    return !1;
                }
    ...
    return !0;
  }, o0 = lt({}, ["annotation-xml", "color-profile", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "missing-glyph"]), Bl = function(w) {
    ...
    for (; bt--; ) {
      ...
      if (X.attrName = de, X.attrValue = Ot, X.keepAttr = !0, X.forceKeepAttr = void 0, Oe($.uponSanitizeAttribute, w, X), Ot = X.attrValue, gl && (de === "id" || de === "name") && Hl(Ot, ml) !== 0 && (sr(Bt, w), Ot = ml + Ot), $e && Dt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, Ot)) {
        sr(Bt, w);
        continue;
      }
      if (de === "attributename" && zl(Ot, "href")) {
        sr(Bt, w);
        continue;
      }
      if (X.forceKeepAttr)
      ...
      if (Ot !== Ns)
        try {
          Zt ? w.setAttributeNS(Zt, Bt, Ot) : w.setAttribute(Bt, Ot), Rs(w) ? ce(w) : Wl(t.removed);
        } catch {
          sr(Bt, w);
        }
    }
    ...
    for (Oe($.beforeSanitizeShadowDOM, w, null); q = X.nextNode(); )
      Oe($.uponSanitizeShadowNode, q, null), _l(q), Ll(q), q.content instanceof s && Fl(q.content);
  ...
  return t.sanitize = function(J) {
    ...
    if (Bs || Ds(w), t.removed = [], typeof J == "string" && (ti = !1), ti) {
      ...
      q = Tl("<!---->"), X = q.ownerDocument.importNode(J, !0), X.nodeType === si.element && X.nodeName === "BODY" || X.nodeName === "HTML" ? q = X : q.appendChild(X);
    else {
    ...
    const Bt = Sl(ti ? J : q);
    for (; bt = Bt.nextNode(); )
      _l(bt), Ll(bt), bt.content instanceof s && Fl(bt.content);
    if (ti)
      return J;
    if (Tr) {
      if (re) {
...
var Xc = /* @__PURE__ */ f((e) => (Py(), zr.sanitize(e)), "removeScript"), Jl = /* @__PURE__ */ f((e, t) => {
  if (Vt(t)) {
  ...
  return e;
}, "sanitizeMore"), xe = /* @__PURE__ */ f((e, t) => e && (t.dompurifyConfig ? e = zr.sanitize(Jl(e, t), t.dompurifyConfig).toString() : e = zr.sanitize(Jl(e, t), {
  FORBID_TAGS: ["style"]
  ...
  const t = e.filter((r) => !isNaN(r));
  return Math.min(...t);
}, "getMin"), th = /* @__PURE__ */ f(function(e) {
  const t = e.split(/(,)/), r = [];
...
}, "processSet"), eh = /* @__PURE__ */ f(() => window.MathMLElement !== void 0, "isMathMLSupported"), pa = /\$\$(.*)\$\$/g, Li = /* @__PURE__ */ f((e) => (e.match(pa)?.length ?? 0) > 0, "hasKatex"), pL = /* @__PURE__ */ f(async (e, t) => {
  ...
  if (!Li(e))
    return e;
  if (!(eh() || t.legacyMathML || t.forceLegacyMathML))
    return e.replace(pa, "MathML is unsupported in this environment.");
  {
    const { default: r } = await import("./katex-D3uLT2GX.js"), i = t.forceLegacyMathML || !eh() && t.legacyMathML ? "htmlAndMathml" : "mathml";
...
var dn = "", un = "", pn = "", fn = /* @__PURE__ */ f((e) => xe(e, wt()), "sanitizeText"), eC = /* @__PURE__ */ f(() => {
  dn = "", pn = "", un = "";
}, "clear"), rC = /* @__PURE__ */ f((e) => {
  dn = fn(e).replace(/^\s+/g, "");
}, "setAccTitle"), iC = /* @__PURE__ */ f(() => dn, "getAccTitle"), oC = /* @__PURE__ */ f((e) => {
  pn = fn(e).replace(/\n\s+/g, `
`);
}, "setAccDescription"), sC = /* @__PURE__ */ f(() => pn, "getAccDescription"), aC = /* @__PURE__ */ f((e) => {
  un = fn(e);
}, "setDiagramTitle"), nC = /* @__PURE__ */ f(() => un, "getDiagramTitle"), rh = P, lC = hn, gt = wt, fL = Hc, gL = Hr, gn = /* @__PURE__ */ f((e) => xe(e, gt()), "sanitizeText"), hC = Ky, cC = /* @__PURE__ */ f(() => Qc, "getCommonDb"), Eo = {}, $o = /* @__PURE__ */ f((e, t, r) => {
  Eo[e] && rh.warn(`Diagram with id ${e} already registered. Overwriting.`), Eo[e] = t, r && Rc(e, r), Jy(e, t.styles), t.injectUtils?.(
    rh,
    lC,
    gt,
    gn,
...
yo.prototype = Jc.prototype = {
  ...
  on: function(e, t) {
    ...
    for (; ++s < a; )
      if (o = (e = i[s]).type) r[o] = ih(r[o], e.name, t);
      else if (t == null) for (o in r) r[o] = ih(r[o], e.name, null);
    return this;
  },
  copy: function() {
    var e = {}, t = this._;
...
function ld(e, t) {
  for (var r = yn(e), i = -1, o = t.length; ++i < o; ) r.add(t[i]);
}
function hd(e, t) {
  for (var r = yn(e), i = -1, o = t.length; ++i < o; ) r.remove(t[i]);
}
function ux(e) {
  return function() {
    ld(this, e);
...
function gx(e, t) {
  var r = ad(e + "");
  if (arguments.length < 2) {
    for (var i = yn(this.node()), o = -1, s = r.length; ++o < s; ) if (!i.contains(r[o])) return !1;
    return !0;
  }
...
function Ax(e, t) {
  var r = typeof e == "function" ? e : td(e), i = t == null ? Fx : typeof t == "function" ? t : mn(t);
  return this.select(function() {
...
var Fi = 0.7, Io = 1 / Fi, qr = "\\s*([+-]?\\d+)\\s*", Ai = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Be = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", jx = /^#([0-9a-f]{3,8})$/, Xx = new RegExp(`^rgb\\(${qr},${qr},${qr}\\)$`), Vx = new RegExp(`^rgb\\(${Be},${Be},${Be}\\)$`), Zx = new RegExp(`^rgba\\(${qr},${qr},${qr},${Ai}\\)$`), Kx = new RegExp(`^rgba\\(${Be},${Be},${Be},${Ai}\\)$`), Qx = new RegExp(`^hsl\\(${Ai},${Be},${Be}\\)$`), Jx = new RegExp(`^hsla\\(${Ai},${Be},${Be},${Ai}\\)$`), sh = {
  aliceblue: 15792383,
...
Cn(ge, ob, ud(Yi, {
  ...
  clamp() {
    return new ge(uh(this.h), io(this.s), io(this.l), Do(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = Do(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${uh(this.h)}, ${io(this.s) * 100}%, ${io(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function uh(e) {
...
function mL(e, t) {
  var r = t - e;
  return r ? fd(e, r > 180 || r < -180 ? r - 360 * Math.round(r / 360) : r) : xn(isNaN(e) ? t : e);
}
function ab(e) {
  return (e = +e) == 1 ? gd : function(t, r) {
    return r - t ? sb(t, r, e) : xn(isNaN(t) ? r : t);
  };
}
function gd(e, t) {
  var r = t - e;
  return r ? fd(e, r) : xn(isNaN(e) ? t : e);
}
...
function md(e, t, r, i, o, s) {
  ...
  return (a = Math.sqrt(e * e + t * t)) && (e /= a, t /= a), (l = e * r + t * i) && (r -= e * l, i -= t * l), (n = Math.sqrt(r * r + i * i)) && (r /= n, i /= n, l /= n), e * i < t * r && (e = -e, t = -t, l = -l, a = -a), {
    translateX: o,
    translateY: s,
    rotate: Math.atan2(t, e) * fh,
    skewX: Math.atan(l) * fh,
    scaleX: a,
    scaleY: n
  };
}
...
No.prototype = bd.prototype = {
  ...
  restart: function(e, t, r) {
    ...
    r = (r == null ? bn() : +r) + (t == null ? 0 : +t), !this._next && yi !== this && (yi ? yi._next = this : Ro = this, yi = this), this._call = e, this._time = r, ba();
  },
  stop: function() {
...
function ba(e) {
  if (!Ur) {
    ...
    var t = e - yr;
    t > 24 ? (e < 1 / 0 && (mi = setTimeout(gh, e - Ei.now() - ds)), ai && (ai = clearInterval(ai))) : (ai || (Po = Ei.now(), ai = setInterval(mb, Cd)), Ur = 1, xd(gh));
  }
}
function mh(e, t, r) {
  var i = new No();
...
var Cb = Jc("start", "end", "cancel", "interrupt"), xb = [], kd = 0, yh = 1, ka = 2, Co = 3, Ch = 4, wa = 5, xo = 6;
...
function bb(e, t, r) {
  ...
  function s(c) {
    r.state = yh, r.timer.restart(a, r.delay, r.time), r.delay <= c && a(c - r.delay);
  }
  function a(c) {
    var h, d, p, u;
    if (r.state !== yh) return l();
    for (h in i)
      if (u = i[h], u.name === r.name) {
        if (u.state === Co) return mh(a);
        u.state === Ch ? (u.state = xo, u.timer.stop(), u.on.call("interrupt", e, e.__data__, u.index, u.group), delete i[h]) : +h < t && (u.state = xo, u.timer.stop(), u.on.call("cancel", e, e.__data__, u.index, u.group), delete i[h]);
      }
    if (mh(function() {
      r.state === Co && (r.state = Ch, r.timer.restart(n, r.delay, r.time), n(c));
...
function wd(e, t) {
  var r;
  return (typeof t == "number" ? Xe : t instanceof Mi ? ph : (r = Mi(t)) ? (t = r, ph) : hb)(e, t);
}
function vb(e) {
  return function() {
    this.removeAttribute(e);
...
function Eb(e, t) {
  ...
  return this.attrTween(e, typeof t == "function" ? (r.local ? Mb : Ab)(r, i, wn(this, "attr." + e, t)) : t == null ? (r.local ? Bb : vb)(r) : (r.local ? Fb : Lb)(r, i, t));
}
function $b(e, t) {
  return function(r) {
...
function h1(e, t, r) {
  ...
  return t == null ? this.styleTween(e, s1(e, i)).on("end.style." + e, Td(e)) : typeof t == "function" ? this.styleTween(e, n1(e, i, wn(this, "style." + e, t))).each(l1(this._id, e)) : this.styleTween(e, a1(e, i, t), r).on("end.style." + e, null);
}
function c1(e, t, r) {
  return function(i) {
...
function g1(e) {
  return this.tween("text", typeof e == "function" ? f1(wn(this, "text", e)) : p1(e == null ? "" : e + ""));
}
function m1(e) {
  return function(t) {
...
function _1(e) {
  var t, r;
  e instanceof We ? (t = e._id, e = e._name) : (t = Sd(), (r = T1).time = bn(), e = e == null ? null : e + "");
...
const yL = Math.abs, CL = Math.atan2, xL = Math.cos, bL = Math.max, kL = Math.min, wL = Math.sin, TL = Math.sqrt, xh = 1e-12, Tn = Math.PI, bh = Tn / 2, SL = 2 * Tn;
function _L(e) {
  return e > 1 ? 0 : e < -1 ? Tn : Math.acos(e);
}
function vL(e) {
  return e >= 1 ? bh : e <= -1 ? -bh : Math.asin(e);
}
function F1(e) {
  let t = 3;
...
const Id = (function e(t) {
  function r(i) {
    return t ? new Od(i, t) : new Sn(i, 0);
  }
...
const N1 = (function e(t) {
  function r(i) {
    return t ? new Dd(i, t) : new _n(i, 0);
  }
  return r.alpha = function(i) {
    return e(+i);
  }, r;
...
const q1 = (function e(t) {
  function r(i) {
    return t ? new Rd(i, t) : new vn(i, 0);
  }
  return r.alpha = function(i) {
    return e(+i);
  }, r;
...
function wh(e, t, r) {
  ...
  return (kh(s) + kh(a)) * Math.min(Math.abs(s), Math.abs(a), 0.5 * Math.abs(n)) || 0;
}
function Th(e, t) {
  var r = e._x1 - e._x0;
  ...
  lineEnd: function() {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        Vs(this, this._t0, Th(this, this._t0));
        break;
    }
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  },
    ...
    if (e = +e, t = +t, !(e === this._x1 && t === this._y1)) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          this._point = 3, Vs(this, Th(this, r = wh(this, e, t)), r);
          break;
        default:
          Vs(this, this._t0, r = wh(this, e, t));
          break;
      }
  ...
  lineEnd: function() {
    ...
    if (r)
      if (this._line ? this._context.lineTo(e[0], t[0]) : this._context.moveTo(e[0], t[0]), r === 2)
        ...
        for (var i = Sh(e), o = Sh(t), s = 0, a = 1; a < r; ++s, ++a)
...
f(Qd, "isNegativeZero");
var H1 = Ln, Y1 = Xd, U1 = Vd, G1 = Kd, j1 = Qd, X1 = Zd, $t = {
  isNothing: H1,
  isObject: Y1,
  toArray: U1,
  repeat: G1,
...
}), tr = Object.prototype.hasOwnProperty, Yo = 1, Ru = 2, Pu = 3, Uo = 4, Zs = 1, bk = 2, _h = 3, kk = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, wk = /[\x85\u2028\u2029]/, Tk = /[,\[\]\{\}]/, Nu = /^(?:!|!!|![a-z\-]+!)$/i, qu = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Ba(e) {
...
function Fa(e, t, r, i) {
  ...
  for ($t.isObject(r) || K(e, "cannot merge mappings; the provided source object is unacceptable"), o = Object.keys(r), a = 0, n = o.length; a < n; a += 1)
    s = o[a], tr.call(t, s) || (Mn(t, s, r[s]), i[s] = !0);
}
f(Fa, "mergeMappings");
function pr(e, t, r, i, o, s, a, n, l) {
  ...
  if (typeof o == "object" && Ba(o) === "[object Object]" && (o = "[object Object]"), o = String(o), t === null && (t = {}), i === "tag:yaml.org,2002:merge")
    ...
    !e.json && !tr.call(r, o) && tr.call(t, o) && (e.line = a || e.line, e.lineStart = n || e.lineStart, e.position = l || e.position, K(e, "duplicated mapping key")), Mn(t, o, s), delete r[o];
  return t;
}
...
function Qu(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; d !== 0; )
    if (d = e.input.charCodeAt(++e.position), d === 43 || d === 45)
      Zs === o ? o = d === 43 ? _h : bk : K(e, "repeat of a chomping mode identifier");
    else if ((h = Hu(d)) >= 0)
...
function ip(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (a = e.input.charCodeAt(e.position)) !== 0 && (_t(e, !0, -1), a = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || a !== 37)); ) {
    ...
    a !== 0 && gs(e), tr.call(vh, i) ? vh[i](e, i, o) : $i(e, 'unknown document directive "' + i + '"');
  }
...
var _k = op, vk = {
  load: _k
}, sp = Object.prototype.toString, ap = Object.prototype.hasOwnProperty, On = 65279, Bk = 9, Oi = 10, Lk = 13, Fk = 32, Ak = 33, Mk = 34, Ma = 35, Ek = 37, $k = 38, Ok = 39, Ik = 42, np = 44, Dk = 45, Go = 58, Rk = 61, Pk = 62, Nk = 63, qk = 64, lp = 91, hp = 93, Wk = 96, cp = 123, zk = 124, dp = 125, Ht = {};
Ht[0] = "\\0";
Ht[7] = "\\a";
Ht[8] = "\\b";
Ht[9] = "\\t";
...
f(Oa, "isPlainSafe");
function mp(e) {
  return jr(e) && e !== On && !Di(e) && e !== Dk && e !== Nk && e !== Go && e !== np && e !== lp && e !== hp && e !== cp && e !== dp && e !== Ma && e !== $k && e !== Ik && e !== Ak && e !== zk && e !== Rk && e !== Pk && e !== Ok && e !== Mk && e !== Ek && e !== qk && e !== Wk;
}
...
function kp(e, t, r, i, o, s, a, n) {
  ...
  return !d && !p ? m && !a && !o(e) ? Cp : s === Ii ? $r : Ia : r > 9 && In(e) ? $r : a ? s === Ii ? $r : Ia : p ? bp : xp;
}
...
f(wp, "writeScalar");
function Da(e, t) {
  var r = In(e) ? String(t) : "", i = e[e.length - 1] === `
`, o = i && (e[e.length - 2] === `
` || e === `
`), s = o ? "+" : i ? "" : "-";
  return r + s + `
...
function To(e, t, r, i) {
  ...
  for (let s = 0; s < o.length; s++) {
    ...
    if (b2(a)) continue;
    let n = t[a], l = e[a];
    if (Wa(n) && (n = { ...n }), Wa(l) && (l = { ...l }), Rn(n) && (n = Mh(n)), Array.isArray(n)) if (Array.isArray(l)) {
    ...
    c !== void 0 ? e[a] = c : Array.isArray(n) || za(l) && za(n) && (Ks(l) || Ks(n) || wo(l) || wo(n)) ? e[a] = To(l, n, r, i) : l == null && Ks(n) ? e[a] = To({}, n, r, i) : l == null && wo(n) ? e[a] = Mh(n) : (l === void 0 || n !== void 0) && (e[a] = n);
  }
  return e;
}
function L2(e, ...t) {
...
function Eh(e) {
  if (e == null) return !0;
  if (Op(e))
    return typeof e.splice != "function" && typeof e != "string" && !Rn(e) && !wo(e) && !Wa(e) ? !1 : e.length === 0;
...
var $h = /* @__PURE__ */ f((e, t = 2) => {
  ...
  const o = zn(t, 25), s = e ? 10 : 5, a = Math.atan2(t[0].y - o.y, t[0].x - o.x), n = { x: 0, y: 0 };
...
function Np(e, t, r) {
  ...
  const o = 25 + e, s = zn(i, o), a = 10 + e * 0.5, n = Math.atan2(i[0].y - s.y, i[0].x - s.x), l = { x: 0, y: 0 };
...
var Oh = 0, R2 = /* @__PURE__ */ f(() => (Oh++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Oh), "generateId");
function Wp(e) {
  let t = "";
...
function Dh(e, t, r) {
  ...
  return a(t), r.forEach(a), Ih(e, s);
}
function iw(e, t) {
  if (e.icons[t]) return Dh(e, t, []);
  const r = rw(e, [t])[t];
  return r ? Dh(e, t, r) : null;
}
...
function cw(e, t) {
  ...
  let h, d;
  a === null ? (d = n === null ? "1em" : n === "auto" ? c : n, h = Rh(d, l / c)) : (h = a === "auto" ? l : a, d = n === null ? Rh(h, c / l) : n === "auto" ? c : n);
  const p = {}, u = (m, y) => {
    hw(y) || (p[m] = y.toString());
  };
...
const dw = /\sid="(\S+)"/g, Ph = /* @__PURE__ */ new Map();
function uw(e) {
  e = e.replace(/[0-9]+$/, "") || "a";
  const t = Ph.get(e) || 0;
  return Ph.set(e, t + 1), t ? `${e}${t}` : e;
}
function pw(e) {
  const t = [];
  let r;
...
})(), jt = { codeRemoveIndent: /^(?: {1,4}| {0,3}\t)/gm, outputLinkReplace: /\\([\[\]])/g, indentCodeCompensation: /^(\s+)(?:```)/, beginningSpace: /^\s+/, endingHash: /#$/, startingSpaceChar: /^ /, endingSpaceChar: / $/, nonSpaceChar: /[^ ]/, newLineCharGlobal: /\n/g, tabCharGlobal: /\t/g, multipleSpaceGlobal: /\s+/g, blankLine: /^[ \t]*$/, doubleBlankLine: /\n[ \t]*\n[ \t]*$/, blockquoteStart: /^ {0,3}>/, blockquoteSetextReplace: /\n {0,3}((?:=+|-+) *)(?=\n|$)/g, blockquoteSetextReplace2: /^ {0,3}>[ \t]?/gm, listReplaceTabs: /^\t+/, listReplaceNesting: /^ {1,4}(?=( {4})*[^ ])/g, listIsTask: /^\[[ xX]\] /, listReplaceTask: /^\[[ xX]\] +/, anyLine: /\n.*\n/, hrefBrackets: /^<(.*)>$/, tableDelimiter: /[:|]/, tableAlignChars: /^\||\| *$/g, tableRowBlankLine: /\n[ \t]*$/, tableAlignRight: /^ *-+: *$/, tableAlignCenter: /^ *:-+: *$/, tableAlignLeft: /^ *:-+ *$/, startATag: /^<a /i, endATag: /^<\/a>/i, startPreScriptTag: /^<(pre|code|kbd|script)(\s|>)/i, endPreScriptTag: /^<\/(pre|code|kbd|script)(\s|>)/i, startAngleBracket: /^</, endAngleBracket: />$/, pedanticHrefTitle: /^([^'"]*[^\s])\s+(['"])(.*)\2/, unicodeAlphaNumeric: /[\p{L}\p{N}]/u, escapeTest: /[&<>"']/, escapeReplace: /[&<>"']/g, escapeTestNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, escapeReplaceNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g, unescapeTest: /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig, caret: /(^|[^\[])\^/g, percentDecode: /%25/g, findPipe: /\|/g, splitPipe: / \|/, slashPipe: /\\\|/g, carriageReturn: /\r\n|\r/g, spaceLine: /^ +$/gm, notSpaceStart: /^\S*/, endingNewline: /\n$/, listItemRegex: (e) => new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`), nextBulletRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), hrRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), fencesBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}(?:\`\`\`|~~~)`), headingBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}#`), htmlBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}<(?:[a-z].*>|!--)`, "i") }, mw = /^(?:[ \t]*(?:\n|$))+/, yw = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, Cw = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, ji = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, xw = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, Xn = /(?:[*+-]|\d{1,9}[.)])/, Xp = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, Vp = mt(Xp).replace(/bull/g, Xn).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), bw = mt(Xp).replace(/bull/g, Xn).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), Vn = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, kw = /^[^\n]+/, Zn = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/, ww = mt(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", Zn).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), Tw = mt(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, Xn).getRegex(), Cs = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", Kn = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, Sw = mt("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", Kn).replace("tag", Cs).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), Zp = mt(Vn).replace("hr", ji).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Cs).getRegex(), _w = mt(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", Zp).getRegex(), Qn = { blockquote: _w, code: yw, def: ww, fences: Cw, heading: xw, hr: ji, html: Sw, lheading: Vp, list: Tw, newline: mw, paragraph: Zp, table: Bi, text: kw }, Nh = mt("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", ji).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Cs).getRegex(), vw = { ...Qn, lheading: bw, table: Nh, paragraph: mt(Vn).replace("hr", ji).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", Nh).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Cs).getRegex() }, Bw = { ...Qn, html: mt(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", Kn).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: Bi, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: mt(Vn).replace("hr", ji).replace("heading", ` *#{1,6} *[^
]`).replace("lheading", Vp).replace("|table", "").replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").replace("|tag", "").getRegex() }, Lw = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, Fw = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, Kp = /^( {2,}|\\)\n(?!\s*$)/, Aw = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, xs = /[\p{P}\p{S}]/u, Jn = /[\s\p{P}\p{S}]/u, Qp = /[^\s\p{P}\p{S}]/u, Mw = mt(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, Jn).getRegex(), Jp = /(?!~)[\p{P}\p{S}]/u, Ew = /(?!~)[\s\p{P}\p{S}]/u, $w = /(?:[^\s\p{P}\p{S}]|~)/u, Ow = mt(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", gw ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex(), tf = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, Iw = mt(tf, "u").replace(/punct/g, xs).getRegex(), Dw = mt(tf, "u").replace(/punct/g, Jp).getRegex(), ef = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", Rw = mt(ef, "gu").replace(/notPunctSpace/g, Qp).replace(/punctSpace/g, Jn).replace(/punct/g, xs).getRegex(), Pw = mt(ef, "gu").replace(/notPunctSpace/g, $w).replace(/punctSpace/g, Ew).replace(/punct/g, Jp).getRegex(), Nw = mt("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, Qp).replace(/punctSpace/g, Jn).replace(/punct/g, xs).getRegex(), qw = mt(/\\(punct)/, "gu").replace(/punct/g, xs).getRegex(), Ww = mt(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), zw = mt(Kn).replace("(?:-->|$)", "-->").getRegex(), Hw = mt("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", zw).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), Zo = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/, Yw = mt(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", Zo).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), rf = mt(/^!?\[(label)\]\[(ref)\]/).replace("label", Zo).replace("ref", Zn).getRegex(), of = mt(/^!?\[(ref)\](?:\[\])?/).replace("ref", Zn).getRegex(), Uw = mt("reflink|nolink(?!\\()", "g").replace("reflink", rf).replace("nolink", of).getRegex(), qh = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/, tl = { _backpedal: Bi, anyPunctuation: qw, autolink: Ww, blockSkip: Ow, br: Kp, code: Fw, del: Bi, emStrongLDelim: Iw, emStrongRDelimAst: Rw, emStrongRDelimUnd: Nw, escape: Lw, link: Yw, nolink: of, punctuation: Mw, reflink: rf, reflinkSearch: Uw, tag: Hw, text: Aw, url: Bi }, Gw = { ...tl, link: mt(/^!?\[(label)\]\((.*?)\)/).replace("label", Zo).getRegex(), reflink: mt(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", Zo).getRegex() }, Ha = { ...tl, emStrongRDelimAst: Pw, emStrongLDelim: Dw, url: mt(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", qh).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/, text: mt(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", qh).getRegex() }, jw = { ...Ha, br: mt(Kp).replace("{2,}", "*").getRegex(), text: mt(Ha.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() }, ao = { normal: Qn, gfm: vw, pedantic: Bw }, hi = { normal: tl, gfm: Ha, breaks: jw, pedantic: Gw }, Xw = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, Wh = (e) => Xw[e];
function Se(e, t) {
  if (t) {
    if (jt.escapeTest.test(e)) return e.replace(jt.escapeReplace, Wh);
  } else if (jt.escapeTestNoEncode.test(e)) return e.replace(jt.escapeReplaceNoEncode, Wh);
  return e;
}
function zh(e) {
  try {
...
`, t = t.substring(B.length + 1), p = I.slice(m);
  ...
  table(t) {
    ...
    let i = Hh(r[1]), o = r[2].replace(this.rules.other.tableAlignChars, "").split("|"), s = r[3]?.trim() ? r[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], a = { type: "table", raw: r[0], header: [], align: [], rows: [] };
    if (i.length === o.length) {
      ...
      for (let n of s) a.rows.push(Hh(n, a.header.length).map((l, c) => ({ text: l, tokens: this.lexer.inline(l), header: !1, align: a.align[c] })));
      return a;
    }
  }
  lheading(t) {
...
` ? r[1].slice(0, -1) : r[1];
  ...
  link(t) {
    ...
    if (r) {
      ...
      return o = o.trim(), this.rules.other.startAngleBracket.test(o) && (this.options.pedantic && !this.rules.other.endAngleBracket.test(i) ? o = o.slice(1) : o = o.slice(1, -1)), Yh(r, { href: o && o.replace(this.rules.inline.anyPunctuation, "$1"), title: s && s.replace(this.rules.inline.anyPunctuation, "$1") }, r[0], this.lexer, this.rules);
    }
  }
  reflink(t, r) {
    let i;
    if ((i = this.rules.inline.reflink.exec(t)) || (i = this.rules.inline.nolink.exec(t))) {
      ...
      return Yh(i, s, i[0], this.lexer, this.rules);
    }
  }
  emStrong(t, r, i = "") {
...
`;
  ...
  link({ href: t, title: r, tokens: i }) {
    let o = this.parser.parseInline(i), s = zh(t);
    if (s === null) return o;
    t = s;
    let a = '<a href="' + t + '"';
  ...
  textRenderer;
  constructor(t) {
    this.options = t || wr, this.options.renderer = this.options.renderer || new Qo(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new el();
  }
  static parse(t, r) {
...
function rl(e, t, r, i) {
  ...
  const [o, ...s] = r, a = [...t, o];
  return e([{ content: a.join(""), type: i }]) ? rl(e, a, s, i) : (t.length === 0 && o && (t.push(o), r.shift()), [
    { content: t.join(""), type: i },
...
async function mf(e, t, r, i, o = !1, s = wt()) {
  ...
  a.attr("width", `${Math.min(10 * r, Uh)}px`), a.attr("height", `${Math.min(10 * r, Uh)}px`);
...
const cT = 0, ta = 1, Gh = 2, no = { A: 7, a: 7, C: 6, c: 6, H: 1, h: 1, L: 2, l: 2, M: 2, m: 2, Q: 4, q: 4, S: 4, s: 4, T: 2, t: 2, V: 1, v: 1, Z: 0, z: 0 };
function ea(e, t) {
  return e.type === t;
}
function ol(e) {
  const t = [], r = (function(a) {
    ...
    return n[n.length] = { type: Gh, text: "" }, n;
  })(e);
  let i = "BOD", o = 0, s = r[o];
  for (; !ea(s, Gh); ) {
    let a = 0;
    const n = [];
    if (i === "BOD") {
      if (s.text !== "M" && s.text !== "m") return ol("M0,0" + e);
...
function jh(e, t) {
  if (e.length) {
    const r = typeof e[0][0] == "number" ? [e] : e, i = lo(r[0], 1 * (1 + 0.2 * t.roughness), t), o = t.disableMultiStroke ? [] : lo(r[0], 1.5 * (1 + 0.22 * t.roughness), Zh(t));
    for (let s = 1; s < r.length; s++) {
      const a = r[s];
      if (a.length) {
        const n = lo(a, 1 * (1 + 0.2 * t.roughness), t), l = t.disableMultiStroke ? [] : lo(a, 1.5 * (1 + 0.22 * t.roughness), Zh(t));
...
function Va(e, t, r, i) {
  const [o, s] = Kh(i.increment, e, t, i.rx, i.ry, 1, i.increment * ts(0.1, ts(0.4, 1, r), r), r);
  let a = es(o, null, r);
  if (!r.disableMultiStroke && r.roughness !== 0) {
    const [n] = Kh(i.increment, e, t, i.rx, i.ry, 1.5, 0, r), l = es(n, null, r);
    a = a.concat(l);
  }
  return { estimatedPoints: s, opset: { type: "path", ops: a } };
}
function Xh(e, t, r, i, o, s, a, n, l) {
  const c = e, h = t;
  ...
  const m = 2 * Math.PI / l.curveStepCount, y = Math.min(m / 2, (g - u) / 2), C = Qh(y, c, h, d, p, u, g, 1, l);
  if (!l.disableMultiStroke) {
    const b = Qh(y, c, h, d, p, u, g, 1.5, l);
    C.push(...b);
  }
...
class is {
  ...
  curve(t, r) {
    const i = this._o(r), o = [], s = jh(t, i);
    if (i.fill && i.fill !== ie) if (i.fillStyle === "solid") {
      const a = jh(t, Object.assign(Object.assign({}, i), { disableMultiStroke: !0, roughness: i.roughness ? i.roughness + i.fillShapeRoughnessGain : 0 }));
      o.push({ type: "fillPath", ops: this._mergedShape(a.ops) });
    } else {
      const a = [], n = t;
      if (n.length) {
        const l = typeof n[0][0] == "number" ? [n] : n;
        for (const c of l) c.length < 3 ? a.push(...c) : c.length === 3 ? a.push(...ia(Jh([c[0], c[0], c[1], c[2]]), 10, (1 + i.roughness) / 2)) : a.push(...ia(Jh(c), 10, (1 + i.roughness) / 2));
      }
  ...
  path(t, r) {
    ...
    const s = i.fill && i.fill !== "transparent" && i.fill !== ie, a = i.stroke !== ie, n = !!(i.simplification && i.simplification < 1), l = (function(h, d, p) {
      ...
      return T;
    })(t, 1, n ? 4 - 4 * (i.simplification || 1) : (1 + i.roughness) / 2), c = Vh(t, i);
    if (s) if (i.fillStyle === "solid") if (l.length === 1) {
      const h = Vh(t, Object.assign(Object.assign({}, i), { disableMultiStroke: !0, roughness: i.roughness ? i.roughness + i.fillShapeRoughnessGain : 0 }));
...
var MT = /* @__PURE__ */ f((e, t, r, i, o, s) => [
  ...
  `a${o},${s} 0,0,0 ${r},0`,
  `l0,${-i}`
].join(" "), "createOuterCylinderPathD"), $T = /* @__PURE__ */ f((e, t, r, i, o, s) => [`M${e - r / 2},${-i / 2}`, `a${o},${s} 0,0,0 ${r},0`].join(" "), "createInnerCylinderPathD"), tc = 8, ec = 8;
async function Uf(e, t) {
  ...
  if (t.width || t.height) {
    const y = t.width ?? 0;
    t.width = (t.width ?? 0) - a, t.width < ec && (t.width = ec);
    const b = y / 2 / (2.5 + y / 50);
    t.height = (t.height ?? 0) - s - b * 3, t.height < tc && (t.height = tc);
  }
...
async function Zf(e, t) {
  ...
  (t.width || t.height) && (t.height = t?.height ?? 0, t.height < rc && (t.height = rc), t.width = (t?.width ?? 0) - s - s / 2, t.width < ic && (t.width = ic));
...
var IT = /* @__PURE__ */ f((e, t, r, i, o, s, a) => [
  ...
  `M${e},${t + s + a}`,
  `a${o},${s} 0,0,0 ${r},0`
].join(" "), "createOuterCylinderPathD"), RT = /* @__PURE__ */ f((e, t, r, i, o, s) => [`M${e - r / 2},${-i / 2}`, `a${o},${s} 0,0,0 ${r},0`].join(" "), "createInnerCylinderPathD"), oc = 10, sc = 10;
async function dg(e, t) {
  ...
  if (t.width || t.height) {
    const C = t.width ?? 0;
    t.width = (t.width ?? 0) - s, t.width < sc && (t.width = sc);
...
var NT = /* @__PURE__ */ f((e, t, r, i, o, s) => `M${e},${t}
  ...
  `a${o},${s} 0,0,0 0,${i}`,
  `l${r},0`
].join(" "), "createOuterCylinderPathD"), WT = /* @__PURE__ */ f((e, t, r, i, o, s) => [`M${e + r / 2},${-i / 2}`, `a${o},${s} 0,0,0 0,${i}`].join(" "), "createInnerCylinderPathD"), ac = 5, nc = 10;
async function Mg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  ...
  if (t.width || t.height) {
    const m = t.height ?? 0;
    t.height = (t.height ?? 0) - s, t.height < ac && (t.height = ac);
    const C = m / 2 / (2.5 + m / 50);
    t.width = (t.width ?? 0) - s - C * 3, t.width < nc && (t.width = nc);
  }
...
async function Og(e, t) {
  ...
  t.labelStyle = r;
  const o = t.padding ?? 0, s = t.look === "neo" ? o * 2 : o;
  (t.width || t.height) && (t.width = ((t?.width ?? 0) - s) / 2, t.width < hc && (t.width = hc), t.height = t?.height ?? 0, t.height < lc && (t.height = lc));
...
f(Rg, "windowPane");
var cc = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), zT = /* @__PURE__ */ new Set(["redux", "redux-dark", "redux-color", "redux-dark-color"]);
async function al(e, t) {
  ...
  }), y.select(".name").attr("transform", "translate(" + -C.width / 2 + ", " + (Y + d / 2) + ")"), i != null && cc.has(i)) {
...
async function Or(e, t, r, i = 0, o = 0, s = [], a = "") {
  ...
  t !== th(t) && (t = th(t), t = t.replaceAll("<", "&lt;").replaceAll(">", "&gt;"));
...
var OL = /* @__PURE__ */ f((e, t) => {
  ...
  t.arrowTypeStart && dc(
    ...
    s,
    a
  ), t.arrowTypeEnd && dc(e, "end", t.arrowTypeEnd, r, i, o, s, a);
}, "addEdgeMarkers"), XT = {
  ...
  "dependency",
  "barb"
], dc = /* @__PURE__ */ f((e, t, r, i, o, s, a = !1, n) => {
...
var QT = /* @__PURE__ */ f((e, t) => {
  ...
  const i = gt(), { subGraphTitleTotalMargin: o } = Gn(i);
  if (e.label) {
    const s = os.get(e.id);
    let a = e.x, n = e.y;
    if (r) {
...
}, "intersection"), uc = /* @__PURE__ */ f((e, t) => {
...
var pc = /* @__PURE__ */ f(function(e, t, r) {
  ...
  for (let i = 0; i < e.length; i++)
    if (t.includes(i)) {
      const o = e[i - 1], s = e[i + 1], a = e[i], n = pc(o, a, 5), l = pc(s, a, 5), c = l.x - n.x, h = l.y - n.y;
      r.push(n);
  ...
  t.toCluster && (P.info("to cluster abc88", r.get(t.toCluster)), c = uc(t.points, r.get(t.toCluster).node), h = !0), t.fromCluster && (P.debug(
    "from cluster abc88",
    r.get(t.fromCluster),
    JSON.stringify(c, null, 2)
  ), c = uc(c.reverse(), r.get(t.fromCluster).node).reverse(), h = !0);
  ...
  if (t.look === "handDrawn") {
    ...
    const Y = v.node(), Q = typeof Y.getTotalLength == "function" ? Y.getTotalLength() : 0, ut = Bh[t.arrowTypeStart] || 0, et = Bh[t.arrowTypeEnd] || 0;
    if (t.look === "neo" && !$) {
...
var oS = /* @__PURE__ */ f((e, t, r, i) => {
  ...
  Kg([
    {
      name: "dagre",
      loader: /* @__PURE__ */ f(async () => await import("./dagre-BM42HDAG-BRO5i-uP.js"), "loader")
    },
    {
      name: "cose-bilkent",
      loader: /* @__PURE__ */ f(async () => await import("./cose-bilkent-S5V4N54A-D3BVmmPm.js"), "loader")
    }
  ]);
...
}, "getRegisteredLayoutAlgorithm"), nl = "comm", Qg = "rule", Jg = "decl", MS = "@media", ES = "@import", $S = "@supports", OS = "@namespace", rn = "@keyframes", tm = "@layer", IS = "@scope", em = Math.abs, ll = String.fromCharCode;
function rm(e) {
  return e.trim();
}
function vo(e, t, r) {
    ...
    switch (g = b, b = Ce()) {
      ...
      case 0:
        switch (b) {
          ...
          // ;
          case 59 + h:
            C == -1 && (B = vo(B, /\f/g, "")), u > 0 && (ve(B) - d || m === 0 && g === 47) && uo(u > 32 ? gc(B + ";", i, r, d - 1, l) : gc(vo(B, " ", "") + ";", i, r, d - 2, l), l);
            break;
          // @ ;
          case 59:
            B += ";";
          // { rule/at-rule
          default:
            if (uo(v = fc(B, t, r, c, h, o, n, k, T = [], S = [], d, s), s), b === 123)
              if (h === 0)
                ...
                h ? Lo(e, v, v, i && uo(fc(e, v, v, 0, 0, o, n, k, o, T = [], d, S), S), o, S, d, n, i ? T : S) : Lo(B, v, v, v, [""], S, 0, n, S);
              }
        }
...
function fc(e, t, r, i, o, s, a, n, l, c, h, d) {
  ...
  return hl(e, t, r, o === 0 ? Qg : n, l, c, h, d);
}
function GS(e, t, r, i) {
  return hl(e, t, r, nl, ll(RS()), Xr(e, 2, -2), 0, i);
}
function gc(e, t, r, i, o) {
  return hl(e, t, r, Jg, Xr(e, 0, i), Xr(e, i + 1, -1), i, o);
}
function sn(e, t) {
...
var sm = "c4", VS = /* @__PURE__ */ f((e) => /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(e), "detector"), ZS = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./c4Diagram-AAUBKEIU-B6wQKPdA.js");
  ...
  const { diagram: e } = await import("./flowDiagram-I6XJVG4X-DJHZb4V9.js");
  ...
  const { diagram: e } = await import("./erDiagram-TEJ5UH35-yFWY-rl8.js");
  ...
  const { diagram: e } = await import("./gitGraphDiagram-PVQCEYII-CQS7Way0.js");
  ...
  const { diagram: e } = await import("./ganttDiagram-6RSMTGT7-BZf3nY33.js");
  ...
  const { diagram: e } = await import("./infoDiagram-5YYISTIA-BEQbaldp.js");
  ...
  const { diagram: e } = await import("./pieDiagram-4H26LBE5-C1q6oq6l.js");
  ...
  const { diagram: e } = await import("./quadrantDiagram-W4KKPZXB-BLYDiIDe.js");
  ...
  const { diagram: e } = await import("./xychartDiagram-2RQKCTM6-DxxyVcQ8.js");
  ...
  const { diagram: e } = await import("./requirementDiagram-4Y6WPE33-CSTg7B7-.js");
  ...
  const { diagram: e } = await import("./sequenceDiagram-3UESZ5HK-DTmXM9Jw.js");
  ...
  const { diagram: e } = await import("./classDiagram-4FO5ZUOK-DbH_QfBg.js");
  ...
  const { diagram: e } = await import("./classDiagram-v2-Q7XG4LA2-DbH_QfBg.js");
  return { id: Cm, diagram: e };
}, "loader"), j_ = {
  id: Cm,
  detector: U_,
  ...
  const { diagram: e } = await import("./stateDiagram-AJRCARHV-6NUJlP9F.js");
  ...
  const { diagram: e } = await import("./stateDiagram-v2-BHNVJYJU-o_iewmsX.js");
  ...
  const { diagram: e } = await import("./journeyDiagram-JHISSGLW-DzPGRkCP.js");
...
`);
  ...
  const { diagram: e } = await import("./timeline-definition-PNZ67QCA-EnI3EMDM.js");
  return { id: Sm, diagram: e };
}, "loader"), yv = {
  id: Sm,
  detector: gv,
  ...
  const { diagram: e } = await import("./mindmap-definition-RKZ34NQL-ovMIa6U7.js");
  ...
  const { diagram: e } = await import("./kanban-definition-UN3LZRKU-Bu7aJtZn.js");
  ...
  const { diagram: e } = await import("./sankeyDiagram-5OEKKPKP-BgHypswD.js");
  return { id: Bm, diagram: e };
}, "loader"), Fv = {
  id: Bm,
  detector: Bv,
  ...
  const { diagram: e } = await import("./diagram-LMA3HP47-Qmw-P961.js");
  return { id: Lm, diagram: e };
}, "loader"), $v = {
  id: Lm,
  detector: Mv,
  ...
  const { diagram: e } = await import("./diagram-2AECGRRQ-BAFcmUCI.js");
  return { id: Fm, diagram: e };
}, "loader"), Dv = {
  id: Fm,
  detector: Ov,
  ...
  const { diagram: e } = await import("./blockDiagram-GPEHLZMM-DPW8c4L3.js");
  return { id: Am, diagram: e };
}, "loader"), Nv = {
  id: Am,
  detector: Rv,
  ...
  const { diagram: e } = await import("./diagram-5GNKFQAL-WqMrJjdM.js");
  return { id: Mm, diagram: e };
}, "loader"), Hv = {
  id: Mm,
  detector: Wv,
  ...
  const { diagram: e } = await import("./architectureDiagram-3BPJPVTR-b051V14U.js");
  ...
  const { diagram: e } = await import("./diagram-KO2AKTUF-Dm6itAWf.js");
  ...
  const { diagram: e } = await import("./ishikawaDiagram-YF4QCWOH-CWObSxY0.js");
  ...
  const { diagram: e } = await import("./vennDiagram-CIIHVFJN-D6AQx3YH.js");
  ...
  const { diagram: e } = await import("./diagram-OG6HWLK6-Bz6s4mvH.js");
  return { id: Dm, diagram: e };
}, "loader"), lB = {
  id: Dm,
  detector: aB,
  ...
  const { diagram: e } = await import("./wardleyDiagram-YWT4CUSO-DmDXZ24a.js");
  return { id: Rm, diagram: e };
}, "loader"), dB = {
  id: Rm,
  detector: hB,
  loader: cB
}, uB = dB, mc = !1, vs = /* @__PURE__ */ f(() => {
  mc || (mc = !0, $o("error", cv, (e) => e.toLowerCase().trim() === "error"), $o(
    "---",
...
function cl(e) {
  const t = yB(e), r = CB(t), i = xB(r.text), o = Un(r.config, i.directive);
  return e = mB(i.text), {
    code: e,
    title: r.title,
    config: o
...
f(dl, "processAndSetConfigs");
async function Hm(e, t) {
  vs();
  try {
    const { code: r, config: i } = dl(e);
...
var Cc = /* @__PURE__ */ f((e, t, r = []) => {
  ...
  if (e.fontFamily !== void 0 && r.insertRule(
    ...
    t.forEach((l) => {
      Eh(l.styles) || n.forEach((c) => {
        r.insertRule(
          Cc(l.id, c, l.styles),
          r.cssRules.length
        );
      }), Eh(l.textStyles) || r.insertRule(
        Cc(
          l.id,
          "tspan",
...
}, "putIntoIFrame"), xc = /* @__PURE__ */ f((e, t, r, i, o) => {
...
var zB = /* @__PURE__ */ f((e, t, r) => {
  P.warn(e), Yn(e) ? (r && r(e.str, e.hash), t.push({ ...e, message: e.str, error: e })) : (r && r(e), e instanceof Error && t.push({
    str: e.message,
    message: e.message,
    hash: e.name,
    error: e
  ...
  try {
    ...
    if (Yn(t) && P.error(t.str), He.parseError && He.parseError(t), !e.suppressErrors)
 ...
 */
var VB = Object.defineProperty, ZB = Object.getOwnPropertyDescriptor, ul = (e, t, r, i) => {
...
ul([
  ln("Defines the color scheme or style used for the Mermaid diagram."),
  vc()
], qi.prototype, "theme", 2);
ul([
  ln("Contains the Mermaid diagram code itself."),
  vc()
], qi.prototype, "value", 2);
qi = ul([
  ln("Represents the settings for a Mermaid diagram widget."),
  x0({ type: "http://org.eclipse.daanse.board.app.ui.vue.widget.mermaid#//MermaidWidgetSettings" })
], qi);
const KB = /* @__PURE__ */ kc({
  ...
  setup(e, { expose: t }) {
    const r = wc(e, "configv"), i = e, { id: o } = p0(i), s = Ol(C0.TINY_EMITTER), a = Ol(a0), l = y0().params.pageid || "", c = qs(1);
    class h extends ns {
      refresh() {
        m.value = Date.now(), Ws(() => {
    ...
    }, { deep: !0, immediate: !0 }), (C, b) => (Sc(), Tc("div", {
      ref_key: "container",
      ref: g,
      key: m.value,
      onClick: p,
      onContextmenu: g0(u, ["prevent"]),
      class: "w-full h-full"
    }, m0(r.value.value), 33));
  }
}), QB = { class: "settings_container" }, JB = /* @__PURE__ */ kc({
  ...
  setup(e) {
    const t = wc(e, "modelValue");
    return (r, i) => {
      const o = Rl("VaTextarea"), s = Rl("VaSelect");
      return Sc(), Tc("div", QB, [
        Pl(o, {
...
var iL = Object.defineProperty, oL = Object.getOwnPropertyDescriptor, pl = (e, t, r, i) => {
