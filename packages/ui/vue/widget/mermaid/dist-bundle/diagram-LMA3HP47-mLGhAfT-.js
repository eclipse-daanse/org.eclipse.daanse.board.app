import { _ as b, F as u, I as $, e as B, l as m, b as C, a as S, p as D, q as T, g as z, s as F, D as P, G as E, z as A } from "./index-D6Sc1U0b.js";
import { p as W } from "./chunk-4BX2VUAB-B_FFW1-Y.js";
import { p as _ } from "./wardley-L42UT6IY-C-B6soca.js";
var N = E.packet, w = class {
  constructor() {
    this.packet = [], this.setAccTitle = C, this.getAccTitle = S, this.setDiagramTitle = D, this.getDiagramTitle = T, this.getAccDescription = z, this.setAccDescription = F;
  }
  static {
    b(this, "PacketDB");
  }
  ...
  for (let { start: a, end: i, bits: d, label: c } of t.blocks) {
    ...
    for (i ??= a + (d ?? 1) - 1, d ??= i - a + 1, r = i, m.debug(`Packet block ${a} - ${r} with label ${c}`); s.length <= l + 1 && e.getPacket().length < I; ) {
...
}, "draw"), G = /* @__PURE__ */ b((t, e, r, { rowHeight: s, paddingX: n, paddingY: l, bitWidth: a, bitsPerRow: i, showBits: d }) => {
