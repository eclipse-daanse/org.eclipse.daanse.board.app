import { _ as l, s as k, g as I, q as R, p as F, a as _, b as D, I as E, z, F as y, D as C, G, l as P, K as W, e as B } from "./index-Ctx7Hj0L.js";
import { p as V } from "./chunk-4BX2VUAB-BMfJU_9w.js";
...
var h = {
  ...
  curves: [],
  options: h
}, x = structuredClone(w), j = G.radar, q = /* @__PURE__ */ l(() => y({
  ...j,
  ...C().radar
}), "getConfig"), b = /* @__PURE__ */ l(() => x.axes, "getAxes"), K = /* @__PURE__ */ l(() => x.curves, "getCurves"), N = /* @__PURE__ */ l(() => x.options, "getOptions"), U = /* @__PURE__ */ l((a) => {
  x.axes = a.map((t) => ({
    name: t.name,
  ...
  const s = r.db, o = s.getAxes(), i = s.getCurves(), n = s.getOptions(), c = s.getConfig(), d = s.getDiagramTitle(), p = E(t), u = at(p, c), g = n.max ?? Math.max(...i.map((f) => Math.max(...f.entries))), m = n.min, v = Math.min(c.width, c.height) / 2;
