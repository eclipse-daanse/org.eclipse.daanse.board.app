...
import { activate as l0, deactivate as h0, component as c0, inject as El } from "@eclipse-daanse/tsm";
import { defineComponent as kc, mergeModels as d0, useModel as wc, toRefs as u0, inject as $l, ref as qs, onMounted as Ol, onUnmounted as p0, watch as Il, nextTick as Ws, createElementBlock as Tc, openBlock as Sc, withModifiers as f0, toDisplayString as g0, resolveComponent as Dl, createVNode as Rl } from "vue";
import { useRoute as m0 } from "vue-router";
import { WidgetAction as _c, WidgetActionInterface as C0, Payload as Pl } from "org.eclipse.daanse.board.app.lib.events";
...
var oS = /* @__PURE__ */ f((e, t, r, i) => {
  ...
  Kg([
    {
      name: "dagre",
      loader: /* @__PURE__ */ f(async () => await import("./dagre-BM42HDAG-B7I1f6BW.js"), "loader")
    },
    {
      name: "cose-bilkent",
      loader: /* @__PURE__ */ f(async () => await import("./cose-bilkent-S5V4N54A-CdFDgj3-.js"), "loader")
    }
  ]);
...
var sm = "c4", VS = /* @__PURE__ */ f((e) => /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(e), "detector"), ZS = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./c4Diagram-AAUBKEIU-3lffj4L1.js");
  ...
  const { diagram: e } = await import("./flowDiagram-I6XJVG4X-BZ5eOUBH.js");
  ...
  const { diagram: e } = await import("./erDiagram-TEJ5UH35-D-DgZCgd.js");
  ...
  const { diagram: e } = await import("./gitGraphDiagram-PVQCEYII-Cw5-v4kr.js");
  ...
  const { diagram: e } = await import("./ganttDiagram-6RSMTGT7-BcrQm_43.js");
  ...
  const { diagram: e } = await import("./infoDiagram-5YYISTIA-BzY25dn7.js");
  ...
  const { diagram: e } = await import("./pieDiagram-4H26LBE5-CrrtKefh.js");
  ...
  const { diagram: e } = await import("./quadrantDiagram-W4KKPZXB-FuM7VMI2.js");
  ...
  const { diagram: e } = await import("./xychartDiagram-2RQKCTM6-yTMw5Tg3.js");
  ...
  const { diagram: e } = await import("./requirementDiagram-4Y6WPE33-DIi_TbiR.js");
  ...
  const { diagram: e } = await import("./sequenceDiagram-3UESZ5HK-BpmhpoM8.js");
  ...
  const { diagram: e } = await import("./classDiagram-4FO5ZUOK-DGnT_5p0.js");
  ...
  const { diagram: e } = await import("./classDiagram-v2-Q7XG4LA2-DGnT_5p0.js");
  return { id: Cm, diagram: e };
}, "loader"), j_ = {
  id: Cm,
  detector: U_,
  ...
  const { diagram: e } = await import("./stateDiagram-AJRCARHV-Ck6RuonN.js");
  ...
  const { diagram: e } = await import("./stateDiagram-v2-BHNVJYJU-BHiTsaXN.js");
  ...
  const { diagram: e } = await import("./journeyDiagram-JHISSGLW-DLA5Bakq.js");
...
`);
  ...
  const { diagram: e } = await import("./timeline-definition-PNZ67QCA-C5yLNEFQ.js");
  return { id: Sm, diagram: e };
}, "loader"), yv = {
  id: Sm,
  detector: gv,
  ...
  const { diagram: e } = await import("./mindmap-definition-RKZ34NQL-CKHxmHM_.js");
  ...
  const { diagram: e } = await import("./kanban-definition-UN3LZRKU-hJLQzmsl.js");
  ...
  const { diagram: e } = await import("./sankeyDiagram-5OEKKPKP-DbE8Sf0m.js");
  return { id: Bm, diagram: e };
}, "loader"), Fv = {
  id: Bm,
  detector: Bv,
  ...
  const { diagram: e } = await import("./diagram-LMA3HP47-mLGhAfT-.js");
  return { id: Lm, diagram: e };
}, "loader"), $v = {
  id: Lm,
  detector: Mv,
  ...
  const { diagram: e } = await import("./diagram-2AECGRRQ-PMSrTnC4.js");
  return { id: Fm, diagram: e };
}, "loader"), Dv = {
  id: Fm,
  detector: Ov,
  ...
  const { diagram: e } = await import("./blockDiagram-GPEHLZMM-BGzC7E0a.js");
  return { id: Am, diagram: e };
}, "loader"), Nv = {
  id: Am,
  detector: Rv,
  ...
  const { diagram: e } = await import("./diagram-5GNKFQAL-t0PayS4I.js");
  return { id: Mm, diagram: e };
}, "loader"), Hv = {
  id: Mm,
  detector: Wv,
  ...
  const { diagram: e } = await import("./architectureDiagram-3BPJPVTR-dtYcq3FK.js");
  ...
  const { diagram: e } = await import("./diagram-KO2AKTUF-CAOeC_I0.js");
  ...
  const { diagram: e } = await import("./ishikawaDiagram-YF4QCWOH-CO8ZmvwI.js");
  ...
  const { diagram: e } = await import("./vennDiagram-CIIHVFJN-DBZBoO_9.js");
  ...
  const { diagram: e } = await import("./diagram-OG6HWLK6-D471ZRMl.js");
  return { id: Dm, diagram: e };
}, "loader"), lB = {
  id: Dm,
  detector: aB,
  ...
  const { diagram: e } = await import("./wardleyDiagram-YWT4CUSO-Dr_Jka4v.js");
...
const KB = /* @__PURE__ */ kc({
  ...
  setup(e, { expose: t }) {
    const r = wc(e, "configv"), i = e, { id: o } = u0(i), s = $l(y0.TINY_EMITTER), a = $l(s0), l = m0().params.pageid || "", c = qs(1);
    class h extends ns {
      refresh() {
        m.value = Date.now(), Ws(() => {
    ...
    }, { immediate: !0 }), Il(() => r.value.value, async (C) => {
      m.value = Date.now(), await Ws();
      try {
        await po.run({
          nodes: g.value ? [g.value] : []
  ...
  setup(e) {
    ...
    return (r, i) => {
      const o = Dl("VaTextarea"), s = Dl("VaSelect");
      return Sc(), Tc("div", QB, [
        Rl(o, {
