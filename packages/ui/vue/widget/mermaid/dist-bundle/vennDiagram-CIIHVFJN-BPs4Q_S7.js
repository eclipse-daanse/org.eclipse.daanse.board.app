import { aU as Gt, _ as w, s as Wt, g as Kt, q as Ht, p as Xt, a as Yt, b as Zt, D as wt, I as Jt, d as ot, al as Qt, V as $t, W as te, X as ee, e as ne, z as se, F as ie, G as oe } from "./index-EP6gW4O2.js";
...
function be(t = {}) {
  ...
  function l(p) {
    ...
    if (f.length > 0) {
      ...
      c && (k = Ct(k, a, d)), I = Nt(k, s, e, i, h), D = jt(I, f, M);
    }
    const U = {};
    f.forEach((k) => {
    ...
    const L = z.selectAll("text").filter((k) => k.sets in D).text((k) => j(k)).attr("x", (k) => Math.floor(D[k.sets].x)).attr("y", (k) => Math.floor(D[k.sets].y));
    ...
    return y !== null && (W.style("font-size", "0px"), L.style("font-size", y), Y.style("font-size", "0px")), { circles: I, textCentres: D, nodes: V, enter: O, update: z, exit: C };
  }
  return l.wrap = function(p) {
    ...
    return arguments.length ? (v = p === "default" ? tt : p === "logRatio" ? Dt : p, l) : v;
  }, l;
}
function rt(t, n) {
  return function(s) {
  ...
  var t = /* @__PURE__ */ w(function(S, g, m, v) {
    ...
    performAction: /* @__PURE__ */ w(function(g, m, v, l, p, f, N) {
      ...
      switch (p) {
        ...
        case 25:
        case 26:
          var D = l.getCurrentSets();
          if (!D) throw new Error("text requires set");
          l.addTextData(D, f[I], void 0);
          break;
        case 27:
        case 28:
          var D = l.getCurrentSets();
          if (!D) throw new Error("text requires set");
          l.addTextData(D, f[I - 1], f[I]);
          break;
        case 29:
        case 41:
          this.$ = [f[I]];
    ...
    parse: /* @__PURE__ */ w(function(g) {
      var m = this, v = [0], l = [], p = [null], f = [], N = this.table, I = "", D = 0, U = 0, j = 2, E = 1, R = f.slice.call(arguments, 1), _ = Object.create(this.lexer), P = { yy: {} };
      ...
      for (var z, L, C, Y, k = {}, F, H, et, X; ; ) {
        if (L = v[v.length - 1], this.defaultActions[L] ? C = this.defaultActions[L] : ((z === null || typeof z > "u") && (z = K()), C = N[L] && N[L][z]), typeof C > "u" || !C.length || !C[0]) {
          ...
          _.showPosition ? Z = "Parse error on line " + (D + 1) + `:
` + _.showPosition() + `
Expecting ` + X.join(", ") + ", got '" + (this.terminals_[z] || z) + "'" : Z = "Parse error on line " + (D + 1) + ": Unexpected " + (z == E ? "end of input" : "'" + (this.terminals_[z] || z) + "'"), this.parseError(Z, {
            text: _.match,
        ...
        switch (C[0]) {
          case 1:
            v.push(z), p.push(_.yytext), f.push(_.yylloc), v.push(C[1]), z = null, U = _.yyleng, I = _.yytext, D = _.yylineno, O = _.yylloc;
            break;
          case 2:
...
}, "validateUnionIdentifiers"), De = /* @__PURE__ */ w(() => pt, "getTextData"), Ce = /* @__PURE__ */ w(() => vt, "getCurrentSets"), Ne = /* @__PURE__ */ w(() => It, "getIndentMode"), Oe = /* @__PURE__ */ w((t) => {
  It = t;
...
var Be = /* @__PURE__ */ w((t, n, s, e) => {
  ...
  for (const E of N) {
    const R = Q([...E.data.sets].sort());
    I.set(R, E);
  }
  b.length > 0 && Ut(o, I, l, b, S, x);
  const D = $t(a.background || "#f4f4f4");
  l.selectAll(".venn-circle").each(function(E, R) {
    const _ = ot(this), V = Q([...E.sets].sort()), O = x.get(V), B = O?.fill || r[R % r.length] || a.primaryColor;
...
function Ut(t, n, s, e, i, o) {
  ...
  for (const [r, y] of u.entries()) {
    ...
    const g = Math.max(80 * i, T * 2 * 0.95), m = Math.max(60 * i, T * 2 * 0.95), p = (d.data.label && d.data.label.length > 0 ? Math.min(32 * i, T * 0.25) : 0) + (y.length <= 2 ? 30 * i : 0), f = b - g / 2, N = x - m / 2 + p, I = Math.max(1, Math.ceil(Math.sqrt(y.length))), D = Math.max(1, Math.ceil(y.length / I)), U = g / I, j = m / D;
