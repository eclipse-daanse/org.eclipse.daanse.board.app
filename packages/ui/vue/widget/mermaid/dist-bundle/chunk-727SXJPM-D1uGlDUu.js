import { g as tt } from "./chunk-FMBD7UC4-CZO0m-92.js";
import { c as st } from "./chunk-ND2GUHAM-_S5HRu_N.js";
import { g as it } from "./chunk-55IACEB6-BoqqIC4_.js";
import { s as at } from "./chunk-2J33WTMH-DIX9piRb.js";
import { _ as f, l as Ie, c as F, o as rt, r as nt, u as Oe, d as de, y as ut, b as lt, a as ct, s as ot, g as ht, p as dt, q as pt, k as I, z as At, x as ft, i as gt, Q as G } from "./index-DYXa-Aya.js";
var we = (function() {
  var t = /* @__PURE__ */ f(function(O, o, h, p) {
    ...
    parse: /* @__PURE__ */ f(function(o) {
      ...
      f(Qe, "lex");
      for (var B, V, L, xe, R = {}, oe, v, We, he; ; ) {
        if (V = p[p.length - 1], this.defaultActions[V] ? L = this.defaultActions[V] : ((B === null || typeof B > "u") && (B = Qe()), L = J[V] && J[V][B]), typeof L > "u" || !L.length || !L[0]) {
          var ve = "";
          he = [];
          for (oe in J[V])
        ...
        switch (L[0]) {
          ...
          case 2:
            if (v = this.productions_[L[1]][1], R.$ = C[C.length - v], R._$ = {
              ...
              return xe;
            v && (p = p.slice(0, -1 * v * 2), C = C.slice(0, -1 * v), e = e.slice(0, -1 * v)), p.push(this.productions_[L[1]][0]), C.push(R.$), e.push(R._$), We = J[p[p.length - 2]][p[p.length - 1]], p.push(We);
            break;
          case 3:
            return !0;
        }
