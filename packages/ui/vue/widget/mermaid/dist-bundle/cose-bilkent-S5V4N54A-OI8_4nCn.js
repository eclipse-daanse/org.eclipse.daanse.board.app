import { b4 as lt, _ as V, l as $, d as gt } from "./index-Ctx7Hj0L.js";
import { c as tt } from "./cytoscape.esm-CxgSUbXJ.js";
...
function it(G) {
  return new Promise((b) => {
    const N = gt("body").append("div").attr("id", "cy").attr("style", "display:none"), I = tt({
