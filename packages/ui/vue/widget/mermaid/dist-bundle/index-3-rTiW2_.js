...
Fc([
  Lc({ eventType: "mermaid.refresh" })
], no.prototype, "refresh");
Fc([
  Lc({ eventType: "mermaid.zoom" })
], no.prototype, "zoom");
function A0(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var fs = { exports: {} }, E0 = fs.exports, zl;
function M0() {
  return zl || (zl = 1, (function(e, t) {
    (function(r, i) {
      e.exports = i();
    })(E0, (function() {
      var r = 1e3, i = 6e4, s = 36e5, o = "millisecond", a = "second", n = "minute", l = "hour", c = "day", h = "week", u = "month", p = "quarter", d = "year", g = "date", m = "Invalid Date", y = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, C = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, b = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(I) {
...
var $0 = M0();
const I0 = /* @__PURE__ */ A0($0);
var Ac = Object.defineProperty, f = (e, t) => Ac(e, "name", { value: t, configurable: !0 }), O0 = (e, t) => {
  for (var r in t)
    Ac(e, r, { get: t[r], enumerable: !0 });
}, Re = {
  trace: 0,
  debug: 1,
  info: 2,
...
}, hn = /* @__PURE__ */ f(function(e = "fatal") {
  let t = Re.fatal;
...
}, "setLogLevel"), le = /* @__PURE__ */ f((e) => `%c${I0().format("ss.SSS")} : ${e} : `, "format");
const gs = {
  /* CLAMP */
  min: {
    r: 0,
...
class N0 {
  /* CONSTRUCTOR */
  constructor(t, r) {
    this.color = r, this.changed = !1, this.data = t, this.type = new P0();
  }
  /* API */
  set(t, r) {
...
const lo = new N0({ r: 0, g: 0, b: 0, a: 0 }, "transparent"), Wr = {
  /* VARIABLES */
...
}, W0 = (e) => q0(e) >= 0.5, Te = (e) => !W0(e), Mc = (e, t, r) => {
  const i = Ae.parse(e), s = i[t], o = nt.channel.clamp[t](s + r);
  return s !== o && (i[t] = o), Ae.stringify(i);
}, A = (e, t) => Mc(e, "l", t), E = (e, t) => Mc(e, "l", -t), x = (e, t) => {
  const r = Ae.parse(e), i = {};
  for (const s in t)
    t[s] && (i[s] = r[s] + t[s]);
  return Ec(e, i);
}, z0 = (e, t, r = 50) => {
  const { r: i, g: s, b: o, a } = Ae.parse(e), { r: n, g: l, b: c, a: h } = Ae.parse(t), u = r / 100, p = u * 2 - 1, d = a - h, m = ((p * d === -1 ? p : (p + d) / (1 + p * d)) + 1) / 2, y = 1 - m, C = i * m + n * y, b = s * m + l * y, k = o * m + c * y, w = a * u + h * (1 - u);
  return Je(C, b, k, w);
}, _ = (e, t = 100) => {
  const r = Ae.parse(e);
  return r.r = 255 - r.r, r.g = 255 - r.g, r.b = 255 - r.b, z0(r, e, t);
};
...
const si = Ft(Array.prototype.forEach), G0 = Ft(Array.prototype.lastIndexOf), Ul = Ft(Array.prototype.pop), oi = Ft(Array.prototype.push), j0 = Ft(Array.prototype.splice), Gt = Array.isArray, yi = Ft(String.prototype.toLowerCase), Ho = Ft(String.prototype.toString), Yl = Ft(String.prototype.match), Fr = Ft(String.prototype.replace), Gl = Ft(String.prototype.indexOf), X0 = Ft(String.prototype.trim), V0 = Ft(Number.prototype.toString), Z0 = Ft(Boolean.prototype.toString), jl = typeof BigInt > "u" ? null : Ft(BigInt.prototype.toString), Xl = typeof Symbol > "u" ? null : Ft(Symbol.prototype.toString), St = Ft(Object.prototype.hasOwnProperty), ai = Ft(Object.prototype.toString), Dt = Ft(RegExp.prototype.test), es = K0(TypeError);
function Ft(e) {
  return function(t) {
...
function te(e) {
  const t = $r(null);
  for (const [r, i] of $c(e))
    St(e, r) && (Gt(i) ? t[r] = Q0(i) : i && typeof i == "object" && i.constructor === Object ? t[r] = te(i) : t[r] = i);
  return t;
}
function J0(e) {
  switch (typeof e) {
...
function Dc() {
  let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : uy();
  const t = (J) => Dc(J);
  ...
  let $ = th();
  t.isSupported = typeof $c == "function" && typeof k == "function" && v && v.createHTMLDocument !== void 0;
  const {
    MUSTACHE_EXPR: z,
    ERB_EXPR: W,
    TMPLIT_EXPR: I,
  ...
  const dt = lt({}, [...Vl, ...Uo, ...Yo, ...Go, ...Zl]);
  let et = null;
  const ut = lt({}, [...Kl, ...jo, ...Ql, ...rs]);
  ...
  let xt = !0, Ct = !0, vt = !1, ue = !0, se = !1, Oe = !0, ar = !1, Lo = !1, Fo = !1, _r = !1, Ki = !1, Qi = !1, fl = !0, gl = !1;
  ...
  const t0 = lt({}, [Ji, ts, _e], Ho);
  let Oo = lt({}, ["mi", "mo", "mn", "ms", "mtext"]), Do = lt({}, ["annotation-xml"]);
  const e0 = lt({}, ["title", "style", "font", "a", "script"]);
  let ii = null;
  const r0 = ["application/xhtml+xml", "text/html"], i0 = "text/html";
  let At = null, Lr = null;
  const s0 = r.createElement("form"), bl = function(T) {
    ...
    r0.indexOf(T.PARSER_MEDIA_TYPE) === -1 ? i0 : T.PARSER_MEDIA_TYPE, At = ii === "application/xhtml+xml" ? Ho : yi, Q = St(T, "ALLOWED_TAGS") && Gt(T.ALLOWED_TAGS) ? lt({}, T.ALLOWED_TAGS, At) : dt, et = St(T, "ALLOWED_ATTR") && Gt(T.ALLOWED_ATTR) ? lt({}, T.ALLOWED_ATTR, At) : ut, Io = St(T, "ALLOWED_NAMESPACES") && Gt(T.ALLOWED_NAMESPACES) ? lt({}, T.ALLOWED_NAMESPACES, Ho) : t0, Mo = St(T, "ADD_URI_SAFE_ATTR") && Gt(T.ADD_URI_SAFE_ATTR) ? lt(te(xl), T.ADD_URI_SAFE_ATTR, At) : xl, yl = St(T, "ADD_DATA_URI_TAGS") && Gt(T.ADD_DATA_URI_TAGS) ? lt(te(Cl), T.ADD_DATA_URI_TAGS, At) : Cl, Se = St(T, "FORBID_CONTENTS") && Gt(T.FORBID_CONTENTS) ? lt({}, T.FORBID_CONTENTS, At) : Eo, rt = St(T, "FORBID_TAGS") && Gt(T.FORBID_TAGS) ? lt({}, T.FORBID_TAGS, At) : te({}), ht = St(T, "FORBID_ATTR") && Gt(T.FORBID_ATTR) ? lt({}, T.FORBID_ATTR, At) : te({}), vr = St(T, "USE_PROFILES") ? T.USE_PROFILES && typeof T.USE_PROFILES == "object" ? te(T.USE_PROFILES) : T.USE_PROFILES : !1, xt = T.ALLOW_ARIA_ATTR !== !1, Ct = T.ALLOW_DATA_ATTR !== !1, vt = T.ALLOW_UNKNOWN_PROTOCOLS || !1, ue = T.ALLOW_SELF_CLOSE_IN_ATTR !== !1, se = T.SAFE_FOR_TEMPLATES || !1, Oe = T.SAFE_FOR_XML !== !1, ar = T.WHOLE_DOCUMENT || !1, _r = T.RETURN_DOM || !1, Ki = T.RETURN_DOM_FRAGMENT || !1, Qi = T.RETURN_TRUSTED_TYPE || !1, Fo = T.FORCE_BODY || !1, fl = T.SANITIZE_DOM !== !1, gl = T.SANITIZE_NAMED_PROPS || !1, Ao = T.KEEP_CONTENT !== !1, ri = T.IN_PLACE || !1, U = ty(T.ALLOWED_URI_REGEXP) ? T.ALLOWED_URI_REGEXP : Ic, Br = typeof T.NAMESPACE == "string" ? T.NAMESPACE : _e, Oo = St(T, "MATHML_TEXT_INTEGRATION_POINTS") && T.MATHML_TEXT_INTEGRATION_POINTS && typeof T.MATHML_TEXT_INTEGRATION_POINTS == "object" ? te(T.MATHML_TEXT_INTEGRATION_POINTS) : lt({}, ["mi", "mo", "mn", "ms", "mtext"]), Do = St(T, "HTML_INTEGRATION_POINTS") && T.HTML_INTEGRATION_POINTS && typeof T.HTML_INTEGRATION_POINTS == "object" ? te(T.HTML_INTEGRATION_POINTS) : lt({}, ["annotation-xml"]);
    ...
    if (it = $r(null), St(q, "tagNameCheck") && bl(q.tagNameCheck) && (it.tagNameCheck = q.tagNameCheck), St(q, "attributeNameCheck") && bl(q.attributeNameCheck) && (it.attributeNameCheck = q.attributeNameCheck), St(q, "allowCustomizedBuiltInElements") && typeof q.allowCustomizedBuiltInElements == "boolean" && (it.allowCustomizedBuiltInElements = q.allowCustomizedBuiltInElements), se && (Ct = !1), Ki && (_r = !0), vr && (Q = lt({}, Zl), et = $r(null), vr.html === !0 && (lt(Q, Vl), lt(et, Kl)), vr.svg === !0 && (lt(Q, Uo), lt(et, jo), lt(et, rs)), vr.svgFilters === !0 && (lt(Q, Yo), lt(et, jo), lt(et, rs)), vr.mathMl === !0 && (lt(Q, Go), lt(et, Ql), lt(et, rs))), ft.tagCheck = null, ft.attributeCheck = null, St(T, "ADD_TAGS") && (typeof T.ADD_TAGS == "function" ? ft.tagCheck = T.ADD_TAGS : Gt(T.ADD_TAGS) && (Q === dt && (Q = te(Q)), lt(Q, T.ADD_TAGS, At))), St(T, "ADD_ATTR") && (typeof T.ADD_ATTR == "function" ? ft.attributeCheck = T.ADD_ATTR : Gt(T.ADD_ATTR) && (et === ut && (et = te(et)), lt(et, T.ADD_ATTR, At))), St(T, "ADD_URI_SAFE_ATTR") && Gt(T.ADD_URI_SAFE_ATTR) && lt(Mo, T.ADD_URI_SAFE_ATTR, At), St(T, "FORBID_CONTENTS") && Gt(T.FORBID_CONTENTS) && (Se === Eo && (Se = te(Se)), lt(Se, T.FORBID_CONTENTS, At)), St(T, "ADD_FORBID_CONTENTS") && Gt(T.ADD_FORBID_CONTENTS) && (Se === Eo && (Se = te(Se)), lt(Se, T.ADD_FORBID_CONTENTS, At)), Ao && (Q["#text"] = !0), ar && lt(Q, ["html", "head", "body"]), Q.table && (lt(Q, ["tbody"]), delete rt.tbody), T.TRUSTED_TYPES_POLICY) {
      ...
      w === void 0 && (w = dy(d, s)), w !== null && typeof S == "string" && (S = w.createHTML(""));
    Zt && Zt(T), Lr = T;
  }, kl = lt({}, [...Uo, ...Yo, ...ey]), Tl = lt({}, [...Go, ...ry]), o0 = function(T) {
    let q = k(T);
    (!q || !q.tagName) && (q = {
      namespaceURI: Br,
      tagName: "template"
    ...
    return Io[T.namespaceURI] ? T.namespaceURI === ts ? q.namespaceURI === _e ? X === "svg" : q.namespaceURI === Ji ? X === "svg" && (bt === "annotation-xml" || Oo[bt]) : !!kl[X] : T.namespaceURI === Ji ? q.namespaceURI === _e ? X === "math" : q.namespaceURI === ts ? X === "math" && Do[bt] : !!Tl[X] : T.namespaceURI === _e ? q.namespaceURI === ts && !Do[bt] || q.namespaceURI === Ji && !Oo[bt] ? !1 : !Tl[X] && (e0[X] || !kl[X]) : !!(ii === "application/xhtml+xml" && Io[T.namespaceURI]) : !1;
  }, de = function(T) {
    oi(t.removed, {
      element: T
    });
  ...
  const _l = function(T) {
    ...
    return T instanceof l && !o0(T) || (X === "noscript" || X === "noembed" || X === "noframes") && Dt(/<\/no(script|embed|frames)/i, T.innerHTML) ? (de(T), !0) : (se && T.nodeType === ni.text && (q = T.textContent, si([z, W, I], (bt) => {
      q = Fr(q, bt, " ");
    }), T.textContent !== q && (oi(t.removed, {
      element: T.cloneNode()
    }), T.textContent = q)), De($.afterSanitizeElements, T, null), !1);
  }, vl = function(T, q, X) {
    if (ht[q] || fl && (q === "id" || q === "name") && (X in r || X in s0))
      return !1;
    if (!(Ct && !ht[q] && Dt(F, q))) {
      if (!(xt && Dt(L, q))) {
        if (!(ft.attributeCheck instanceof Function && ft.attributeCheck(q, T))) {
          if (!et[q] || ht[q]) {
            ...
            if (!Dt(U, Fr(X, R, ""))) {
              if (!((q === "src" || q === "xlink:href" || q === "href") && T !== "script" && Gl(X, "data:") === 0 && yl[T])) {
                if (!(vt && !Dt(M, Fr(X, R, "")))) {
                  if (X)
                    return !1;
                }
    ...
    return !0;
  }, a0 = lt({}, ["annotation-xml", "color-profile", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "missing-glyph"]), Bl = function(T) {
    return !a0[yi(T)] && Dt(H, T);
  }, Ll = function(T) {
    ...
    for (; bt--; ) {
      ...
      let It = Bt === "value" ? qo : X0(qo);
      if (X.attrName = pe, X.attrValue = It, X.keepAttr = !0, X.forceKeepAttr = void 0, De($.uponSanitizeAttribute, T, X), It = X.attrValue, gl && (pe === "id" || pe === "name") && Gl(It, ml) !== 0 && (nr(Bt, T), It = ml + It), Oe && Dt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, It)) {
        nr(Bt, T);
        continue;
      }
      if (pe === "attributename" && Yl(It, "href")) {
        nr(Bt, T);
        continue;
      }
      if (X.forceKeepAttr)
      ...
      if (w && typeof d == "object" && typeof d.getAttributeType == "function" && !Qt)
        switch (d.getAttributeType(Al, pe)) {
          case "TrustedHTML": {
            It = w.createHTML(It);
            break;
          }
      ...
      if (It !== qo)
        try {
          Qt ? T.setAttributeNS(Qt, Bt, It) : T.setAttribute(Bt, It), Po(T) ? de(T) : Ul(t.removed);
        } catch {
          nr(Bt, T);
        }
    }
  ...
  return t.sanitize = function(J) {
    ...
    if ($o = !J, $o && (J = "<!-->"), typeof J != "string" && !No(J) && (J = J0(J), typeof J != "string"))
    ...
    return ar && Q["!doctype"] && q.ownerDocument && q.ownerDocument.doctype && q.ownerDocument.doctype.name && Dt(Oc, q.ownerDocument.doctype.name) && (Qt = "<!DOCTYPE " + q.ownerDocument.doctype.name + `>
` + Qt), se && si([z, W, I], (ne) => {
      Qt = Fr(Qt, ne, " ");
...
}, yr = {}, cn = /* @__PURE__ */ f(function(e, t) {
  e = e.replace(Rc, "").replace(vi, "").replace(py, `
`);
...
}, "detectType"), ua = /* @__PURE__ */ f((...e) => {
  for (const { id: t, detector: r, loader: i } of e)
    Nc(t, r, i);
}, "registerLazyLoadedDiagrams"), Nc = /* @__PURE__ */ f((e, t, r) => {
...
}, "addDetector"), fy = /* @__PURE__ */ f((e) => yr[e].loader, "getDiagramLoader"), da = /* @__PURE__ */ f((e, t, { depth: r = 2, clobber: i = !1 } = {}) => {
...
}, "assignWithDepth"), Mt = da, Me = "#ffffff", $e = "#f2f2f2", at = /* @__PURE__ */ f((e, t) => t ? x(e, { s: -40, l: 10 }) : x(e, { s: -40, l: -10 }), "mkBorder"), gy = class {
  static {
    f(this, "Theme");
  }
  constructor() {
...
}, Wc = /* @__PURE__ */ f((e, t = "") => Object.keys(e).reduce((r, i) => Array.isArray(e[i]) ? r : typeof e[i] == "object" && e[i] !== null ? [...r, t + i, ...Wc(e[i], "")] : [...r, t + i], []), "keyify"), Ry = new Set(Wc(qc, "")), zc = qc, Fs = /* @__PURE__ */ f((e) => {
  if (P.debug("sanitizeDirective called with", e), !(typeof e != "object" || e == null)) {
    ...
    for (const t of Object.keys(e)) {
      if (P.debug("Checking key", t), t.startsWith("__") || t.includes("proto") || t.includes("constr") || !Ry.has(t) || e[t] == null) {
      ...
      for (const i of r)
        t.includes(i) && (P.debug("sanitizing css option", t), e[t] = Hc(e[t]));
    }
    if (e.themeVariables)
...
}, "sanitizeDirective"), Hc = /* @__PURE__ */ f((e) => {
  let t = 0, r = 0;
  for (const i of e) {
    if (t < r)
...
}, "sanitizeCss"), Yr = Object.freeze(zc), Ge = /* @__PURE__ */ f((e) => !(e === !1 || ["false", "null", "0"].includes(String(e).trim().toLowerCase())), "evaluate"), ee = Mt({}, Yr), As, Cr = [], Bi = Mt({}, Yr), ho = /* @__PURE__ */ f((e, t) => {
  let r = Mt({}, e), i = {};
  for (const s of t)
    Gc(s), i = Mt(i, s);
  ...
  return Bi = r, Xc(Bi), Bi;
}, "updateCurrentConfig"), Py = /* @__PURE__ */ f((e) => (ee = Mt({}, Yr), ee = Mt(ee, e), e.theme && We[e.theme] && (ee.themeVariables = We[e.theme].getThemeVariables(e.themeVariables)), ho(ee, Cr), ee), "setSiteConfig"), Ny = /* @__PURE__ */ f((e) => {
  As = Mt({}, e);
}, "saveConfigFromInitialize"), qy = /* @__PURE__ */ f((e) => (ee = Mt(ee, e), ho(ee, Cr), ee), "updateSiteConfig"), Uc = /* @__PURE__ */ f(() => Mt({}, ee), "getSiteConfig"), Yc = /* @__PURE__ */ f((e) => (Xc(e), Mt(Bi, e), Tt()), "setConfig"), Tt = /* @__PURE__ */ f(() => Mt({}, Bi), "getConfig"), Gc = /* @__PURE__ */ f((e) => {
  e && (["secure", ...ee.secure ?? []].forEach((t) => {
    ...
    typeof e[t] == "string" && (e[t].includes("<") || e[t].includes(">") || e[t].includes("url(data:")) && delete e[t], typeof e[t] == "object" && Gc(e[t]);
  }));
}, "sanitize"), Wy = /* @__PURE__ */ f((e) => {
  Fs(e), e.fontFamily && !e.themeVariables?.fontFamily && (e.themeVariables = {
    ...e.themeVariables,
    fontFamily: e.fontFamily
  }), Cr.push(e), ho(ee, Cr);
}, "addDirective"), Es = /* @__PURE__ */ f((e = ee) => {
  Cr = [], ho(e, Cr);
}, "reset"), zy = {
  ...
  eh[e] || (P.warn(zy[e]), eh[e] = !0);
}, "issueWarning"), Xc = /* @__PURE__ */ f((e) => {
  e && (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) && jc("LAZY_LOAD_DEPRECATED");
}, "checkConfig"), CL = /* @__PURE__ */ f(() => {
  let e = {};
  As && (e = Mt(e, As));
  for (const t of Cr)
    e = Mt(e, t);
  return e;
}, "getUserDefinedConfig"), Kt = /* @__PURE__ */ f((e) => (e.flowchart?.htmlLabels != null && jc("FLOWCHART_HTML_LABELS_DEPRECATED"), Ge(e.htmlLabels ?? e.flowchart?.htmlLabels ?? !0)), "getEffectiveHtmlLabels"), zi = /<br\s*\/?>/gi, Hy = /* @__PURE__ */ f((e) => e ? Kc(e).replace(/\\n/g, "#br#").split("#br#") : [""], "getRows"), Uy = /* @__PURE__ */ (() => {
  let e = !1;
  return () => {
    e || (Vc(), e = !0);
  };
...
f(Vc, "setupDompurifyHooks");
var Zc = /* @__PURE__ */ f((e) => (Uy(), Ur.sanitize(e)), "removeScript"), rh = /* @__PURE__ */ f((e, t) => {
  if (Kt(t)) {
    const r = t.securityLevel;
    r === "antiscript" || r === "strict" || r === "sandbox" ? e = Zc(e) : r !== "loose" && (e = Kc(e), e = e.replace(/</g, "&lt;").replace(/>/g, "&gt;"), e = e.replace(/=/g, "&equals;"), e = Xy(e));
  }
  return e;
}, "sanitizeMore"), ke = /* @__PURE__ */ f((e, t) => e && (t.dompurifyConfig ? e = Ur.sanitize(rh(e, t), t.dompurifyConfig).toString() : e = Ur.sanitize(rh(e, t), {
  FORBID_TAGS: ["style"]
}).toString(), e), "sanitizeText"), Yy = /* @__PURE__ */ f((e, t) => typeof e == "string" ? ke(e, t) : e.flat().map((r) => ke(r, t)), "sanitizeTextOrArray"), Gy = /* @__PURE__ */ f((e) => zi.test(e), "hasBreaks"), jy = /* @__PURE__ */ f((e) => e.split(zi), "splitBreaks"), Xy = /* @__PURE__ */ f((e) => e.replace(/#br#/g, "<br/>"), "placeholderToBreak"), Kc = /* @__PURE__ */ f((e) => e.replace(zi, "#br#"), "breakToPlaceholder"), Vy = /* @__PURE__ */ f((e) => {
  let t = "";
...
}, "getUrl"), Zy = /* @__PURE__ */ f(function(...e) {
  const t = e.filter((r) => !isNaN(r));
  return Math.max(...t);
}, "getMax"), Ky = /* @__PURE__ */ f(function(...e) {
  const t = e.filter((r) => !isNaN(r));
  return Math.min(...t);
}, "getMin"), ih = /* @__PURE__ */ f(function(e) {
  const t = e.split(/(,)/), r = [];
  for (let i = 0; i < t.length; i++) {
    let s = t[i];
    if (s === "," && i > 0 && i + 1 < t.length) {
      const o = t[i - 1], a = t[i + 1];
      Qy(o, a) && (s = o + "," + a, i++, r.pop());
    }
    r.push(Jy(s));
  }
  return r.join("");
}, "parseGenericTypes"), pa = /* @__PURE__ */ f((e, t) => Math.max(0, e.split(t).length - 1), "countOccurrence"), Qy = /* @__PURE__ */ f((e, t) => {
  const r = pa(e, "~"), i = pa(t, "~");
  return r === 1 && i === 1;
...
}, "processSet"), sh = /* @__PURE__ */ f(() => window.MathMLElement !== void 0, "isMathMLSupported"), fa = /\$\$(.*)\$\$/g, Ai = /* @__PURE__ */ f((e) => (e.match(fa)?.length ?? 0) > 0, "hasKatex"), xL = /* @__PURE__ */ f(async (e, t) => {
  const r = document.createElement("div");
  r.innerHTML = await Qc(e, t), r.id = "katex-temp", r.style.visibility = "hidden", r.style.position = "absolute", r.style.top = "0", document.querySelector("body")?.insertAdjacentElement("beforeend", r);
  const s = { width: r.clientWidth, height: r.clientHeight };
  return r.remove(), s;
}, "calculateMathMLDimensions"), tC = /* @__PURE__ */ f(async (e, t) => {
  if (!Ai(e))
    return e;
  if (!(sh() || t.legacyMathML || t.forceLegacyMathML))
    return e.replace(fa, "MathML is unsupported in this environment.");
  {
    const { default: r } = await import("./katex-D3uLT2GX.js"), i = t.forceLegacyMathML || !sh() && t.legacyMathML ? "htmlAndMathml" : "mathml";
...
}, "renderKatexUnsanitized"), Qc = /* @__PURE__ */ f(async (e, t) => ke(await tC(e, t), t), "renderKatexSanitized"), Hi = {
  getRows: Hy,
  sanitizeText: ke,
  sanitizeTextOrArray: Yy,
  hasBreaks: Gy,
  splitBreaks: jy,
  lineBreakRegex: zi,
  removeScript: Zc,
  ...
  getMax: Zy,
  getMin: Ky
}, eC = /* @__PURE__ */ f(function(e, t) {
  for (let r of t)
    e.attr(r[0], r[1]);
}, "d3Attrs"), rC = /* @__PURE__ */ f(function(e, t, r) {
  let i = /* @__PURE__ */ new Map();
  return r ? (i.set("width", "100%"), i.set("style", `max-width: ${t}px;`)) : (i.set("height", e), i.set("width", t)), i;
}, "calculateSvgSizeAttrs"), Jc = /* @__PURE__ */ f(function(e, t, r, i) {
  const s = rC(t, r, i);
  eC(e, s);
}, "configureSvgSize"), iC = /* @__PURE__ */ f(function(e, t, r, i) {
...
f(ga, "cssStyleSheetToString");
var sC = /* @__PURE__ */ f((e, t, r, i) => {
  let s = "";
  ...
  ${t}
`;
}, "getStyles"), oC = /* @__PURE__ */ f((e, t) => {
  t !== void 0 && (ms[e] = t);
}, "addStylesForDiagram"), aC = sC, tu = {};
O0(tu, {
  clear: () => nC,
  getAccDescription: () => uC,
  getAccTitle: () => hC,
  getDiagramTitle: () => pC,
  setAccDescription: () => cC,
  setAccTitle: () => lC,
  setDiagramTitle: () => dC
});
var un = "", dn = "", pn = "", fn = /* @__PURE__ */ f((e) => ke(e, Tt()), "sanitizeText"), nC = /* @__PURE__ */ f(() => {
  un = "", pn = "", dn = "";
}, "clear"), lC = /* @__PURE__ */ f((e) => {
  un = fn(e).replace(/^\s+/g, "");
}, "setAccTitle"), hC = /* @__PURE__ */ f(() => un, "getAccTitle"), cC = /* @__PURE__ */ f((e) => {
  pn = fn(e).replace(/\n\s+/g, `
`);
}, "setAccDescription"), uC = /* @__PURE__ */ f(() => pn, "getAccDescription"), dC = /* @__PURE__ */ f((e) => {
  dn = fn(e);
}, "setDiagramTitle"), pC = /* @__PURE__ */ f(() => dn, "getDiagramTitle"), oh = P, fC = hn, gt = Tt, bL = Yc, kL = Yr, gn = /* @__PURE__ */ f((e) => ke(e, gt()), "sanitizeText"), gC = iC, mC = /* @__PURE__ */ f(() => tu, "getCommonDb"), Ms = {}, $s = /* @__PURE__ */ f((e, t, r) => {
  Ms[e] && oh.warn(`Diagram with id ${e} already registered. Overwriting.`), Ms[e] = t, r && Nc(e, r), oC(e, t.styles), t.injectUtils?.(
    oh,
    fC,
    gt,
    gn,
...
}, "registerDiagram"), ma = /* @__PURE__ */ f((e) => {
  if (e in Ms)
    return Ms[e];
  throw new yC(e);
}, "getDiagram"), yC = class extends Error {
  static {
...
ys.prototype = eu.prototype = {
  constructor: ys,
  on: function(e, t) {
    var r = this._, i = xC(e + "", r), s, o = -1, a = i.length;
    if (arguments.length < 2) {
      for (; ++o < a; ) if ((s = (e = i[o]).type) && (s = bC(r[s], e.name))) return s;
      return;
    }
    if (t != null && typeof t != "function") throw new Error("invalid callback: " + t);
    for (; ++o < a; )
      if (s = (e = i[o]).type) r[s] = ah(r[s], e.name, t);
      else if (t == null) for (s in r) r[s] = ah(r[s], e.name, null);
    return this;
  },
  copy: function() {
    var e = {}, t = this._;
...
function ah(e, t, r) {
  for (var i = 0, s = e.length; i < s; ++i)
    if (e[i].name === t) {
      e[i] = CC, e = e.slice(0, i).concat(e.slice(i + 1));
      break;
    }
...
function co(e) {
  var t = e += "", r = t.indexOf(":");
  return r >= 0 && (t = e.slice(0, r)) !== "xmlns" && (e = e.slice(r + 1)), nh.hasOwnProperty(t) ? { space: nh[t], local: e } : e;
}
function kC(e) {
  return function() {
...
function BC(e) {
  return function() {
    return _C(e.apply(this, arguments));
  };
}
function LC(e) {
  typeof e == "function" ? e = BC(e) : e = iu(e);
...
function MC(e) {
  return this.select(e == null ? EC : AC(typeof e == "function" ? e : ou(e)));
}
...
function DC(e) {
  return this.selectAll(e == null ? IC : OC(typeof e == "function" ? e : ou(e)));
}
function RC(e) {
...
function PC() {
  return new ae(this._enter || this._groups.map(au), this._parents);
}
function Is(e, t) {
...
function HC(e, t) {
  ...
  var r = t ? WC : qC, i = this._parents, s = this._groups;
  typeof e != "function" && (e = NC(e));
  for (var o = s.length, a = new Array(o), n = new Array(o), l = new Array(o), c = 0; c < o; ++c) {
    var h = i[c], u = s[c], p = u.length, d = UC(e.call(h, h && h.__data__, c, i)), g = d.length, m = n[c] = new Array(g), y = a[c] = new Array(g), C = l[c] = new Array(p);
    r(h, u, m, y, C, d, t);
...
function YC() {
  return new ae(this._exit || this._groups.map(au), this._parents);
}
function GC(e, t, r) {
...
function hx(e, t) {
  ...
  return this.each((t == null ? r.local ? sx : ix : typeof t == "function" ? r.local ? lx : nx : r.local ? ax : ox)(r, t));
}
function nu(e) {
...
function px(e, t, r) {
  return arguments.length > 1 ? this.each((t == null ? cx : typeof t == "function" ? dx : ux)(e, t, r ?? "")) : Gr(this.node(), e);
}
function Gr(e, t) {
...
function yx(e, t) {
  return arguments.length > 1 ? this.each((t == null ? fx : typeof t == "function" ? mx : gx)(e, t)) : this.node()[e];
}
function lu(e) {
...
function bx(e, t) {
  return function() {
    (t.apply(this, arguments) ? cu : uu)(this, e);
  };
}
function kx(e, t) {
  var r = lu(e + "");
  ...
  return this.each((typeof t == "function" ? bx : t ? Cx : xx)(r, t));
}
function Tx() {
  this.textContent = "";
}
...
function _x(e) {
  return arguments.length ? this.each(e == null ? Tx : (typeof e == "function" ? Sx : wx)(e)) : this.node().textContent;
}
function vx() {
  this.innerHTML = "";
}
...
function Fx(e) {
  return arguments.length ? this.each(e == null ? vx : (typeof e == "function" ? Lx : Bx)(e)) : this.node().innerHTML;
}
function Ax() {
...
function Dx(e, t) {
  var r = typeof e == "function" ? e : ru(e), i = t == null ? Ox : typeof t == "function" ? t : mn(t);
  return this.select(function() {
...
function jx(e, t, r) {
  ...
  for (n = t ? Gx : Yx, s = 0; s < o; ++s) this.each(n(i[s], t, r));
  return this;
}
function du(e, t, r) {
...
function Zx(e, t) {
  return this.each((typeof t == "function" ? Vx : Xx)(e, t));
}
function* Kx() {
  for (var e = this._groups, t = 0, r = e.length; t < r; ++t)
...
function Ui() {
  return new ae([[document.documentElement]], pu);
}
function Qx() {
  return this;
}
...
function ct(e) {
  return typeof e == "string" ? new ae([[document.querySelector(e)]], [document.documentElement]) : new ae([[e]], pu);
}
function Cn(e, t, r) {
...
var Ei = 0.7, Os = 1 / Ei, zr = "\\s*([+-]?\\d+)\\s*", Mi = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Fe = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Jx = /^#([0-9a-f]{3,8})$/, tb = new RegExp(`^rgb\\(${zr},${zr},${zr}\\)$`), eb = new RegExp(`^rgb\\(${Fe},${Fe},${Fe}\\)$`), rb = new RegExp(`^rgba\\(${zr},${zr},${zr},${Mi}\\)$`), ib = new RegExp(`^rgba\\(${Fe},${Fe},${Fe},${Mi}\\)$`), sb = new RegExp(`^hsl\\(${Mi},${Fe},${Fe}\\)$`), ob = new RegExp(`^hsla\\(${Mi},${Fe},${Fe},${Mi}\\)$`), lh = {
  aliceblue: 15792383,
...
function $i(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = Jx.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? uh(t) : r === 3 ? new ie(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? is(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? is(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = tb.exec(e)) ? new ie(t[1], t[2], t[3], 1) : (t = eb.exec(e)) ? new ie(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = rb.exec(e)) ? is(t[1], t[2], t[3], t[4]) : (t = ib.exec(e)) ? is(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = sb.exec(e)) ? fh(t[1], t[2] / 100, t[3] / 100, 1) : (t = ob.exec(e)) ? fh(t[1], t[2] / 100, t[3] / 100, t[4]) : lh.hasOwnProperty(e) ? uh(lh[e]) : e === "transparent" ? new ie(NaN, NaN, NaN, 0) : null;
}
function uh(e) {
...
function Ca(e, t, r, i) {
  return arguments.length === 1 ? lb(e) : new ie(e, t, r, i ?? 1);
}
function ie(e, t, r, i) {
...
function cb(e, t, r, i) {
  return arguments.length === 1 ? gu(e) : new ye(e, t, r, i ?? 1);
}
function ye(e, t, r, i) {
...
Cn(ye, cb, fu(Yi, {
  ...
  clamp() {
    return new ye(gh(this.h), ss(this.s), ss(this.l), Ds(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = Ds(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${gh(this.h)}, ${ss(this.s) * 100}%, ${ss(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function gh(e) {
...
function TL(e, t) {
  var r = t - e;
  return r ? mu(e, r > 180 || r < -180 ? r - 360 * Math.round(r / 360) : r) : xn(isNaN(e) ? t : e);
}
function db(e) {
  return (e = +e) == 1 ? yu : function(t, r) {
    return r - t ? ub(t, r, e) : xn(isNaN(t) ? r : t);
  };
}
function yu(e, t) {
  var r = t - e;
  return r ? mu(e, r) : xn(isNaN(e) ? t : e);
}
const mh = (function e(t) {
  var r = db(t);
  function i(s, o) {
    var a = r((s = Ca(s)).r, (o = Ca(o)).r), n = r(s.g, o.g), l = r(s.b, o.b), c = yu(s.opacity, o.opacity);
    return function(h) {
...
function gb(e, t) {
  ...
  return r < t.length && (o = t.slice(r), n[a] ? n[a] += o : n[++a] = o), n.length < 2 ? l[0] ? fb(l[0].x) : pb(t) : (t = l.length, function(c) {
    for (var h = 0, u; h < t; ++h) n[(u = l[h]).i] = u.x(c);
    return n.join("");
  });
}
var yh = 180 / Math.PI, ba = {
  translateX: 0,
  translateY: 0,
  rotate: 0,
  skewX: 0,
...
function mb(e) {
  ...
  return t.isIdentity ? ba : Cu(t.a, t.b, t.c, t.d, t.e, t.f);
}
function yb(e) {
  return e == null || (os || (os = document.createElementNS("http://www.w3.org/2000/svg", "g")), os.setAttribute("transform", e), !(e = os.transform.baseVal.consolidate())) ? ba : (e = e.matrix, Cu(e.a, e.b, e.c, e.d, e.e, e.f));
}
function xu(e, t, r, i) {
  function s(c) {
...
var Cb = xu(mb, "px, ", "px)", "deg)"), xb = xu(yb, ", ", ")", ")"), jr = 0, Ci = 0, li = 0, bu = 1e3, Rs, xi, Ps = 0, xr = 0, uo = 0, Ii = typeof performance == "object" && performance.now ? performance : Date, ku = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function bn() {
  return xr || (ku(bb), xr = Ii.now() + uo);
}
function bb() {
  xr = 0;
}
...
function ka(e) {
  if (!jr) {
    ...
    var t = e - xr;
    t > 24 ? (e < 1 / 0 && (Ci = setTimeout(Ch, e - Ii.now() - uo)), li && (li = clearInterval(li))) : (li || (Ps = Ii.now(), li = setInterval(Tb, bu)), jr = 1, ku(Ch));
  }
}
function xh(e, t, r) {
  var i = new Ns();
...
var Sb = eu("start", "end", "cancel", "interrupt"), _b = [], wu = 0, bh = 1, Ta = 2, Cs = 3, kh = 4, wa = 5, xs = 6;
function po(e, t, r, i, s, o) {
...
function kn(e, t) {
  var r = we(e, t);
  if (r.state > wu) throw new Error("too late; already scheduled");
  return r;
}
function Ie(e, t) {
  var r = we(e, t);
...
function vb(e, t, r) {
  ...
  i[t] = r, r.timer = Tu(o, 0, r.time);
  function o(c) {
    r.state = bh, r.timer.restart(a, r.delay, r.time), r.delay <= c && a(c - r.delay);
  }
  function a(c) {
    var h, u, p, d;
    if (r.state !== bh) return l();
    for (h in i)
      if (d = i[h], d.name === r.name) {
        if (d.state === Cs) return xh(a);
        d.state === kh ? (d.state = xs, d.timer.stop(), d.on.call("interrupt", e, e.__data__, d.index, d.group), delete i[h]) : +h < t && (d.state = xs, d.timer.stop(), d.on.call("cancel", e, e.__data__, d.index, d.group), delete i[h]);
      }
    if (xh(function() {
      r.state === Cs && (r.state = kh, r.timer.restart(n, r.delay, r.time), n(c));
    }), r.state = Ta, r.on.call("start", e, e.__data__, r.index, r.group), r.state === Ta) {
      for (r.state = Cs, s = new Array(p = r.tween.length), h = 0, u = -1; h < p; ++h)
        (d = r.tween[h].value.call(e, e.__data__, r.index, r.group)) && (s[++u] = d);
      s.length = u + 1;
    }
  }
  function n(c) {
    for (var h = c < r.duration ? r.ease.call(null, c / r.duration) : (r.timer.restart(l), r.state = wa, 1), u = -1, p = s.length; ++u < p; )
      s[u].call(e, h);
...
function Eb(e, t) {
  ...
  return this.each((t == null ? Fb : Ab)(r, e, t));
}
function Tn(e, t, r) {
  var i = e._id;
...
function Su(e, t) {
  var r;
  return (typeof t == "number" ? Ze : t instanceof $i ? mh : (r = $i(t)) ? (t = r, mh) : gb)(e, t);
}
function Mb(e) {
  return function() {
    this.removeAttribute(e);
...
function Pb(e, t) {
  var r = co(e), i = r === "transform" ? xb : Su;
  return this.attrTween(e, typeof t == "function" ? (r.local ? Rb : Db)(r, i, Tn(this, "attr." + e, t)) : t == null ? (r.local ? $b : Mb)(r) : (r.local ? Ob : Ib)(r, i, t));
}
function Nb(e, t) {
  return function(r) {
...
function Hb(e, t) {
  ...
  var i = co(e);
  return this.tween(r, (i.local ? Wb : zb)(i, t));
}
function Ub(e, t) {
  return function() {
...
function Gb(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? Ub : Yb)(t, e)) : we(this.node(), t).delay;
}
function jb(e, t) {
  return function() {
...
function Vb(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? jb : Xb)(t, e)) : we(this.node(), t).duration;
}
function Zb(e, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function Kb(e) {
  var t = this._id;
  return arguments.length ? this.each(Zb(t, e)) : we(this.node(), t).ease;
}
function Qb(e, t) {
  return function() {
    var r = t.apply(this, arguments);
...
function Jb(e) {
  ...
  return this.each(Qb(this._id, e));
}
function t1(e) {
  typeof e != "function" && (e = su(e));
  for (var t = this._groups, r = t.length, i = new Array(r), s = 0; s < r; ++s)
...
function s1(e, t) {
  var r = this._id;
  return arguments.length < 2 ? we(this.node(), r).on.on(e) : this.each(i1(r, e, t));
}
function o1(e) {
  return function() {
...
function a1() {
  return this.on("end.remove", o1(this._id));
}
function n1(e) {
  ...
  for (var i = this._groups, s = i.length, o = new Array(s), a = 0; a < s; ++a)
    for (var n = i[a], l = n.length, c = o[a] = new Array(l), h, u, p = 0; p < l; ++p)
      (h = n[p]) && (u = e.call(h, h.__data__, p, n)) && ("__data__" in h && (u.__data__ = h.__data__), c[p] = u, po(c[p], t, r, p, c, we(h, r)));
...
function l1(e) {
  ...
  for (var i = this._groups, s = i.length, o = [], a = [], n = 0; n < s; ++n)
    for (var l = i[n], c = l.length, h, u = 0; u < c; ++u)
      if (h = l[u]) {
        for (var p = e.call(h, h.__data__, u, l), d, g = we(h, r), m = 0, y = p.length; m < y; ++m)
          (d = p[m]) && po(d, t, r, m, p, g);
        o.push(p), a.push(h);
      }
  return new He(o, a, t, r);
}
var h1 = Ui.prototype.constructor;
function c1() {
...
function f1(e, t) {
  ...
  return function() {
    var l = Ie(this, e), c = l.on, h = l.value[o] == null ? n || (n = _u(t)) : void 0;
    (c !== r || s !== h) && (i = (r = c).copy()).on(a, s = h), l.on = i;
  };
}
function g1(e, t, r) {
  var i = (e += "") == "transform" ? Cb : Su;
  return t == null ? this.styleTween(e, u1(e, i)).on("end.style." + e, _u(e)) : typeof t == "function" ? this.styleTween(e, p1(e, i, Tn(this, "style." + e, t))).each(f1(this._id, e)) : this.styleTween(e, d1(e, i, t), r).on("end.style." + e, null);
}
function m1(e, t, r) {
  return function(i) {
...
function k1(e) {
  return this.tween("text", typeof e == "function" ? b1(Tn(this, "text", e)) : x1(e == null ? "" : e + ""));
}
function T1(e) {
  return function(t) {
...
function S1(e) {
  ...
  if (typeof e != "function") throw new Error();
  return this.tween(t, w1(e));
}
function _1() {
  for (var e = this._name, t = this._id, r = vu(), i = this._groups, s = i.length, o = 0; o < s; ++o)
...
function E1(e) {
  var t, r;
  e instanceof He ? (t = e._id, e = e._name) : (t = vu(), (r = F1).time = bn(), e = e == null ? null : e + "");
  for (var i = this._groups, s = i.length, o = 0; o < s; ++o)
    for (var a = i[o], n = a.length, l, c = 0; c < n; ++c)
      (l = a[c]) && po(l, e, t, c, a, r || A1(l, t));
  return new He(i, this._parents, e, t);
}
Ui.prototype.interrupt = Lb;
Ui.prototype.transition = E1;
const Sa = Math.PI, _a = 2 * Sa, cr = 1e-6, M1 = _a - cr;
function Bu(e) {
  this._ += e[0];
...
class I1 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? Bu : $1(t);
  }
  moveTo(t, r) {
  ...
  arcTo(t, r, i, s, o) {
    ...
    else if (p > cr) if (!(Math.abs(u * l - c * h) > cr) || !o)
      this._append`L${this._x1 = t},${this._y1 = r}`;
    else {
      let d = i - a, g = s - n, m = l * l + c * c, y = d * d + g * g, C = Math.sqrt(m), b = Math.sqrt(p), k = o * Math.tan((Sa - Math.acos((m + p - y) / (2 * C * b))) / 2), w = k / b, S = k / C;
  ...
  arc(t, r, i, s, o, a) {
    ...
    this._x1 === null ? this._append`M${c},${h}` : (Math.abs(this._x1 - c) > cr || Math.abs(this._y1 - h) > cr) && this._append`L${c},${h}`, i && (p < 0 && (p = p % _a + _a), p > M1 ? this._append`A${i},${i},0,1,${u},${t - n},${r - l}A${i},${i},0,1,${u},${this._x1 = c},${this._y1 = h}` : p > cr && this._append`A${i},${i},0,${+(p >= Sa)},${u},${this._x1 = t + i * Math.cos(o)},${this._y1 = r + i * Math.sin(o)}`);
  }
  rect(t, r, i, s) {
...
const wL = Math.abs, SL = Math.atan2, _L = Math.cos, vL = Math.max, BL = Math.min, LL = Math.sin, FL = Math.sqrt, Th = 1e-12, wn = Math.PI, wh = wn / 2, AL = 2 * wn;
function EL(e) {
  return e > 1 ? 0 : e < -1 ? wn : Math.acos(e);
}
function ML(e) {
  return e >= 1 ? wh : e <= -1 ? -wh : Math.asin(e);
}
function O1(e) {
  let t = 3;
...
function N1(e, t) {
  var r = Ar(!0), i = null, s = Li, o = null, a = O1(n);
  e = typeof e == "function" ? e : e === void 0 ? R1 : Ar(e), t = typeof t == "function" ? t : t === void 0 ? P1 : Ar(t);
  function n(l) {
    var c, h = (l = D1(l)).length, u, p = !1, d;
...
function Iu(e, t) {
  this._basis = new fo(e), this._beta = t;
}
Iu.prototype = {
  lineStart: function() {
...
const z1 = (function e(t) {
  function r(i) {
    return t === 1 ? new fo(i) : new Iu(i, t);
  }
...
const Ru = (function e(t) {
  function r(i) {
    return t ? new Du(i, t) : new Sn(i, 0);
  }
...
const Y1 = (function e(t) {
  function r(i) {
    return t ? new Pu(i, t) : new _n(i, 0);
  }
  return r.alpha = function(i) {
    return e(+i);
  }, r;
...
const G1 = (function e(t) {
  function r(i) {
    return t ? new Nu(i, t) : new vn(i, 0);
  }
  return r.alpha = function(i) {
    return e(+i);
  }, r;
  ...
  lineEnd: function() {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        Zo(this, this._t0, vh(this, this._t0));
        break;
    }
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  },
    ...
    if (e = +e, t = +t, !(e === this._x1 && t === this._y1)) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          this._point = 3, Zo(this, vh(this, r = _h(this, e, t)), r);
          break;
        default:
          Zo(this, this._t0, r = _h(this, e, t));
          break;
      }
...
function Wu(e) {
  this._context = new zu(e);
}
(Wu.prototype = Object.create(zs.prototype)).point = function(e, t) {
  ...
  lineEnd: function() {
    ...
    if (r)
      if (this._line ? this._context.lineTo(e[0], t[0]) : this._context.moveTo(e[0], t[0]), r === 2)
        ...
        for (var i = Bh(e), s = Bh(t), o = 0, a = 1; a < r; ++o, ++a)
...
f(td, "isNegativeZero");
var V1 = Ln, Z1 = Zu, K1 = Ku, Q1 = Ju, J1 = td, tk = Qu, $t = {
  isNothing: V1,
  isObject: Z1,
  toArray: K1,
  repeat: Q1,
...
f(Xr, "YAMLException$1");
Xr.prototype = Object.create(Error.prototype);
Xr.prototype.constructor = Xr;
Xr.prototype.toString = /* @__PURE__ */ f(function(t) {
...
function id(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    ...
    return r;
  }, this.instanceOf = t.instanceOf || null, this.predicate = t.predicate || null, this.represent = t.represent || null, this.representName = t.representName || null, this.defaultStyle = t.defaultStyle || null, this.multi = t.multi || !1, this.styleAliases = rd(t.styleAliases || null), ik.indexOf(this.kind) === -1)
...
f(Hs, "Schema$1");
Hs.prototype.extend = /* @__PURE__ */ f(function(t) {
  var r = [], i = [];
  if (t instanceof Ht)
    i.push(t);
  ...
  return s.implicit = (this.implicit || []).concat(r), s.explicit = (this.explicit || []).concat(i), s.compiledImplicit = Ba(s, "implicit"), s.compiledExplicit = Ba(s, "explicit"), s.compiledTypeMap = sd(s.compiledImplicit, s.compiledExplicit), s;
}, "extend");
var sk = Hs, ok = new Ht("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: /* @__PURE__ */ f(function(e) {
    return e !== null ? e : "";
  }, "construct")
}), ak = new Ht("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: /* @__PURE__ */ f(function(e) {
    return e !== null ? e : [];
  }, "construct")
}), nk = new Ht("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: /* @__PURE__ */ f(function(e) {
    return e !== null ? e : {};
  }, "construct")
...
f(ad, "constructYamlNull");
function nd(e) {
  return e === null;
}
f(nd, "isNull");
var hk = new Ht("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: od,
  construct: ad,
  predicate: nd,
...
f(ld, "resolveYamlBoolean");
function hd(e) {
  return e === "true" || e === "True" || e === "TRUE";
}
f(hd, "constructYamlBoolean");
function cd(e) {
  return Object.prototype.toString.call(e) === "[object Boolean]";
}
f(cd, "isBoolean");
var ck = new Ht("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: ld,
  construct: hd,
  predicate: cd,
...
function fd(e) {
  ...
  for (; r < t; r++)
    if (s = e[r], s !== "_") {
      if (!pd(e.charCodeAt(r)))
        return !1;
      i = !0;
    }
  return !(!i || s === "_");
}
f(fd, "resolveYamlInteger");
function gd(e) {
  var t = e, r = 1, i;
...
function yd(e) {
  return !(e === null || !dk.test(e) || // Quick hack to not allow integers end with `_`
  // Probably should update regexp & check speed
  e[e.length - 1] === "_");
}
f(yd, "resolveYamlFloat");
function Cd(e) {
  var t, r;
  return t = e.replace(/_/g, "").toLowerCase(), r = t[0] === "-" ? -1 : 1, "+-".indexOf(t[0]) >= 0 && (t = t.slice(1)), t === ".inf" ? r === 1 ? Number.POSITIVE_INFINITY : Number.NEGATIVE_INFINITY : t === ".nan" ? NaN : r * parseFloat(t, 10);
}
f(Cd, "constructYamlFloat");
var pk = /^[-+]?[0-9]+e/;
function xd(e, t) {
  var r;
  if (isNaN(e))
    ...
    return "-0.0";
  return r = e.toString(10), pk.test(r) ? r.replace("e", ".e") : r;
}
...
f(bd, "isFloat");
var fk = new Ht("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: yd,
  construct: Cd,
  predicate: bd,
...
function Sd(e) {
  return e === null ? !1 : Td.exec(e) !== null || wd.exec(e) !== null;
}
f(Sd, "resolveYamlTimestamp");
function _d(e) {
  var t, r, i, s, o, a, n, l = 0, c = null, h, u, p;
  if (t = Td.exec(e), t === null && (t = wd.exec(e)), t === null) throw new Error("Date resolve error");
...
f(_d, "constructYamlTimestamp");
function vd(e) {
  return e.toISOString();
}
f(vd, "representYamlTimestamp");
var mk = new Ht("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: Sd,
  construct: _d,
  instanceOf: Date,
...
f(Bd, "resolveYamlMerge");
var yk = new Ht("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Bd
...
f(Ad, "representYamlBinary");
function Ed(e) {
  return Object.prototype.toString.call(e) === "[object Uint8Array]";
}
f(Ed, "isBinary");
var Ck = new Ht("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Ld,
  construct: Fd,
  predicate: Ed,
  represent: Ad
}), xk = Object.prototype.hasOwnProperty, bk = Object.prototype.toString;
function Md(e) {
  if (e === null) return !0;
  var t = [], r, i, s, o, a, n = e;
  for (r = 0, i = n.length; r < i; r += 1) {
    if (s = n[r], a = !1, bk.call(s) !== "[object Object]") return !1;
    for (o in s)
      if (xk.call(s, o))
        if (!a) a = !0;
        else return !1;
...
f(Md, "resolveYamlOmap");
function $d(e) {
  return e !== null ? e : [];
}
f($d, "constructYamlOmap");
var kk = new Ht("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: Md,
  construct: $d
}), Tk = Object.prototype.toString;
function Id(e) {
  if (e === null) return !0;
  var t, r, i, s, o, a = e;
  for (o = new Array(a.length), t = 0, r = a.length; t < r; t += 1) {
    if (i = a[t], Tk.call(i) !== "[object Object]" || (s = Object.keys(i), s.length !== 1)) return !1;
    o[t] = [s[0], i[s[0]]];
  }
  return !0;
}
f(Id, "resolveYamlPairs");
function Od(e) {
  if (e === null) return [];
  var t, r, i, s, o, a = e;
  for (o = new Array(a.length), t = 0, r = a.length; t < r; t += 1)
...
f(Od, "constructYamlPairs");
var wk = new Ht("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: Id,
  construct: Od
...
f(Rd, "constructYamlSet");
var _k = new Ht("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: Dd,
  construct: Rd
}), Pd = gk.extend({
...
}), rr = Object.prototype.hasOwnProperty, Us = 1, Nd = 2, qd = 3, Ys = 4, Ko = 1, vk = 2, Lh = 3, Bk = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Lk = /[\x85\u2028\u2029]/, Fk = /[,\[\]\{\}]/, Wd = /^(?:!|!!|![a-z\-]+!)$/i, zd = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function La(e) {
...
f(Yd, "fromDecimalCode");
function Fa(e) {
  return e === 48 ? "\0" : e === 97 ? "\x07" : e === 98 ? "\b" : e === 116 || e === 9 ? "	" : e === 110 ? `
` : e === 118 ? "\v" : e === 102 ? "\f" : e === 114 ? "\r" : e === 101 ? "\x1B" : e === 32 ? " " : e === 34 ? '"' : e === 47 ? "/" : e === 92 ? "\\" : e === 78 ? "" : e === 95 ? " " : e === 76 ? "\u2028" : e === 80 ? "\u2029" : "";
}
f(Fa, "simpleEscapeSequence");
function Gd(e) {
...
f(En, "setProperty");
var jd = new Array(256), Xd = new Array(256);
for (lr = 0; lr < 256; lr++)
  jd[lr] = Fa(lr) ? 1 : 0, Xd[lr] = Fa(lr);
var lr;
function Vd(e, t) {
  this.input = e, this.filename = t.filename || null, this.schema = t.schema || Pd, this.onWarning = t.onWarning || null, this.legacy = t.legacy || !1, this.json = t.json || !1, this.listener = t.listener || null, this.implicitTypes = this.schema.compiledImplicit, this.typeMap = this.schema.compiledTypeMap, this.length = e.length, this.position = 0, this.line = 0, this.lineStart = 0, this.lineIndent = 0, this.firstTabInLine = -1, this.documents = [];
}
f(Vd, "State$1");
function Mn(e, t) {
  var r = {
  ...
  return r.snippet = ek(r), new re(t, r);
}
f(Mn, "generateError");
function K(e, t) {
  throw Mn(e, t);
...
var Fh = {
  ...
  TAG: /* @__PURE__ */ f(function(t, r, i) {
    var s, o;
    i.length !== 2 && K(t, "TAG directive accepts exactly two arguments"), s = i[0], o = i[1], Wd.test(s) || K(t, "ill-formed tag handle (first argument) of the TAG directive"), rr.call(t.tagMap, s) && K(t, 'there is a previously declared suffix for "' + s + '" tag handle'), zd.test(o) || K(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
f(Gi, "testDocumentSeparator");
function yo(e, t) {
  t === 1 ? e.result += " " : t > 1 && (e.result += $t.repeat(`
`, t - 1));
}
f(yo, "writeFoldedLines");
function Zd(e, t, r) {
  var i, s, o, a, n, l, c, h, u = e.kind, p = e.result, d;
  if (d = e.input.charCodeAt(e.position), Xt(d) || fr(d) || d === 35 || d === 38 || d === 42 || d === 33 || d === 124 || d === 62 || d === 39 || d === 34 || d === 37 || d === 64 || d === 96 || (d === 63 || d === 45) && (s = e.input.charCodeAt(e.position + 1), Xt(s) || r && fr(s)))
    return !1;
  for (e.kind = "scalar", e.result = "", o = a = e.position, n = !1; d !== 0; ) {
    if (d === 58) {
      if (s = e.input.charCodeAt(e.position + 1), Xt(s) || r && fr(s))
        break;
    } else if (d === 35) {
      if (i = e.input.charCodeAt(e.position - 1), Xt(i))
        break;
    } else {
      if (e.position === e.lineStart && Gi(e) || r && fr(d))
        break;
      if (xe(d))
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = i = e.position; (n = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (n === 92) {
      if (ze(e, r, e.position, !0), n = e.input.charCodeAt(++e.position), xe(n))
        ...
        e.result += Xd[n], e.position++;
      else if ((a = Ud(n)) > 0) {
        for (s = a, o = 0; s > 0; s--)
          n = e.input.charCodeAt(++e.position), (a = Hd(n)) >= 0 ? o = (o << 4) + a : K(e, "expected hexadecimal character");
        e.result += Gd(o), e.position++;
      } else
...
f(Qd, "readDoubleQuotedScalar");
function Jd(e, t) {
  var r = !0, i, s, o, a = e.tag, n, l = e.anchor, c, h, u, p, d, g = /* @__PURE__ */ Object.create(null), m, y, C, b;
...
function tp(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      Ko === s ? s = u === 43 ? Lh : vk : K(e, "repeat of a chomping mode identifier");
    else if ((h = Yd(u)) >= 0)
...
function Ea(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, K(e, "tab characters must not be used in indentation")), !(l !== 45 || (a = e.input.charCodeAt(e.position + 1), !Xt(a)))); ) {
    ...
    if (r = e.line, br(e, t, qd, !1, !0), o.push(e.result), _t(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
f(Ea, "readBlockSequence");
function ep(e, t, r) {
  var i, s, o, a, n, l, c = e.tag, h = e.anchor, u = {}, p = /* @__PURE__ */ Object.create(null), d = null, g = null, m = null, y = !1, C = !1, b;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), b = e.input.charCodeAt(e.position); b !== 0; ) {
    if (!y && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, K(e, "tab characters must not be used in indentation")), i = e.input.charCodeAt(e.position + 1), o = e.line, (b === 63 || b === 58) && Xt(i))
      b === 63 ? (y && (gr(e, u, p, d, g, null, a, n, l), d = g = m = null), C = !0, y = !0, s = !0) : y ? (y = !1, s = !0) : K(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, b = i;
    else {
      if (a = e.line, n = e.lineStart, l = e.position, !br(e, r, Nd, !1, !0))
        break;
      if (e.line === o) {
        for (b = e.input.charCodeAt(e.position); tr(b); )
          b = e.input.charCodeAt(++e.position);
        if (b === 58)
          b = e.input.charCodeAt(++e.position), Xt(b) || K(e, "a whitespace character is expected after the key-value separator within a block mapping"), y && (gr(e, u, p, d, g, null, a, n, l), d = g = m = null), C = !0, y = !1, s = !1, d = e.tag, g = e.result;
        else if (C)
    ...
    if ((e.line === o || e.lineIndent > t) && (y && (a = e.line, n = e.lineStart, l = e.position), br(e, t, Ys, !0, s) && (y ? g = e.result : m = e.result), y || (gr(e, u, p, d, g, m, a, n, l), d = g = m = null), _t(e, !0, -1), b = e.input.charCodeAt(e.position)), (e.line === o || e.lineIndent > t) && b !== 0)
      K(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return y && gr(e, u, p, d, g, null, a, n, l), C && (e.tag = c, e.anchor = h, e.kind = "mapping", e.result = u), C;
}
f(ep, "readBlockMapping");
function rp(e) {
  var t, r = !1, i = !1, s, o, a;
  ...
  if (e.tag !== null && K(e, "duplication of a tag property"), a = e.input.charCodeAt(++e.position), a === 60 ? (r = !0, a = e.input.charCodeAt(++e.position)) : a === 33 ? (i = !0, s = "!!", a = e.input.charCodeAt(++e.position)) : s = "!", t = e.position, r) {
    ...
    for (; a !== 0 && !Xt(a); )
      a === 33 && (i ? K(e, "tag suffix cannot contain exclamation marks") : (s = e.input.slice(t - 1, e.position + 1), Wd.test(s) || K(e, "named tag handle cannot contain such characters"), i = !0, t = e.position + 1)), a = e.input.charCodeAt(++e.position);
    o = e.input.slice(t, e.position), Fk.test(o) && K(e, "tag suffix cannot contain flow indicator characters");
  }
  o && !zd.test(o) && K(e, "tag name cannot contain such characters: " + o);
  try {
    o = decodeURIComponent(o);
  } catch {
...
f(rp, "readTagProperty");
function ip(e) {
  var t, r;
  if (r = e.input.charCodeAt(e.position), r !== 38) return !1;
  for (e.anchor !== null && K(e, "duplication of an anchor property"), r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !Xt(r) && !fr(r); )
...
f(ip, "readAnchorProperty");
function sp(e) {
  var t, r, i;
  if (i = e.input.charCodeAt(e.position), i !== 42) return !1;
  for (i = e.input.charCodeAt(++e.position), t = e.position; i !== 0 && !Xt(i) && !fr(i); )
...
function br(e, t, r, i, s) {
  ...
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, o = a = n = Ys === r || qd === r, i && _t(e, !0, -1) && (c = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; rp(e) || ip(e); )
      _t(e, !0, -1) ? (c = !0, n = o, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : n = !1;
  if (n && (n = c || s), (l === 1 || Ys === r) && (Us === r || Nd === r ? m = t : m = t + 1, y = e.position - e.lineStart, l === 1 ? n && (Ea(e, y) || ep(e, y, m)) || Jd(e, m) ? h = !0 : (a && tp(e, m) || Kd(e, m) || Qd(e, m) ? h = !0 : sp(e) ? (h = !0, (e.tag !== null || e.anchor !== null) && K(e, "alias node should not have any properties")) : Zd(e, m, Us === r) && (h = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (h = n && Ea(e, y))), e.tag === null)
...
function op(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (a = e.input.charCodeAt(e.position)) !== 0 && (_t(e, !0, -1), a = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || a !== 37)); ) {
    ...
    a !== 0 && mo(e), rr.call(Fh, i) ? Fh[i](e, i, s) : Oi(e, 'unknown document directive "' + i + '"');
  }
  if (_t(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, _t(e, !0, -1)) : o && K(e, "directives end mark is expected"), br(e, e.lineIndent - 1, Ys, !1, !0), _t(e, !0, -1), e.checkLineBreaks && Lk.test(e.input.slice(t, e.position)) && Oi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Gi(e)) {
...
`), e.charCodeAt(0) === 65279 && (e = e.slice(1)));
  var r = new Vd(e, t), i = e.indexOf("\0");
...
var Ek = ap, Mk = {
  load: Ek
}, np = Object.prototype.toString, lp = Object.prototype.hasOwnProperty, In = 65279, $k = 9, Di = 10, Ik = 13, Ok = 32, Dk = 33, Rk = 34, Ma = 35, Pk = 37, Nk = 38, qk = 39, Wk = 42, hp = 44, zk = 45, Gs = 58, Hk = 61, Uk = 62, Yk = 63, Gk = 64, cp = 91, up = 93, jk = 96, dp = 123, Xk = 124, pp = 125, Ut = {};
Ut[0] = "\\0";
Ut[7] = "\\a";
Ut[8] = "\\b";
Ut[9] = "\\t";
...
function fp(e, t) {
  ...
  for (r = {}, i = Object.keys(t), s = 0, o = i.length; s < o; s += 1)
    a = i[s], n = String(t[a]), a.slice(0, 2) === "!!" && (a = "tag:yaml.org,2002:" + a.slice(2)), l = e.compiledTypeMap.fallback[a], l && lp.call(l.styleAliases, n) && (n = l.styleAliases[n]), r[a] = n;
  return r;
}
f(fp, "compileStyleMap");
function gp(e) {
  var t, r, i;
...
var Kk = 1, Ri = 2;
function mp(e) {
  this.schema = e.schema || Pd, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = $t.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = fp(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? Ri : Kk, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
f(mp, "State");
function $a(e, t) {
...
f(Vr, "isPrintable");
function Ia(e) {
  return Vr(e) && e !== In && e !== Ik && e !== Di;
}
f(Ia, "isNsCharOrWhitespace");
function Oa(e, t, r) {
  var i = Ia(e), s = i && !Pi(e);
  return (
    // ns-plain-safe
    (r ? (
      // c = flow-in
      i
    ) : i && e !== hp && e !== cp && e !== up && e !== dp && e !== pp) && e !== Ma && !(t === Gs && !s) || Ia(t) && !Pi(t) && e === Ma || t === Gs && s
  );
}
f(Oa, "isPlainSafe");
function Cp(e) {
  return Vr(e) && e !== In && !Pi(e) && e !== zk && e !== Yk && e !== Gs && e !== hp && e !== cp && e !== up && e !== dp && e !== pp && e !== Ma && e !== Nk && e !== Wk && e !== Dk && e !== Xk && e !== Hk && e !== Uk && e !== qk && e !== Rk && e !== Pk && e !== Gk && e !== jk;
}
f(Cp, "isPlainSafeFirst");
function xp(e) {
  return !Pi(e) && e !== Gs;
}
...
var bp = 1, Da = 2, kp = 3, Tp = 4, Or = 5;
function wp(e, t, r, i, s, o, a, n) {
  var l, c = 0, h = null, u = !1, p = !1, d = i !== -1, g = -1, m = Cp(Nr(e, 0)) && xp(Nr(e, e.length - 1));
  if (t || a)
  ...
  return !u && !p ? m && !a && !s(e) ? bp : o === Ri ? Or : Da : r > 9 && On(e) ? Or : a ? o === Ri ? Or : Da : p ? Tp : kp;
}
f(wp, "chooseScalarStyle");
function Sp(e, t, r, i, s) {
  e.dump = (function() {
    if (t.length === 0)
      return e.quotingType === Ri ? '""' : "''";
    if (!e.noCompatMode && (Vk.indexOf(t) !== -1 || Zk.test(t)))
    ...
    switch (f(l, "testAmbiguity"), wp(
      ...
      case Tp:
        return ">" + Ra(t, e.indent) + Pa($a(_p(t, a), o));
      case Or:
        return '"' + vp(t) + '"';
      default:
...
function vp(e) {
  for (var t = "", r = 0, i, s = 0; s < e.length; r >= 65536 ? s += 2 : s++)
    r = Nr(e, s), i = Ut[r], !i && Vr(r) ? (t += e[s], r >= 65536 && (t += e[s + 1])) : t += i || gp(r);
  return t;
}
f(vp, "escapeString");
function Bp(e, t, r) {
...
function Fp(e, t, r, i) {
  ...
  for (n = 0, l = a.length; n < l; n += 1)
    p = "", (!i || s !== "") && (p += js(e, t)), c = a[n], h = r[c], e.replacer && (h = e.replacer.call(r, c, h)), Ee(e, t + 1, c, !0, !0, !0) && (u = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, u && (e.dump && Di === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, u && (p += js(e, t)), Ee(e, t + 1, h, !0, u) && (e.dump && Di === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, s += p));
  e.tag = o, e.dump = s || "{}";
}
f(Fp, "writeBlockMapping");
function Wa(e, t, r) {
  var i, s, o, a, n, l;
  for (s = r ? e.explicitTypes : e.implicitTypes, o = 0, a = s.length; o < a; o += 1)
    if (n = s[o], (n.instanceOf || n.predicate) && (!n.instanceOf || typeof t == "object" && t instanceof n.instanceOf) && (!n.predicate || n.predicate(t))) {
      if (r ? n.multi && n.representName ? e.tag = n.representName(t) : e.tag = n.tag : e.tag = "?", n.represent) {
        if (l = e.styleMap[n.tag] || n.defaultStyle, np.call(n.represent) === "[object Function]")
          i = n.represent(t, l);
        else if (lp.call(n.represent, l))
          i = n.represent[l](t, l);
        else
...
function Ee(e, t, r, i, s, o, a) {
  ...
  if (h && (u = e.duplicates.indexOf(r), p = u !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (s = !1), p && e.usedDuplicates[u])
    ...
    if (h && p && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), n === "[object Object]")
      i && Object.keys(e.dump).length !== 0 ? (Fp(e, t, e.dump, s), p && (e.dump = "&ref_" + u + e.dump)) : (Lp(e, t, e.dump), p && (e.dump = "&ref_" + u + " " + e.dump));
    else if (n === "[object Array]")
      i && e.dump.length !== 0 ? (e.noArrayIndent && !a && t > 0 ? qa(e, t - 1, e.dump, s) : qa(e, t, e.dump, s), p && (e.dump = "&ref_" + u + e.dump)) : (Bp(e, t, e.dump), p && (e.dump = "&ref_" + u + " " + e.dump));
    else if (n === "[object String]")
      e.tag !== "?" && Sp(e, e.dump, t, o, l);
    else {
...
f(Jk, "renamed");
var t2 = kd, e2 = Mk.load;
/*! Bundled license information:

js-yaml/dist/js-yaml.mjs:
  (*! js-yaml 4.1.1 https://github.com/nodeca/js-yaml @license MIT *)
*/
var hi = /* @__PURE__ */ f((e, t) => {
  if (t)
...
f(ki, "calculateDeltaAndAngle");
var kt = /* @__PURE__ */ f((e) => Array.isArray(e) ? { x: e[0], y: e[1] } : e, "pointTransformer"), r2 = /* @__PURE__ */ f((e) => ({
  x: /* @__PURE__ */ f(function(t, r, i) {
    ...
    ), l = Math.abs(kt(t).x - kt(i[0]).x), c = Math.abs(kt(t).y - kt(i[0]).y), h = Wt[e.arrowTypeStart], u = Wt[e.arrowTypeEnd], p = 1;
    if (a < u && a > 0 && n < u) {
      let d = u + p - a;
      d *= o === "right" ? -1 : 1, s -= d;
    }
  ...
  y: /* @__PURE__ */ f(function(t, r, i) {
    ...
    const a = Math.abs(
      ...
      kt(t).x - kt(i[i.length - 1]).x
    ), l = Math.abs(kt(t).y - kt(i[0]).y), c = Math.abs(kt(t).x - kt(i[0]).x), h = Wt[e.arrowTypeStart], u = Wt[e.arrowTypeEnd], p = 1;
    if (a < u && a > 0 && n < u) {
      let d = u + p - a;
      d *= o === "up" ? -1 : 1, s -= d;
    }
...
}), "getLineFunctionsWithOffset"), ci = {}, Et = {}, Eh;
function i2() {
...
function s2() {
  if (Mh) return ci;
  Mh = 1, Object.defineProperty(ci, "__esModule", { value: !0 }), ci.sanitizeUrl = void 0;
  var e = i2();
  function t(a) {
...
const n2 = "[object RegExp]", Mp = "[object String]", $p = "[object Number]", Ip = "[object Boolean]", Op = "[object Arguments]", l2 = "[object Symbol]", h2 = "[object Date]", c2 = "[object Map]", u2 = "[object Set]", d2 = "[object Array]", p2 = "[object ArrayBuffer]", f2 = "[object Object]", g2 = "[object DataView]", m2 = "[object Uint8Array]", y2 = "[object Uint8ClampedArray]", C2 = "[object Uint16Array]", x2 = "[object Uint32Array]", b2 = "[object Int8Array]", k2 = "[object Int16Array]", T2 = "[object Int32Array]", w2 = "[object Float32Array]", S2 = "[object Float64Array]", $h = typeof globalThis == "object" && globalThis || typeof window == "object" && window || typeof self == "object" && self || typeof global == "object" && global || /* @__PURE__ */ (function() {
  return this;
})();
function Rn(e) {
  return typeof $h.Buffer < "u" && $h.Buffer.isBuffer(e);
}
function _2(e) {
  return Number.isSafeInteger(e) && e >= 0;
}
function Dp(e) {
  return e != null && typeof e != "function" && _2(e.length);
}
function v2(e) {
  return e === "__proto__";
}
...
function qr(e, t, r, i = /* @__PURE__ */ new Map(), s = void 0) {
  ...
  if (e instanceof DataView) {
    ...
    return i.set(e, a), fe(a, e, r, i, s), a;
  }
  ...
  if (e instanceof Error) {
    ...
    return i.set(e, a), a.message = e.message, a.name = e.name, a.stack = e.stack, a.cause = e.cause, a.constructor = e.constructor, fe(a, e, r, i, s), a;
  }
...
function fe(e, t, r = e, i, s) {
  const o = [...Object.keys(t), ...Ep(t)];
  ...
  return B2(e, (r, i, s, o) => {
    if (typeof e == "object") {
      ...
      switch (Object.prototype.toString.call(e)) {
        ...
        case Op: {
          const a = {};
          return fe(a, e), a.length = e.length, a[Symbol.iterator] = e[Symbol.iterator], a;
        }
        default:
          return;
      }
...
function ws(e, t, r, i) {
  ...
  if (i.has(t)) return M2(i.get(t));
  if (i.set(t, e), Array.isArray(t)) {
    t = t.slice();
    for (let o = 0; o < t.length; o++) t[o] = t[o] ?? void 0;
  }
  const s = [...Object.keys(t), ...Ep(t)];
  for (let o = 0; o < s.length; o++) {
    const a = s[o];
    if (v2(a)) continue;
    let n = t[a], l = e[a];
    if (za(n) && (n = { ...n }), za(l) && (l = { ...l }), Rn(n) && (n = Ih(n)), Array.isArray(n)) if (Array.isArray(l)) {
    ...
    c !== void 0 ? e[a] = c : Array.isArray(n) || Ha(l) && Ha(n) && (Qo(l) || Qo(n) || Ts(l) || Ts(n)) ? e[a] = ws(l, n, r, i) : l == null && Qo(n) ? e[a] = ws({}, n, r, i) : l == null && Ts(n) ? e[a] = Ih(n) : (l === void 0 || n !== void 0) && (e[a] = n);
  }
  return e;
}
function I2(e, ...t) {
...
function Oh(e) {
  ...
  if (typeof e == "object" || typeof e == "function") {
    ...
    const t = Object.keys(e);
    return E2(e) ? t.filter((r) => r !== "constructor").length === 0 : t.length === 0;
  }
  return !0;
}
var O2 = "​", D2 = {
  ...
  curveBumpY: Eu,
  curveBundle: z1,
  curveCardinalClosed: H1,
  curveCardinalOpen: U1,
  curveCardinal: Ou,
  curveCatmullRomClosed: Y1,
  curveCatmullRomOpen: G1,
  curveCatmullRom: Ru,
  curveLinear: Li,
  curveLinearClosed: j1,
  curveMonotoneX: Hu,
  curveMonotoneY: Uu,
  curveNatural: Gu,
  curveStep: ju,
  curveStepAfter: Vu,
  curveStepBefore: Xu
}, R2 = /\s*(?:(\w+)(?=:):|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, P2 = /* @__PURE__ */ f(function(e, t) {
...
}, "detectInit"), Rp = /* @__PURE__ */ f(function(e, t = null) {
  try {
    const r = new RegExp(
      `[%]{2}(?![{]${R2.source})(?=[}][%]{2}).*
`,
...
}, "detectDirective"), N2 = /* @__PURE__ */ f(function(e) {
  return e.replace(vi, "");
}, "removeDirectives"), q2 = /* @__PURE__ */ f(function(e, t) {
...
f(qn, "interpolateToCurve");
function Pp(e, t) {
  const r = e.trim();
  if (r)
    return t.securityLevel !== "loose" ? o2.sanitizeUrl(r) : r;
}
f(Pp, "formatUrl");
var W2 = /* @__PURE__ */ f((e, ...t) => {
...
f(qp, "calcLabelPosition");
var Dh = /* @__PURE__ */ f((e, t = 2) => {
  const r = Math.pow(10, t);
  return Math.round(e * r) / r;
}, "roundNumber"), zn = /* @__PURE__ */ f((e, t) => {
  let r, i = t;
  for (const s of e) {
    if (r) {
      const o = Wn(s, r);
      ...
      if (o < i)
        ...
        if (a > 0 && a < 1)
          return {
            x: Dh((1 - a) * r.x + a * s.x, 5),
            y: Dh((1 - a) * r.y + a * s.y, 5)
          };
      }
    }
    r = s;
...
}, "calculatePoint"), z2 = /* @__PURE__ */ f((e, t, r) => {
...
f(Wp, "calcTerminalLabelPosition");
function zp(e) {
  let t = "", r = "";
  for (const i of e)
...
f(zp, "getStylesFromArray");
var Rh = 0, H2 = /* @__PURE__ */ f(() => (Rh++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Rh), "generateId");
function Hp(e) {
  let t = "";
...
f(Hp, "makeRandomHex");
var U2 = /* @__PURE__ */ f((e) => Hp(e.length), "random"), Y2 = /* @__PURE__ */ f(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
}, "getTextObj"), G2 = /* @__PURE__ */ f(function(e, t) {
  ...
  (e, t, r) => {
    ...
    return i.forEach((a, n) => {
      ...
      if (l > t) {
        const { hyphenatedStrings: p, remainingWord: d } = X2(a, t, "-", r);
        s.push(o, ...p), o = d;
...
f(Up, "calculateTextHeight");
function Ue(e, t) {
  return Hn(e, t).width;
}
f(Ue, "calculateTextWidth");
var Hn = ji(
  (e, t) => {
    ...
    for (const p of a) {
      ...
      for (const m of n) {
        const y = Y2();
        y.text = m || O2;
        const C = G2(h, y).style("font-size", o).style("font-weight", s).style("font-family", p), b = (C._groups || C)[0][0].getBBox();
...
var Ce = {
  assignWithDepth: Mt,
  wrapLabel: j2,
  calculateTextHeight: Up,
  calculateTextWidth: Ue,
  calculateTextDimensions: Hn,
  cleanAndMerge: Yn,
  detectInit: P2,
  detectDirective: Rp,
  isSubstringInArray: q2,
  interpolateToCurve: qn,
  calcLabelPosition: qp,
  calcCardinalityPosition: z2,
  calcTerminalLabelPosition: Wp,
  formatUrl: Pp,
  getStylesFromArray: zp,
  generateId: H2,
  random: U2,
  runFunc: W2,
  entityDecode: Z2,
...
}, "encodeEntities"), kr = /* @__PURE__ */ f(function(e) {
  return e.replace(/ﬂ°°/g, "&#").replace(/ﬂ°/g, "&").replace(/¶ß/g, ";");
}, "decodeEntities"), $L = /* @__PURE__ */ f((e, t, {
  counter: r = 0,
  prefix: i,
  suffix: s
      ...
      (s) => new Promise((o) => {
        function a() {
          if (s.style.display = "flex", s.style.flexDirection = "column", i) {
            const n = gt().fontSize ? gt().fontSize : window.getComputedStyle(document.body).fontSize, l = 5, [c = zc.fontSize] = Co(n), h = c * l + "px";
...
}, "solidStateFill"), Qr = /* @__PURE__ */ f((e) => {
  const t = tT([
    ...e.cssCompiledStyles || [],
    ...e.cssStyles || [],
    ...e.labelStyle || []
...
}, "compileStyles"), tT = /* @__PURE__ */ f((e) => {
  const t = /* @__PURE__ */ new Map();
  return e.forEach((r) => {
    const [i, s] = r.split(":");
    t.set(i.trim(), s?.trim());
  }), t;
}, "styles2Map"), jp = /* @__PURE__ */ f((e) => e === "color" || e === "font-size" || e === "font-family" || e === "font-weight" || e === "font-style" || e === "text-decoration" || e === "text-align" || e === "text-transform" || e === "line-height" || e === "letter-spacing" || e === "word-spacing" || e === "text-shadow" || e === "text-overflow" || e === "white-space" || e === "word-wrap" || e === "word-break" || e === "overflow-wrap" || e === "hyphens", "isLabelStyle"), V = /* @__PURE__ */ f((e) => {
  const { stylesArray: t } = Qr(e), r = [], i = [], s = [], o = [];
  return t.forEach((a) => {
    const n = a[0];
    jp(n) ? r.push(a.join(":") + " !important") : (i.push(a.join(":") + " !important"), n.includes("stroke") && s.push(a.join(":") + " !important"), n === "fill" && o.push(a.join(":") + " !important"));
  }), {
    labelStyles: r.join(";"),
    nodeStyles: i.join(";"),
    stylesArray: t,
  ...
  return Object.assign(
    {
      ...
      fillLineDash: [0, 0],
      strokeLineDash: eT(a.get("stroke-dasharray"))
    },
    t
  );
}, "userNodeOverrides"), eT = /* @__PURE__ */ f((e) => {
  if (!e)
    return [0, 0];
...
function Ph(e, t) {
  const r = nT(e, t);
  for (const i in iT) i in Vs ? i in e && !(i in r) && (r[i] = Vs[i]) : i in t ? r[i] = t[i] : i in e && (r[i] = e[i]);
  return r;
}
function lT(e, t) {
...
function Nh(e, t, r) {
  ...
  return a(t), r.forEach(a), Ph(e, o);
}
function hT(e, t) {
  if (e.icons[t]) return Nh(e, t, []);
  const r = lT(e, [t])[t];
  return r ? Nh(e, t, r) : null;
}
const cT = /(-?[0-9.]*[0-9]+[0-9.]*)/g, uT = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function qh(e, t, r) {
  if (t === 1) return e;
...
function fT(e, t, r) {
  const i = dT(e);
  return pT(i.defs, t + i.content + r);
}
...
function mT(e, t) {
  ...
  [r, i].forEach((m) => {
    ...
    k % 2 === 1 && (s.left !== s.top && (w = s.left, s.left = s.top, s.top = w), s.width !== s.height && (w = s.width, s.width = s.height, s.height = w)), y.length && (o = fT(o, '<g transform="' + y.join(" ") + '">', "</g>"));
  });
  const a = i.width, n = i.height, l = s.width, c = s.height;
  let h, u;
  a === null ? (u = n === null ? "1em" : n === "auto" ? c : n, h = qh(u, l / c)) : (h = a === "auto" ? l : a, u = n === null ? qh(h, c / l) : n === "auto" ? c : n);
  const p = {}, d = (m, y) => {
    gT(y) || (p[m] = y.toString());
  };
...
const yT = /\sid="(\S+)"/g, Wh = /* @__PURE__ */ new Map();
function CT(e) {
  e = e.replace(/[0-9]+$/, "") || "a";
  const t = Wh.get(e) || 0;
  return Wh.set(e, t + 1), t ? `${e}${t}` : e;
}
function xT(e) {
  const t = [];
  let r;
  for (; r = yT.exec(e); ) t.push(r[1]);
  if (!t.length) return e;
  const i = "suffix" + (Math.random() * 16777216 | Date.now()).toString(16);
  return t.forEach((s) => {
    const o = CT(s), a = s.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
...
})(), Vt = { codeRemoveIndent: /^(?: {1,4}| {0,3}\t)/gm, outputLinkReplace: /\\([\[\]])/g, indentCodeCompensation: /^(\s+)(?:```)/, beginningSpace: /^\s+/, endingHash: /#$/, startingSpaceChar: /^ /, endingSpaceChar: / $/, nonSpaceChar: /[^ ]/, newLineCharGlobal: /\n/g, tabCharGlobal: /\t/g, multipleSpaceGlobal: /\s+/g, blankLine: /^[ \t]*$/, doubleBlankLine: /\n[ \t]*\n[ \t]*$/, blockquoteStart: /^ {0,3}>/, blockquoteSetextReplace: /\n {0,3}((?:=+|-+) *)(?=\n|$)/g, blockquoteSetextReplace2: /^ {0,3}>[ \t]?/gm, listReplaceTabs: /^\t+/, listReplaceNesting: /^ {1,4}(?=( {4})*[^ ])/g, listIsTask: /^\[[ xX]\] /, listReplaceTask: /^\[[ xX]\] +/, anyLine: /\n.*\n/, hrefBrackets: /^<(.*)>$/, tableDelimiter: /[:|]/, tableAlignChars: /^\||\| *$/g, tableRowBlankLine: /\n[ \t]*$/, tableAlignRight: /^ *-+: *$/, tableAlignCenter: /^ *:-+: *$/, tableAlignLeft: /^ *:-+ *$/, startATag: /^<a /i, endATag: /^<\/a>/i, startPreScriptTag: /^<(pre|code|kbd|script)(\s|>)/i, endPreScriptTag: /^<\/(pre|code|kbd|script)(\s|>)/i, startAngleBracket: /^</, endAngleBracket: />$/, pedanticHrefTitle: /^([^'"]*[^\s])\s+(['"])(.*)\2/, unicodeAlphaNumeric: /[\p{L}\p{N}]/u, escapeTest: /[&<>"']/, escapeReplace: /[&<>"']/g, escapeTestNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, escapeReplaceNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g, unescapeTest: /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig, caret: /(^|[^\[])\^/g, percentDecode: /%25/g, findPipe: /\|/g, splitPipe: / \|/, slashPipe: /\\\|/g, carriageReturn: /\r\n|\r/g, spaceLine: /^ +$/gm, notSpaceStart: /^\S*/, endingNewline: /\n$/, listItemRegex: (e) => new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`), nextBulletRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), hrRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), fencesBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}(?:\`\`\`|~~~)`), headingBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}#`), htmlBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}<(?:[a-z].*>|!--)`, "i") }, TT = /^(?:[ \t]*(?:\n|$))+/, wT = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, ST = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, Xi = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, _T = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, Xn = /(?:[*+-]|\d{1,9}[.)])/, Zp = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, Kp = mt(Zp).replace(/bull/g, Xn).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), vT = mt(Zp).replace(/bull/g, Xn).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), Vn = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, BT = /^[^\n]+/, Zn = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/, LT = mt(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", Zn).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), FT = mt(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, Xn).getRegex(), xo = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", Kn = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, AT = mt("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", Kn).replace("tag", xo).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), Qp = mt(Vn).replace("hr", Xi).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", xo).getRegex(), ET = mt(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", Qp).getRegex(), Qn = { blockquote: ET, code: wT, def: LT, fences: ST, heading: _T, hr: Xi, html: AT, lheading: Kp, list: FT, newline: TT, paragraph: Qp, table: Fi, text: BT }, zh = mt("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", Xi).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", xo).getRegex(), MT = { ...Qn, lheading: vT, table: zh, paragraph: mt(Vn).replace("hr", Xi).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", zh).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", xo).getRegex() }, $T = { ...Qn, html: mt(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", Kn).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: Fi, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: mt(Vn).replace("hr", Xi).replace("heading", ` *#{1,6} *[^
]`).replace("lheading", Kp).replace("|table", "").replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").replace("|tag", "").getRegex() }, IT = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, OT = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, Jp = /^( {2,}|\\)\n(?!\s*$)/, DT = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, bo = /[\p{P}\p{S}]/u, Jn = /[\s\p{P}\p{S}]/u, tf = /[^\s\p{P}\p{S}]/u, RT = mt(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, Jn).getRegex(), ef = /(?!~)[\p{P}\p{S}]/u, PT = /(?!~)[\s\p{P}\p{S}]/u, NT = /(?:[^\s\p{P}\p{S}]|~)/u, qT = mt(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", kT ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex(), rf = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, WT = mt(rf, "u").replace(/punct/g, bo).getRegex(), zT = mt(rf, "u").replace(/punct/g, ef).getRegex(), sf = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", HT = mt(sf, "gu").replace(/notPunctSpace/g, tf).replace(/punctSpace/g, Jn).replace(/punct/g, bo).getRegex(), UT = mt(sf, "gu").replace(/notPunctSpace/g, NT).replace(/punctSpace/g, PT).replace(/punct/g, ef).getRegex(), YT = mt("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, tf).replace(/punctSpace/g, Jn).replace(/punct/g, bo).getRegex(), GT = mt(/\\(punct)/, "gu").replace(/punct/g, bo).getRegex(), jT = mt(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), XT = mt(Kn).replace("(?:-->|$)", "-->").getRegex(), VT = mt("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", XT).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), Zs = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/, ZT = mt(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", Zs).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), of = mt(/^!?\[(label)\]\[(ref)\]/).replace("label", Zs).replace("ref", Zn).getRegex(), af = mt(/^!?\[(ref)\](?:\[\])?/).replace("ref", Zn).getRegex(), KT = mt("reflink|nolink(?!\\()", "g").replace("reflink", of).replace("nolink", af).getRegex(), Hh = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/, tl = { _backpedal: Fi, anyPunctuation: GT, autolink: jT, blockSkip: qT, br: Jp, code: OT, del: Fi, emStrongLDelim: WT, emStrongRDelimAst: HT, emStrongRDelimUnd: YT, escape: IT, link: ZT, nolink: af, punctuation: RT, reflink: of, reflinkSearch: KT, tag: VT, text: DT, url: Fi }, QT = { ...tl, link: mt(/^!?\[(label)\]\((.*?)\)/).replace("label", Zs).getRegex(), reflink: mt(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", Zs).getRegex() }, Ua = { ...tl, emStrongRDelimAst: UT, emStrongLDelim: zT, url: mt(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", Hh).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/, text: mt(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", Hh).getRegex() }, JT = { ...Ua, br: mt(Jp).replace("{2,}", "*").getRegex(), text: mt(Ua.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() }, ns = { normal: Qn, gfm: MT, pedantic: $T }, ui = { normal: tl, gfm: Ua, breaks: JT, pedantic: QT }, tw = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, Uh = (e) => tw[e];
function ve(e, t) {
  if (t) {
    if (Vt.escapeTest.test(e)) return e.replace(Vt.escapeReplace, Uh);
  } else if (Vt.escapeTestNoEncode.test(e)) return e.replace(Vt.escapeReplaceNoEncode, Uh);
  return e;
}
function Yh(e) {
  try {
...
`) };
  ...
  fences(t) {
    ...
    if (r) {
      let i = r[0], s = rw(i, r[3] || "", this.rules);
...
` + d;
            ...
            !g && !d.trim() && (g = !0), h += B + `
`, t = t.substring(B.length + 1), p = O.slice(m);
          }
        }
  ...
  table(t) {
    ...
    let i = Gh(r[1]), s = r[2].replace(this.rules.other.tableAlignChars, "").split("|"), o = r[3]?.trim() ? r[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], a = { type: "table", raw: r[0], header: [], align: [], rows: [] };
    if (i.length === s.length) {
      ...
      for (let n of o) a.rows.push(Gh(n, a.header.length).map((l, c) => ({ text: l, tokens: this.lexer.inline(l), header: !1, align: a.align[c] })));
      return a;
    }
  }
  lheading(t) {
...
` ? r[1].slice(0, -1) : r[1];
  ...
  link(t) {
    ...
    if (r) {
      ...
      return s = s.trim(), this.rules.other.startAngleBracket.test(s) && (this.options.pedantic && !this.rules.other.endAngleBracket.test(i) ? s = s.slice(1) : s = s.slice(1, -1)), jh(r, { href: s && s.replace(this.rules.inline.anyPunctuation, "$1"), title: o && o.replace(this.rules.inline.anyPunctuation, "$1") }, r[0], this.lexer, this.rules);
    }
  }
  reflink(t, r) {
    let i;
    if ((i = this.rules.inline.reflink.exec(t)) || (i = this.rules.inline.nolink.exec(t))) {
      ...
      return jh(i, o, i[0], this.lexer, this.rules);
    }
  }
  emStrong(t, r, i = "") {
...
`;
  ...
  link({ href: t, title: r, tokens: i }) {
    let s = this.parser.parseInline(i), o = Yh(t);
    if (o === null) return s;
    t = o;
    let a = '<a href="' + t + '"';
...
yt.options = yt.setOptions = function(e) {
  return Tr.setOptions(e), yt.defaults = Tr.defaults, Vp(yt.defaults), yt;
};
yt.getDefaults = jn;
yt.defaults = Sr;
yt.use = function(...e) {
  return Tr.use(...e), yt.defaults = Tr.defaults, Vp(yt.defaults), yt;
};
...
var sw = {
  ...
  height: 80,
  width: 80
}, ja = /* @__PURE__ */ new Map(), lf = /* @__PURE__ */ new Map(), ow = /* @__PURE__ */ f((e) => {
  for (const t of e) {
    if (!t.name)
      throw new Error(
...
}, "registerIconPacks"), hf = /* @__PURE__ */ f(async (e, t) => {
  ...
  return o;
}, "getRegisteredIconData"), aw = /* @__PURE__ */ f(async (e) => {
  try {
    return await hf(e), !0;
  } catch {
    return !1;
  }
}, "isIconAvailable"), Vi = /* @__PURE__ */ f(async (e, t, r) => {
  let i;
  try {
    i = await hf(e, t?.fallbackPrefix);
  } catch (a) {
    P.error(a), i = sw;
  }
  const s = mT(i, t), o = bT(xT(s.body), {
    ...s.attributes,
    ...r
  });
  return ke(o, Tt());
...
f(cf, "preprocessMarkdown");
function uf(e) {
  return e.split(/\\n|\n|<br\s*\/?>/gi).map(
    (t) => t.trim().match(/<[^>]+>|[^\s<>]+/g)?.map((r) => ({ content: r, type: "normal" })) ?? []
  );
}
f(uf, "nonMarkdownToLines");
function df(e, t = {}) {
  const r = cf(e, t), i = yt.lexer(r), s = [[]];
  let o = 0;
...
f(gf, "splitTextToChars");
function mf(e, t) {
  const r = gf(t.content);
  return rl(e, [], r, t.type);
}
f(mf, "splitWordToFitWidth");
function rl(e, t, r, i) {
  if (r.length === 0)
    return [
...
f(rl, "splitWordToFitWidthRecursion");
function yf(e, t) {
...
f(Js, "splitLineToFitWidthRecursion");
function Xa(e, t) {
  t && e.attr("style", t);
}
f(Xa, "applyStyle");
var Xh = 16384;
async function Cf(e, t, r, i, s = !1, o = Tt()) {
  const a = e.append("foreignObject");
  a.attr("width", `${Math.min(10 * r, Xh)}px`), a.attr("height", `${Math.min(10 * r, Xh)}px`);
  const n = a.append("xhtml:div"), l = Ai(t.label) ? await Qc(t.label.replace(Hi.lineBreakRegex, `
...
f(nw, "computeDimensionOfText");
function bf(e, t, r, i = !1, s = !1) {
  ...
  let c = 0;
  for (const h of r) {
    const u = /* @__PURE__ */ f((d) => xf(a, 1.1, d) <= e, "checkWidth"), p = u(h) ? [h] : yf(h, u);
    for (const d of p) {
...
f(To, "updateTextContentAndStyles");
async function kf(e, t = {}) {
  const r = [];
  e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, (s, o, a) => (r.push(
    (async () => {
      const n = `${o}:${a}`;
      return await aw(n) ? await Vi(n, void 0, { class: "label-icon" }) : `<i class='${ke(s, t).replace(":", " ")}'></i>`;
    })()
  ), s));
  const i = await Promise.all(r);
  return e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, () => i.shift() ?? "");
}
f(kf, "replaceIconSubstring");
var je = /* @__PURE__ */ f(async (e, t = "", {
  style: r = "",
  isTitle: i = !1,
  classes: s = "",
  useHtmlLabels: o = !0,
  ...
  if (P.debug(
    ...
    const u = a ? ff(t, h) : pf(t), p = await kf(kr(u), h), d = t.replace(/\\\\/g, "\\"), g = {
      isNode: n,
      label: Ai(t) ? d : p,
      labelStyle: r.replace("fill:", "color:")
    };
    return await Cf(e, g, l, s, c, h);
  } else {
    const u = kr(t.replace(/<br\s*\/?>/g, "<br/>")), p = a ? df(u.replace("<br>", "<br/>"), h) : uf(u), d = bf(
      l,
      e,
      p,
      t ? c : !1,
...
function hw(e, t, r, i = 1) {
  ...
  const l = (function(c, h, u) {
    ...
    for (const b of c) {
      const k = [...b];
      lw(k[0], k[k.length - 1]) || k.push([k[0][0], k[0][1]]), k.length > 2 && p.push(k);
    }
    const d = [];
    h = Math.max(h, 0.1);
    const g = [];
...
function Zi(e, t) {
  ...
  let o = 1;
  return t.roughness >= 1 && (((r = t.randomizer) === null || r === void 0 ? void 0 : r.next()) || Math.random()) > 0.7 && (o = s), hw(e, s, i, o || 1);
}
class il {
  constructor(t) {
    this.helper = t;
...
class dw {
  ...
  dotsOnLines(t, r) {
    ...
    const a = s / 4;
    for (const n of t) {
      const l = wo(n), c = l / s, h = Math.ceil(c) - 1, u = l - h * s, p = (n[0][0] + n[1][0]) / 2 - s / 4, d = Math.min(n[0][1], n[1][1]);
      for (let g = 0; g < h; g++) {
        const m = d + u + g * s, y = p - a + 2 * Math.random() * a, C = m - a + 2 * Math.random() * a, b = this.helper.ellipse(y, C, o, o, r);
        i.push(...b.ops);
      }
    }
...
class pw {
  ...
  dashedLine(t, r) {
    ...
    return t.forEach(((a) => {
      ...
      for (let d = 0; d < l; d++) {
        const g = d * (i + s), m = g + i, y = [h[0] + g * Math.cos(p) + c * Math.cos(p), h[1] + g * Math.sin(p) + c * Math.sin(p)], C = [h[0] + m * Math.cos(p) + c * Math.cos(p), h[1] + m * Math.sin(p) + c * Math.sin(p)];
...
class fw {
  ...
  zigzagLines(t, r, i) {
    ...
    return t.forEach(((o) => {
      ...
      for (let u = 0; u < n; u++) {
        const p = 2 * u * r, d = 2 * (u + 1) * r, g = Math.sqrt(2 * Math.pow(r, 2)), m = [l[0] + p * Math.cos(h), l[1] + p * Math.sin(h)], y = [l[0] + d * Math.cos(h), l[1] + d * Math.sin(h)], C = [m[0] + g * Math.cos(h + Math.PI / 4), m[1] + g * Math.sin(h + Math.PI / 4)];
...
const mw = 0, ea = 1, Vh = 2, ls = { A: 7, a: 7, C: 6, c: 6, H: 1, h: 1, L: 2, l: 2, M: 2, m: 2, Q: 4, q: 4, S: 4, s: 4, T: 2, t: 2, V: 1, v: 1, Z: 0, z: 0 };
function ra(e, t) {
  return e.type === t;
}
function sl(e) {
  const t = [], r = (function(a) {
    ...
    else if (a.match(/^([aAcChHlLmMqQsStTvVzZ])/)) n[n.length] = { type: mw, text: RegExp.$1 }, a = a.substr(RegExp.$1.length);
    else {
      if (!a.match(/^(([-+]?[0-9]+(\.[0-9]*)?|[-+]?\.[0-9]+)([eE][-+]?[0-9]+)?)/)) return [];
      n[n.length] = { type: ea, text: `${parseFloat(RegExp.$1)}` }, a = a.substr(RegExp.$1.length);
    }
    return n[n.length] = { type: Vh, text: "" }, n;
  })(e);
  let i = "BOD", s = 0, o = r[s];
  for (; !ra(o, Vh); ) {
    let a = 0;
  ...
  for (const { key: c, data: h } of e) {
    switch (c) {
      ...
      case "T": {
        ...
        const m = i + 2 * (d - i) / 3, y = s + 2 * (g - s) / 3, C = u + 2 * (d - u) / 3, b = p + 2 * (g - p) / 3;
        t.push({ key: "C", data: [m, y, C, b, u, p] }), n = d, l = g, i = u, s = p;
        break;
      }
      case "Q": {
        const [u, p, d, g] = h, m = i + 2 * (u - i) / 3, y = s + 2 * (p - s) / 3, C = d + 2 * (u - d) / 3, b = g + 2 * (p - g) / 3;
        t.push({ key: "C", data: [m, y, C, b, d, g] }), n = u, l = p, i = d, s = g;
        break;
      }
      case "A": {
        const u = Math.abs(h[0]), p = Math.abs(h[1]), d = h[2], g = h[3], m = h[4], y = h[5], C = h[6];
        u === 0 || p === 0 ? (t.push({ key: "C", data: [i, s, y, C, y, C] }), i = y, s = C) : (i !== y || s !== C) && (Sf(i, s, y, C, u, p, d, g, m).forEach((function(b) {
          t.push({ key: "C", data: b });
        })), i = y, s = C);
        break;
      }
...
function Sf(e, t, r, i, s, o, a, n, l, c) {
  const h = (u = a, Math.PI * u / 180);
  var u;
  let p = [], d = 0, g = 0, m = 0, y = 0;
  if (c) [d, g, m, y] = c;
  else {
    [e, t] = pi(e, t, -h), [r, i] = pi(r, i, -h);
  ...
  if (Math.abs(C) > 120 * Math.PI / 180) {
    const W = g, I = r, F = i;
    g = l && g > d ? d + 120 * Math.PI / 180 * 1 : d + 120 * Math.PI / 180 * -1, p = Sf(r = m + s * Math.cos(g), i = y + o * Math.sin(g), I, F, s, o, a, 0, l, [g, W, m, y]);
  }
  C = g - d;
  ...
  if (D[0] = 2 * N[0] - D[0], D[1] = 2 * N[1] - D[1], c) return [D, $, z].concat(p);
  {
    ...
    for (let I = 0; I < p.length; I += 3) {
      const F = pi(p[I][0], p[I][1], h), L = pi(p[I + 1][0], p[I + 1][1], h), M = pi(p[I + 2][0], p[I + 2][1], h);
      W.push([F[0], F[1], L[0], L[1], M[0], M[1]]);
    }
    return W;
  }
}
const yw = { randOffset: function(e, t) {
  return ot(e, t);
...
function Ss(e, t, r) {
  ...
  return i === 2 ? _f(e[0][0], e[0][1], e[1][0], e[1][1], r) : { type: "path", ops: [] };
}
function Cw(e, t, r, i, s) {
  return (function(o, a) {
    return Ss(o, !0, a);
...
function Zh(e, t) {
  if (e.length) {
    const r = typeof e[0][0] == "number" ? [e] : e, i = hs(r[0], 1 * (1 + 0.2 * t.roughness), t), s = t.disableMultiStroke ? [] : hs(r[0], 1.5 * (1 + 0.22 * t.roughness), Jh(t));
    for (let o = 1; o < r.length; o++) {
      const a = r[o];
      if (a.length) {
        const n = hs(a, 1 * (1 + 0.2 * t.roughness), t), l = t.disableMultiStroke ? [] : hs(a, 1.5 * (1 + 0.22 * t.roughness), Jh(t));
...
function Za(e, t, r, i) {
  const [s, o] = tc(i.increment, e, t, i.rx, i.ry, 1, i.increment * to(0.1, to(0.4, 1, r), r), r);
  let a = eo(s, null, r);
  if (!r.disableMultiStroke && r.roughness !== 0) {
    const [n] = tc(i.increment, e, t, i.rx, i.ry, 1.5, 0, r), l = eo(n, null, r);
    a = a.concat(l);
  }
  return { estimatedPoints: o, opset: { type: "path", ops: a } };
}
function Kh(e, t, r, i, s, o, a, n, l) {
  const c = e, h = t;
  ...
  const m = 2 * Math.PI / l.curveStepCount, y = Math.min(m / 2, (g - d) / 2), C = ec(y, c, h, u, p, d, g, 1, l);
  if (!l.disableMultiStroke) {
    const b = ec(y, c, h, u, p, d, g, 1.5, l);
    C.push(...b);
  }
  return a && (n ? C.push(...ir(c, h, c + u * Math.cos(d), h + p * Math.sin(d), l), ...ir(c, h, c + u * Math.cos(g), h + p * Math.sin(g), l)) : C.push({ op: "lineTo", data: [c, h] }, { op: "lineTo", data: [c + u * Math.cos(d), h + p * Math.sin(d)] })), { type: "path", ops: C };
}
function Qh(e, t) {
  const r = wf(Tf(sl(e))), i = [];
  let s = [0, 0], o = [0, 0];
  for (const { key: a, data: n } of r) switch (a) {
    ...
    case "C": {
      const [l, c, h, u, p, d] = n;
      i.push(...xw(l, c, h, u, p, d, o, t)), o = [p, d];
      break;
    }
    case "Z":
...
function Bf(e) {
  return e.randomizer || (e.randomizer = new gw(e.seed || 0)), e.randomizer.next();
}
function to(e, t, r, i = 1) {
  return r.roughness * i * (Bf(r) * (t - e) + e);
}
function ot(e, t, r = 1) {
  return to(-e, e, t, r);
}
...
function Ka(e, t, r, i, s, o, a) {
  ...
  return a ? m.push({ op: "move", data: [e + (b ? 0 : y()), t + (b ? 0 : y())] }) : m.push({ op: "move", data: [e + (b ? 0 : ot(h, s, c)), t + (b ? 0 : ot(h, s, c))] }), a ? m.push({ op: "bcurveTo", data: [d + e + (r - e) * p + y(), g + t + (i - t) * p + y(), d + e + 2 * (r - e) * p + y(), g + t + 2 * (i - t) * p + y(), r + (b ? 0 : y()), i + (b ? 0 : y())] }) : m.push({ op: "bcurveTo", data: [d + e + (r - e) * p + C(), g + t + (i - t) * p + C(), d + e + 2 * (r - e) * p + C(), g + t + 2 * (i - t) * p + C(), r + (b ? 0 : C()), i + (b ? 0 : C())] }), m;
}
function hs(e, t, r) {
  if (!e.length) return [];
  const i = [];
...
function Qa(e, t, r, i) {
  ...
  if ((function(n, l) {
    ...
    const l = e[t + 0], c = e[t + 1], h = e[t + 2], u = e[t + 3], p = ur(l, c, 0.5), d = ur(c, h, 0.5), g = ur(h, u, 0.5), m = ur(p, d, 0.5), y = ur(d, g, 0.5), C = ur(m, y, 0.5);
    Qa([l, p, m, C], 0, r, s), Qa([C, y, g, u], 0, r, s);
  }
  var o, a;
  return s;
}
...
class io {
  ...
  line(t, r, i, s, o) {
    const a = this._o(o);
    return this._d("line", [_f(t, r, i, s, a)], a);
  }
  rectangle(t, r, i, s, o) {
    const a = this._o(o), n = [], l = Cw(t, r, i, s, a);
    if (a.fill) {
  ...
  ellipse(t, r, i, s, o) {
    const a = this._o(o), n = [], l = vf(i, s, a), c = Za(t, r, a, l);
  ...
  arc(t, r, i, s, o, a, n = !1, l) {
    const c = this._o(l), h = [], u = Kh(t, r, i, s, o, a, n, !0, c);
    if (n && c.fill) if (c.fillStyle === "solid") {
      const p = Object.assign({}, c);
      p.disableMultiStroke = !0;
      const d = Kh(t, r, i, s, o, a, !0, !1, p);
      d.type = "fillPath", h.push(d);
    } else h.push((function(p, d, g, m, y, C, b) {
      const k = p, w = d;
  ...
  curve(t, r) {
    const i = this._o(r), s = [], o = Zh(t, i);
    if (i.fill && i.fill !== oe) if (i.fillStyle === "solid") {
      const a = Zh(t, Object.assign(Object.assign({}, i), { disableMultiStroke: !0, roughness: i.roughness ? i.roughness + i.fillShapeRoughnessGain : 0 }));
      s.push({ type: "fillPath", ops: this._mergedShape(a.ops) });
    } else {
      const a = [], n = t;
      if (n.length) {
        const l = typeof n[0][0] == "number" ? [n] : n;
        for (const c of l) c.length < 3 ? a.push(...c) : c.length === 3 ? a.push(...sa(rc([c[0], c[0], c[1], c[2]]), 10, (1 + i.roughness) / 2)) : a.push(...sa(rc(c), 10, (1 + i.roughness) / 2));
      }
  ...
  path(t, r) {
    ...
    const o = i.fill && i.fill !== "transparent" && i.fill !== oe, a = i.stroke !== oe, n = !!(i.simplification && i.simplification < 1), l = (function(h, u, p) {
      const d = wf(Tf(sl(h))), g = [];
      let m = [], y = [0, 0], C = [];
      const b = () => {
      ...
      return w;
    })(t, 1, n ? 4 - 4 * (i.simplification || 1) : (1 + i.roughness) / 2), c = Qh(t, i);
    if (o) if (i.fillStyle === "solid") if (l.length === 1) {
      const h = Qh(t, Object.assign(Object.assign({}, i), { disableMultiStroke: !0, roughness: i.roughness ? i.roughness + i.fillShapeRoughnessGain : 0 }));
...
var G = { canvas: (e, t) => new Tw(e, t), svg: (e, t) => new ww(e, t), generator: (e) => new io(e), newSeed: () => io.newSeed() }, st = /* @__PURE__ */ f(async (e, t, r) => {
  let i;
  ...
  if (s) {
    ...
    await Gp(d, n), u = d.getBoundingClientRect(), g.attr("width", u.width), g.attr("height", u.height);
  }
...
var Sw = /* @__PURE__ */ f((e, t) => {
...
}, "intersectRect"), Jr = Sw, _w = /* @__PURE__ */ f(async (e, t, r, i = !1, s = !1) => {
  let o = t || "";
...
}, "createLabel"), Ke = _w, or = /* @__PURE__ */ f((e, t, r, i, s) => [
  "M",
  e + s,
  t,
  ...
  "Z"
  // Close the path
].join(" "), "createRoundedRectPathD"), Lf = /* @__PURE__ */ f(async (e, t) => {
  P.info("Creating subgraph rect for ", t.id, t);
  const r = gt(), { themeVariables: i, handDrawnSeed: s } = r, { clusterBkg: o, clusterBorder: a } = i, { labelStyles: n, nodeStyles: l, borderStyles: c, backgroundStyles: h } = V(t), u = e.insert("g").attr("class", "cluster " + t.cssClasses).attr("id", t.domId).attr("data-look", t.look), p = Kt(r), d = u.insert("g").attr("class", "cluster-label ");
  let g;
...
}, "noteGroup"), Bw = /* @__PURE__ */ f(async (e, t) => {
  ...
  if (t.look === "handDrawn") {
    ...
    B = h.insert("rect", ":first-child"), B.attr("class", "outer").attr("x", w).attr("y", S).attr("width", C).attr("height", b).attr("data-look", t.look), p.attr("class", "inner").attr("x", w).attr("y", v).attr("width", C).attr("height", k);
  u.attr(
    "transform",
...
}, "roundedWithTitle"), Lw = /* @__PURE__ */ f(async (e, t) => {
  P.info("Creating subgraph rect for ", t.id, t);
  const r = gt(), { themeVariables: i, handDrawnSeed: s } = r, { clusterBkg: o, clusterBorder: a } = i, { labelStyles: n, nodeStyles: l, borderStyles: c, backgroundStyles: h } = V(t), u = e.insert("g").attr("class", "cluster " + t.cssClasses).attr("id", t.domId).attr("data-look", t.look), p = Kt(r), d = u.insert("g").attr("class", "cluster-label "), g = await je(d, t.label, {
    style: t.labelStyle,
    useHtmlLabels: p,
    isNode: !0,
    width: t.width
...
}, "kanbanSection"), Fw = /* @__PURE__ */ f((e, t) => {
  ...
  let d;
  if (t.look === "handDrawn") {
    const y = G.svg(a).rectangle(u, p, c, h, {
      fill: "lightgrey",
      roughness: 0.5,
      strokeLineDash: [5],
      stroke: o,
  ...
  divider: Fw,
  kanbanSection: Lw
}, Ff = /* @__PURE__ */ new Map(), Mw = /* @__PURE__ */ f(async (e, t) => {
  const r = t.shape || "rect", i = await Ew[r](e, t);
  return Ff.set(t.id, i), i;
}, "insertCluster"), NL = /* @__PURE__ */ f(() => {
  Ff = /* @__PURE__ */ new Map();
}, "clear");
function Af(e, t) {
...
function Of(e, t, r) {
  ...
  for (let h = 0; h < t.length; h++) {
    let u = t[h], p = t[h < t.length - 1 ? h + 1 : 0], d = Ow(
      e,
      r,
      { x: l + u.x, y: c + u.y },
      { x: l + p.x, y: c + p.y }
  ...
  return o.length ? (o.length > 1 && o.sort(function(h, u) {
    let p = h.x - r.x, d = h.y - r.y, g = Math.sqrt(p * p + d * d), m = u.x - r.x, y = u.y - r.y, C = Math.sqrt(m * m + y * y);
    return g < C ? -1 : g === C ? 0 : 1;
  }), o[0]) : e;
}
f(Of, "intersectPolygon");
var Dw = Of, Y = {
  node: $w,
  circle: Iw,
  ellipse: Mf,
...
function Df(e, t) {
  ...
  return u.attr("class", "anchor").attr("style", Ot(n)), Z(t, u), t.intersect = function(p) {
    return P.info("Circle intersect", t, a, p), Y.circle(t, a, p);
  }, o;
}
f(Df, "anchor");
...
async function Pf(e, t) {
  ...
  const s = t.padding ?? 0, o = t.look === "neo" ? 16 : s, a = t.look === "neo" ? 12 : s, n = /* @__PURE__ */ f((N) => N + a, "calcTotalHeight"), l = /* @__PURE__ */ f((N) => {
    const D = N / 2;
    return [D / (2.5 + N / 50), D];
  }, "calcEllipseRadius"), { shapeSvg: c, bbox: h } = await st(e, t, tt(t)), u = n(t?.height ? t?.height : h.height), [p, d] = l(u), g = Rf(u, p, d), y = (t?.width ? t?.width : h.width) + o * 2 + g - g, C = u, { cssStyles: b } = t, k = [
    { x: y / 2, y: -C / 2 },
    { x: -y / 2, y: -C / 2 },
    ...en(-y / 2, -C / 2, -y / 2, C / 2, p, d, !1),
    { x: y / 2, y: C / 2 },
    ...en(y / 2, C / 2, y / 2, -C / 2, p, d, !0)
  ], w = G.svg(c), S = j(t, {});
  t.look !== "handDrawn" && (S.roughness = 0, S.fillStyle = "solid");
  const v = pt(k), B = w.path(v, S), O = c.insert(() => B, ":first-child");
  return O.attr("class", "basic label-container outer-path"), b && t.look !== "handDrawn" && O.selectAll("path").attr("style", b), i && t.look !== "handDrawn" && O.selectAll("path").attr("style", i), O.attr("transform", `translate(${p / 2}, 0)`), Z(t, O), t.intersect = function(N) {
...
async function Nf(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const s = t.padding ?? 0, o = t.look === "neo" ? 28 : s, a = t.look === "neo" ? 24 : s, { shapeSvg: n, bbox: l } = await st(e, t, tt(t)), c = (t?.width ?? l.width) + (t.look === "neo" ? o * 2 : o + us), h = (t?.height ?? l.height) + (t.look === "neo" ? a * 2 : a), u = 0, p = c, d = -h, g = 0, m = [
    { x: u + us, y: d },
    { x: p, y: d },
    { x: p, y: g },
    { x: u, y: g },
  ...
  const { cssStyles: C } = t;
  if (t.look === "handDrawn") {
    const b = G.svg(n), k = j(t, {}), w = pt(m), S = b.path(w, k);
...
async function ol(e, t, r) {
  ...
  if (t.look === "handDrawn") {
    ...
    u = o.insert(() => m, ":first-child"), u.attr("class", "basic label-container").attr("style", Ot(p));
  } else
...
function zf(e, t) {
  ...
  t.look !== "handDrawn" && (l.roughness = 0, l.fillStyle = "solid");
  const c = n.circle(0, 0, o * 2, l), h = Wf(o), u = n.path(h, l), p = s.insert(() => c, ":first-child");
...
async function Yf(e, t) {
  ...
  const k = pt(d).replace("Z", ""), w = y.path(k, C), v = pt(g).replace("Z", ""), B = y.path(v, C), O = pt(m), N = y.path(O, { ...C }), D = s.insert("g", ":first-child");
  return D.insert(() => N, ":first-child").attr("stroke-opacity", 0), D.insert(() => w, ":first-child"), D.insert(() => B, ":first-child"), D.attr("class", "text"), p && t.look !== "handDrawn" && D.selectAll("path").attr("style", p), i && t.look !== "handDrawn" && D.selectAll("path").attr("style", i), D.attr("transform", `translate(${u - u / 4}, 0)`), a.attr(
    "transform",
    `translate(${-c / 2 + (t.padding ?? 0) / 2 - (o.x - (o.left ?? 0))},${-h / 2 + (t.padding ?? 0) / 2 - (o.y - (o.top ?? 0))})`
...
async function Gf(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const s = t.padding ?? 0, o = t.look === "neo" ? 16 : s, a = t.look === "neo" ? 12 : s, n = 20, l = 5, { shapeSvg: c, bbox: h } = await st(e, t, tt(t)), u = Math.max(n, (h.width + o * 2) * 1.25, t?.width ?? 0), p = Math.max(l, h.height + a * 2, t?.height ?? 0), d = p / 2, { cssStyles: g } = t, m = G.svg(c), y = j(t, {});
  t.look !== "handDrawn" && (y.roughness = 0, y.fillStyle = "solid");
  const C = u, b = p, k = C - d, w = b / 4, S = [
    { x: k, y: 0 },
    { x: w, y: 0 },
    { x: 0, y: b / 2 },
    { x: w, y: b },
  ...
  ], v = pt(S), B = m.path(v, y), O = c.insert(() => B, ":first-child");
  return O.attr("class", "basic label-container outer-path"), g && t.look !== "handDrawn" && O.selectChildren("path").attr("style", g), i && t.look !== "handDrawn" && O.selectChildren("path").attr("style", i), O.attr("transform", `translate(${-u / 2}, ${-p / 2})`), Z(t, O), t.intersect = function(N) {
    return Y.polygon(t, S, N);
  }, c;
}
f(Gf, "curvedTrapezoid");
var Rw = /* @__PURE__ */ f((e, t, r, i, s, o) => [
  `M${e},${t + o}`,
  `a${s},${o} 0,0,0 ${r},0`,
  `a${s},${o} 0,0,0 ${-r},0`,
  `l0,${i}`,
  `a${s},${o} 0,0,0 ${r},0`,
  `l0,${-i}`
].join(" "), "createCylinderPathD"), Pw = /* @__PURE__ */ f((e, t, r, i, s, o) => [
  `M${e},${t + o}`,
  `M${e + r},${t + o}`,
  `a${s},${o} 0,0,0 ${-r},0`,
  `l0,${i}`,
  `a${s},${o} 0,0,0 ${r},0`,
  `l0,${-i}`
].join(" "), "createOuterCylinderPathD"), Nw = /* @__PURE__ */ f((e, t, r, i, s, o) => [`M${e - r / 2},${-i / 2}`, `a${s},${o} 0,0,0 ${r},0`].join(" "), "createInnerCylinderPathD"), ic = 8, sc = 8;
async function jf(e, t) {
  ...
  if (t.width || t.height) {
    const y = t.width ?? 0;
    t.width = (t.width ?? 0) - a, t.width < sc && (t.width = sc);
    const b = y / 2 / (2.5 + y / 50);
    t.height = (t.height ?? 0) - o - b * 3, t.height < ic && (t.height = ic);
  }
  ...
  const { cssStyles: m } = t;
  if (t.look === "handDrawn") {
    const y = G.svg(n), C = Pw(0, 0, h, d, u, p), b = Nw(0, p, h, d, u, p), k = j(t, {}), w = y.path(C, k), S = y.path(b, j(t, { fill: "none" }));
    g = n.insert(() => S, ":first-child"), g = n.insert(() => w, ":first-child"), g.attr("class", "basic label-container"), m && g.attr("style", m);
  } else {
    const y = Rw(0, 0, h, d, u, p);
  ...
  return g.attr("label-offset-y", p), g.attr("transform", `translate(${-h / 2}, ${-(d / 2 + p)})`), Z(t, g), c.attr(
    ...
    if (u != 0 && (Math.abs(b) < (t.width ?? 0) / 2 || Math.abs(b) == (t.width ?? 0) / 2 && Math.abs(C.y - (t.y ?? 0)) > (t.height ?? 0) / 2 - p)) {
      let k = p * p * (1 - b * b / (u * u));
...
async function ti(e, t, r) {
  ...
  if (r?.rx && r.ry && (p = r.rx, d = r.ry), t.look === "handDrawn") {
    const m = G.svg(o), y = j(t, {}), C = p || d ? m.path(or(c, h, n, l, p || 0), y) : m.rectangle(c, h, n, l, y);
    u = o.insert(() => C, ":first-child"), u.attr("class", "basic label-container").attr("style", Ot(g));
  } else
    u = o.insert("rect", ":first-child"), u.attr("class", "basic label-container").attr("style", s).attr("rx", Ot(p)).attr("ry", Ot(d)).attr("x", c).attr("y", h).attr("width", n).attr("height", l);
...
async function Xf(e, t) {
  ...
  const h = c.select(".basic.label-container"), u = (Number(h.attr("width")) || a) ?? 0, p = (Number(h.attr("height")) || n) ?? 0;
  return u > 0 && p > 0 && h.attr("stroke-dasharray", `${u} ${p}`), c;
}
f(Xf, "datastore");
async function Vf(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const s = t.look === "neo" ? 16 : t.padding ?? 0, o = t.look === "neo" ? 16 : t.padding ?? 0, { shapeSvg: a, bbox: n, label: l } = await st(e, t, tt(t)), c = n.width + s, h = n.height + o, u = h * 0.2, p = -c / 2, d = -h / 2 - u / 2, { cssStyles: g } = t, m = G.svg(a), y = j(t, {});
  t.look !== "handDrawn" && (y.roughness = 0, y.fillStyle = "solid");
  const C = [
    { x: p, y: d + u },
    { x: -p, y: d + u },
...
async function Zf(e, t) {
  ...
  if (t.look === "handDrawn") {
    ...
    u = n.insert("g", ":first-child"), u.attr("class", Ot(t.cssClasses)).attr("style", Ot(p)), u.node()?.appendChild(y), u.node()?.appendChild(C);
  } else {
...
async function Qf(e, t) {
  ...
  (t.width || t.height) && (t.height = t?.height ?? 0, t.height < oc && (t.height = oc), t.width = (t?.width ?? 0) - o - o / 2, t.width < ac && (t.width = ac));
  ...
  return d && t.look !== "handDrawn" && b.selectChildren("path").attr("style", d), i && t.look !== "handDrawn" && b.selectChildren("path").attr("style", i), t.width = c, t.height = h, Z(t, b), l.attr(
    ...
    return P.info("Triangle intersect", t, p, k), Y.polygon(t, p, k);
  }, a;
}
f(Qf, "flippedTriangle");
function Jf(e, t, { dir: r, config: { state: i, themeVariables: s } }) {
  ...
  const h = -1 * l / 2, u = -1 * c / 2, p = G.svg(a), d = j(t, {
    stroke: s.lineColor,
    fill: s.lineColor
  });
...
async function tg(e, t) {
  ...
  const { shapeSvg: l, bbox: c } = await st(e, t, tt(t)), h = (t?.width ? t?.width : Math.max(s, c.width)) + a * 2, u = (t?.height ? t?.height : Math.max(o, c.height)) + n * 2, p = u / 2, { cssStyles: d } = t, g = G.svg(l), m = j(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  const y = [
    { x: -h / 2, y: -u / 2 },
    { x: h / 2 - p, y: -u / 2 },
    ...Ni(-h / 2 + p, 0, p, 50, 90, 270),
    { x: h / 2 - p, y: u / 2 },
    { x: -h / 2, y: u / 2 }
  ...
  return k.attr("class", "basic label-container outer-path"), d && t.look !== "handDrawn" && k.selectChildren("path").attr("style", d), i && t.look !== "handDrawn" && k.selectChildren("path").attr("style", i), Z(t, k), t.intersect = function(w) {
    return P.info("Pill intersect", t, { radius: p, point: w }), Y.polygon(t, y, w);
  }, l;
}
f(tg, "halfRoundedRectangle");
var qw = /* @__PURE__ */ f((e, t, r, i, s) => [
  `M${e + s},${t}`,
  `L${e + r - s},${t}`,
  `L${e + r},${t - i / 2}`,
  `L${e + r - s},${t - i}`,
...
async function eg(e, t) {
  ...
  const { cssStyles: C } = t;
  if (t.look === "handDrawn") {
    const b = G.svg(h), k = j(t, {}), w = qw(0, 0, g, p, d), S = b.path(w, k);
...
async function ig(e, t, { config: { themeVariables: r, flowchart: i } }) {
  ...
  const { shapeSvg: c, bbox: h, label: u } = await st(e, t, "icon-shape default"), p = t.pos === "t", d = n, g = n, { nodeBorder: m } = r, { stylesMap: y } = Qr(t), C = -g / 2, b = -d / 2, k = t.label ? 8 : 0, w = G.svg(c), S = j(t, { stroke: "none", fill: "none" });
  t.look !== "handDrawn" && (S.roughness = 0, S.fillStyle = "solid");
  ...
  if (t.icon) {
    ...
    z.attr(
      "transform",
      `translate(${-I / 2 - L},${p ? h.height / 2 + k / 2 - F / 2 - M : -h.height / 2 - k / 2 - F / 2 - M})`
    ), z.attr("style", `color: ${y.get("stroke") ?? m};`);
  }
  return u.attr(
    "transform",
    `translate(${-h.width / 2 - (h.x - (h.left ?? 0))},${p ? -O / 2 : O / 2 - h.height})`
  ), D.attr(
    "transform",
...
async function sg(e, t, { config: { themeVariables: r, flowchart: i } }) {
  ...
  const o = t.assetHeight ?? 48, a = t.assetWidth ?? 48, n = Math.max(o, a), l = i?.wrappingWidth;
  t.width = Math.max(n, l ?? 0);
  const { shapeSvg: c, bbox: h, label: u } = await st(e, t, "icon-shape default"), p = 20, d = t.label ? 8 : 0, g = t.pos === "t", { nodeBorder: m, mainBkg: y } = r, { stylesMap: C } = Qr(t), b = G.svg(c), k = j(t, {});
  ...
  const v = S.node().getBBox(), B = v.width, O = v.height, N = v.x, D = v.y, $ = Math.max(B, O) * Math.SQRT2 + p * 2, z = b.circle(0, 0, $, k), W = Math.max($, h.width), I = $ + h.height + d, F = b.rectangle(-W / 2, -I / 2, W, I, {
    ...k,
    fill: "transparent",
    stroke: "none"
...
f(ag, "iconSquare");
async function ng(e, t, { config: { flowchart: r } }) {
  const i = new Image();
  ...
  const { shapeSvg: u, bbox: p, label: d } = await st(e, t, "image-shape default"), g = t.pos === "t", m = -c / 2, y = -h / 2, C = t.label ? 8 : 0, b = G.svg(u), k = j(t, {});
  t.look !== "handDrawn" && (k.roughness = 0, k.fillStyle = "solid");
  const w = b.rectangle(m, y, c, h, k), S = Math.max(c, p.width), v = h + p.height + C, B = b.rectangle(-S / 2, -v / 2, S, v, {
    ...k,
    fill: "none",
    stroke: "none"
...
async function lg(e, t) {
  ...
  const { cssStyles: d } = t;
  if (t.look === "handDrawn") {
    const g = G.svg(n), m = j(t, {}), y = pt(u), C = g.path(y, m);
    p = n.insert(() => C, ":first-child").attr("transform", `translate(${-c / 2}, ${h / 2})`), d && p.attr("style", d);
  } else
    p = Xe(n, c, h, u);
...
async function cg(e, t) {
  ...
  if (t.look === "handDrawn") {
    const g = G.svg(n), m = j(t, {}), y = pt(u), C = g.path(y, m);
    p = n.insert(() => C, ":first-child").attr("transform", `translate(${-h / 2}, ${c / 2})`), d && p.attr("style", d);
  } else
    p = Xe(n, h, c, u);
...
f(dg, "lightningBolt");
var Ww = /* @__PURE__ */ f((e, t, r, i, s, o, a) => [
  `M${e},${t + o}`,
  `a${s},${o} 0,0,0 ${r},0`,
  `a${s},${o} 0,0,0 ${-r},0`,
  `l0,${i}`,
  ...
  `M${e},${t + o + a}`,
  `a${s},${o} 0,0,0 ${r},0`
].join(" "), "createCylinderPathD"), zw = /* @__PURE__ */ f((e, t, r, i, s, o, a) => [
  `M${e},${t + o}`,
  `M${e + r},${t + o}`,
  `a${s},${o} 0,0,0 ${-r},0`,
  `l0,${i}`,
  ...
  `M${e},${t + o + a}`,
  `a${s},${o} 0,0,0 ${r},0`
].join(" "), "createOuterCylinderPathD"), Hw = /* @__PURE__ */ f((e, t, r, i, s, o) => [`M${e - r / 2},${-i / 2}`, `a${s},${o} 0,0,0 ${r},0`].join(" "), "createInnerCylinderPathD"), nc = 10, lc = 10;
async function pg(e, t) {
  ...
  if (t.width || t.height) {
    const C = t.width ?? 0;
    t.width = (t.width ?? 0) - o, t.width < lc && (t.width = lc);
    const k = C / 2 / (2.5 + C / 50);
    t.height = (t.height ?? 0) - a - k * 3, t.height < nc && (t.height = nc);
  }
  ...
  return m.attr("label-offset-y", p), m.attr("transform", `translate(${-h / 2}, ${-(d / 2 + p)})`), Z(t, m), c.attr(
    ...
    if (u != 0 && (Math.abs(k) < (t.width ?? 0) / 2 || Math.abs(k) == (t.width ?? 0) / 2 && Math.abs(b.y - (t.y ?? 0)) > (t.height ?? 0) / 2 - p)) {
      let w = p * p * (1 - k * k / (u * u));
      w > 0 && (w = Math.sqrt(w)), w = p - w, C.y - (t.y ?? 0) > 0 && (w = -w), b.y += w;
    }
    return b;
  }, n;
}
...
async function fg(e, t) {
  ...
  const { shapeSvg: n, bbox: l, label: c } = await st(e, t, tt(t)), h = (t?.width ? t?.width : l.width) + (o ?? 0) * 2, u = (t?.height ? t?.height : l.height) + (a ?? 0) * 2, p = t.look === "neo" ? u / 4 : u / 8, d = u + p, { cssStyles: g } = t, m = G.svg(n), y = j(t, {});
  t.look !== "handDrawn" && (y.roughness = 0, y.fillStyle = "solid");
  const C = [
    { x: -h / 2 - h / 2 * 0.1, y: -d / 2 },
    { x: -h / 2 - h / 2 * 0.1, y: d / 2 },
...
async function gg(e, t) {
  ...
  const { shapeSvg: l, bbox: c, label: h } = await st(e, t, tt(t)), u = (t?.width ? t?.width : c.width) + o * 2 + 2 * n, p = (t?.height ? t?.height : c.height) + a * 2 + 2 * n, d = u - 2 * n, g = p - 2 * n, m = -d / 2, y = -g / 2, { cssStyles: C } = t, b = G.svg(l), k = j(t, {}), w = [
    { x: m - n, y: y + n },
    { x: m - n, y: y + g + n },
    { x: m + d - n, y: y + g + n },
    { x: m + d - n, y: y + g },
...
async function mg(e, t) {
  ...
  const u = Math.max(o.width, t?.width ?? 0) + l * 2, p = Math.max(o.height, t?.height ?? 0) + c * 3, d = t.look === "neo" ? p / 4 : p / 8, g = p + (h ? d / 2 : -d / 2), m = -u / 2, y = -g / 2, C = 10, { cssStyles: b } = t, k = sr(
    m - C,
    y + g + C,
    m + u - C,
    y + g + C,
  ...
  const N = pt(S), D = B.path(N, O), $ = pt(v), z = B.path($, O), W = s.insert(() => D, ":first-child");
...
f(mg, "multiWaveEdgedRectangle");
async function yg(e, t, { config: { themeVariables: r } }) {
  const { labelStyles: i, nodeStyles: s } = V(t);
  t.labelStyle = i, t.useHtmlLabels || Kt(Tt()) || (t.centerLabel = !0);
  const { shapeSvg: a, bbox: n, label: l } = await st(e, t, tt(t)), c = Math.max(n.width + (t.padding ?? 0) * 2, t?.width ?? 0), h = Math.max(n.height + (t.padding ?? 0) * 2, t?.height ?? 0), u = -c / 2, p = -h / 2, { cssStyles: d } = t, g = G.svg(a), m = j(t, {
    fill: r.noteBkgColor,
    stroke: r.noteBorderColor
  });
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  const y = g.rectangle(u, p, c, h, m), C = a.insert(() => y, ":first-child");
...
async function Cg(e, t) {
  ...
  const { cssStyles: p } = t;
  if (t.look === "handDrawn") {
    const d = G.svg(s), g = j(t, {}), m = Uw(0, 0, l), y = d.path(m, g);
...
async function xg(e, t) {
  ...
  t.look !== "handDrawn" && (b.roughness = 0, b.fillStyle = "solid");
  const k = pt(m), w = C.path(k, b), S = n.insert(() => w, ":first-child");
...
f(bg, "rectWithTitle");
async function kg(e, t, { config: { themeVariables: r } }) {
...
async function Tg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const s = t.look === "neo" ? 16 : t.padding ?? 0, o = t.look === "neo" ? 12 : t.padding ?? 0, { shapeSvg: a, bbox: n, label: l } = await st(e, t, tt(t)), c = (t?.width ?? n.width) + s * 2 + (t.look === "neo" ? hr : hr * 2), h = (t?.height ?? n.height) + o * 2, u = c - hr, p = h, d = hr - c / 2, g = -h / 2, { cssStyles: m } = t, y = G.svg(a), C = j(t, {});
  t.look !== "handDrawn" && (C.roughness = 0, C.fillStyle = "solid");
  const b = [
    { x: d, y: g },
    { x: d + u, y: g },
...
async function wg(e, t) {
  ...
  const { shapeSvg: n, bbox: l, label: c } = await st(e, t, tt(t)), h = (t?.width ? t?.width : l.width) + o * 2, u = ((t?.height ? t?.height : l.height) + a * 2) * 1.5, p = h, d = u / 1.5, g = -p / 2, m = -d / 2, { cssStyles: y } = t, C = G.svg(n), b = j(t, {});
  t.look !== "handDrawn" && (b.roughness = 0, b.fillStyle = "solid");
  const k = [
    { x: g, y: m },
    { x: g, y: m + d },
    { x: g + p, y: m + d },
    { x: g + p, y: m - d / 2 }
  ], w = pt(k), S = C.path(w, b), v = n.insert(() => S, ":first-child");
...
async function _g(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const s = t.padding ?? 0, o = t.look === "neo" ? 20 : s, a = t.look === "neo" ? 12 : s, { shapeSvg: n, bbox: l } = await st(e, t, tt(t)), c = l.height + (t.look === "neo" ? a * 2 : a), h = l.width + c / 4 + (t.look === "neo" ? o * 2 : o), u = c / 2, { cssStyles: p } = t, d = G.svg(n), g = j(t, {});
  ...
  ], y = pt(m), C = d.path(y, g), b = n.insert(() => C, ":first-child");
...
function Bg(e, t, { config: { themeVariables: r } }) {
  ...
  const h = e.insert("g").attr("class", "node default").attr("id", t.domId ?? t.id), u = G.svg(h), p = j(t, {});
...
function Lg(e, t, { config: { themeVariables: r } }) {
  ...
  let a;
  if (t.look === "handDrawn") {
    const l = G.svg(o).circle(0, 0, t.width, J2(i));
...
async function Fg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const s = t?.padding ?? 8, o = t.look === "neo" ? 28 : s, a = t.look === "neo" ? 12 : s, { shapeSvg: n, bbox: l } = await st(e, t, tt(t)), c = (t?.width ?? l.width) + 2 * Mr + o, h = (t?.height ?? l.height) + a, u = c - 2 * Mr, p = h, d = -c / 2, g = -h / 2, m = [
    { x: 0, y: 0 },
    { x: u, y: 0 },
    { x: u, y: -p },
    { x: 0, y: -p },
  ...
  if (t.look === "handDrawn") {
    const y = G.svg(n), C = j(t, {}), b = y.rectangle(d, g, u + 16, p, C), k = y.line(d + Mr, g, d + Mr, g + p, C), w = y.line(d + Mr + u, g, d + Mr + u, g + p, C);
...
async function Ag(e, t) {
  ...
  t.look !== "handDrawn" && (k.roughness = 0, k.fillStyle = "solid");
  const v = pt(w), B = b.path(v, k), O = pt(S), N = b.path(O, { ...k, fillStyle: "solid" }), D = n.insert(() => N, ":first-child");
...
async function Eg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const { shapeSvg: s, bbox: o, label: a } = await st(e, t, tt(t)), n = Math.max(o.width + (t.padding ?? 0) * 2, t?.width ?? 0), l = Math.max(o.height + (t.padding ?? 0) * 2, t?.height ?? 0), c = l / 8, h = 0.2 * n, u = 0.2 * l, p = l + c, { cssStyles: d } = t, g = G.svg(s), m = j(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  const y = [
    { x: -n / 2 - n / 2 * 0.1, y: p / 2 },
    ...sr(
  ...
  ], w = pt(y), S = g.path(w, m), v = pt(k), B = g.path(v, {
    ...m,
    fillStyle: "solid"
...
f(Mg, "text");
var Yw = /* @__PURE__ */ f((e, t, r, i, s, o) => `M${e},${t}
    a${s},${o} 0,0,1 0,${-i}
    l${r},0
    a${s},${o} 0,0,1 0,${i}
    M${r},${-i}
    a${s},${o} 0,0,0 0,${i}
    l${-r},0`, "createCylinderPathD"), Gw = /* @__PURE__ */ f((e, t, r, i, s, o) => [
  `M${e},${t}`,
  `M${e + r},${t}`,
  `a${s},${o} 0,0,0 0,${-i}`,
  `l${-r},0`,
  `a${s},${o} 0,0,0 0,${i}`,
  `l${r},0`
].join(" "), "createOuterCylinderPathD"), jw = /* @__PURE__ */ f((e, t, r, i, s, o) => [`M${e + r / 2},${-i / 2}`, `a${s},${o} 0,0,0 0,${i}`].join(" "), "createInnerCylinderPathD"), hc = 5, cc = 10;
async function $g(e, t) {
  ...
  if (t.width || t.height) {
    const m = t.height ?? 0;
    t.height = (t.height ?? 0) - o, t.height < hc && (t.height = hc);
    const C = m / 2 / (2.5 + m / 50);
    t.width = (t.width ?? 0) - o - C * 3, t.width < cc && (t.width = cc);
  }
  ...
  let g;
  if (t.look === "handDrawn") {
    const m = G.svg(a), y = Gw(0, 0, p, c, u, h), C = jw(0, 0, p, c, u, h), b = m.path(y, j(t, {})), k = m.path(C, j(t, { fill: "none" }));
    g = a.insert(() => k, ":first-child"), g = a.insert(() => b, ":first-child"), g.attr("class", "basic label-container"), d && g.attr("style", d);
  } else {
    const m = Yw(0, 0, p, c, u, h);
...
async function Og(e, t) {
  ...
  const { shapeSvg: c, bbox: h } = await st(e, t, tt(t)), u = (t?.width ? t?.width : h.width) + o * 2, p = (t?.height ? t?.height : h.height) + a * 2, { cssStyles: d } = t, g = G.svg(c), m = j(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  const y = [
    { x: -u / 2 * 0.8, y: -p / 2 },
    { x: u / 2 * 0.8, y: -p / 2 },
...
f(Og, "trapezoidalPentagon");
var uc = 10, dc = 10;
async function Dg(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const s = t.padding ?? 0, o = t.look === "neo" ? s * 2 : s;
  (t.width || t.height) && (t.width = ((t?.width ?? 0) - o) / 2, t.width < dc && (t.width = dc), t.height = t?.height ?? 0, t.height < uc && (t.height = uc));
  const { shapeSvg: a, bbox: n, label: l } = await st(e, t, tt(t)), c = Ge(gt().flowchart?.htmlLabels), h = (t?.width ? t?.width : n.width) + o, u = t?.height ? t?.height : h + n.height, p = u, d = [
    { x: 0, y: 0 },
    { x: p, y: 0 },
    { x: p / 2, y: -u }
  ], { cssStyles: g } = t, m = G.svg(a), y = j(t, {});
  t.look !== "handDrawn" && (y.roughness = 0, y.fillStyle = "solid");
  const C = pt(d), b = m.path(C, y), k = a.insert(() => b, ":first-child").attr("transform", `translate(${-u / 2}, ${u / 2})`).attr("class", "outer-path");
...
async function Rg(e, t) {
  ...
  const { shapeSvg: l, bbox: c, label: h } = await st(e, t, tt(t)), u = (t?.width ? t?.width : c.width) + (o ?? 0) * 2, p = (t?.height ? t?.height : c.height) + (a ?? 0) * 2, d = t.look === "neo" ? p / 4 : p / 8, g = p + (n ? d : -d), { cssStyles: m } = t, C = 14 - u, b = C > 0 ? C / 2 : 0, k = G.svg(l), w = j(t, {});
  ...
  const S = [
    ...
    { x: u / 2 + b, y: -g / 2 },
    { x: -u / 2 - b, y: -g / 2 }
  ], v = pt(S), B = k.path(v, w), O = l.insert(() => B, ":first-child");
...
async function Pg(e, t) {
  ...
  const { shapeSvg: n, bbox: l } = await st(e, t, tt(t)), c = (t?.width ? t?.width : l.width) + o * 2, h = (t?.height ? t?.height : l.height) + a, u = h / 8, p = h + u * 2, { cssStyles: d } = t, g = G.svg(n), m = j(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  const y = [
    { x: -c / 2, y: p / 2 },
...
async function Ng(e, t) {
  ...
  const { shapeSvg: a, bbox: n, label: l } = await st(e, t, tt(t)), c = (t?.width ? t?.width : n.width) + s * 2 + wt, h = (t?.height ? t?.height : n.height) + o * 2 + wt, u = c - wt, p = h - wt, d = -u / 2, g = -p / 2, { cssStyles: m } = t, y = G.svg(a), C = j(t, {}), b = [
    { x: d - wt, y: g - wt },
    { x: d - wt, y: g + p },
    { x: d + u, y: g + p },
    { x: d + u, y: g - wt }
  ], k = `M${d - wt},${g - wt} L${d + u},${g - wt} L${d + u},${g + p} L${d - wt},${g + p} L${d - wt},${g - wt}
                M${d - wt},${g} L${d + u},${g}
                M${d},${g - wt} L${d},${g + p}`;
  t.look !== "handDrawn" && (C.roughness = 0, C.fillStyle = "solid");
...
f(Ng, "windowPane");
var pc = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), Xw = /* @__PURE__ */ new Set(["redux", "redux-dark", "redux-color", "redux-dark-color"]);
async function al(e, t) {
  const r = t;
  r.alias && (t.label = r.alias);
  const { theme: i, themeVariables: s } = Tt(), { rowEven: o, rowOdd: a, nodeBorder: n, borderColorArray: l } = s;
  if (t.look === "handDrawn") {
    const { themeVariables: rt } = Tt(), { background: ht } = rt, ft = {
      ...t,
      id: t.id + "-background",
  ...
  for (const rt of r.attributes) {
    ...
    const vt = Math.max(ht.height, ft.height, xt.height, Ct.height) + u;
  ...
  }), y.select(".name").attr("transform", "translate(" + -C.width / 2 + ", " + (U + u / 2) + ")"), i != null && pc.has(i)) {
    const rt = r.colorIndex ?? 0;
    y.attr("data-color-id", `color-${rt % l.length}`);
  }
  const Q = I.rectangle(H, U, M, R, F), dt = y.insert(() => Q, ":first-child").attr("class", "outer-path").attr("style", p.join(""));
  k.push(0);
...
async function Dr(e, t, r, i = 0, s = 0, o = [], a = "") {
  ...
  t !== ih(t) && (t = ih(t), t = t.replaceAll("<", "&lt;").replaceAll(">", "&gt;"));
...
f(Rr, "lineToPolygon");
async function qg(e, t, r, i, s = r.class.padding ?? 12) {
...
async function Wg(e, t) {
  ...
  const { shapeSvg: c, bbox: h } = await qg(e, t, r, n, a), { labelStyles: u, nodeStyles: p } = V(t);
...
async function Hg(e, t, { config: r }) {
  ...
  if (t.look === "handDrawn") {
    ...
    if (z) {
      ...
      W.attr("x1", I).attr("y1", F).attr("x2", I).attr("y2", L).attr("stroke-width", "4").attr("stroke", Vw(z));
    }
  }
...
async function Vg(e, t, r) {
  ...
  const o = t.shape ? Xg[t.shape] : void 0;
  if (!o)
...
f(Vg, "insertNode");
var qL = /* @__PURE__ */ f((e, t) => {
  So.set(t.id, e);
}, "setNodeElem"), WL = /* @__PURE__ */ f(() => {
  So.clear();
}, "clear"), zL = /* @__PURE__ */ f((e) => {
  const t = So.get(e.id);
  P.trace(
    "Transforming node",
    e.diff,
...
}, "positionNode"), Jw = /* @__PURE__ */ f((e, t, r, i, s, o = !1, a) => {
  t.arrowTypeStart && fc(
    e,
    "start",
    t.arrowTypeStart,
    ...
    o,
    a
  ), t.arrowTypeEnd && fc(e, "end", t.arrowTypeEnd, r, i, s, o, a);
}, "addEdgeMarkers"), tS = {
  ...
  "dependency",
  "barb"
], fc = /* @__PURE__ */ f((e, t, r, i, s, o, a = !1, n) => {
  const l = tS[r], c = l && eS.includes(l.type);
  if (!l) {
...
}, "addEdgeMarker"), rS = /* @__PURE__ */ f((e) => typeof e == "string" ? e : gt()?.flowchart?.curve, "resolveEdgeCurveType"), so = /* @__PURE__ */ new Map(), Pt = /* @__PURE__ */ new Map(), HL = /* @__PURE__ */ f(() => {
  so.clear(), Pt.clear();
}, "clear"), gi = /* @__PURE__ */ f((e) => e ? typeof e == "string" ? e : e.reduce((t, r) => t + ";" + r, "") : "", "getLabelStyles"), iS = /* @__PURE__ */ f(async (e, t) => {
  const r = gt();
  let i = Kt(r);
  const { labelStyles: s } = V(t);
  t.labelStyle = s;
  ...
  if (t.startLabelLeft) {
    ...
    g.attr("transform", hi(y, i)), Pt.get(t.id) || Pt.set(t.id, {}), Pt.get(t.id).startLeft = d, Si(p, t.startLabelLeft);
  }
  if (t.startLabelRight) {
    ...
    g.attr("transform", hi(y, i)), Pt.get(t.id) || Pt.set(t.id, {}), Pt.get(t.id).startRight = d, Si(p, t.startLabelRight);
  }
  if (t.endLabelLeft) {
    const d = e.insert("g").attr("class", "edgeTerminals"), g = d.insert("g").attr("class", "inner"), m = await Ke(
      d,
    ...
    g.attr("transform", hi(y, i)), Pt.get(t.id) || Pt.set(t.id, {}), Pt.get(t.id).endLeft = d, Si(p, t.endLabelLeft);
  }
  if (t.endLabelRight) {
    const d = e.insert("g").attr("class", "edgeTerminals"), g = d.insert("g").attr("class", "inner"), m = await Ke(
      d,
    ...
    g.attr("transform", hi(y, i)), Pt.get(t.id) || Pt.set(t.id, {}), Pt.get(t.id).endRight = d, Si(p, t.endLabelRight);
  }
  return c;
}, "insertEdgeLabel");
function Si(e, t) {
...
f(Si, "setTerminalWidth");
var sS = /* @__PURE__ */ f((e, t) => {
  ...
  if (Math.abs(s - t.y) * a > Math.abs(i - t.x) * l) {
    ...
    return n === 0 && (p.x = t.x, p.y = t.y), h === 0 && (p.x = t.x), c === 0 && (p.y = t.y), P.debug(`abc89 top/bottom calc, Q ${c}, q ${u}, R ${h}, r ${n}`, p), p;
  } else {
    r.x < t.x ? n = t.x - a - i : n = i - a - t.x;
    let u = c * n / h, p = r.x < t.x ? r.x + h - n : r.x - h + n, d = r.y < t.y ? r.y + u : r.y - u;
    return P.debug(`sides calc abc89, Q ${c}, q ${u}, R ${h}, r ${n}`, { _x: p, _y: d }), n === 0 && (p = t.x, d = t.y), h === 0 && (p = t.x), c === 0 && (d = t.y), { x: p, y: d };
  }
}, "intersection"), gc = /* @__PURE__ */ f((e, t) => {
  P.warn("abc88 cutPathAtIntersect", e, t);
  let r = [], i = e[0], s = !1;
  return e.forEach((o) => {
    if (P.info("abc88 checking point", o, t), !oS(t, o) && !s) {
      const a = aS(t, i, o);
...
f(Zg, "extractCornerPoints");
var mc = /* @__PURE__ */ f(function(e, t, r) {
  const i = t.x - e.x, s = t.y - e.y, o = Math.sqrt(i * i + s * s), a = r / o;
  return { x: t.x - a * i, y: t.y - a * s };
}, "findAdjacentPoint"), nS = /* @__PURE__ */ f(function(e) {
  const { cornerPointPositions: t } = Zg(e), r = [];
  for (let i = 0; i < e.length; i++)
    if (t.includes(i)) {
      const s = e[i - 1], o = e[i + 1], a = e[i], n = mc(s, a, 5), l = mc(o, a, 5), c = l.x - n.x, h = l.y - n.y;
      r.push(n);
      ...
      r.push(e[i]);
  return r;
}, "fixCorners"), lS = /* @__PURE__ */ f((e, t, r) => {
  const i = e - t - r, s = 2, o = 2, a = s + o, n = Math.floor(i / a), l = Array(n).fill(`${s} ${o}`).join(" ");
  return `0 ${t} ${l} ${r}`;
}, "generateDashArray"), hS = /* @__PURE__ */ f(function(e, t, r, i, s, o, a, n = !1) {
  if (!a)
    throw new Error(
  ...
  for (const M in t.cssCompiledStyles)
    jp(M) || d.push(t.cssCompiledStyles[M]);
  P.debug("UIO intersect check", t.points, p.x, u.x), p.intersect && u.intersect && !n && (c = c.slice(1, t.points.length - 1), c.unshift(u.intersect(c[0])), P.debug(
    "Last point UIO",
    t.start,
    "-->",
    t.end,
  ...
  t.toCluster && (P.info("to cluster abc88", r.get(t.toCluster)), c = gc(t.points, r.get(t.toCluster).node), h = !0), t.fromCluster && (P.debug(
    "from cluster abc88",
    r.get(t.fromCluster),
    JSON.stringify(c, null, 2)
  ), c = gc(c.reverse(), r.get(t.fromCluster).node).reverse(), h = !0);
  ...
  const { x: b, y: k } = r2(t), w = N1().x(b).y(k).curve(C);
  let S;
  switch (t.thickness) {
    case "normal":
  ...
  let v, B = y === "rounded" ? Kg(Qg(m, t), 5) : w(m);
  ...
  if (t.look === "handDrawn") {
    ...
    const U = v.node(), Q = typeof U.getTotalLength == "function" ? U.getTotalLength() : 0, dt = Ah[t.arrowTypeStart] || 0, et = Ah[t.arrowTypeEnd] || 0;
    if (t.look === "neo" && !$) {
      const it = `stroke-dasharray: ${t.pattern === "dotted" || t.pattern === "dashed" ? lS(Q, dt, et) : `0 ${dt} ${Q - dt - et} ${et}`}; stroke-dashoffset: 0;`;
...
function Kg(e, t) {
  ...
  for (let o = 0; o < i; o++) {
    ...
    if (o === 0)
      ...
      const m = c / d, y = h / d, C = u / g, b = p / g, k = m * C + y * b, w = Math.max(-1, Math.min(1, k)), S = Math.acos(w);
...
f(Qg, "applyMarkerOffsetsToPoints");
var cS = /* @__PURE__ */ f((e, t, r, i) => {
  t.forEach((s) => {
    $S[s](e, r, i);
  });
}, "insertMarkers"), uS = /* @__PURE__ */ f((e, t, r) => {
...
}, "composition"), pS = /* @__PURE__ */ f((e, t, r) => {
...
}, "aggregation"), fS = /* @__PURE__ */ f((e, t, r) => {
...
}, "dependency"), gS = /* @__PURE__ */ f((e, t, r) => {
...
}, "zero_or_one"), wS = /* @__PURE__ */ f((e, t, r) => {
...
}, "one_or_more"), SS = /* @__PURE__ */ f((e, t, r) => {
...
}, "zero_or_more"), _S = /* @__PURE__ */ f((e, t, r) => {
...
}, "only_one_neo"), vS = /* @__PURE__ */ f((e, t, r) => {
...
}, "zero_or_one_neo"), BS = /* @__PURE__ */ f((e, t, r) => {
  const i = Tt(), { themeVariables: s } = i, { strokeWidth: o } = s;
...
}, "one_or_more_neo"), LS = /* @__PURE__ */ f((e, t, r) => {
...
}, "zero_or_more_neo"), FS = /* @__PURE__ */ f((e, t, r) => {
...
}, "requirement_arrow"), AS = /* @__PURE__ */ f((e, t, r) => {
  const i = Tt(), { themeVariables: s } = i, { strokeWidth: o } = s;
...
}, "requirement_arrow_neo"), ES = /* @__PURE__ */ f((e, t, r) => {
...
}, "requirement_contains"), MS = /* @__PURE__ */ f((e, t, r) => {
  ...
  one_or_more_neo: BS,
  zero_or_more_neo: LS,
  requirement_arrow: FS,
  requirement_contains: ES,
  requirement_arrow_neo: AS,
  requirement_contains_neo: MS
}, IS = cS, OS = {
  common: Hi,
  getConfig: Tt,
  insertCluster: Mw,
  ...
  labelHelper: st,
  log: P,
  positionEdgeLabel: sS
}, qi = {}, Jg = /* @__PURE__ */ f((e) => {
  for (const t of e)
    qi[t.name] = t;
}, "registerLayoutLoaders"), DS = /* @__PURE__ */ f(() => {
  Jg([
    {
      name: "dagre",
      loader: /* @__PURE__ */ f(async () => await import("./dagre-BM42HDAG-TrWkqeGq.js"), "loader")
    },
    {
      name: "cose-bilkent",
      loader: /* @__PURE__ */ f(async () => await import("./cose-bilkent-S5V4N54A-CNwHGbsA.js"), "loader")
    }
  ]);
}, "registerDefaultLayoutLoaders");
DS();
var UL = /* @__PURE__ */ f(async (e, t) => {
  ...
  return i.render(e, t, OS, {
    algorithm: r.algorithm
  });
}, "render"), YL = /* @__PURE__ */ f((e = "", { fallback: t = "dagre" } = {}) => {
  if (e in qi)
    return e;
  if (t in qi)
...
}, "getRegisteredLayoutAlgorithm"), nl = "comm", tm = "rule", em = "decl", RS = "@media", PS = "@import", NS = "@supports", qS = "@namespace", sn = "@keyframes", rm = "@layer", WS = "@scope", im = Math.abs, ll = String.fromCharCode;
function sm(e) {
  return e.trim();
}
function vs(e, t, r) {
...
var _o = 1, Kr = 1, am = 0, ce = 0, Lt = 0, ei = "";
...
function be() {
  return Lt = ce < am ? Hr(ei, ce++) : 0, Kr++, Lt === 10 && (Kr = 1, _o++), Lt;
}
function Qe() {
  return Hr(ei, ce);
}
...
function YS(e) {
  return _o = Kr = 1, am = Le(ei = e), ce = 0, [];
}
function GS(e) {
  return ei = "", e;
}
function na(e) {
  return sm(vo(ce - 1, on(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function jS(e) {
  for (; (Lt = Qe()) && Lt < 33; )
    be();
...
function KS(e) {
  return GS(Ls("", null, null, null, [""], e = YS(e), 0, [0], e));
}
function Ls(e, t, r, i, s, o, a, n, l) {
  for (var c = 0, h = 0, u = a, p = 0, d = 0, g = 0, m = 1, y = 1, C = 1, b = 0, k = "", w = s, S = o, v = i, B = k; y; )
    switch (g = b, b = be()) {
      // (
      case 40:
        if (g != 108 && Hr(B, u - 1) == 58) {
          zS(B += vs(na(b), "&", "&\f"), "&\f", im(c ? n[c - 1] : 0)) != -1 && (C = -1);
          break;
        }
      // " ' [
      case 34:
      ...
      case 47:
        switch (Qe()) {
          case 42:
          case 47:
            ds(QS(VS(be(), Bs()), t, r, l), l), (Wi(g || 1) == 5 || Wi(Qe() || 1) == 5) && Le(B) && Zr(B, -1, void 0) !== " " && (B += " ");
            break;
          default:
            B += "/";
        }
      ...
      case 0:
        switch (b) {
          ...
          // ;
          case 59 + h:
            C == -1 && (B = vs(B, /\f/g, "")), d > 0 && (Le(B) - u || m === 0 && g === 47) && ds(d > 32 ? Cc(B + ";", i, r, u - 1, l) : Cc(vs(B, " ", "") + ";", i, r, u - 2, l), l);
            break;
          // @ ;
          case 59:
            B += ";";
          // { rule/at-rule
          default:
            if (ds(v = yc(B, t, r, c, h, s, n, k, w = [], S = [], u, o), o), b === 123)
              if (h === 0)
                ...
                h ? Ls(e, v, v, i && ds(yc(e, v, v, 0, 0, s, n, k, s, w = [], u, S), S), s, S, u, n, i ? w : S) : Ls(B, v, v, v, [""], S, 0, n, S);
              }
        }
      ...
      default:
        ...
        switch (B += ll(b), b * m) {
          ...
          // @
          case 64:
            Qe() === 45 && (B += na(be())), p = Qe(), h = u = Le(k = B += ZS(Bs())), b++;
            break;
          // -
          case 45:
            g === 45 && Le(B) == 2 && (m = 0);
...
function yc(e, t, r, i, s, o, a, n, l, c, h, u) {
  for (var p = s - 1, d = s === 0 ? o : [""], g = om(d), m = 0, y = 0, C = 0; m < i; ++m)
    for (var b = 0, k = Zr(e, p + 1, p = im(y = a[m])), w = e; b < g; ++b)
      (w = sm(y > 0 ? d[b] + " " + k : vs(k, /&\f/g, d[b]))) && (l[C++] = w);
  return hl(e, t, r, s === 0 ? tm : n, l, c, h, u);
}
function QS(e, t, r, i) {
  return hl(e, t, r, nl, ll(HS()), Zr(e, 2, -2), 0, i);
}
function Cc(e, t, r, i, s) {
  return hl(e, t, r, em, Zr(e, 0, i), Zr(e, i + 1, -1), i, s);
}
function an(e, t) {
...
var nm = "c4", e_ = /* @__PURE__ */ f((e) => /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(e), "detector"), r_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./c4Diagram-AAUBKEIU-DIZ3UCmy.js");
  return { id: nm, diagram: e };
}, "loader"), i_ = {
  id: nm,
  detector: e_,
  loader: r_
}, s_ = i_, lm = "flowchart", o_ = /* @__PURE__ */ f((e, t) => t?.flowchart?.defaultRenderer === "dagre-wrapper" || t?.flowchart?.defaultRenderer === "elk" ? !1 : /^\s*graph/.test(e), "detector"), a_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./flowDiagram-I6XJVG4X-Ds2aulrS.js");
  return { id: lm, diagram: e };
}, "loader"), n_ = {
  id: lm,
  detector: o_,
  loader: a_
}, l_ = n_, hm = "flowchart-v2", h_ = /* @__PURE__ */ f((e, t) => t?.flowchart?.defaultRenderer === "dagre-d3" ? !1 : (t?.flowchart?.defaultRenderer === "elk" && (t.layout = "elk"), /^\s*graph/.test(e) && t?.flowchart?.defaultRenderer === "dagre-wrapper" ? !0 : /^\s*flowchart/.test(e)), "detector"), c_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./flowDiagram-I6XJVG4X-Ds2aulrS.js");
  ...
  detector: h_,
  loader: c_
}, d_ = u_, cm = "er", p_ = /* @__PURE__ */ f((e) => /^\s*erDiagram/.test(e), "detector"), f_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./erDiagram-TEJ5UH35-zFvg2mWN.js");
  return { id: cm, diagram: e };
}, "loader"), g_ = {
  id: cm,
  detector: p_,
  loader: f_
}, m_ = g_, um = "gitGraph", y_ = /* @__PURE__ */ f((e) => /^\s*gitGraph/.test(e), "detector"), C_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./gitGraphDiagram-PVQCEYII-Df6dmtxK.js");
  return { id: um, diagram: e };
}, "loader"), x_ = {
  id: um,
  detector: y_,
  loader: C_
}, b_ = x_, dm = "gantt", k_ = /* @__PURE__ */ f((e) => /^\s*gantt/.test(e), "detector"), T_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./ganttDiagram-6RSMTGT7-C7L1znML.js");
  return { id: dm, diagram: e };
}, "loader"), w_ = {
  id: dm,
  detector: k_,
  loader: T_
}, S_ = w_, pm = "info", __ = /* @__PURE__ */ f((e) => /^\s*info/.test(e), "detector"), v_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./infoDiagram-5YYISTIA-kzKvW4jg.js");
  return { id: pm, diagram: e };
}, "loader"), B_ = {
  id: pm,
  detector: __,
  loader: v_
}, fm = "pie", L_ = /* @__PURE__ */ f((e) => /^\s*pie/.test(e), "detector"), F_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./pieDiagram-4H26LBE5-DsAflDRy.js");
  return { id: fm, diagram: e };
}, "loader"), A_ = {
  id: fm,
  detector: L_,
  loader: F_
}, gm = "quadrantChart", E_ = /* @__PURE__ */ f((e) => /^\s*quadrantChart/.test(e), "detector"), M_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./quadrantDiagram-W4KKPZXB-_hwQV0xi.js");
  return { id: gm, diagram: e };
}, "loader"), $_ = {
  id: gm,
  detector: E_,
  loader: M_
}, I_ = $_, mm = "xychart", O_ = /* @__PURE__ */ f((e) => /^\s*xychart(-beta)?/.test(e), "detector"), D_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./xychartDiagram-2RQKCTM6-Bnz9CXYc.js");
  return { id: mm, diagram: e };
}, "loader"), R_ = {
  id: mm,
  detector: O_,
  loader: D_
}, P_ = R_, ym = "requirement", N_ = /* @__PURE__ */ f((e) => /^\s*requirement(Diagram)?/.test(e), "detector"), q_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./requirementDiagram-4Y6WPE33-qEeLHrKN.js");
  return { id: ym, diagram: e };
}, "loader"), W_ = {
  id: ym,
  detector: N_,
  loader: q_
}, z_ = W_, Cm = "sequence", H_ = /* @__PURE__ */ f((e) => /^\s*sequenceDiagram/.test(e), "detector"), U_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./sequenceDiagram-3UESZ5HK-BdsEYBqh.js");
  return { id: Cm, diagram: e };
}, "loader"), Y_ = {
  id: Cm,
  detector: H_,
  loader: U_
}, G_ = Y_, xm = "class", j_ = /* @__PURE__ */ f((e, t) => t?.class?.defaultRenderer === "dagre-wrapper" ? !1 : /^\s*classDiagram/.test(e), "detector"), X_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./classDiagram-4FO5ZUOK-CF25SdxS.js");
  return { id: xm, diagram: e };
}, "loader"), V_ = {
  id: xm,
  detector: j_,
  loader: X_
}, Z_ = V_, bm = "classDiagram", K_ = /* @__PURE__ */ f((e, t) => /^\s*classDiagram/.test(e) && t?.class?.defaultRenderer === "dagre-wrapper" ? !0 : /^\s*classDiagram-v2/.test(e), "detector"), Q_ = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./classDiagram-v2-Q7XG4LA2-CF25SdxS.js");
  return { id: bm, diagram: e };
}, "loader"), J_ = {
  id: bm,
  detector: K_,
  loader: Q_
}, tv = J_, km = "state", ev = /* @__PURE__ */ f((e, t) => t?.state?.defaultRenderer === "dagre-wrapper" ? !1 : /^\s*stateDiagram/.test(e), "detector"), rv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./stateDiagram-AJRCARHV-BU1JOLLG.js");
  return { id: km, diagram: e };
}, "loader"), iv = {
  id: km,
  detector: ev,
  loader: rv
}, sv = iv, Tm = "stateDiagram", ov = /* @__PURE__ */ f((e, t) => !!(/^\s*stateDiagram-v2/.test(e) || /^\s*stateDiagram/.test(e) && t?.state?.defaultRenderer === "dagre-wrapper"), "detector"), av = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./stateDiagram-v2-BHNVJYJU-Chk28QzU.js");
  return { id: Tm, diagram: e };
}, "loader"), nv = {
  id: Tm,
  detector: ov,
  loader: av
}, lv = nv, wm = "journey", hv = /* @__PURE__ */ f((e) => /^\s*journey/.test(e), "detector"), cv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./journeyDiagram-JHISSGLW-C9CIDFkw.js");
  return { id: wm, diagram: e };
}, "loader"), uv = {
  id: wm,
  detector: hv,
  loader: cv
}, dv = uv, pv = /* @__PURE__ */ f((e, t, r) => {
  P.debug(`rendering svg for syntax error
`);
  const i = X1(t), s = i.append("g");
  ...
  detector: yv,
  loader: Cv
}, bv = xv, vm = "timeline", kv = /* @__PURE__ */ f((e) => /^\s*timeline/.test(e), "detector"), Tv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./timeline-definition-PNZ67QCA-BMV8sMLn.js");
  return { id: vm, diagram: e };
}, "loader"), wv = {
  id: vm,
  detector: kv,
  loader: Tv
}, Sv = wv, Bm = "mindmap", _v = /* @__PURE__ */ f((e) => /^\s*mindmap/.test(e), "detector"), vv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./mindmap-definition-RKZ34NQL-CbVTDIzy.js");
  return { id: Bm, diagram: e };
}, "loader"), Bv = {
  id: Bm,
  detector: _v,
  loader: vv
}, Lv = Bv, Lm = "kanban", Fv = /* @__PURE__ */ f((e) => /^\s*kanban/.test(e), "detector"), Av = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./kanban-definition-UN3LZRKU-D2Zctl5z.js");
  return { id: Lm, diagram: e };
}, "loader"), Ev = {
  id: Lm,
  detector: Fv,
  loader: Av
}, Mv = Ev, Fm = "sankey", $v = /* @__PURE__ */ f((e) => /^\s*sankey(-beta)?/.test(e), "detector"), Iv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./sankeyDiagram-5OEKKPKP-pSB5F1G0.js");
  return { id: Fm, diagram: e };
}, "loader"), Ov = {
  id: Fm,
  detector: $v,
  loader: Iv
}, Dv = Ov, Am = "packet", Rv = /* @__PURE__ */ f((e) => /^\s*packet(-beta)?/.test(e), "detector"), Pv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./diagram-LMA3HP47-o4n0-M8x.js");
  return { id: Am, diagram: e };
}, "loader"), Nv = {
  id: Am,
  detector: Rv,
  loader: Pv
}, Em = "radar", qv = /* @__PURE__ */ f((e) => /^\s*radar-beta/.test(e), "detector"), Wv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./diagram-2AECGRRQ-26Bu11CM.js");
  return { id: Em, diagram: e };
}, "loader"), zv = {
  id: Em,
  detector: qv,
  loader: Wv
}, Mm = "block", Hv = /* @__PURE__ */ f((e) => /^\s*block(-beta)?/.test(e), "detector"), Uv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./blockDiagram-GPEHLZMM-BdM0kJrg.js");
  return { id: Mm, diagram: e };
}, "loader"), Yv = {
  id: Mm,
  detector: Hv,
  loader: Uv
}, Gv = Yv, $m = "treeView", jv = /* @__PURE__ */ f((e) => /^\s*treeView-beta/.test(e), "detector"), Xv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./diagram-5GNKFQAL-B5ccF1oA.js");
  return { id: $m, diagram: e };
}, "loader"), Vv = {
  id: $m,
  detector: jv,
  loader: Xv
}, Zv = Vv, Im = "architecture", Kv = /* @__PURE__ */ f((e) => /^\s*architecture/.test(e), "detector"), Qv = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./architectureDiagram-3BPJPVTR-CcNd0Si9.js");
  return { id: Im, diagram: e };
}, "loader"), Jv = {
  id: Im,
  detector: Kv,
  loader: Qv
}, tB = Jv, Om = "eventmodeling", eB = /* @__PURE__ */ f((e) => /^\s*eventmodeling/.test(e), "detector"), rB = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./diagram-KO2AKTUF-mDjRKBmC.js");
  return { id: Om, diagram: e };
}, "loader"), iB = {
  id: Om,
  detector: eB,
  loader: rB
}, sB = iB, Dm = "ishikawa", oB = /* @__PURE__ */ f((e) => /^\s*ishikawa(-beta)?\b/i.test(e), "detector"), aB = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./ishikawaDiagram-YF4QCWOH-E0Cc0naG.js");
  return { id: Dm, diagram: e };
}, "loader"), nB = {
  id: Dm,
  detector: oB,
  loader: aB
}, Rm = "venn", lB = /* @__PURE__ */ f((e) => /^\s*venn-beta/.test(e), "detector"), hB = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./vennDiagram-CIIHVFJN-C6cWafLp.js");
  return { id: Rm, diagram: e };
}, "loader"), cB = {
  id: Rm,
  detector: lB,
  loader: hB
}, uB = cB, Pm = "treemap", dB = /* @__PURE__ */ f((e) => /^\s*treemap/.test(e), "detector"), pB = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./diagram-OG6HWLK6-BtIdA3k7.js");
  return { id: Pm, diagram: e };
}, "loader"), fB = {
  id: Pm,
  detector: dB,
  loader: pB
}, Nm = "wardley-beta", gB = /* @__PURE__ */ f((e) => /^\s*wardley-beta/i.test(e), "detector"), mB = /* @__PURE__ */ f(async () => {
  const { diagram: e } = await import("./wardleyDiagram-YWT4CUSO-iOTWq4PY.js");
  return { id: Nm, diagram: e };
}, "loader"), yB = {
  id: Nm,
  detector: gB,
  loader: mB
}, CB = yB, xc = !1, Bo = /* @__PURE__ */ f(() => {
  xc || (xc = !0, $s("error", mv, (e) => e.toLowerCase().trim() === "error"), $s(
    "---",
...
}, "addDiagrams"), xB = /* @__PURE__ */ f(async () => {
...
}, "loadRegisteredDiagrams"), bB = "graphics-document document";
function qm(e, t) {
  e.attr("role", bB), t !== "" && e.attr("aria-roledescription", t);
}
f(qm, "setA11yDiagramInfo");
function Wm(e, t, r, i) {
  if (e.insert !== void 0) {
    if (r) {
...
f(Wm, "addSVGa11yTitleDescription");
var nn = class zm {
...
`;
    try {
      ...
      const c = fy(s);
      if (!c)
        throw new Pc(`Diagram ${s} not found.`);
      const { id: h, diagram: u } = await c();
      $s(h, u);
    }
    const { db: o, parser: a, renderer: n, init: l } = ma(s);
    return a.parser && (a.parser.yy = o), o.clear?.(), l?.(i), r.title && o.setDiagramTitle?.(r.title), await a.parse(t), new zm(s, t, o, a, n);
  }
  async render(t, r) {
...
}, "attachFunctions"), TB = /* @__PURE__ */ f((e) => e.replace(/^\s*%%(?!{)[^\n]+\n?/gm, "").trimStart(), "cleanupComments");
function Hm(e) {
  const t = e.match(Rc);
  if (!t)
    return {
...
f(Hm, "extractFrontMatter");
var wB = /* @__PURE__ */ f((e) => e.replace(/\r\n?/g, `
`).replace(
  /<(\w+)([^>]*)>/g,
  (t, r, i) => "<" + r + i.replace(/="([^"]*)"/g, "='$1'") + ">"
), "cleanupText"), SB = /* @__PURE__ */ f((e) => {
  const { text: t, metadata: r } = Hm(e), { displayMode: i, title: s, config: o = {} } = r;
  return i && (o.gantt || (o.gantt = {}), o.gantt.displayMode = i), { title: s, config: o, text: t };
}, "processFrontmatter"), _B = /* @__PURE__ */ f((e) => {
...
function cl(e) {
  const t = wB(e), r = SB(t), i = _B(r.text), s = Yn(r.config, i.directive);
  return e = TB(i.text), {
    code: e,
    title: r.title,
    config: s
...
f(cl, "preprocessDiagram");
function Um(e) {
  const t = new TextEncoder().encode(e), r = Array.from(t, (i) => String.fromCodePoint(i)).join("");
  return btoa(r);
}
f(Um, "toBase64");
var vB = 5e4, BB = "graph TB;a[Maximum text size in diagram exceeded];style a fill:#faa", LB = "sandbox", FB = "loose", AB = "http://www.w3.org/2000/svg", EB = "http://www.w3.org/1999/xlink", MB = "http://www.w3.org/1999/xhtml", $B = "100%", IB = "100%", OB = "border:0;margin:0;", DB = "margin:0", RB = "allow-top-navigation-by-user-activation allow-popups", PB = 'The "iframe" tag is not supported by your browser.', NB = ["foreignobject"], qB = ["dominant-baseline"];
function ul(e) {
  const t = cl(e);
  return Es(), Wy(t.config ?? {}), t;
}
f(ul, "processAndSetConfigs");
async function Ym(e, t) {
  Bo();
  try {
    const { code: r, config: i } = ul(e);
    return { diagramType: (await jm(r)).type, config: i };
  } catch (r) {
    if (t?.suppressErrors)
      return !1;
    throw r;
...
f(Ym, "parse");
var kc = /* @__PURE__ */ f((e, t, r = []) => {
  const i = Hc(`{ ${r.join(" !important; ")} !important; }`);
  return `.${e} ${t} ${i}`;
}, "cssImportantStyles"), WB = /* @__PURE__ */ f((e, t = /* @__PURE__ */ new Map()) => {
  ...
  if (e.fontFamily !== void 0 && r.insertRule(
    ...
    t.forEach((l) => {
      Oh(l.styles) || n.forEach((c) => {
        r.insertRule(
          kc(l.id, c, l.styles),
          r.cssRules.length
        );
      }), Oh(l.textStyles) || r.insertRule(
        kc(
          l.id,
          "tspan",
...
`;
  return i + ga(r);
}, "createCssStyles"), zB = /* @__PURE__ */ f((e, t) => an(
  KS(`${e}{${t}}`),
  t_([
    /* @__PURE__ */ f(function(i, s, o, a) {
...
), "compileCSS"), HB = /* @__PURE__ */ f((e, t, r, i) => {
  const s = WB(e, r), o = aC(
    t,
    s,
  ...
  return zB(i, o);
}, "createUserStyles"), UB = /* @__PURE__ */ f((e = "", t, r) => {
  let i = e;
  return !r && !t && (i = i.replace(
    /marker-end="url\([\d+./:=?A-Za-z-]*?#/g,
    'marker-end="url(#'
  )), i = kr(i), i = i.replace(/<br>/g, "<br/>"), i;
}, "cleanUpSvgCode"), YB = /* @__PURE__ */ f((e = "", t) => {
  const r = t?.viewBox?.baseVal?.height ? t.viewBox.baseVal.height + "px" : IB, i = Um(`<body style="${DB}">${e}</body>`);
  return `<iframe style="width:${$B};height:${r};${OB}" src="data:text/html;charset=UTF-8;base64,${i}" sandbox="${RB}">
  ${PB}
</iframe>`;
}, "putIntoIFrame"), Tc = /* @__PURE__ */ f((e, t, r, i, s) => {
  const o = e.append("div");
  o.attr("id", r), i && o.attr("style", i);
  const a = o.append("svg").attr("id", t).attr("width", "100%").attr("xmlns", AB);
  return s && a.attr("xmlns:xlink", s), a.append("g"), e;
}, "appendDivSvgG");
function ln(e, t) {
  return e.append("iframe").attr("id", t).attr("style", "width: 100%; height: 100%;").attr("sandbox", "");
}
f(ln, "sandboxedIframe");
var GB = /* @__PURE__ */ f((e, t, r, i) => {
  e.getElementById(t)?.remove(), e.getElementById(r)?.remove(), e.getElementById(i)?.remove();
}, "removeExistingElements"), jB = /* @__PURE__ */ f(async function(e, t, r) {
  Bo();
  const i = ul(t);
  t = i.code;
  const s = Tt();
  P.debug(s), t.length > (s?.maxTextSize ?? vB) && (t = BB);
  const o = `#${e}`, a = "i" + e, n = "#" + a, l = "d" + e, c = "#" + l, h = /* @__PURE__ */ f(() => {
    const W = ct(p ? n : c).node();
    W && "remove" in W && W.remove();
  }, "removeTempElements");
  let u = ct(document.body);
  const p = s.securityLevel === LB, d = s.securityLevel === FB, g = s.fontFamily;
  if (r !== void 0) {
    if (r && (r.innerHTML = ""), p) {
      const z = ln(ct(r), a);
      ...
      u = ct(r);
    Tc(u, e, l, `font-family: ${g}`, EB);
  } else {
    if (GB(document, e, l, a), p) {
  ...
  const C = u.select(c).node(), b = m.type, k = C.firstChild, w = k.firstChild, S = m.renderer.getClasses?.(t, m), v = HB(s, b, S, o), B = document.createElement("style");
  B.innerHTML = v, k.insertBefore(B, w);
  try {
    await m.renderer.draw(t, e, "11.15.0", m);
  } catch (z) {
    throw s.suppressErrorRendering ? h() : fv.draw(t, e, "11.15.0"), z;
  }
  const O = u.select(`${c} svg`), N = m.db.getAccTitle?.(), D = m.db.getAccDescription?.();
  Xm(b, O, N, D), u.select(`[id="${e}"]`).selectAll("foreignobject > *").attr("xmlns", MB);
  let $ = u.select(c).node().innerHTML;
  if (P.debug("config.arrowMarkerAbsolute", s.arrowMarkerAbsolute), $ = UB($, p, Ge(s.arrowMarkerAbsolute)), p) {
...
function Gm(e = {}) {
  const t = Mt({}, e);
  t?.fontFamily && !t.themeVariables?.fontFamily && (t.themeVariables || (t.themeVariables = {}), t.themeVariables.fontFamily = t.fontFamily), Ny(t), t?.theme && t.theme in We ? t.themeVariables = We[t.theme].getThemeVariables(
    t.themeVariables
  ) : t && (t.themeVariables = We.default.getThemeVariables(t.themeVariables));
  const r = typeof t == "object" ? Py(t) : Uc();
  hn(r.logLevel), Bo();
}
f(Gm, "initialize");
var jm = /* @__PURE__ */ f((e, t = {}) => {
  const { code: r } = cl(e);
  return nn.fromText(r, t);
}, "getDiagramFromText");
function Xm(e, t, r, i) {
  qm(t, e), Wm(t, r, i, t.attr("id"));
}
f(Xm, "addA11yInfo");
var wr = Object.freeze({
  render: jB,
  parse: Ym,
  getDiagramFromText: jm,
  initialize: Gm,
  getConfig: Tt,
  setConfig: Yc,
  getSiteConfig: Uc,
...
var XB = /* @__PURE__ */ f((e, t, r) => {
...
}, "handleError"), Vm = /* @__PURE__ */ f(async function(e = {
...
}, "run"), VB = /* @__PURE__ */ f(async function({ postRenderCallback: e, querySelector: t, nodes: r } = {
  querySelector: ".mermaid"
}) {
  ...
  for (const l of Array.from(s)) {
    ...
    a = l.innerHTML, a = nf(Ce.entityDecode(a)).trim().replace(/<br\s*\/?>/gi, "<br/>");
    const h = Ce.detectInit(a);
    h && P.debug("Detected early reinit: ", h);
    try {
      const { svg: u, bindFunctions: p } = await Jm(c, a, l);
      l.innerHTML = u, e && await e(c), p && p(l);
    } catch (u) {
      XB(u, n, Ye.parseError);
    }
  }
  if (n.length > 0)
    throw n[0];
}, "runThrowsErrors"), Zm = /* @__PURE__ */ f(function(e) {
  wr.initialize(e);
}, "initialize"), ZB = /* @__PURE__ */ f(async function(e, t, r) {
  P.warn("mermaid.init is deprecated. Please use run instead."), e && Zm(e);
...
}, "init"), KB = /* @__PURE__ */ f(async (e, {
  lazyLoad: t = !0
} = {}) => {
  Bo(), ua(...e), t === !1 && await xB();
}, "registerExternalDiagrams"), Km = /* @__PURE__ */ f(function() {
  if (Ye.startOnLoad) {
    const { startOnLoad: e } = wr.getConfig();
    e && Ye.run().catch((t) => P.error("Mermaid failed to initialize", t));
  }
}, "contentLoaded");
typeof document < "u" && window.addEventListener("load", Km, !1);
var QB = /* @__PURE__ */ f(function(e) {
  Ye.parseError = e;
}, "setParseErrorHandler"), oo = [], la = !1, Qm = /* @__PURE__ */ f(async () => {
  if (!la) {
  ...
  oo.push(s), Qm().catch(i);
}), "parse"), Jm = /* @__PURE__ */ f((e, t, r) => new Promise((i, s) => {
  ...
  oo.push(o), Qm().catch(s);
}), "render"), tL = /* @__PURE__ */ f(() => Object.keys(yr).map((e) => ({
  id: e
  ...
  detectType: cn,
  registerIconPacks: ow,
  getRegisteredDiagramsMetadata: tL
}, ps = Ye;
...
class jt extends T0 {
   ...
   */
  init() {
    w0.INSTANCE.set(jt.eNS_URI, this), this.setEFactoryInstance(dl.eINSTANCE);
    const t = new S0();
    ...
    const i = new ql();
    i.setName("value"), i.setLowerBound(0), i.setUpperBound(1), t.getEStructuralFeatures().push(i), jt.Literals.MERMAID_WIDGET_SETTINGS__VALUE = i, jt.Literals.MERMAID_WIDGET_SETTINGS__THEME.setEType(Wl().getEClassifier("EString")), jt.Literals.MERMAID_WIDGET_SETTINGS__VALUE.setEType(Wl().getEClassifier("EString"));
  }
}
class zt extends _0 {
...
const eL = /* @__PURE__ */ Sc({
  ...
  setup(e, { expose: t }) {
    const r = _c(e, "configv"), i = e, { id: s } = g0(i), o = Il(b0.TINY_EMITTER), a = Il(l0), l = x0().params.pageid || "", c = Wo(1);
    class h extends no {
      refresh() {
        m.value = Date.now(), zo(() => {
          ps.run({ nodes: g.value ? [g.value] : [] }).catch(() => {
          });
        });
      }
      zoom(b) {
    ...
    }, { deep: !0, immediate: !0 }), (C, b) => (Bc(), vc("div", {
      ref_key: "container",
      ref: g,
      key: m.value,
      onClick: p,
      onContextmenu: y0(d, ["prevent"]),
      class: "w-full h-full"
    }, C0(r.value.value), 33));
  }
}), rL = { class: "settings_container" }, iL = /* @__PURE__ */ Sc({
  ...
  setup(e) {
    const t = _c(e, "modelValue");
    return (r, i) => {
      const s = Rl("VaTextarea"), o = Rl("VaSelect");
      return Bc(), vc("div", rL, [
        Pl(s, {
  ...
  for (const [i, s] of t)
    r[i] = s;
  return r;
}, oL = /* @__PURE__ */ sL(iL, [["__scopeId", "data-v-43f12bc1"]]), aL = [
  {
...
`;
var lL = Object.defineProperty, hL = Object.getOwnPropertyDescriptor, pl = (e, t, r, i) => {
  for (var s = i > 1 ? void 0 : i ? hL(t, r) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (s = (i ? a(t, r, s) : a(s)) || s);
  return i && s && lL(t, r, s), s;
}, wc = (e, t) => (r, i) => t(r, i, e);
jt.eINSTANCE;
...
let ao = class {
  ...
  register() {
    this.events.registerWidget(Pr, aL), this.actions.registerWidgetType(Pr, no, "widget");
  }
  unregister() {
