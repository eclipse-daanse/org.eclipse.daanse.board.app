import { b4 as Be, _ as dt, I as ke, Y as Ze, l as Re, b as qe, a as Qe, p as Je, q as Ke, g as je, s as _e, z as tr, F as er, D as rr, G as ir, c as ye, aO as Ee, b5 as ve, i as ar, d as nr, x as or, b6 as sr, b7 as hr } from "./index-DUg_7Lze.js";
import { p as lr } from "./chunk-4BX2VUAB-4ctcn5Z1.js";
import { p as fr } from "./wardley-L42UT6IY-C-B6soca.js";
import { c as Se } from "./cytoscape.esm-CxgSUbXJ.js";
        ...
        (function(w) {
          ...
          (function(w, U, L) {
            ...
            s.prototype.getNodes = function() {
              ...
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, d = -h.MAX_VALUE, N, b, A, S, V, X = this.nodes, Z = X.length, D = 0; D < Z; D++) {
                var _ = X[D];
              ...
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, d = -h.MAX_VALUE, N, b, A, S, V = c.length, X = 0; X < V; X++) {
                var Z = c[X];
                N = Z.getLeft(), b = Z.getRight(), A = Z.getTop(), S = Z.getBottom(), l > N && (l = N), T < b && (T = b), g > A && (g = A), d < S && (d = S);
              }
          ...
          (function(w, U, L) {
            ...
            h.calcSeparationAmount = function(a, e, i, f) {
              ...
              var s = a.getX(), o = a.getY(), c = a.getRight(), l = a.getX(), T = a.getBottom(), g = a.getRight(), d = a.getWidthHalf(), N = a.getHeightHalf(), b = e.getX(), A = e.getY(), S = e.getRight(), V = e.getX(), X = e.getBottom(), Z = e.getRight(), D = e.getWidthHalf(), _ = e.getHeightHalf(), n = !1, m = !1;
              if (f === v) {
                if (r > t)
                ...
                if (-p === y ? f > v ? (i[0] = l, i[1] = T, n = !0) : (i[0] = c, i[1] = o, n = !0) : p === y && (f > v ? (i[0] = s, i[1] = o, n = !0) : (i[0] = g, i[1] = T, n = !0)), -E === y ? v > f ? (i[2] = V, i[3] = X, m = !0) : (i[2] = S, i[3] = A, m = !0) : E === y && (v > f ? (i[2] = b, i[3] = A, m = !0) : (i[2] = Z, i[3] = X, m = !0)), n && m)
                  return !1;
              ...
              var r = a.x, v = a.y, t = e.x, s = e.y, o = i.x, c = i.y, l = f.x, T = f.y, g = void 0, d = void 0, N = void 0, b = void 0, A = void 0, S = void 0, V = void 0, X = void 0, Z = void 0;
              return N = s - v, A = r - t, V = t * v - r * s, b = T - c, S = o - l, X = l * c - o * T, Z = N * S - b * A, Z === 0 ? null : (g = (A * X - S * V) / Z, d = (b * V - N * X) / Z, new u(g, d));
            ...
            u.svd = function(h) {
                ...
                if (t < v) {
                  ...
                  if (e[t] = -e[t], /* @__PURE__ */ (function(Tt, Ct) {
                    ...
                    for (var X = t + 1; X < this.n; X++)
                      for (var Z = -e[X] / e[t + 1], D = t + 1; D < this.m; D++)
                        h[D][X] += Z * i[D];
                  }
              ...
              for (var z = this.n - 1; z >= 0; z--) {
                if (/* @__PURE__ */ (function(Tt, Ct) {
                  ...
                  for (var Y = z + 1; Y < a; Y++) {
                    for (var rt = 0, $ = z + 1; $ < this.n; $++)
                      rt += this.V[$][z] * this.V[$][Y];
                    rt = -rt / this.V[z + 1][z];
              ...
              for (var B = n - 1, tt = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                ...
                switch (J++, It) {
                  ...
                  case 3:
                    {
                      var Yt = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(e[n - 2])), Math.abs(this.s[J])), Math.abs(e[J])), Vt = this.s[n - 1] / Yt, F = this.s[n - 2] / Yt, P = e[n - 2] / Yt, k = this.s[J] / Yt, K = e[J] / Yt, q = ((F + Vt) * (F - Vt) + P * P) / 2, at = Vt * P * (Vt * P), ct = 0;
                      /* @__PURE__ */ (function(Tt, Ct) {
                        return Tt || Ct;
                      })(q !== 0, at !== 0) && (ct = Math.sqrt(q * q + at), q < 0 && (ct = -ct), ct = at / (q + ct));
                      for (var nt = (k + Vt) * (k - Vt) + ct, et = k * K, j = J; j < n - 1; j++) {
        ...
        (() => {
          var U = {
            ...
            765: (
              /***/
              ((a, e, i) => {
                var f = i(551).FDLayout, r = i(578), v = i(880), t = i(991), s = i(767), o = i(806), c = i(902), l = i(551).FDLayoutConstants, T = i(551).LayoutConstants, g = i(551).Point, d = i(551).PointD, N = i(551).DimensionD, b = i(551).Layout, A = i(551).Integer, S = i(551).IGeometry, V = i(551).LGraph, X = i(551).Transform, Z = i(551).LinkedList;
                function D() {
                ...
                D.prototype.newGraphManager = function() {
                  ...
                  var y = function O(H) {
                    for (var B = H.getChild().getNodes(), tt, ht = 0, J = 0; J < B.length; J++)
                      tt = B[J], tt.getChild() == null ? n.fixedNodeSet.has(tt.id) && (ht += 100) : ht += O(tt);
                    return ht;
                  };
                    ...
                    if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      this.shuffle = function(O) {
                        ...
                        for (tt = O.length - 1; tt >= 2 * O.length / 3; tt--)
                          H = Math.floor(Math.random() * (tt + 1)), B = O[tt], O[tt] = O[H], O[H] = B;
                        return O;
                        ...
                        if (O.left) {
                          var H = M.has(O.left) ? M.get(O.left) : O.left, B = M.has(O.right) ? M.get(O.right) : O.right;
                      ...
                      var $ = Y(z, n.fixedNodesOnVertical);
                  ...
                  if (this.constraints.fixedNodeConstraint && this.constraints.fixedNodeConstraint.forEach(function($) {
                    var O = n.idToNodeMap.get($.nodeId);
                  ...
                  if (this.constraints.relativePlacementConstraint)
                    if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      this.totalIterations % 10 == 0 && (this.shuffle(this.nodesInRelativeHorizontal), this.shuffle(this.nodesInRelativeVertical)), this.nodesInRelativeHorizontal.forEach(function($) {
                        if (!n.fixedNodesOnHorizontal.has($)) {
                          var O = 0;
                          n.dummyToNodeForVerticalAlignment.has($) ? O = n.idToNodeMap.get(n.dummyToNodeForVerticalAlignment.get($)[0]).displacementX : O = n.idToNodeMap.get($).displacementX, n.nodeToRelativeConstraintMapHorizontal.get($).forEach(function(H) {
                            if (H.right) {
                              var B = n.nodeToTempPositionMapHorizontal.get(H.right) - n.nodeToTempPositionMapHorizontal.get($) - O;
                              B < H.gap && (O -= H.gap - B);
                            } else {
                              var B = n.nodeToTempPositionMapHorizontal.get($) - n.nodeToTempPositionMapHorizontal.get(H.left) + O;
                              B < H.gap && (O += H.gap - B);
                            }
                          }), n.nodeToTempPositionMapHorizontal.set($, n.nodeToTempPositionMapHorizontal.get($) + O), n.dummyToNodeForVerticalAlignment.has($) ? n.dummyToNodeForVerticalAlignment.get($).forEach(function(H) {
                            n.idToNodeMap.get(H).displacementX = O;
                          }) : n.idToNodeMap.get($).displacementX = O;
                        }
                      }), this.nodesInRelativeVertical.forEach(function($) {
                        if (!n.fixedNodesOnHorizontal.has($)) {
                          var O = 0;
                          n.dummyToNodeForHorizontalAlignment.has($) ? O = n.idToNodeMap.get(n.dummyToNodeForHorizontalAlignment.get($)[0]).displacementY : O = n.idToNodeMap.get($).displacementY, n.nodeToRelativeConstraintMapVertical.get($).forEach(function(H) {
                            if (H.bottom) {
                              var B = n.nodeToTempPositionMapVertical.get(H.bottom) - n.nodeToTempPositionMapVertical.get($) - O;
                              B < H.gap && (O -= H.gap - B);
                            } else {
                              var B = n.nodeToTempPositionMapVertical.get($) - n.nodeToTempPositionMapVertical.get(H.top) + O;
                              B < H.gap && (O += H.gap - B);
                            }
                          }), n.nodeToTempPositionMapVertical.set($, n.nodeToTempPositionMapVertical.get($) + O), n.dummyToNodeForHorizontalAlignment.has($) ? n.dummyToNodeForHorizontalAlignment.get($).forEach(function(H) {
                            n.idToNodeMap.get(H).displacementY = O;
                          }) : n.idToNodeMap.get($).displacementY = O;
                        }
                      });
                    else {
                  ...
                  var Y = z.length;
                  m != null && Y--;
                  for (var rt = 0, $ = z.length, O, H = n.getEdgesBetween(m); H.length > 1; ) {
                    var B = H[0];
                    H.splice(0, 1);
                    var tt = z.indexOf(B);
                    tt >= 0 && z.splice(tt, 1), $--, Y--;
                  }
                  m != null ? O = (z.indexOf(H[0]) + 1) % $ : O = 0;
                  for (var ht = Math.abs(E - p) / Y, J = O; rt != Y; J = ++J % $) {
                  ...
                  n.forEach(function($) {
                    I += $.getWidth(), M += $.getHeight(), $.getWidth() > R && (R = $.getWidth());
                  });
                  ...
                  n.sort(function($, O) {
                    var H = W;
                    return M.idealRowWidth ? (H = I, H($.id, O.id)) : H($, O);
                  });
                  ...
                  if (E == n[1].source ? p = n[1].target : p = n[1].source, o.PURE_INCREMENTAL)
                    ...
                    for (var $ = A.MAX_VALUE, O, H, B = 0; B < Y.length; B++)
                      Y[B] < $ ? ($ = Y[B], O = 1, H = B) : Y[B] == $ && O++;
                    if (O == 3 && $ == 0)
                ...
                o.handleConstraints = function(c) {
                  ...
                  var X = function(P, k) {
                    ...
                    return P.forEach(function(q) {
                      k += d[g.get(q)], K += N[g.get(q)];
                    }), { x: k / P.size, y: K / P.size };
                  }, D = function(P, k, K, q, at) {
                    function ct(lt, ot) {
                    ...
                    nt.forEach(function(lt, ot) {
                      lt == 0 ? (ut.push(ot), K || (k == "horizontal" ? et.set(ot, g.has(ot) ? d[g.get(ot)] : q.get(ot)) : et.set(ot, g.has(ot) ? N[g.get(ot)] : q.get(ot)))) : et.set(ot, Number.NEGATIVE_INFINITY), K && j.set(ot, /* @__PURE__ */ new Set([ot]));
                      ...
                      if (lt.forEach(function(st) {
                        ...
                        ot.forEach(function(st) {
                          k == "horizontal" ? (et.set(st, g.has(st) ? d[g.get(st)] : q.get(st)), Lt += et.get(st)) : (et.set(st, g.has(st) ? N[g.get(st)] : q.get(st)), Lt += et.get(st));
                        ...
                        lt.forEach(function(st) {
                          k == "horizontal" ? ft += g.has(st) ? d[g.get(st)] : q.get(st) : ft += g.has(st) ? N[g.get(st)] : q.get(st);
                    ...
                    for (var wt = function() {
                      ...
                      Lt.forEach(function(ft) {
                        if (et.get(ft.id) < et.get(ot) + ft.gap)
                          if (K && K.has(ft.id)) {
                            var st = void 0;
                            if (k == "horizontal" ? st = g.has(ft.id) ? d[g.get(ft.id)] : q.get(ft.id) : st = g.has(ft.id) ? N[g.get(ft.id)] : q.get(ft.id), et.set(ft.id, st), st < et.get(ot) + ft.gap) {
                      ...
                      j.forEach(function(lt, ot) {
                        ...
                        try {
                          for (var bt = lt[Symbol.iterator](), zt; !(Tt = (zt = bt.next()).done); Tt = !0) {
                            ...
                            k == "horizontal" ? kt = g.has(St) ? d[g.get(St)] : q.get(St) : kt = g.has(St) ? N[g.get(St)] : q.get(St);
                            var Kt = et.get(St);
                    ...
                    var k = 0, K = 0, q = 0, at = 0;
                    if (P.forEach(function(j) {
                      j.left ? d[g.get(j.left)] - d[g.get(j.right)] >= 0 ? k++ : K++ : N[g.get(j.top)] - N[g.get(j.bottom)] >= 0 ? q++ : at++;
                    }), k > K && q > at)
                    ...
                    var k = [], K = new v(), q = /* @__PURE__ */ new Set(), at = 0;
                    return P.forEach(function(ct, nt) {
                      if (!q.has(nt)) {
                        k[at] = [];
                        var et = nt;
                        for (K.push(et), q.add(et), k[at].push(et); K.length != 0; ) {
                          et = K.shift();
                          var j = P.get(et);
                          j.forEach(function(ut) {
                            q.has(ut.id) || (K.push(ut.id), q.add(ut.id), k[at].push(ut.id));
                          });
                        }
                        at++;
                      }
                    ...
                    return P.forEach(function(K, q) {
                      ...
                      K.forEach(function(at) {
                        k.get(q).push(at), k.get(at.id).push({ id: q, gap: at.gap, direction: at.direction });
                      });
                    }), k;
                  }, p = function(P) {
                    var k = /* @__PURE__ */ new Map();
                    return P.forEach(function(K, q) {
                      ...
                      K.forEach(function(at) {
                        k.get(at.id).push({ id: q, gap: at.gap, direction: at.direction });
                      });
                    }), k;
                    ...
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1)
                      ...
                      (function() {
                        ...
                        if (l.alignmentConstraint.vertical) {
                          for (var P = l.alignmentConstraint.vertical, k = function(et) {
                            ...
                            ut.size > 0 ? wt = d[g.get(ut.values().next().value)] : wt = Z(j).x, P[et].forEach(function(pt) {
                        ...
                        if (l.alignmentConstraint.horizontal) {
                          for (var q = l.alignmentConstraint.horizontal, at = function(et) {
                            ...
                            ut.size > 0 ? wt = d[g.get(ut.values().next().value)] : wt = Z(j).y, q[et].forEach(function(pt) {
                      ...
                      if (z < x.size / 2)
                        ...
                        var $ = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Map(), H = [];
                        Q[Y].forEach(function(F) {
                          W.get(F).forEach(function(P) {
                            P.direction == "horizontal" ? ($.has(F) ? $.get(F).push(P) : $.set(F, [P]), $.has(P.id) || $.set(P.id, []), H.push({ left: F, right: P.id })) : (O.has(F) ? O.get(F).push(P) : O.set(F, [P]), O.has(P.id) || O.set(P.id, []), H.push({ top: F, bottom: P.id }));
                          });
                        }), _(H), M = !1;
                        var B = D($, "horizontal"), tt = D(O, "vertical");
                        Q[Y].forEach(function(F, P) {
                          y[P] = [d[g.get(F)], N[g.get(F)]], E[P] = [], B.has(F) ? E[P][0] = B.get(F) : E[P][0] = d[g.get(F)], tt.has(F) ? E[P][1] = tt.get(F) : E[P][1] = N[g.get(F)];
                        }), I = !0;
                      }
                    }
                    if (I) {
                  ...
                  if (r.ENFORCE_CONSTRAINTS) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                      var Et = { x: 0, y: 0 };
                      l.fixedNodeConstraint.forEach(function(F, P) {
                        var k = { x: d[g.get(F.nodeId)], y: N[g.get(F.nodeId)] }, K = F.position, q = X(K, k);
                        Et.x += q.x, Et.y += q.y;
                    ...
                    if (l.alignmentConstraint) {
                      if (l.alignmentConstraint.vertical)
                        for (var Dt = l.alignmentConstraint.vertical, Rt = function(P) {
                          ...
                          var K = new Set([].concat(f(k)).filter(function(at) {
                            return R.has(at);
                          })), q = void 0;
                          K.size > 0 ? q = d[g.get(K.values().next().value)] : q = Z(k).x, k.forEach(function(at) {
                      ...
                      if (l.alignmentConstraint.horizontal)
                        for (var Ut = l.alignmentConstraint.horizontal, Pt = function(P) {
                          ...
                          K.size > 0 ? q = N[g.get(K.values().next().value)] : q = Z(k).y, k.forEach(function(at) {
                    ...
                    l.relativePlacementConstraint && (function() {
                      var F = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), q = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map(), ct = /* @__PURE__ */ new Set(), nt = /* @__PURE__ */ new Set();
                      if (R.forEach(function(Gt) {
                        ct.add(Gt), nt.add(Gt);
                      }), l.alignmentConstraint) {
                        if (l.alignmentConstraint.vertical)
                          for (var et = l.alignmentConstraint.vertical, j = function(yt) {
                            k.set("dummy" + yt, []), et[yt].forEach(function(Mt) {
                              F.set(Mt, "dummy" + yt), k.get("dummy" + yt).push(Mt), R.has(Mt) && ct.add("dummy" + yt);
                      ...
                      var bt = m(lt), zt = m(ot), St = n(bt), kt = n(zt), Kt = p(lt), fe = p(ot), Qt = [], jt = [];
            ...
            548: (
              ...
              ((a, e, i) => {
                ...
                v.getTopMostNodes = function(t) {
                  ...
                  var l = new r(), T = /* @__PURE__ */ new Set(), g = [], d = void 0, N = void 0, b = void 0, A = !1, S = 1, V = [], X = [], Z = function() {
                    var _ = t.collection();
                    X.push(_);
                    ...
                    if (o.quality == "draft") {
                      ...
                      try {
                        for (var A = s.nodeIndexes[Symbol.iterator](), S; !(d = (S = A.next()).done); d = !0) {
                          var V = S.value, X = f(V, 2), Z = X[0], D = X[1], _ = o.cy.getElementById(Z);
                          if (_) {
                      ...
                      Object.keys(s).forEach(function(x) {
                        var Q = s[x], z = Q.getRect().x, Y = Q.getRect().x + Q.getRect().width, rt = Q.getRect().y, $ = Q.getRect().y + Q.getRect().height;
                        z < c && (c = z), Y > l && (l = Y), rt < T && (T = rt), $ > g && (g = $);
                      });
                  ...
                  for (var l = Number.MAX_SAFE_INTEGER, T = Number.MIN_SAFE_INTEGER, g = Number.MAX_SAFE_INTEGER, d = Number.MIN_SAFE_INTEGER, N = void 0, b = void 0, A = void 0, S = void 0, V = t.descendants().not(":parent"), X = V.length, Z = 0; Z < X; Z++) {
                    var D = V[Z];
            ...
            816: (
              ...
              ((a, e, i) => {
                var f = i(548), r = i(140).CoSELayout, v = i(140).CoSENode, t = i(140).layoutBase.PointD, s = i(140).layoutBase.DimensionD, o = i(140).layoutBase.LayoutConstants, c = i(140).layoutBase.FDLayoutConstants, l = i(140).CoSEConstants, T = function(d, N) {
                  var b = d.cy, A = d.eles, S = A.nodes(), V = A.edges(), X = void 0, Z = void 0, D = void 0, _ = {};
                  d.randomize && (X = N.nodeIndexes, Z = N.xCoords, D = N.yCoords);
                  var n = function(x) {
                    return typeof x == "function";
                  }, m = function(x, Q) {
                    return n(x) ? x(Q) : x;
                  }, p = f.calcParentsWithoutChildren(b, A), E = function W(x, Q, z, Y) {
                    for (var rt = Q.length, $ = 0; $ < rt; $++) {
                      var O = Q[$], H = null;
                      O.intersection(p).length == 0 && (H = O.children());
                      var B = void 0, tt = O.layoutDimensions({
                        nodeDimensionsIncludeLabels: Y.nodeDimensionsIncludeLabels
                      });
                      if (O.outerWidth() != null && O.outerHeight() != null)
                        if (Y.randomize)
                          if (!O.isParent())
                            B = x.add(new v(z.graphManager, new t(Z[X.get(O.id())] - tt.w / 2, D[X.get(O.id())] - tt.h / 2), new s(parseFloat(tt.w), parseFloat(tt.h))));
                          else {
                            var ht = f.calcBoundingBox(O, Z, D, X);
                            O.intersection(p).length == 0 ? B = x.add(new v(z.graphManager, new t(ht.topLeftX, ht.topLeftY), new s(ht.width, ht.height))) : B = x.add(new v(z.graphManager, new t(ht.topLeftX, ht.topLeftY), new s(parseFloat(tt.w), parseFloat(tt.h))));
                          }
                        else
                          B = x.add(new v(z.graphManager, new t(O.position("x") - tt.w / 2, O.position("y") - tt.h / 2), new s(parseFloat(tt.w), parseFloat(tt.h))));
                      else
                        B = x.add(new v(this.graphManager));
                      if (B.id = O.data("id"), B.nodeRepulsion = m(Y.nodeRepulsion, O), B.paddingLeft = parseInt(O.css("padding")), B.paddingTop = parseInt(O.css("padding")), B.paddingRight = parseInt(O.css("padding")), B.paddingBottom = parseInt(O.css("padding")), Y.nodeDimensionsIncludeLabels && (B.labelWidth = O.boundingBox({ includeLabels: !0, includeNodes: !1, includeOverlays: !1 }).w, B.labelHeight = O.boundingBox({ includeLabels: !0, includeNodes: !1, includeOverlays: !1 }).h, B.labelPosVertical = O.css("text-valign"), B.labelPosHorizontal = O.css("text-halign")), _[O.data("id")] = B, isNaN(B.rect.x) && (B.rect.x = 0), isNaN(B.rect.y) && (B.rect.y = 0), H != null && H.length > 0) {
                        var J = void 0;
                        J = z.getGraphManager().add(z.newGraph(), B), W(J, H, z, Y);
                      }
                    }
                  }, y = function(x, Q, z) {
                    for (var Y = 0, rt = 0, $ = 0; $ < z.length; $++) {
                      var O = z[$], H = _[O.data("source")], B = _[O.data("target")];
                      if (H && B && H !== B && H.getEdgesBetween(B).length == 0) {
                        var tt = Q.add(x.newEdge(), H, B);
              ...
              ((a, e, i) => {
                ...
                var v = i(658), t = i(548), s = i(657), o = s.spectralLayout, c = i(816), l = c.coseLayout, T = Object.freeze({
                  ...
                  return f(d, [{
                    key: "run",
                    value: function() {
                      var b = this, A = this.options, S = A.cy, V = A.eles, X = [], Z = [], D = void 0, _ = [];
                      ...
                      if (S.layoutUtilities && A.packComponents && (m = S.layoutUtilities("get"), m || (m = S.layoutUtilities()), p = !0), V.nodes().length > 0)
                        if (p) {
                          ...
                          if (D = t.connectComponents(S, A.eles, I), D.forEach(function(vt) {
                            ...
                            if (A.tile) {
                              ...
                              if (D.forEach(function(vt, it) {
                                ...
                                for (var $ = Y.length - 1; $ >= 0; $--)
                                  D.splice(Y[$], 1), X.splice(Y[$], 1), _.splice(Y[$], 1);
                              }
                            }
                            D.forEach(function(vt, it) {
                              A.eles = vt, Z.push(l(A, X[it])), t.relocateComponent(_[it], Z[it], A);
                            });
                          } else
                            D.forEach(function(vt, it) {
                          ...
                          if (D.length > 1) {
                            var H = [], B = V.filter(function(vt) {
                              return vt.css("display") == "none";
                            });
                            D.forEach(function(vt, it) {
                              var gt = void 0;
                              if (A.quality == "draft" && (gt = X[it].nodeIndexes), vt.nodes().not(B).length > 0) {
                                var mt = {};
                                mt.edges = [], mt.nodes = [];
                                var At = void 0;
                                vt.nodes().not(B).forEach(function(Ot) {
                                  if (A.quality == "draft")
                                    ...
                                    Z[it][Ot.id()] && mt.nodes.push({ x: Z[it][Ot.id()].getLeft(), y: Z[it][Ot.id()].getTop(), width: Z[it][Ot.id()].getWidth(), height: Z[it][Ot.id()].getHeight() });
                                  ...
                                  if (Et.css("display") != "none" && Dt.css("display") != "none")
                                    if (A.quality == "draft") {
                                      ...
                                      Z[it][Et.id()] && Z[it][Dt.id()] && mt.edges.push({ startX: Z[it][Et.id()].getCenterX(), startY: Z[it][Et.id()].getCenterY(), endX: Z[it][Dt.id()].getCenterX(), endY: Z[it][Dt.id()].getCenterY() });
                          ...
                          A.quality == "default" || A.quality == "proof" ? (Z.push(l(A, X[0])), t.relocateComponent(_[0], Z[0], A)) : t.relocateComponent(_[0], X[0], A);
                        }
                      var J = function(it, gt) {
                        if (A.quality == "default" || A.quality == "proof") {
                          typeof it == "number" && (it = gt);
                          var mt = void 0, At = void 0, Ot = it.data("id");
                          return Z.forEach(function(Dt) {
            ...
            657: (
              ...
              ((a, e, i) => {
                var f = i(548), r = i(140).layoutBase.Matrix, v = i(140).layoutBase.SVD, t = function(o) {
                  var c = o.cy, l = o.eles, T = l.nodes(), g = l.nodes(":parent"), d = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), A = [], S = [], V = [], X = [], Z = [], D = [], _ = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = o.piTol, I = o.samplingType, M = o.nodeSeparation, R = void 0, W = function() {
                    for (var P = 0, k = 0, K = !1; k < R; ) {
                    ...
                    if (K) {
                      for (var ot = 0; ot < m; ot++)
                        D[ot][k] < Z[ot] && (Z[ot] = D[ot][k]);
                      for (var Lt = 0; Lt < m; Lt++)
                        Z[Lt] > ut && (ut = Z[Lt], wt = Lt);
                    }
                    return wt;
                  }, Q = function(P) {
                    var k = void 0;
                    ...
                    for (var P = v.svd(_), k = P.S, K = P.U, q = P.V, at = k[0] * k[0] * k[0], ct = [], nt = 0; nt < R; nt++) {
                      ct[nt] = [];
                      for (var et = 0; et < R; et++)
                        ct[nt][et] = 0, nt == et && (ct[nt][et] = k[nt] / (k[nt] * k[nt] + at / (k[nt] * k[nt])));
                    }
                    n = r.multMat(r.multMat(q, ct), r.transpose(K));
                  }, Y = function() {
                    for (var P = void 0, k = void 0, K = [], q = [], at = [], ct = [], nt = 0; nt < m; nt++)
                    ...
                    for (j = E; ; ) {
                      for (var xt = 0; xt < m; xt++)
                        ct[xt] = q[xt];
                      if (ct = r.minusOp(ct, r.multCons(at, r.dotProduct(at, ct))), q = r.multGamma(r.multL(r.multGamma(ct), D, n)), k = r.dotProduct(ct, q), q = r.normalize(q), et = r.dotProduct(ct, q), ut = Math.abs(et / j), ut <= 1 + y && ut >= 1)
                        break;
                      j = et;
                    }
                    for (var lt = 0; lt < m; lt++)
                      ct[lt] = q[lt];
                    S = r.multCons(at, Math.sqrt(Math.abs(P))), V = r.multCons(ct, Math.sqrt(Math.abs(k)));
                  };
                  ...
                  for (var rt = 0, $ = 0; $ < T.length; $++)
                    T[$].isParent() || N.set(T[$].id(), rt++);
                  ...
                  g.forEach(function(F) {
                    ...
                    var k = 0, K = P.nodes(":childless")[0].connectedEdges().length;
                    P.nodes(":childless").forEach(function(q, at) {
                      q.connectedEdges().length < K && (K = q.connectedEdges().length, k = at);
                    }), b.set(F.id(), P.nodes(":childless")[k].id());
                  }), T.forEach(function(F) {
                    var P = void 0;
                    F.isParent() ? P = N.get(b.get(F.id())) : P = N.get(F.id()), F.neighborhood().nodes().forEach(function(k) {
                      l.intersection(F.edgesWith(k)).length > 0 && (k.isParent() ? A[P].push(b.get(k.id())) : A[P].push(k.id()));
                    });
                  });
                  var Nt = function(P) {
                    var k = N.get(P), K = void 0;
                    d.get(P).forEach(function(q) {
                      c.getElementById(q).isParent() ? K = b.get(q) : K = q, A[k].push(K), A[N.get(K)].push(P);
                    });
                  }, vt = !0, it = !1, gt = void 0;
                  try {
...
var De = {
...
}, "isArchitectureJunction"), Fe = /* @__PURE__ */ dt((C) => C.data(), "edgeData"), ie = /* @__PURE__ */ dt((C) => C.data(), "nodeData"), Or = ir.architecture, be = class {
  constructor() {
  ...
  lr(C, G), C.groups.map((w) => G.addGroup(w)), C.services.map((w) => G.addService({ ...w, type: "service" })), C.junctions.map((w) => G.addJunction({ ...w, type: "junction" })), C.edges.map((w) => G.addEdge(w));
}, "populateDb"), Pe = {
  parser: {
  ...
  parse: /* @__PURE__ */ dt(async (C) => {
    const G = await fr("architecture", C);
    Re.debug(G);
  ...
  await Promise.all(
    G.edges().map(async (i) => {
      ...
      if (t && (Wt(r) ? g += r === "L" ? -V : V : d += r === "T" ? -V : V + 18), l && (Wt(o) ? A += o === "L" ? -V : V : S += o === "T" ? -V : V + 18), !t && w.getNode(f)?.type === "junction" && (Wt(r) ? g += r === "L" ? h : -h : d += r === "T" ? h : -h), !l && w.getNode(s)?.type === "junction" && (Wt(o) ? A += o === "L" ? h : -h : S += o === "T" ? h : -h), i[0]._private.rscratch) {
        const X = C.insert("g");
        if (X.insert("path").attr("d", `M ${g},${d} L ${N},${b} L${A},${S} `).attr("class", "edge").attr("id", `${U}-${or(f, s, { prefix: "L" })}`), v) {
          const Z = Wt(r) ? oe[r](g, a) : g - e, D = qt(r) ? oe[r](d, a) : d - e;
          X.insert("polygon").attr("points", xe[r](a)).attr("transform", `translate(${Z},${D})`).attr("class", "arrow");
        }
        if (c) {
          const Z = Wt(o) ? oe[o](A, a) : A - e, D = qt(o) ? oe[o](S, a) : S - e;
          X.insert("polygon").attr("points", xe[o](a)).attr("transform", `translate(${Z},${D})`).attr("class", "arrow");
        }
        if (T) {
          const Z = me(r, o) ? "XY" : Wt(r) ? "X" : "Y";
          let D = 0;
          Z === "X" ? D = Math.abs(g - A) : Z === "Y" ? D = Math.abs(d - S) / 1.5 : D = Math.abs(g - A) / 2;
          const _ = X.append("g");
          if (await Ee(
            _,
            T,
...
function ze(C, G, w, U, L, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    const e = nr("body").append("div").attr("id", "cy").attr("style", "display:none"), i = Se({
    ...
    c.one("layoutstop", () => {
      function l(T, g, d, N) {
        let b, A;
        const { x: S, y: V } = T, { x: X, y: Z } = g;
        A = (N - V + (S - d) * (V - Z) / (S - X)) / Math.sqrt(1 + Math.pow((V - Z) / (S - X), 2)), b = Math.sqrt(Math.pow(N - V, 2) + Math.pow(d - S, 2) - Math.pow(A, 2));
        const D = Math.sqrt(Math.pow(X - S, 2) + Math.pow(Z - V, 2));
        b = b / D;
        let _ = (X - S) * (N - V) - (Z - V) * (d - S);
        switch (!0) {
          case _ >= 0:
            _ = 1;
            break;
      ...
      for (const T of Object.values(i.edges()))
        if (T.data?.()) {
          ...
          if (g !== N && d !== b) {
            const A = T.sourceEndpoint(), S = T.targetEndpoint(), { sourceDir: V } = Fe(T), [X, Z] = qt(V) ? [A.x, S.y] : [S.x, A.y], { weights: D, distances: _ } = l(A, S, X, Z);
...
var Pr = /* @__PURE__ */ dt(async (C, G, w, U) => {
  const L = U.db;
  L.setDiagramId(G);
  const u = L.getServices(), h = L.getJunctions(), a = L.getGroups(), e = L.getEdges(), i = L.getDataStructures(), f = ke(G), r = f.append("g");
