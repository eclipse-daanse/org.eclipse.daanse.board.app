import { g as qe } from "./chunk-FMBD7UC4-DsIBSMI8.js";
import { _ as b, n as Oe, l as Q, c as g1, o as He, r as Xe, u as ie, b as Qe, s as Je, p as Ze, a as $e, g as et, q as tt, k as st, t as it, J as rt, v as at, x as te, d as se, y as nt, z as ut, A as ot, B as lt } from "./index-3-rTiW2_.js";
import { c as ct } from "./chunk-ND2GUHAM-Cmu9dsts.js";
import { g as ht } from "./chunk-55IACEB6-Bl2NLz0t.js";
import { s as dt } from "./chunk-2J33WTMH-CjHBRsVM.js";
import { c as pt } from "./channel-B0600o8J.js";
...
You have to call mermaid.initialize.`
  ...
  f.type = a.type, f.layoutAlgorithm = He(l), f.layoutAlgorithm === "dagre" && l === "elk" && Q.warn(
  ...
  var e = /* @__PURE__ */ b(function(f1, c, h, p) {
    ...
    parse: /* @__PURE__ */ b(function(c) {
      ...
      function Ye(H) {
        p.length = p.length - 2 * H, x.length = x.length - H, t.length = t.length - H;
      }
      b(Ye, "popStack");
      function Ge() {
        var H;
        return H = u.pop() || M.lex() || Ne, typeof H != "number" && (H instanceof Array && (u = H, H = u.pop()), H = h.symbols_[H] || H), H;
      }
      b(Ge, "lex");
      for (var j, k1, X, $1, w1 = {}, q1, c1, Pe, H1; ; ) {
        if (k1 = p[p.length - 1], this.defaultActions[k1] ? X = this.defaultActions[k1] : ((j === null || typeof j > "u") && (j = Ge()), X = R1[k1] && R1[k1][j]), typeof X > "u" || !X.length || !X[0]) {
          ...
          H1 = [];
          for (q1 in R1[k1])
            this.terminals_[q1] && q1 > We && H1.push("'" + this.terminals_[q1] + "'");
          M.showPosition ? ee = "Parse error on line " + (B + 1) + `:
` + M.showPosition() + `
Expecting ` + H1.join(", ") + ", got '" + (this.terminals_[j] || j) + "'" : ee = "Parse error on line " + (B + 1) + ": Unexpected " + (j == Ne ? "end of input" : "'" + (this.terminals_[j] || j) + "'"), this.parseError(ee, {
            text: M.match,
