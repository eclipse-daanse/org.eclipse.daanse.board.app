...
Lc([
  Bc({ eventType: "mermaid.refresh" })
], no.prototype, "refresh");
Lc([
  Bc({ eventType: "mermaid.zoom" })
], no.prototype, "zoom");
function F0(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var ps = { exports: {} }, A0 = ps.exports, Wl;
function E0() {
...
var M0 = E0();
const $0 = /* @__PURE__ */ F0(M0);
var Fc = Object.defineProperty, p = (e, t) => Fc(e, "name", { value: t, configurable: !0 }), I0 = (e, t) => {
  for (var r in t)
    Fc(e, r, { get: t[r], enumerable: !0 });
}, Re = {
  trace: 0,
  debug: 1,
  info: 2,
...
}, "setLogLevel"), le = /* @__PURE__ */ p((e) => `%c${$0().format("ss.SSS")} : ${e} : `, "format");
const gs = {
  /* CLAMP */
  min: {
    r: 0,
...
const lo = new P0({ r: 0, g: 0, b: 0, a: 0 }, "transparent"), Wr = {
  /* VARIABLES */
  ...
  const r = Ae.parse(e);
  return r.r = 255 - r.r, r.g = 255 - r.g, r.b = 255 - r.b, W0(r, e, t);
};
...
const si = Ft(Array.prototype.forEach), Y0 = Ft(Array.prototype.lastIndexOf), Hl = Ft(Array.prototype.pop), oi = Ft(Array.prototype.push), G0 = Ft(Array.prototype.splice), Gt = Array.isArray, yi = Ft(String.prototype.toLowerCase), Ho = Ft(String.prototype.toString), Ul = Ft(String.prototype.match), Fr = Ft(String.prototype.replace), Yl = Ft(String.prototype.indexOf), j0 = Ft(String.prototype.trim), X0 = Ft(Number.prototype.toString), V0 = Ft(Boolean.prototype.toString), Gl = typeof BigInt > "u" ? null : Ft(BigInt.prototype.toString), jl = typeof Symbol > "u" ? null : Ft(Symbol.prototype.toString), St = Ft(Object.prototype.hasOwnProperty), ai = Ft(Object.prototype.toString), Dt = Ft(RegExp.prototype.test), es = Z0(TypeError);
function Ft(e) {
  return function(t) {
...
function te(e) {
  ...
  for (const [r, i] of Mc(e))
    St(e, r) && (Gt(i) ? t[r] = K0(i) : i && typeof i == "object" && i.constructor === Object ? t[r] = te(i) : t[r] = i);
  return t;
}
function Q0(e) {
  switch (typeof e) {
...
function Oc() {
  ...
  const dt = lt({}, [...Xl, ...Uo, ...Yo, ...Go, ...Vl]);
  let et = null;
  const ut = lt({}, [...Zl, ...jo, ...Kl, ...rs]);
  ...
  const Jm = lt({}, [Ji, ts, _e], Ho);
  let Oo = lt({}, ["mi", "mo", "mn", "ms", "mtext"]), Do = lt({}, ["annotation-xml"]);
  const t0 = lt({}, ["title", "style", "font", "a", "script"]);
  let ii = null;
  const e0 = ["application/xhtml+xml", "text/html"], r0 = "text/html";
  let At = null, Lr = null;
  const i0 = r.createElement("form"), bl = function(T) {
    ...
    e0.indexOf(T.PARSER_MEDIA_TYPE) === -1 ? r0 : T.PARSER_MEDIA_TYPE, At = ii === "application/xhtml+xml" ? Ho : yi, Q = St(T, "ALLOWED_TAGS") && Gt(T.ALLOWED_TAGS) ? lt({}, T.ALLOWED_TAGS, At) : dt, et = St(T, "ALLOWED_ATTR") && Gt(T.ALLOWED_ATTR) ? lt({}, T.ALLOWED_ATTR, At) : ut, Io = St(T, "ALLOWED_NAMESPACES") && Gt(T.ALLOWED_NAMESPACES) ? lt({}, T.ALLOWED_NAMESPACES, Ho) : Jm, Mo = St(T, "ADD_URI_SAFE_ATTR") && Gt(T.ADD_URI_SAFE_ATTR) ? lt(te(xl), T.ADD_URI_SAFE_ATTR, At) : xl, yl = St(T, "ADD_DATA_URI_TAGS") && Gt(T.ADD_DATA_URI_TAGS) ? lt(te(Cl), T.ADD_DATA_URI_TAGS, At) : Cl, Se = St(T, "FORBID_CONTENTS") && Gt(T.FORBID_CONTENTS) ? lt({}, T.FORBID_CONTENTS, At) : Eo, rt = St(T, "FORBID_TAGS") && Gt(T.FORBID_TAGS) ? lt({}, T.FORBID_TAGS, At) : te({}), ht = St(T, "FORBID_ATTR") && Gt(T.FORBID_ATTR) ? lt({}, T.FORBID_ATTR, At) : te({}), vr = St(T, "USE_PROFILES") ? T.USE_PROFILES && typeof T.USE_PROFILES == "object" ? te(T.USE_PROFILES) : T.USE_PROFILES : !1, xt = T.ALLOW_ARIA_ATTR !== !1, Ct = T.ALLOW_DATA_ATTR !== !1, vt = T.ALLOW_UNKNOWN_PROTOCOLS || !1, ue = T.ALLOW_SELF_CLOSE_IN_ATTR !== !1, se = T.SAFE_FOR_TEMPLATES || !1, Oe = T.SAFE_FOR_XML !== !1, ar = T.WHOLE_DOCUMENT || !1, _r = T.RETURN_DOM || !1, Ki = T.RETURN_DOM_FRAGMENT || !1, Qi = T.RETURN_TRUSTED_TYPE || !1, Fo = T.FORCE_BODY || !1, pl = T.SANITIZE_DOM !== !1, gl = T.SANITIZE_NAMED_PROPS || !1, Ao = T.KEEP_CONTENT !== !1, ri = T.IN_PLACE || !1, U = J0(T.ALLOWED_URI_REGEXP) ? T.ALLOWED_URI_REGEXP : $c, Br = typeof T.NAMESPACE == "string" ? T.NAMESPACE : _e, Oo = St(T, "MATHML_TEXT_INTEGRATION_POINTS") && T.MATHML_TEXT_INTEGRATION_POINTS && typeof T.MATHML_TEXT_INTEGRATION_POINTS == "object" ? te(T.MATHML_TEXT_INTEGRATION_POINTS) : lt({}, ["mi", "mo", "mn", "ms", "mtext"]), Do = St(T, "HTML_INTEGRATION_POINTS") && T.HTML_INTEGRATION_POINTS && typeof T.HTML_INTEGRATION_POINTS == "object" ? te(T.HTML_INTEGRATION_POINTS) : lt({}, ["annotation-xml"]);
    ...
    if (it = $r(null), St(q, "tagNameCheck") && bl(q.tagNameCheck) && (it.tagNameCheck = q.tagNameCheck), St(q, "attributeNameCheck") && bl(q.attributeNameCheck) && (it.attributeNameCheck = q.attributeNameCheck), St(q, "allowCustomizedBuiltInElements") && typeof q.allowCustomizedBuiltInElements == "boolean" && (it.allowCustomizedBuiltInElements = q.allowCustomizedBuiltInElements), se && (Ct = !1), Ki && (_r = !0), vr && (Q = lt({}, Vl), et = $r(null), vr.html === !0 && (lt(Q, Xl), lt(et, Zl)), vr.svg === !0 && (lt(Q, Uo), lt(et, jo), lt(et, rs)), vr.svgFilters === !0 && (lt(Q, Yo), lt(et, jo), lt(et, rs)), vr.mathMl === !0 && (lt(Q, Go), lt(et, Kl), lt(et, rs))), pt.tagCheck = null, pt.attributeCheck = null, St(T, "ADD_TAGS") && (typeof T.ADD_TAGS == "function" ? pt.tagCheck = T.ADD_TAGS : Gt(T.ADD_TAGS) && (Q === dt && (Q = te(Q)), lt(Q, T.ADD_TAGS, At))), St(T, "ADD_ATTR") && (typeof T.ADD_ATTR == "function" ? pt.attributeCheck = T.ADD_ATTR : Gt(T.ADD_ATTR) && (et === ut && (et = te(et)), lt(et, T.ADD_ATTR, At))), St(T, "ADD_URI_SAFE_ATTR") && Gt(T.ADD_URI_SAFE_ATTR) && lt(Mo, T.ADD_URI_SAFE_ATTR, At), St(T, "FORBID_CONTENTS") && Gt(T.FORBID_CONTENTS) && (Se === Eo && (Se = te(Se)), lt(Se, T.FORBID_CONTENTS, At)), St(T, "ADD_FORBID_CONTENTS") && Gt(T.ADD_FORBID_CONTENTS) && (Se === Eo && (Se = te(Se)), lt(Se, T.ADD_FORBID_CONTENTS, At)), Ao && (Q["#text"] = !0), ar && lt(Q, ["html", "head", "body"]), Q.table && (lt(Q, ["tbody"]), delete rt.tbody), T.TRUSTED_TYPES_POLICY) {
      ...
      w === void 0 && (w = uy(d, s)), w !== null && typeof S == "string" && (S = w.createHTML(""));
    Zt && Zt(T), Lr = T;
  }, kl = lt({}, [...Uo, ...Yo, ...ty]), Tl = lt({}, [...Go, ...ey]), s0 = function(T) {
    let q = k(T);
    (!q || !q.tagName) && (q = {
      namespaceURI: Br,
      tagName: "template"
    ...
    return Io[T.namespaceURI] ? T.namespaceURI === ts ? q.namespaceURI === _e ? X === "svg" : q.namespaceURI === Ji ? X === "svg" && (bt === "annotation-xml" || Oo[bt]) : !!kl[X] : T.namespaceURI === Ji ? q.namespaceURI === _e ? X === "math" : q.namespaceURI === ts ? X === "math" && Do[bt] : !!Tl[X] : T.namespaceURI === _e ? q.namespaceURI === ts && !Do[bt] || q.namespaceURI === Ji && !Oo[bt] ? !1 : !Tl[X] && (t0[X] || !kl[X]) : !!(ii === "application/xhtml+xml" && Io[T.namespaceURI]) : !1;
  }, de = function(T) {
    oi(t.removed, {
      element: T
    });
  ...
  const _l = function(T) {
    ...
    return T instanceof l && !s0(T) || (X === "noscript" || X === "noembed" || X === "noframes") && Dt(/<\/no(script|embed|frames)/i, T.innerHTML) ? (de(T), !0) : (se && T.nodeType === ni.text && (q = T.textContent, si([z, W, I], (bt) => {
      q = Fr(q, bt, " ");
    }), T.textContent !== q && (oi(t.removed, {
      element: T.cloneNode()
    }), T.textContent = q)), De($.afterSanitizeElements, T, null), !1);
  }, vl = function(T, q, X) {
    if (ht[q] || pl && (q === "id" || q === "name") && (X in r || X in i0))
      return !1;
    if (!(Ct && !ht[q] && Dt(F, q))) {
      if (!(xt && Dt(L, q))) {
        if (!(pt.attributeCheck instanceof Function && pt.attributeCheck(q, T))) {
          if (!et[q] || ht[q]) {
            ...
            if (!Dt(U, Fr(X, R, ""))) {
              if (!((q === "src" || q === "xlink:href" || q === "href") && T !== "script" && Yl(X, "data:") === 0 && yl[T])) {
                if (!(vt && !Dt(M, Fr(X, R, "")))) {
                  if (X)
                    return !1;
                }
    ...
    return !0;
  }, o0 = lt({}, ["annotation-xml", "color-profile", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "missing-glyph"]), Bl = function(T) {
    return !o0[yi(T)] && Dt(H, T);
  }, Ll = function(T) {
    ...
    for (; bt--; ) {
      ...
      let It = Bt === "value" ? qo : j0(qo);
      if (X.attrName = fe, X.attrValue = It, X.keepAttr = !0, X.forceKeepAttr = void 0, De($.uponSanitizeAttribute, T, X), It = X.attrValue, gl && (fe === "id" || fe === "name") && Yl(It, ml) !== 0 && (nr(Bt, T), It = ml + It), Oe && Dt(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, It)) {
        nr(Bt, T);
        continue;
      }
      if (fe === "attributename" && Ul(It, "href")) {
        nr(Bt, T);
        continue;
      }
      if (X.forceKeepAttr)
      ...
      if (It !== qo)
        try {
          Qt ? T.setAttributeNS(Qt, Bt, It) : T.setAttribute(Bt, It), Po(T) ? de(T) : Hl(t.removed);
        } catch {
          nr(Bt, T);
        }
    }
  ...
  return t.sanitize = function(J) {
    ...
    if ($o = !J, $o && (J = "<!-->"), typeof J != "string" && !No(J) && (J = Q0(J), typeof J != "string"))
    ...
    return ar && Q["!doctype"] && q.ownerDocument && q.ownerDocument.doctype && q.ownerDocument.doctype.name && Dt(Ic, q.ownerDocument.doctype.name) && (Qt = "<!DOCTYPE " + q.ownerDocument.doctype.name + `>
` + Qt), se && si([z, W, I], (ne) => {
      Qt = Fr(Qt, ne, " ");
...
var Ur = Oc(), Dc = /^-{3}\s*[\n\r](.*?)[\n\r]-{3}\s*[\n\r]+/s, vi = /%{2}{\s*(?:(\w+)\s*:|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, dy = /\s*%%.*\n/gm, Rc = class extends Error {
  ...
  e = e.replace(Dc, "").replace(vi, "").replace(dy, `
`);
  ...
  for (const { id: t, detector: r, loader: i } of e)
    Pc(t, r, i);
}, "registerLazyLoadedDiagrams"), Pc = /* @__PURE__ */ p((e, t, r) => {
...
}, "addDetector"), fy = /* @__PURE__ */ p((e) => yr[e].loader, "getDiagramLoader"), da = /* @__PURE__ */ p((e, t, { depth: r = 2, clobber: i = !1 } = {}) => {
...
}, "assignWithDepth"), Mt = da, Me = "#ffffff", $e = "#f2f2f2", at = /* @__PURE__ */ p((e, t) => t ? x(e, { s: -40, l: 10 }) : x(e, { s: -40, l: -10 }), "mkBorder"), py = class {
  static {
    p(this, "Theme");
  }
  constructor() {
  ...
  base: {
    getThemeVariables: gy
  },
  dark: {
    getThemeVariables: yy
  },
  default: {
    getThemeVariables: xy
  },
  forest: {
  ...
  "redux-dark": {
    getThemeVariables: Ey
  },
  "redux-color": {
    getThemeVariables: $y
  },
  "redux-dark-color": {
    getThemeVariables: Oy
  }
}, Yt = {
  flowchart: {
    useMaxWidth: !0,
...
}, qc = /* @__PURE__ */ p((e, t = "") => Object.keys(e).reduce((r, i) => Array.isArray(e[i]) ? r : typeof e[i] == "object" && e[i] !== null ? [...r, t + i, ...qc(e[i], "")] : [...r, t + i], []), "keyify"), Dy = new Set(qc(Nc, "")), Wc = Nc, Fs = /* @__PURE__ */ p((e) => {
  if (P.debug("sanitizeDirective called with", e), !(typeof e != "object" || e == null)) {
    ...
    for (const t of Object.keys(e)) {
      if (P.debug("Checking key", t), t.startsWith("__") || t.includes("proto") || t.includes("constr") || !Dy.has(t) || e[t] == null) {
      ...
      for (const i of r)
        t.includes(i) && (P.debug("sanitizing css option", t), e[t] = zc(e[t]));
    }
    if (e.themeVariables)
...
}, "sanitizeDirective"), zc = /* @__PURE__ */ p((e) => {
  let t = 0, r = 0;
  for (const i of e) {
    if (t < r)
...
}, "sanitizeCss"), Yr = Object.freeze(Wc), Ge = /* @__PURE__ */ p((e) => !(e === !1 || ["false", "null", "0"].includes(String(e).trim().toLowerCase())), "evaluate"), ee = Mt({}, Yr), As, Cr = [], Bi = Mt({}, Yr), ho = /* @__PURE__ */ p((e, t) => {
  let r = Mt({}, e), i = {};
  for (const s of t)
    Yc(s), i = Mt(i, s);
  ...
  return Bi = r, jc(Bi), Bi;
}, "updateCurrentConfig"), Ry = /* @__PURE__ */ p((e) => (ee = Mt({}, Yr), ee = Mt(ee, e), e.theme && We[e.theme] && (ee.themeVariables = We[e.theme].getThemeVariables(e.themeVariables)), ho(ee, Cr), ee), "setSiteConfig"), Py = /* @__PURE__ */ p((e) => {
  As = Mt({}, e);
}, "saveConfigFromInitialize"), Ny = /* @__PURE__ */ p((e) => (ee = Mt(ee, e), ho(ee, Cr), ee), "updateSiteConfig"), Hc = /* @__PURE__ */ p(() => Mt({}, ee), "getSiteConfig"), Uc = /* @__PURE__ */ p((e) => (jc(e), Mt(Bi, e), Tt()), "setConfig"), Tt = /* @__PURE__ */ p(() => Mt({}, Bi), "getConfig"), Yc = /* @__PURE__ */ p((e) => {
  ...
  th[e] || (P.warn(Wy[e]), th[e] = !0);
}, "issueWarning"), jc = /* @__PURE__ */ p((e) => {
  e && (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) && Gc("LAZY_LOAD_DEPRECATED");
}, "checkConfig"), mL = /* @__PURE__ */ p(() => {
  let e = {};
  As && (e = Mt(e, As));
  for (const t of Cr)
    e = Mt(e, t);
  return e;
}, "getUserDefinedConfig"), Kt = /* @__PURE__ */ p((e) => (e.flowchart?.htmlLabels != null && Gc("FLOWCHART_HTML_LABELS_DEPRECATED"), Ge(e.htmlLabels ?? e.flowchart?.htmlLabels ?? !0)), "getEffectiveHtmlLabels"), zi = /<br\s*\/?>/gi, zy = /* @__PURE__ */ p((e) => e ? Zc(e).replace(/\\n/g, "#br#").split("#br#") : [""], "getRows"), Hy = /* @__PURE__ */ (() => {
  let e = !1;
  return () => {
    e || (Xc(), e = !0);
  };
...
p(Xc, "setupDompurifyHooks");
var Vc = /* @__PURE__ */ p((e) => (Hy(), Ur.sanitize(e)), "removeScript"), eh = /* @__PURE__ */ p((e, t) => {
  if (Kt(t)) {
    const r = t.securityLevel;
    r === "antiscript" || r === "strict" || r === "sandbox" ? e = Vc(e) : r !== "loose" && (e = Zc(e), e = e.replace(/</g, "&lt;").replace(/>/g, "&gt;"), e = e.replace(/=/g, "&equals;"), e = jy(e));
  }
  return e;
}, "sanitizeMore"), ke = /* @__PURE__ */ p((e, t) => e && (t.dompurifyConfig ? e = Ur.sanitize(eh(e, t), t.dompurifyConfig).toString() : e = Ur.sanitize(eh(e, t), {
  FORBID_TAGS: ["style"]
}).toString(), e), "sanitizeText"), Uy = /* @__PURE__ */ p((e, t) => typeof e == "string" ? ke(e, t) : e.flat().map((r) => ke(r, t)), "sanitizeTextOrArray"), Yy = /* @__PURE__ */ p((e) => zi.test(e), "hasBreaks"), Gy = /* @__PURE__ */ p((e) => e.split(zi), "splitBreaks"), jy = /* @__PURE__ */ p((e) => e.replace(/#br#/g, "<br/>"), "placeholderToBreak"), Zc = /* @__PURE__ */ p((e) => e.replace(zi, "#br#"), "breakToPlaceholder"), Xy = /* @__PURE__ */ p((e) => {
  let t = "";
...
}, "getUrl"), Vy = /* @__PURE__ */ p(function(...e) {
  const t = e.filter((r) => !isNaN(r));
  return Math.max(...t);
}, "getMax"), Zy = /* @__PURE__ */ p(function(...e) {
  const t = e.filter((r) => !isNaN(r));
  return Math.min(...t);
}, "getMin"), rh = /* @__PURE__ */ p(function(e) {
  const t = e.split(/(,)/), r = [];
  for (let i = 0; i < t.length; i++) {
    let s = t[i];
    if (s === "," && i > 0 && i + 1 < t.length) {
      const o = t[i - 1], a = t[i + 1];
      Ky(o, a) && (s = o + "," + a, i++, r.pop());
    }
    r.push(Qy(s));
  }
  return r.join("");
}, "parseGenericTypes"), fa = /* @__PURE__ */ p((e, t) => Math.max(0, e.split(t).length - 1), "countOccurrence"), Ky = /* @__PURE__ */ p((e, t) => {
  const r = fa(e, "~"), i = fa(t, "~");
  return r === 1 && i === 1;
}, "shouldCombineSets"), Qy = /* @__PURE__ */ p((e) => {
  const t = fa(e, "~");
  let r = !1;
  if (t <= 1)
    return e;
...
}, "processSet"), ih = /* @__PURE__ */ p(() => window.MathMLElement !== void 0, "isMathMLSupported"), pa = /\$\$(.*)\$\$/g, Ai = /* @__PURE__ */ p((e) => (e.match(pa)?.length ?? 0) > 0, "hasKatex"), yL = /* @__PURE__ */ p(async (e, t) => {
  const r = document.createElement("div");
  r.innerHTML = await Kc(e, t), r.id = "katex-temp", r.style.visibility = "hidden", r.style.position = "absolute", r.style.top = "0", document.querySelector("body")?.insertAdjacentElement("beforeend", r);
  const s = { width: r.clientWidth, height: r.clientHeight };
  return r.remove(), s;
}, "calculateMathMLDimensions"), Jy = /* @__PURE__ */ p(async (e, t) => {
  if (!Ai(e))
    return e;
  if (!(ih() || t.legacyMathML || t.forceLegacyMathML))
    return e.replace(pa, "MathML is unsupported in this environment.");
  {
    const { default: r } = await import("./katex-D3uLT2GX.js"), i = t.forceLegacyMathML || !ih() && t.legacyMathML ? "htmlAndMathml" : "mathml";
...
}, "renderKatexUnsanitized"), Kc = /* @__PURE__ */ p(async (e, t) => ke(await Jy(e, t), t), "renderKatexSanitized"), Hi = {
  getRows: zy,
  sanitizeText: ke,
  sanitizeTextOrArray: Uy,
  hasBreaks: Yy,
  splitBreaks: Gy,
  lineBreakRegex: zi,
  removeScript: Vc,
  ...
  getMax: Vy,
  getMin: Zy
}, tC = /* @__PURE__ */ p(function(e, t) {
  for (let r of t)
    e.attr(r[0], r[1]);
}, "d3Attrs"), eC = /* @__PURE__ */ p(function(e, t, r) {
  let i = /* @__PURE__ */ new Map();
  return r ? (i.set("width", "100%"), i.set("style", `max-width: ${t}px;`)) : (i.set("height", e), i.set("width", t)), i;
}, "calculateSvgSizeAttrs"), Qc = /* @__PURE__ */ p(function(e, t, r, i) {
  const s = eC(t, r, i);
  tC(e, s);
}, "configureSvgSize"), rC = /* @__PURE__ */ p(function(e, t, r, i) {
  const s = t.node().getBBox(), o = s.width, a = s.height;
  P.info(`SVG bounds: ${o}x${a}`, s);
  let n = 0, l = 0;
  P.info(`Graph bounds: ${n}x${l}`, e), n = o + r * 2, l = a + r * 2, P.info(`Calculated bounds: ${n}x${l}`), Qc(t, l, n, i);
...
var iC = /* @__PURE__ */ p((e, t, r, i) => {
  ...
  ${t}
`;
}, "getStyles"), sC = /* @__PURE__ */ p((e, t) => {
  t !== void 0 && (ms[e] = t);
}, "addStylesForDiagram"), oC = iC, Jc = {};
I0(Jc, {
  clear: () => aC,
  getAccDescription: () => cC,
  getAccTitle: () => lC,
  getDiagramTitle: () => dC,
  setAccDescription: () => hC,
  setAccTitle: () => nC,
  setDiagramTitle: () => uC
});
var un = "", dn = "", fn = "", pn = /* @__PURE__ */ p((e) => ke(e, Tt()), "sanitizeText"), aC = /* @__PURE__ */ p(() => {
  un = "", fn = "", dn = "";
}, "clear"), nC = /* @__PURE__ */ p((e) => {
  un = pn(e).replace(/^\s+/g, "");
}, "setAccTitle"), lC = /* @__PURE__ */ p(() => un, "getAccTitle"), hC = /* @__PURE__ */ p((e) => {
  fn = pn(e).replace(/\n\s+/g, `
`);
}, "setAccDescription"), cC = /* @__PURE__ */ p(() => fn, "getAccDescription"), uC = /* @__PURE__ */ p((e) => {
  dn = pn(e);
}, "setDiagramTitle"), dC = /* @__PURE__ */ p(() => dn, "getDiagramTitle"), sh = P, fC = hn, gt = Tt, CL = Uc, xL = Yr, gn = /* @__PURE__ */ p((e) => ke(e, gt()), "sanitizeText"), pC = rC, gC = /* @__PURE__ */ p(() => Jc, "getCommonDb"), Ms = {}, $s = /* @__PURE__ */ p((e, t, r) => {
  Ms[e] && sh.warn(`Diagram with id ${e} already registered. Overwriting.`), Ms[e] = t, r && Pc(e, r), sC(e, t.styles), t.injectUtils?.(
    sh,
    fC,
    gt,
    gn,
  ...
  if (e in Ms)
    return Ms[e];
  throw new mC(e);
}, "getDiagram"), mC = class extends Error {
  static {
...
ys.prototype = tu.prototype = {
  constructor: ys,
  on: function(e, t) {
    var r = this._, i = CC(e + "", r), s, o = -1, a = i.length;
    if (arguments.length < 2) {
      for (; ++o < a; ) if ((s = (e = i[o]).type) && (s = xC(r[s], e.name))) return s;
      return;
    }
    if (t != null && typeof t != "function") throw new Error("invalid callback: " + t);
    for (; ++o < a; )
      if (s = (e = i[o]).type) r[s] = oh(r[s], e.name, t);
      else if (t == null) for (s in r) r[s] = oh(r[s], e.name, null);
    return this;
  },
  copy: function() {
    var e = {}, t = this._;
...
function oh(e, t, r) {
  for (var i = 0, s = e.length; i < s; ++i)
    if (e[i].name === t) {
      e[i] = yC, e = e.slice(0, i).concat(e.slice(i + 1));
      break;
    }
...
function co(e) {
  var t = e += "", r = t.indexOf(":");
  return r >= 0 && (t = e.slice(0, r)) !== "xmlns" && (e = e.slice(r + 1)), ah.hasOwnProperty(t) ? { space: ah[t], local: e } : e;
}
function bC(e) {
  return function() {
...
function BC(e) {
  typeof e == "function" ? e = vC(e) : e = ru(e);
...
function EC(e) {
  return this.select(e == null ? AC : FC(typeof e == "function" ? e : su(e)));
}
...
function OC(e) {
  return this.selectAll(e == null ? $C : IC(typeof e == "function" ? e : su(e)));
}
function DC(e) {
...
function RC() {
  return new ae(this._enter || this._groups.map(ou), this._parents);
}
function Is(e, t) {
...
function zC(e, t) {
  ...
  var r = t ? qC : NC, i = this._parents, s = this._groups;
  typeof e != "function" && (e = PC(e));
  for (var o = s.length, a = new Array(o), n = new Array(o), l = new Array(o), c = 0; c < o; ++c) {
    var h = i[c], u = s[c], f = u.length, d = HC(e.call(h, h && h.__data__, c, i)), g = d.length, m = n[c] = new Array(g), y = a[c] = new Array(g), C = l[c] = new Array(f);
    r(h, u, m, y, C, d, t);
...
function UC() {
  return new ae(this._exit || this._groups.map(ou), this._parents);
}
function YC(e, t, r) {
...
function dx(e, t, r) {
  return arguments.length > 1 ? this.each((t == null ? hx : typeof t == "function" ? ux : cx)(e, t, r ?? "")) : Gr(this.node(), e);
}
function Gr(e, t) {
  return e.style.getPropertyValue(t) || au(e).getComputedStyle(e, null).getPropertyValue(t);
}
function fx(e) {
  return function() {
    delete this[e];
...
function xx(e, t) {
  return function() {
    (t.apply(this, arguments) ? hu : cu)(this, e);
  };
}
function bx(e, t) {
  var r = nu(e + "");
  ...
  return this.each((typeof t == "function" ? xx : t ? yx : Cx)(r, t));
}
function kx() {
  this.textContent = "";
}
...
function Sx(e) {
  return arguments.length ? this.each(e == null ? kx : (typeof e == "function" ? wx : Tx)(e)) : this.node().textContent;
}
function _x() {
  this.innerHTML = "";
}
...
function Lx(e) {
  return arguments.length ? this.each(e == null ? _x : (typeof e == "function" ? Bx : vx)(e)) : this.node().innerHTML;
}
function Fx() {
...
function Ox(e, t) {
  var r = typeof e == "function" ? e : eu(e), i = t == null ? Ix : typeof t == "function" ? t : mn(t);
  return this.select(function() {
...
function Gx(e, t, r) {
  ...
  for (n = t ? Yx : Ux, s = 0; s < o; ++s) this.each(n(i[s], t, r));
  return this;
}
function uu(e, t, r) {
  var i = au(e), s = i.CustomEvent;
...
function Vx(e, t) {
  return this.each((typeof t == "function" ? Xx : jx)(e, t));
}
function* Zx() {
  for (var e = this._groups, t = 0, r = e.length; t < r; ++t)
...
function Ui() {
  return new ae([[document.documentElement]], du);
}
function Kx() {
  return this;
}
...
function ct(e) {
  return typeof e == "string" ? new ae([[document.querySelector(e)]], [document.documentElement]) : new ae([[e]], du);
}
function Cn(e, t, r) {
...
var Ei = 0.7, Os = 1 / Ei, zr = "\\s*([+-]?\\d+)\\s*", Mi = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Fe = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Qx = /^#([0-9a-f]{3,8})$/, Jx = new RegExp(`^rgb\\(${zr},${zr},${zr}\\)$`), tb = new RegExp(`^rgb\\(${Fe},${Fe},${Fe}\\)$`), eb = new RegExp(`^rgba\\(${zr},${zr},${zr},${Mi}\\)$`), rb = new RegExp(`^rgba\\(${Fe},${Fe},${Fe},${Mi}\\)$`), ib = new RegExp(`^hsl\\(${Mi},${Fe},${Fe}\\)$`), sb = new RegExp(`^hsla\\(${Mi},${Fe},${Fe},${Mi}\\)$`), nh = {
  aliceblue: 15792383,
...
function $i(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = Qx.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? ch(t) : r === 3 ? new ie(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? is(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? is(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = Jx.exec(e)) ? new ie(t[1], t[2], t[3], 1) : (t = tb.exec(e)) ? new ie(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = eb.exec(e)) ? is(t[1], t[2], t[3], t[4]) : (t = rb.exec(e)) ? is(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = ib.exec(e)) ? fh(t[1], t[2] / 100, t[3] / 100, 1) : (t = sb.exec(e)) ? fh(t[1], t[2] / 100, t[3] / 100, t[4]) : nh.hasOwnProperty(e) ? ch(nh[e]) : e === "transparent" ? new ie(NaN, NaN, NaN, 0) : null;
}
function ch(e) {
...
function Ca(e, t, r, i) {
  return arguments.length === 1 ? nb(e) : new ie(e, t, r, i ?? 1);
}
function ie(e, t, r, i) {
...
function hb(e, t, r, i) {
  return arguments.length === 1 ? pu(e) : new ye(e, t, r, i ?? 1);
}
function ye(e, t, r, i) {
...
Cn(ye, hb, fu(Yi, {
  ...
  clamp() {
    return new ye(ph(this.h), ss(this.s), ss(this.l), Ds(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = Ds(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${ph(this.h)}, ${ss(this.s) * 100}%, ${ss(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function ph(e) {
...
function bL(e, t) {
  var r = t - e;
  return r ? gu(e, r > 180 || r < -180 ? r - 360 * Math.round(r / 360) : r) : xn(isNaN(e) ? t : e);
}
function ub(e) {
  return (e = +e) == 1 ? mu : function(t, r) {
    return r - t ? cb(t, r, e) : xn(isNaN(t) ? r : t);
  };
}
function mu(e, t) {
  var r = t - e;
  return r ? gu(e, r) : xn(isNaN(e) ? t : e);
}
const gh = (function e(t) {
  var r = ub(t);
  function i(s, o) {
    var a = r((s = Ca(s)).r, (o = Ca(o)).r), n = r(s.g, o.g), l = r(s.b, o.b), c = mu(s.opacity, o.opacity);
    return function(h) {
...
function pb(e, t) {
  ...
  return r < t.length && (o = t.slice(r), n[a] ? n[a] += o : n[++a] = o), n.length < 2 ? l[0] ? fb(l[0].x) : db(t) : (t = l.length, function(c) {
    for (var h = 0, u; h < t; ++h) n[(u = l[h]).i] = u.x(c);
    return n.join("");
  });
}
var mh = 180 / Math.PI, ba = {
  translateX: 0,
  translateY: 0,
  rotate: 0,
  skewX: 0,
...
function gb(e) {
  ...
  return t.isIdentity ? ba : yu(t.a, t.b, t.c, t.d, t.e, t.f);
}
function mb(e) {
  return e == null || (os || (os = document.createElementNS("http://www.w3.org/2000/svg", "g")), os.setAttribute("transform", e), !(e = os.transform.baseVal.consolidate())) ? ba : (e = e.matrix, yu(e.a, e.b, e.c, e.d, e.e, e.f));
}
function Cu(e, t, r, i) {
  function s(c) {
...
var yb = Cu(gb, "px, ", "px)", "deg)"), Cb = Cu(mb, ", ", ")", ")"), jr = 0, Ci = 0, li = 0, xu = 1e3, Rs, xi, Ps = 0, xr = 0, uo = 0, Ii = typeof performance == "object" && performance.now ? performance : Date, bu = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function bn() {
  return xr || (bu(xb), xr = Ii.now() + uo);
}
function xb() {
  xr = 0;
}
...
function ka(e) {
  if (!jr) {
    ...
    var t = e - xr;
    t > 24 ? (e < 1 / 0 && (Ci = setTimeout(yh, e - Ii.now() - uo)), li && (li = clearInterval(li))) : (li || (Ps = Ii.now(), li = setInterval(kb, xu)), jr = 1, bu(yh));
  }
}
function Ch(e, t, r) {
  var i = new Ns();
...
var wb = tu("start", "end", "cancel", "interrupt"), Sb = [], Tu = 0, xh = 1, Ta = 2, Cs = 3, bh = 4, wa = 5, xs = 6;
...
function _b(e, t, r) {
  ...
  i[t] = r, r.timer = ku(o, 0, r.time);
  function o(c) {
    r.state = xh, r.timer.restart(a, r.delay, r.time), r.delay <= c && a(c - r.delay);
  }
  function a(c) {
    var h, u, f, d;
    if (r.state !== xh) return l();
    for (h in i)
      if (d = i[h], d.name === r.name) {
        if (d.state === Cs) return Ch(a);
        d.state === bh ? (d.state = xs, d.timer.stop(), d.on.call("interrupt", e, e.__data__, d.index, d.group), delete i[h]) : +h < t && (d.state = xs, d.timer.stop(), d.on.call("cancel", e, e.__data__, d.index, d.group), delete i[h]);
      }
    if (Ch(function() {
      r.state === Cs && (r.state = bh, r.timer.restart(n, r.delay, r.time), n(c));
...
function Ab(e, t) {
  ...
  return this.each((t == null ? Lb : Fb)(r, e, t));
}
function Tn(e, t, r) {
  var i = e._id;
...
function wu(e, t) {
  var r;
  return (typeof t == "number" ? Ze : t instanceof $i ? gh : (r = $i(t)) ? (t = r, gh) : pb)(e, t);
}
function Eb(e) {
  return function() {
    this.removeAttribute(e);
...
function Rb(e, t) {
  var r = co(e), i = r === "transform" ? Cb : wu;
  return this.attrTween(e, typeof t == "function" ? (r.local ? Db : Ob)(r, i, Tn(this, "attr." + e, t)) : t == null ? (r.local ? Mb : Eb)(r) : (r.local ? Ib : $b)(r, i, t));
}
function Pb(e, t) {
  return function(r) {
...
function zb(e, t) {
  ...
  var i = co(e);
  return this.tween(r, (i.local ? qb : Wb)(i, t));
}
function Hb(e, t) {
  return function() {
...
function Yb(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? Hb : Ub)(t, e)) : we(this.node(), t).delay;
}
function Gb(e, t) {
  return function() {
...
function Xb(e) {
  var t = this._id;
  return arguments.length ? this.each((typeof e == "function" ? Gb : jb)(t, e)) : we(this.node(), t).duration;
}
function Vb(e, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function Zb(e) {
  var t = this._id;
  return arguments.length ? this.each(Vb(t, e)) : we(this.node(), t).ease;
}
function Kb(e, t) {
  return function() {
    var r = t.apply(this, arguments);
...
function Qb(e) {
  ...
  return this.each(Kb(this._id, e));
}
function Jb(e) {
  typeof e != "function" && (e = iu(e));
  for (var t = this._groups, r = t.length, i = new Array(r), s = 0; s < r; ++s)
...
function i1(e, t) {
  var r = this._id;
  return arguments.length < 2 ? we(this.node(), r).on.on(e) : this.each(r1(r, e, t));
}
function s1(e) {
  return function() {
...
var l1 = Ui.prototype.constructor;
function h1() {
...
function f1(e, t) {
  ...
  return function() {
    var l = Ie(this, e), c = l.on, h = l.value[o] == null ? n || (n = Su(t)) : void 0;
    (c !== r || s !== h) && (i = (r = c).copy()).on(a, s = h), l.on = i;
  };
}
function p1(e, t, r) {
  var i = (e += "") == "transform" ? yb : wu;
  return t == null ? this.styleTween(e, c1(e, i)).on("end.style." + e, Su(e)) : typeof t == "function" ? this.styleTween(e, d1(e, i, Tn(this, "style." + e, t))).each(f1(this._id, e)) : this.styleTween(e, u1(e, i, t), r).on("end.style." + e, null);
}
function g1(e, t, r) {
  return function(i) {
...
function b1(e) {
  return this.tween("text", typeof e == "function" ? x1(Tn(this, "text", e)) : C1(e == null ? "" : e + ""));
}
function k1(e) {
  return function(t) {
...
function w1(e) {
  ...
  if (typeof e != "function") throw new Error();
  return this.tween(t, T1(e));
}
function S1() {
  for (var e = this._name, t = this._id, r = _u(), i = this._groups, s = i.length, o = 0; o < s; ++o)
...
function A1(e) {
  var t, r;
  e instanceof He ? (t = e._id, e = e._name) : (t = _u(), (r = L1).time = bn(), e = e == null ? null : e + "");
  for (var i = this._groups, s = i.length, o = 0; o < s; ++o)
    for (var a = i[o], n = a.length, l, c = 0; c < n; ++c)
      (l = a[c]) && fo(l, e, t, c, a, r || F1(l, t));
  return new He(i, this._parents, e, t);
}
Ui.prototype.interrupt = Bb;
Ui.prototype.transition = A1;
const Sa = Math.PI, _a = 2 * Sa, cr = 1e-6, E1 = _a - cr;
function vu(e) {
  this._ += e[0];
...
class $1 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? vu : M1(t);
  }
  moveTo(t, r) {
  ...
  arc(t, r, i, s, o, a) {
    ...
    this._x1 === null ? this._append`M${c},${h}` : (Math.abs(this._x1 - c) > cr || Math.abs(this._y1 - h) > cr) && this._append`L${c},${h}`, i && (f < 0 && (f = f % _a + _a), f > E1 ? this._append`A${i},${i},0,1,${u},${t - n},${r - l}A${i},${i},0,1,${u},${this._x1 = c},${this._y1 = h}` : f > cr && this._append`A${i},${i},0,${+(f >= Sa)},${u},${this._x1 = t + i * Math.cos(o)},${this._y1 = r + i * Math.sin(o)}`);
  }
  rect(t, r, i, s) {
...
const kL = Math.abs, TL = Math.atan2, wL = Math.cos, SL = Math.max, _L = Math.min, vL = Math.sin, BL = Math.sqrt, kh = 1e-12, wn = Math.PI, Th = wn / 2, LL = 2 * wn;
function FL(e) {
  return e > 1 ? 0 : e < -1 ? wn : Math.acos(e);
}
function AL(e) {
  return e >= 1 ? Th : e <= -1 ? -Th : Math.asin(e);
}
function I1(e) {
  let t = 3;
...
function P1(e, t) {
  var r = Ar(!0), i = null, s = Li, o = null, a = I1(n);
  e = typeof e == "function" ? e : e === void 0 ? D1 : Ar(e), t = typeof t == "function" ? t : t === void 0 ? R1 : Ar(t);
  function n(l) {
    var c, h = (l = O1(l)).length, u, f = !1, d;
...
const Du = (function e(t) {
  function r(i) {
    return t ? new Ou(i, t) : new Sn(i, 0);
  }
...
const U1 = (function e(t) {
  function r(i) {
    return t ? new Ru(i, t) : new _n(i, 0);
  }
  return r.alpha = function(i) {
    return e(+i);
  }, r;
...
const Y1 = (function e(t) {
  function r(i) {
    return t ? new Pu(i, t) : new vn(i, 0);
  }
  return r.alpha = function(i) {
    return e(+i);
  }, r;
...
function Sh(e, t, r) {
  ...
  return (wh(o) + wh(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(n)) || 0;
}
function _h(e, t) {
  var r = e._x1 - e._x0;
  ...
  lineEnd: function() {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        Zo(this, this._t0, _h(this, this._t0));
        break;
    }
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  },
    ...
    if (e = +e, t = +t, !(e === this._x1 && t === this._y1)) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          this._point = 3, Zo(this, _h(this, r = Sh(this, e, t)), r);
          break;
        default:
          Zo(this, this._t0, r = Sh(this, e, t));
          break;
      }
  ...
  lineEnd: function() {
    ...
    if (r)
      if (this._line ? this._context.lineTo(e[0], t[0]) : this._context.moveTo(e[0], t[0]), r === 2)
        ...
        for (var i = vh(e), s = vh(t), o = 0, a = 1; a < r; ++o, ++a)
...
p(Ju, "isNegativeZero");
var X1 = Ln, V1 = Vu, Z1 = Zu, K1 = Qu, Q1 = Ju, J1 = Ku, $t = {
  isNothing: X1,
  isObject: V1,
  toArray: Z1,
  repeat: K1,
...
function rd(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    ...
    return r;
  }, this.instanceOf = t.instanceOf || null, this.predicate = t.predicate || null, this.represent = t.represent || null, this.representName = t.representName || null, this.defaultStyle = t.defaultStyle || null, this.multi = t.multi || !1, this.styleAliases = ed(t.styleAliases || null), rk.indexOf(this.kind) === -1)
...
Hs.prototype.extend = /* @__PURE__ */ p(function(t) {
  ...
  return s.implicit = (this.implicit || []).concat(r), s.explicit = (this.explicit || []).concat(i), s.compiledImplicit = Ba(s, "implicit"), s.compiledExplicit = Ba(s, "explicit"), s.compiledTypeMap = id(s.compiledImplicit, s.compiledExplicit), s;
}, "extend");
var ik = Hs, sk = new Ht("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: /* @__PURE__ */ p(function(e) {
    return e !== null ? e : "";
  }, "construct")
}), ok = new Ht("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: /* @__PURE__ */ p(function(e) {
    return e !== null ? e : [];
  }, "construct")
}), ak = new Ht("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: /* @__PURE__ */ p(function(e) {
    return e !== null ? e : {};
  }, "construct")
...
p(sd, "resolveYamlNull");
function od() {
  return null;
}
p(od, "constructYamlNull");
function ad(e) {
  return e === null;
}
p(ad, "isNull");
var lk = new Ht("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: sd,
  construct: od,
  predicate: ad,
...
p(nd, "resolveYamlBoolean");
function ld(e) {
  return e === "true" || e === "True" || e === "TRUE";
}
p(ld, "constructYamlBoolean");
function hd(e) {
  return Object.prototype.toString.call(e) === "[object Boolean]";
}
p(hd, "isBoolean");
var hk = new Ht("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: nd,
  construct: ld,
  predicate: hd,
...
function md(e) {
  return !(e === null || !uk.test(e) || // Quick hack to not allow integers end with `_`
  // Probably should update regexp & check speed
  e[e.length - 1] === "_");
}
p(md, "resolveYamlFloat");
function yd(e) {
  var t, r;
  return t = e.replace(/_/g, "").toLowerCase(), r = t[0] === "-" ? -1 : 1, "+-".indexOf(t[0]) >= 0 && (t = t.slice(1)), t === ".inf" ? r === 1 ? Number.POSITIVE_INFINITY : Number.NEGATIVE_INFINITY : t === ".nan" ? NaN : r * parseFloat(t, 10);
}
p(yd, "constructYamlFloat");
var dk = /^[-+]?[0-9]+e/;
function Cd(e, t) {
  var r;
  if (isNaN(e))
    ...
    return "-0.0";
  return r = e.toString(10), dk.test(r) ? r.replace("e", ".e") : r;
}
p(Cd, "representYamlFloat");
function xd(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && (e % 1 !== 0 || $t.isNegativeZero(e));
}
p(xd, "isFloat");
...
function wd(e) {
  return e === null ? !1 : kd.exec(e) !== null || Td.exec(e) !== null;
}
p(wd, "resolveYamlTimestamp");
function Sd(e) {
  var t, r, i, s, o, a, n, l = 0, c = null, h, u, f;
  if (t = kd.exec(e), t === null && (t = Td.exec(e)), t === null) throw new Error("Date resolve error");
...
p(Sd, "constructYamlTimestamp");
function _d(e) {
  return e.toISOString();
}
p(_d, "representYamlTimestamp");
var gk = new Ht("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: wd,
  construct: Sd,
  instanceOf: Date,
...
p(vd, "resolveYamlMerge");
var mk = new Ht("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: vd
...
p(Fd, "representYamlBinary");
function Ad(e) {
  return Object.prototype.toString.call(e) === "[object Uint8Array]";
}
p(Ad, "isBinary");
var yk = new Ht("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Bd,
  construct: Ld,
  predicate: Ad,
  represent: Fd
}), Ck = Object.prototype.hasOwnProperty, xk = Object.prototype.toString;
function Ed(e) {
  if (e === null) return !0;
  var t = [], r, i, s, o, a, n = e;
  for (r = 0, i = n.length; r < i; r += 1) {
    if (s = n[r], a = !1, xk.call(s) !== "[object Object]") return !1;
    for (o in s)
      if (Ck.call(s, o))
        if (!a) a = !0;
        else return !1;
...
p(Ed, "resolveYamlOmap");
function Md(e) {
  return e !== null ? e : [];
}
p(Md, "constructYamlOmap");
var bk = new Ht("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: Ed,
  construct: Md
...
function $d(e) {
  ...
  for (o = new Array(a.length), t = 0, r = a.length; t < r; t += 1) {
    if (i = a[t], kk.call(i) !== "[object Object]" || (s = Object.keys(i), s.length !== 1)) return !1;
    o[t] = [s[0], i[s[0]]];
  }
  return !0;
}
p($d, "resolveYamlPairs");
function Id(e) {
  if (e === null) return [];
  var t, r, i, s, o, a = e;
  for (o = new Array(a.length), t = 0, r = a.length; t < r; t += 1)
...
p(Id, "constructYamlPairs");
var Tk = new Ht("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: $d,
  construct: Id
...
p(Dd, "constructYamlSet");
var Sk = new Ht("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: Od,
  construct: Dd
}), Rd = pk.extend({
...
}), rr = Object.prototype.hasOwnProperty, Us = 1, Pd = 2, Nd = 3, Ys = 4, Ko = 1, _k = 2, Bh = 3, vk = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Bk = /[\x85\u2028\u2029]/, Lk = /[,\[\]\{\}]/, qd = /^(?:!|!!|![a-z\-]+!)$/i, Wd = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function La(e) {
...
p(En, "setProperty");
var Gd = new Array(256), jd = new Array(256);
for (lr = 0; lr < 256; lr++)
  Gd[lr] = Fa(lr) ? 1 : 0, jd[lr] = Fa(lr);
var lr;
function Xd(e, t) {
...
function Mn(e, t) {
  ...
  return r.snippet = tk(r), new re(t, r);
}
p(Mn, "generateError");
function K(e, t) {
  throw Mn(e, t);
...
var Lh = {
  ...
  TAG: /* @__PURE__ */ p(function(t, r, i) {
    var s, o;
    i.length !== 2 && K(t, "TAG directive accepts exactly two arguments"), s = i[0], o = i[1], qd.test(s) || K(t, "ill-formed tag handle (first argument) of the TAG directive"), rr.call(t.tagMap, s) && K(t, 'there is a previously declared suffix for "' + s + '" tag handle'), Wd.test(o) || K(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function ze(e, t, r, i) {
  ...
  if (t < r) {
    ...
    else vk.test(n) && K(e, "the stream contains non-printable characters");
    e.result += n;
  }
}
p(ze, "captureSegment");
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = i = e.position; (n = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (n === 92) {
      if (ze(e, r, e.position, !0), n = e.input.charCodeAt(++e.position), xe(n))
        ...
        e.result += jd[n], e.position++;
      else if ((a = Hd(n)) > 0) {
        for (s = a, o = 0; s > 0; s--)
          n = e.input.charCodeAt(++e.position), (a = zd(n)) >= 0 ? o = (o << 4) + a : K(e, "expected hexadecimal character");
        e.result += Yd(o), e.position++;
      } else
...
function Jd(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      Ko === s ? s = u === 43 ? Bh : _k : K(e, "repeat of a chomping mode identifier");
    else if ((h = Ud(u)) >= 0)
...
function Ea(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, K(e, "tab characters must not be used in indentation")), !(l !== 45 || (a = e.input.charCodeAt(e.position + 1), !Xt(a)))); ) {
    ...
    if (r = e.line, br(e, t, Nd, !1, !0), o.push(e.result), _t(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
function tf(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), b = e.input.charCodeAt(e.position); b !== 0; ) {
    if (!y && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, K(e, "tab characters must not be used in indentation")), i = e.input.charCodeAt(e.position + 1), o = e.line, (b === 63 || b === 58) && Xt(i))
      ...
      if (a = e.line, n = e.lineStart, l = e.position, !br(e, r, Pd, !1, !0))
        break;
      if (e.line === o) {
...
function ef(e) {
  ...
  if (e.tag !== null && K(e, "duplication of a tag property"), a = e.input.charCodeAt(++e.position), a === 60 ? (r = !0, a = e.input.charCodeAt(++e.position)) : a === 33 ? (i = !0, s = "!!", a = e.input.charCodeAt(++e.position)) : s = "!", t = e.position, r) {
    ...
    o = e.input.slice(t, e.position), Lk.test(o) && K(e, "tag suffix cannot contain flow indicator characters");
  }
  o && !Wd.test(o) && K(e, "tag name cannot contain such characters: " + o);
  try {
    o = decodeURIComponent(o);
  } catch {
...
function br(e, t, r, i, s) {
  ...
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, o = a = n = Ys === r || Nd === r, i && _t(e, !0, -1) && (c = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; ef(e) || rf(e); )
      _t(e, !0, -1) ? (c = !0, n = o, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : n = !1;
  if (n && (n = c || s), (l === 1 || Ys === r) && (Us === r || Pd === r ? m = t : m = t + 1, y = e.position - e.lineStart, l === 1 ? n && (Ea(e, y) || tf(e, y, m)) || Qd(e, m) ? h = !0 : (a && Jd(e, m) || Zd(e, m) || Kd(e, m) ? h = !0 : sf(e) ? (h = !0, (e.tag !== null || e.anchor !== null) && K(e, "alias node should not have any properties")) : Vd(e, m, Us === r) && (h = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (h = n && Ea(e, y))), e.tag === null)
...
function of(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (a = e.input.charCodeAt(e.position)) !== 0 && (_t(e, !0, -1), a = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || a !== 37)); ) {
    ...
    a !== 0 && mo(e), rr.call(Lh, i) ? Lh[i](e, i, s) : Oi(e, 'unknown document directive "' + i + '"');
  }
  if (_t(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, _t(e, !0, -1)) : o && K(e, "directives end mark is expected"), br(e, e.lineIndent - 1, Ys, !1, !0), _t(e, !0, -1), e.checkLineBreaks && Bk.test(e.input.slice(t, e.position)) && Oi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Gi(e)) {
...
`), e.charCodeAt(0) === 65279 && (e = e.slice(1)));
  var r = new Xd(e, t), i = e.indexOf("\0");
...
var Ak = af, Ek = {
  load: Ak
}, nf = Object.prototype.toString, lf = Object.prototype.hasOwnProperty, In = 65279, Mk = 9, Di = 10, $k = 13, Ik = 32, Ok = 33, Dk = 34, Ma = 35, Rk = 37, Pk = 38, Nk = 39, qk = 42, hf = 44, Wk = 45, Gs = 58, zk = 61, Hk = 62, Uk = 63, Yk = 64, cf = 91, uf = 93, Gk = 96, df = 123, jk = 124, ff = 125, Ut = {};
Ut[0] = "\\0";
Ut[7] = "\\a";
Ut[8] = "\\b";
Ut[9] = "\\t";
...
function pf(e, t) {
  ...
  for (r = {}, i = Object.keys(t), s = 0, o = i.length; s < o; s += 1)
    a = i[s], n = String(t[a]), a.slice(0, 2) === "!!" && (a = "tag:yaml.org,2002:" + a.slice(2)), l = e.compiledTypeMap.fallback[a], l && lf.call(l.styleAliases, n) && (n = l.styleAliases[n]), r[a] = n;
  return r;
}
p(pf, "compileStyleMap");
function gf(e) {
  var t, r, i;
...
var Zk = 1, Ri = 2;
function mf(e) {
  this.schema = e.schema || Rd, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = $t.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = pf(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? Ri : Zk, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
p(mf, "State");
function $a(e, t) {
...
function Oa(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      i
    ) : i && e !== hf && e !== cf && e !== uf && e !== df && e !== ff) && e !== Ma && !(t === Gs && !s) || Ia(t) && !Pi(t) && e === Ma || t === Gs && s
  );
}
p(Oa, "isPlainSafe");
function Cf(e) {
  return Vr(e) && e !== In && !Pi(e) && e !== Wk && e !== Uk && e !== Gs && e !== hf && e !== cf && e !== uf && e !== df && e !== ff && e !== Ma && e !== Pk && e !== qk && e !== Ok && e !== jk && e !== zk && e !== Hk && e !== Nk && e !== Dk && e !== Rk && e !== Yk && e !== Gk;
}
p(Cf, "isPlainSafeFirst");
function xf(e) {
  return !Pi(e) && e !== Gs;
}
p(xf, "isPlainSafeLast");
function Nr(e, t) {
...
var bf = 1, Da = 2, kf = 3, Tf = 4, Or = 5;
function wf(e, t, r, i, s, o, a, n) {
  var l, c = 0, h = null, u = !1, f = !1, d = i !== -1, g = -1, m = Cf(Nr(e, 0)) && xf(Nr(e, e.length - 1));
  if (t || a)
  ...
  return !u && !f ? m && !a && !s(e) ? bf : o === Ri ? Or : Da : r > 9 && On(e) ? Or : a ? o === Ri ? Or : Da : f ? Tf : kf;
}
p(wf, "chooseScalarStyle");
function Sf(e, t, r, i, s) {
  e.dump = (function() {
    if (t.length === 0)
      return e.quotingType === Ri ? '""' : "''";
    if (!e.noCompatMode && (Xk.indexOf(t) !== -1 || Vk.test(t)))
    ...
    switch (p(l, "testAmbiguity"), wf(
      ...
      case Tf:
        return ">" + Ra(t, e.indent) + Pa($a(_f(t, a), o));
      case Or:
        return '"' + vf(t) + '"';
      default:
...
function vf(e) {
  for (var t = "", r = 0, i, s = 0; s < e.length; r >= 65536 ? s += 2 : s++)
    r = Nr(e, s), i = Ut[r], !i && Vr(r) ? (t += e[s], r >= 65536 && (t += e[s + 1])) : t += i || gf(r);
  return t;
}
p(vf, "escapeString");
function Bf(e, t, r) {
  ...
  for (s = r ? e.explicitTypes : e.implicitTypes, o = 0, a = s.length; o < a; o += 1)
    if (n = s[o], (n.instanceOf || n.predicate) && (!n.instanceOf || typeof t == "object" && t instanceof n.instanceOf) && (!n.predicate || n.predicate(t))) {
      if (r ? n.multi && n.representName ? e.tag = n.representName(t) : e.tag = n.tag : e.tag = "?", n.represent) {
        if (l = e.styleMap[n.tag] || n.defaultStyle, nf.call(n.represent) === "[object Function]")
          i = n.represent(t, l);
        else if (lf.call(n.represent, l))
          i = n.represent[l](t, l);
        else
...
function Ee(e, t, r, i, s, o, a) {
  ...
  if (h && (u = e.duplicates.indexOf(r), f = u !== -1), (e.tag !== null && e.tag !== "?" || f || e.indent !== 2 && t > 0) && (s = !1), f && e.usedDuplicates[u])
    ...
    if (h && f && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), n === "[object Object]")
      i && Object.keys(e.dump).length !== 0 ? (Ff(e, t, e.dump, s), f && (e.dump = "&ref_" + u + e.dump)) : (Lf(e, t, e.dump), f && (e.dump = "&ref_" + u + " " + e.dump));
    else if (n === "[object Array]")
      i && e.dump.length !== 0 ? (e.noArrayIndent && !a && t > 0 ? qa(e, t - 1, e.dump, s) : qa(e, t, e.dump, s), f && (e.dump = "&ref_" + u + e.dump)) : (Bf(e, t, e.dump), f && (e.dump = "&ref_" + u + " " + e.dump));
    else if (n === "[object String]")
      e.tag !== "?" && Sf(e, e.dump, t, o, l);
    else {
...
var kt = /* @__PURE__ */ p((e) => Array.isArray(e) ? { x: e[0], y: e[1] } : e, "pointTransformer"), e2 = /* @__PURE__ */ p((e) => ({
...
}), "getLineFunctionsWithOffset"), ci = {}, Et = {}, Ah;
function r2() {
...
function i2() {
  if (Eh) return ci;
  Eh = 1, Object.defineProperty(ci, "__esModule", { value: !0 }), ci.sanitizeUrl = void 0;
  var e = r2();
  function t(a) {
...
const a2 = "[object RegExp]", Mf = "[object String]", $f = "[object Number]", If = "[object Boolean]", Of = "[object Arguments]", n2 = "[object Symbol]", l2 = "[object Date]", h2 = "[object Map]", c2 = "[object Set]", u2 = "[object Array]", d2 = "[object ArrayBuffer]", f2 = "[object Object]", p2 = "[object DataView]", g2 = "[object Uint8Array]", m2 = "[object Uint8ClampedArray]", y2 = "[object Uint16Array]", C2 = "[object Uint32Array]", x2 = "[object Int8Array]", b2 = "[object Int16Array]", k2 = "[object Int32Array]", T2 = "[object Float32Array]", w2 = "[object Float64Array]", Mh = typeof globalThis == "object" && globalThis || typeof window == "object" && window || typeof self == "object" && self || typeof global == "object" && global || /* @__PURE__ */ (function() {
  return this;
})();
function Rn(e) {
  return typeof Mh.Buffer < "u" && Mh.Buffer.isBuffer(e);
}
function S2(e) {
  return Number.isSafeInteger(e) && e >= 0;
}
function Df(e) {
  return e != null && typeof e != "function" && S2(e.length);
}
function _2(e) {
  return e === "__proto__";
}
...
function ws(e, t, r, i) {
  ...
  if (i.has(t)) return E2(i.get(t));
  if (i.set(t, e), Array.isArray(t)) {
    t = t.slice();
    for (let o = 0; o < t.length; o++) t[o] = t[o] ?? void 0;
  }
  const s = [...Object.keys(t), ...Ef(t)];
  for (let o = 0; o < s.length; o++) {
    const a = s[o];
    if (_2(a)) continue;
    let n = t[a], l = e[a];
    if (za(n) && (n = { ...n }), za(l) && (l = { ...l }), Rn(n) && (n = $h(n)), Array.isArray(n)) if (Array.isArray(l)) {
    ...
    c !== void 0 ? e[a] = c : Array.isArray(n) || Ha(l) && Ha(n) && (Qo(l) || Qo(n) || Ts(l) || Ts(n)) ? e[a] = ws(l, n, r, i) : l == null && Qo(n) ? e[a] = ws({}, n, r, i) : l == null && Ts(n) ? e[a] = $h(n) : (l === void 0 || n !== void 0) && (e[a] = n);
  }
  return e;
}
function $2(e, ...t) {
...
function Ih(e) {
  ...
  if (typeof e == "object" || typeof e == "function") {
    ...
    const t = Object.keys(e);
    return A2(e) ? t.filter((r) => r !== "constructor").length === 0 : t.length === 0;
  }
  return !0;
}
var I2 = "​", O2 = {
  ...
  curveBumpY: Au,
  curveBundle: W1,
  curveCardinalClosed: z1,
  curveCardinalOpen: H1,
  curveCardinal: Iu,
  curveCatmullRomClosed: U1,
  curveCatmullRomOpen: Y1,
  curveCatmullRom: Du,
  curveLinear: Li,
  ...
  curveStepAfter: Xu,
  curveStepBefore: ju
}, D2 = /\s*(?:(\w+)(?=:):|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, R2 = /* @__PURE__ */ p(function(e, t) {
...
}, "detectInit"), Rf = /* @__PURE__ */ p(function(e, t = null) {
  try {
    const r = new RegExp(
      `[%]{2}(?![{]${D2.source})(?=[}][%]{2}).*
`,
...
}, "detectDirective"), P2 = /* @__PURE__ */ p(function(e) {
  return e.replace(vi, "");
}, "removeDirectives"), N2 = /* @__PURE__ */ p(function(e, t) {
...
function Pf(e, t) {
  const r = e.trim();
  if (r)
    return t.securityLevel !== "loose" ? s2.sanitizeUrl(r) : r;
}
p(Pf, "formatUrl");
var q2 = /* @__PURE__ */ p((e, ...t) => {
...
p(Nf, "traverseEdge");
function qf(e) {
  return e.length === 1 ? e[0] : Nf(e);
}
p(qf, "calcLabelPosition");
var Oh = /* @__PURE__ */ p((e, t = 2) => {
  ...
  for (const s of e) {
    if (r) {
      ...
      if (o < i)
        ...
        if (a > 0 && a < 1)
          return {
            x: Oh((1 - a) * r.x + a * s.x, 5),
            y: Oh((1 - a) * r.y + a * s.y, 5)
          };
      }
    }
    r = s;
...
}, "calculatePoint"), W2 = /* @__PURE__ */ p((e, t, r) => {
...
p(Wf, "calcTerminalLabelPosition");
function zf(e) {
  let t = "", r = "";
  for (const i of e)
...
p(zf, "getStylesFromArray");
var Dh = 0, z2 = /* @__PURE__ */ p(() => (Dh++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Dh), "generateId");
function Hf(e) {
  let t = "";
...
p(Hf, "makeRandomHex");
var H2 = /* @__PURE__ */ p((e) => Hf(e.length), "random"), U2 = /* @__PURE__ */ p(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
}, "getTextObj"), Y2 = /* @__PURE__ */ p(function(e, t) {
  ...
  (e, t, r) => {
    ...
    return i.forEach((a, n) => {
      ...
      if (l > t) {
        const { hyphenatedStrings: f, remainingWord: d } = j2(a, t, "-", r);
        s.push(o, ...f), o = d;
  ...
  (e, t) => {
    ...
    for (const f of a) {
      ...
      for (const m of n) {
        const y = U2();
        y.text = m || I2;
        const C = Y2(h, y).style("font-size", o).style("font-weight", s).style("font-family", f), b = (C._groups || C)[0][0].getBBox();
...
var Ce = {
  assignWithDepth: Mt,
  wrapLabel: G2,
  calculateTextHeight: Uf,
  calculateTextWidth: Ue,
  calculateTextDimensions: Hn,
  cleanAndMerge: Yn,
  detectInit: R2,
  detectDirective: Rf,
  isSubstringInArray: N2,
  interpolateToCurve: qn,
  calcLabelPosition: qf,
  calcCardinalityPosition: W2,
  calcTerminalLabelPosition: Wf,
  formatUrl: Pf,
  getStylesFromArray: zf,
  generateId: z2,
  random: H2,
  runFunc: q2,
  entityDecode: V2,
  insertTitle: Z2,
  isLabelCoordinateInPath: Yf,
  parseFontSize: Co,
  InitIDGenerator: X2
}, K2 = /* @__PURE__ */ p(function(e) {
  let t = e;
...
}, "decodeEntities"), EL = /* @__PURE__ */ p((e, t, {
  counter: r = 0,
  prefix: i,
  suffix: s
      ...
      (s) => new Promise((o) => {
        function a() {
          if (s.style.display = "flex", s.style.flexDirection = "column", i) {
            const n = gt().fontSize ? gt().fontSize : window.getComputedStyle(document.body).fontSize, l = 5, [c = Wc.fontSize] = Co(n), h = c * l + "px";
...
}, "compileStyles"), J2 = /* @__PURE__ */ p((e) => {
  const t = /* @__PURE__ */ new Map();
  return e.forEach((r) => {
    const [i, s] = r.split(":");
    t.set(i.trim(), s?.trim());
  }), t;
}, "styles2Map"), jf = /* @__PURE__ */ p((e) => e === "color" || e === "font-size" || e === "font-family" || e === "font-weight" || e === "font-style" || e === "text-decoration" || e === "text-align" || e === "text-transform" || e === "line-height" || e === "letter-spacing" || e === "word-spacing" || e === "text-shadow" || e === "text-overflow" || e === "white-space" || e === "word-wrap" || e === "word-break" || e === "overflow-wrap" || e === "hyphens", "isLabelStyle"), V = /* @__PURE__ */ p((e) => {
  const { stylesArray: t } = Qr(e), r = [], i = [], s = [], o = [];
  return t.forEach((a) => {
    const n = a[0];
    jf(n) ? r.push(a.join(":") + " !important") : (i.push(a.join(":") + " !important"), n.includes("stroke") && s.push(a.join(":") + " !important"), n === "fill" && o.push(a.join(":") + " !important"));
  }), {
    labelStyles: r.join(";"),
    nodeStyles: i.join(";"),
    stylesArray: t,
...
}, "userNodeOverrides"), tT = /* @__PURE__ */ p((e) => {
  if (!e)
    return [0, 0];
...
function Rh(e, t) {
  const r = aT(e, t);
  for (const i in rT) i in Vs ? i in e && !(i in r) && (r[i] = Vs[i]) : i in t ? r[i] = t[i] : i in e && (r[i] = e[i]);
  return r;
}
function nT(e, t) {
...
function Ph(e, t, r) {
  ...
  return a(t), r.forEach(a), Rh(e, o);
}
function lT(e, t) {
  if (e.icons[t]) return Ph(e, t, []);
  const r = nT(e, [t])[t];
  return r ? Ph(e, t, r) : null;
}
const hT = /(-?[0-9.]*[0-9]+[0-9.]*)/g, cT = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function Nh(e, t, r) {
  if (t === 1) return e;
...
function gT(e, t) {
  ...
  let h, u;
  a === null ? (u = n === null ? "1em" : n === "auto" ? c : n, h = Nh(u, l / c)) : (h = a === "auto" ? l : a, u = n === null ? Nh(h, c / l) : n === "auto" ? c : n);
  const f = {}, d = (m, y) => {
    pT(y) || (f[m] = y.toString());
  };
...
const mT = /\sid="(\S+)"/g, qh = /* @__PURE__ */ new Map();
function yT(e) {
  e = e.replace(/[0-9]+$/, "") || "a";
  const t = qh.get(e) || 0;
  return qh.set(e, t + 1), t ? `${e}${t}` : e;
}
function CT(e) {
  const t = [];
  let r;
  for (; r = mT.exec(e); ) t.push(r[1]);
  if (!t.length) return e;
  const i = "suffix" + (Math.random() * 16777216 | Date.now()).toString(16);
  return t.forEach((s) => {
    const o = yT(s), a = s.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
...
})(), Vt = { codeRemoveIndent: /^(?: {1,4}| {0,3}\t)/gm, outputLinkReplace: /\\([\[\]])/g, indentCodeCompensation: /^(\s+)(?:```)/, beginningSpace: /^\s+/, endingHash: /#$/, startingSpaceChar: /^ /, endingSpaceChar: / $/, nonSpaceChar: /[^ ]/, newLineCharGlobal: /\n/g, tabCharGlobal: /\t/g, multipleSpaceGlobal: /\s+/g, blankLine: /^[ \t]*$/, doubleBlankLine: /\n[ \t]*\n[ \t]*$/, blockquoteStart: /^ {0,3}>/, blockquoteSetextReplace: /\n {0,3}((?:=+|-+) *)(?=\n|$)/g, blockquoteSetextReplace2: /^ {0,3}>[ \t]?/gm, listReplaceTabs: /^\t+/, listReplaceNesting: /^ {1,4}(?=( {4})*[^ ])/g, listIsTask: /^\[[ xX]\] /, listReplaceTask: /^\[[ xX]\] +/, anyLine: /\n.*\n/, hrefBrackets: /^<(.*)>$/, tableDelimiter: /[:|]/, tableAlignChars: /^\||\| *$/g, tableRowBlankLine: /\n[ \t]*$/, tableAlignRight: /^ *-+: *$/, tableAlignCenter: /^ *:-+: *$/, tableAlignLeft: /^ *:-+ *$/, startATag: /^<a /i, endATag: /^<\/a>/i, startPreScriptTag: /^<(pre|code|kbd|script)(\s|>)/i, endPreScriptTag: /^<\/(pre|code|kbd|script)(\s|>)/i, startAngleBracket: /^</, endAngleBracket: />$/, pedanticHrefTitle: /^([^'"]*[^\s])\s+(['"])(.*)\2/, unicodeAlphaNumeric: /[\p{L}\p{N}]/u, escapeTest: /[&<>"']/, escapeReplace: /[&<>"']/g, escapeTestNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, escapeReplaceNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g, unescapeTest: /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig, caret: /(^|[^\[])\^/g, percentDecode: /%25/g, findPipe: /\|/g, splitPipe: / \|/, slashPipe: /\\\|/g, carriageReturn: /\r\n|\r/g, spaceLine: /^ +$/gm, notSpaceStart: /^\S*/, endingNewline: /\n$/, listItemRegex: (e) => new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`), nextBulletRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), hrRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), fencesBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}(?:\`\`\`|~~~)`), headingBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}#`), htmlBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}<(?:[a-z].*>|!--)`, "i") }, kT = /^(?:[ \t]*(?:\n|$))+/, TT = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, wT = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, Xi = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, ST = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, Xn = /(?:[*+-]|\d{1,9}[.)])/, Zf = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, Kf = mt(Zf).replace(/bull/g, Xn).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), _T = mt(Zf).replace(/bull/g, Xn).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), Vn = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, vT = /^[^\n]+/, Zn = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/, BT = mt(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", Zn).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), LT = mt(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, Xn).getRegex(), xo = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", Kn = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, FT = mt("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", Kn).replace("tag", xo).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), Qf = mt(Vn).replace("hr", Xi).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", xo).getRegex(), AT = mt(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", Qf).getRegex(), Qn = { blockquote: AT, code: TT, def: BT, fences: wT, heading: ST, hr: Xi, html: FT, lheading: Kf, list: LT, newline: kT, paragraph: Qf, table: Fi, text: vT }, Wh = mt("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", Xi).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", xo).getRegex(), ET = { ...Qn, lheading: _T, table: Wh, paragraph: mt(Vn).replace("hr", Xi).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", Wh).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", xo).getRegex() }, MT = { ...Qn, html: mt(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", Kn).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: Fi, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: mt(Vn).replace("hr", Xi).replace("heading", ` *#{1,6} *[^
]`).replace("lheading", Kf).replace("|table", "").replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").replace("|tag", "").getRegex() }, $T = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, IT = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, Jf = /^( {2,}|\\)\n(?!\s*$)/, OT = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, bo = /[\p{P}\p{S}]/u, Jn = /[\s\p{P}\p{S}]/u, tp = /[^\s\p{P}\p{S}]/u, DT = mt(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, Jn).getRegex(), ep = /(?!~)[\p{P}\p{S}]/u, RT = /(?!~)[\s\p{P}\p{S}]/u, PT = /(?:[^\s\p{P}\p{S}]|~)/u, NT = mt(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", bT ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex(), rp = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, qT = mt(rp, "u").replace(/punct/g, bo).getRegex(), WT = mt(rp, "u").replace(/punct/g, ep).getRegex(), ip = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", zT = mt(ip, "gu").replace(/notPunctSpace/g, tp).replace(/punctSpace/g, Jn).replace(/punct/g, bo).getRegex(), HT = mt(ip, "gu").replace(/notPunctSpace/g, PT).replace(/punctSpace/g, RT).replace(/punct/g, ep).getRegex(), UT = mt("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, tp).replace(/punctSpace/g, Jn).replace(/punct/g, bo).getRegex(), YT = mt(/\\(punct)/, "gu").replace(/punct/g, bo).getRegex(), GT = mt(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), jT = mt(Kn).replace("(?:-->|$)", "-->").getRegex(), XT = mt("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", jT).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), Zs = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/, VT = mt(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", Zs).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), sp = mt(/^!?\[(label)\]\[(ref)\]/).replace("label", Zs).replace("ref", Zn).getRegex(), op = mt(/^!?\[(ref)\](?:\[\])?/).replace("ref", Zn).getRegex(), ZT = mt("reflink|nolink(?!\\()", "g").replace("reflink", sp).replace("nolink", op).getRegex(), zh = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/, tl = { _backpedal: Fi, anyPunctuation: YT, autolink: GT, blockSkip: NT, br: Jf, code: IT, del: Fi, emStrongLDelim: qT, emStrongRDelimAst: zT, emStrongRDelimUnd: UT, escape: $T, link: VT, nolink: op, punctuation: DT, reflink: sp, reflinkSearch: ZT, tag: XT, text: OT, url: Fi }, KT = { ...tl, link: mt(/^!?\[(label)\]\((.*?)\)/).replace("label", Zs).getRegex(), reflink: mt(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", Zs).getRegex() }, Ua = { ...tl, emStrongRDelimAst: HT, emStrongLDelim: WT, url: mt(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", zh).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/, text: mt(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", zh).getRegex() }, QT = { ...Ua, br: mt(Jf).replace("{2,}", "*").getRegex(), text: mt(Ua.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() }, ns = { normal: Qn, gfm: ET, pedantic: MT }, ui = { normal: tl, gfm: Ua, breaks: QT, pedantic: KT }, JT = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, Hh = (e) => JT[e];
function ve(e, t) {
  if (t) {
    if (Vt.escapeTest.test(e)) return e.replace(Vt.escapeReplace, Hh);
  } else if (Vt.escapeTestNoEncode.test(e)) return e.replace(Vt.escapeReplaceNoEncode, Hh);
  return e;
}
function Uh(e) {
  try {
...
`) };
  ...
  fences(t) {
    ...
    if (r) {
      let i = r[0], s = ew(i, r[3] || "", this.rules);
...
`, t = t.substring(B.length + 1), f = O.slice(m);
  ...
  table(t) {
    ...
    let i = Yh(r[1]), s = r[2].replace(this.rules.other.tableAlignChars, "").split("|"), o = r[3]?.trim() ? r[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], a = { type: "table", raw: r[0], header: [], align: [], rows: [] };
    if (i.length === s.length) {
      ...
      for (let n of o) a.rows.push(Yh(n, a.header.length).map((l, c) => ({ text: l, tokens: this.lexer.inline(l), header: !1, align: a.align[c] })));
      return a;
    }
  }
  lheading(t) {
...
` ? r[1].slice(0, -1) : r[1];
  ...
  link(t) {
    ...
    if (r) {
      ...
      return s = s.trim(), this.rules.other.startAngleBracket.test(s) && (this.options.pedantic && !this.rules.other.endAngleBracket.test(i) ? s = s.slice(1) : s = s.slice(1, -1)), Gh(r, { href: s && s.replace(this.rules.inline.anyPunctuation, "$1"), title: o && o.replace(this.rules.inline.anyPunctuation, "$1") }, r[0], this.lexer, this.rules);
    }
  }
  reflink(t, r) {
    let i;
    if ((i = this.rules.inline.reflink.exec(t)) || (i = this.rules.inline.nolink.exec(t))) {
      ...
      return Gh(i, o, i[0], this.lexer, this.rules);
    }
  }
  emStrong(t, r, i = "") {
...
`;
  ...
  link({ href: t, title: r, tokens: i }) {
    let s = this.parser.parseInline(i), o = Uh(t);
    if (o === null) return s;
    t = o;
    let a = '<a href="' + t + '"';
...
yt.options = yt.setOptions = function(e) {
  return Tr.setOptions(e), yt.defaults = Tr.defaults, Vf(yt.defaults), yt;
};
yt.getDefaults = jn;
yt.defaults = Sr;
yt.use = function(...e) {
  return Tr.use(...e), yt.defaults = Tr.defaults, Vf(yt.defaults), yt;
};
...
var iw = {
  ...
  height: 80,
  width: 80
}, ja = /* @__PURE__ */ new Map(), np = /* @__PURE__ */ new Map(), sw = /* @__PURE__ */ p((e) => {
  for (const t of e) {
    if (!t.name)
      throw new Error(
...
}, "registerIconPacks"), lp = /* @__PURE__ */ p(async (e, t) => {
  const r = oT(e, !0, t !== void 0);
  if (!r)
  ...
  return o;
}, "getRegisteredIconData"), ow = /* @__PURE__ */ p(async (e) => {
  try {
    return await lp(e), !0;
  } catch {
    return !1;
  ...
  let i;
  try {
    i = await lp(e, t?.fallbackPrefix);
  } catch (a) {
    P.error(a), i = iw;
  }
  const s = gT(i, t), o = xT(CT(s.body), {
    ...s.attributes,
    ...r
  });
  return ke(o, Tt());
...
p(hp, "preprocessMarkdown");
function cp(e) {
  return e.split(/\\n|\n|<br\s*\/?>/gi).map(
    (t) => t.trim().match(/<[^>]+>|[^\s<>]+/g)?.map((r) => ({ content: r, type: "normal" })) ?? []
  );
}
p(cp, "nonMarkdownToLines");
function up(e, t = {}) {
  const r = hp(e, t), i = yt.lexer(r), s = [[]];
  let o = 0;
...
p(Xa, "applyStyle");
var jh = 16384;
async function yp(e, t, r, i, s = !1, o = Tt()) {
  const a = e.append("foreignObject");
  a.attr("width", `${Math.min(10 * r, jh)}px`), a.attr("height", `${Math.min(10 * r, jh)}px`);
  const n = a.append("xhtml:div"), l = Ai(t.label) ? await Kc(t.label.replace(Hi.lineBreakRegex, `
...
p(aw, "computeDimensionOfText");
function xp(e, t, r, i = !1, s = !1) {
  ...
  let c = 0;
  for (const h of r) {
    const u = /* @__PURE__ */ p((d) => Cp(a, 1.1, d) <= e, "checkWidth"), f = u(h) ? [h] : mp(h, u);
    for (const d of f) {
...
async function bp(e, t = {}) {
  ...
  e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, (s, o, a) => (r.push(
    (async () => {
      const n = `${o}:${a}`;
      return await ow(n) ? await Vi(n, void 0, { class: "label-icon" }) : `<i class='${ke(s, t).replace(":", " ")}'></i>`;
    })()
  ), s));
  const i = await Promise.all(r);
  return e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, () => i.shift() ?? "");
}
p(bp, "replaceIconSubstring");
var je = /* @__PURE__ */ p(async (e, t = "", {
  ...
  if (P.debug(
    ...
    const u = a ? fp(t, h) : dp(t), f = await bp(kr(u), h), d = t.replace(/\\\\/g, "\\"), g = {
      isNode: n,
      label: Ai(t) ? d : f,
      labelStyle: r.replace("fill:", "color:")
    };
    return await yp(e, g, l, s, c, h);
  } else {
    const u = kr(t.replace(/<br\s*\/?>/g, "<br/>")), f = a ? up(u.replace("<br>", "<br/>"), h) : cp(u), d = xp(
      l,
      e,
      f,
      t ? c : !1,
...
function lw(e, t, r, i = 1) {
  ...
  const l = (function(c, h, u) {
    ...
    for (const b of c) {
      const k = [...b];
      nw(k[0], k[k.length - 1]) || k.push([k[0][0], k[0][1]]), k.length > 2 && f.push(k);
    }
    const d = [];
    h = Math.max(h, 0.1);
    const g = [];
...
function Zi(e, t) {
  ...
  let o = 1;
  return t.roughness >= 1 && (((r = t.randomizer) === null || r === void 0 ? void 0 : r.next()) || Math.random()) > 0.7 && (o = s), lw(e, s, i, o || 1);
}
class il {
  constructor(t) {
    this.helper = t;
...
const gw = 0, ea = 1, Xh = 2, ls = { A: 7, a: 7, C: 6, c: 6, H: 1, h: 1, L: 2, l: 2, M: 2, m: 2, Q: 4, q: 4, S: 4, s: 4, T: 2, t: 2, V: 1, v: 1, Z: 0, z: 0 };
function ra(e, t) {
  return e.type === t;
}
function sl(e) {
  const t = [], r = (function(a) {
    ...
    else if (a.match(/^([aAcChHlLmMqQsStTvVzZ])/)) n[n.length] = { type: gw, text: RegExp.$1 }, a = a.substr(RegExp.$1.length);
    else {
      if (!a.match(/^(([-+]?[0-9]+(\.[0-9]*)?|[-+]?\.[0-9]+)([eE][-+]?[0-9]+)?)/)) return [];
      n[n.length] = { type: ea, text: `${parseFloat(RegExp.$1)}` }, a = a.substr(RegExp.$1.length);
    }
    return n[n.length] = { type: Xh, text: "" }, n;
  })(e);
  let i = "BOD", s = 0, o = r[s];
  for (; !ra(o, Xh); ) {
    let a = 0;
  ...
  for (const { key: c, data: h } of e) {
    switch (c) {
      ...
      case "A": {
        ...
        u === 0 || f === 0 ? (t.push({ key: "C", data: [i, s, y, C, y, C] }), i = y, s = C) : (i !== y || s !== C) && (wp(i, s, y, C, u, f, d, g, m).forEach((function(b) {
          t.push({ key: "C", data: b });
        })), i = y, s = C);
        break;
      }
...
function wp(e, t, r, i, s, o, a, n, l, c) {
  ...
  if (Math.abs(C) > 120 * Math.PI / 180) {
    const W = g, I = r, F = i;
    g = l && g > d ? d + 120 * Math.PI / 180 * 1 : d + 120 * Math.PI / 180 * -1, f = wp(r = m + s * Math.cos(g), i = y + o * Math.sin(g), I, F, s, o, a, 0, l, [g, W, m, y]);
  }
  C = g - d;
...
function Vh(e, t) {
  if (e.length) {
    const r = typeof e[0][0] == "number" ? [e] : e, i = hs(r[0], 1 * (1 + 0.2 * t.roughness), t), s = t.disableMultiStroke ? [] : hs(r[0], 1.5 * (1 + 0.22 * t.roughness), Qh(t));
    for (let o = 1; o < r.length; o++) {
      const a = r[o];
      if (a.length) {
        const n = hs(a, 1 * (1 + 0.2 * t.roughness), t), l = t.disableMultiStroke ? [] : hs(a, 1.5 * (1 + 0.22 * t.roughness), Qh(t));
...
function Za(e, t, r, i) {
  const [s, o] = Jh(i.increment, e, t, i.rx, i.ry, 1, i.increment * to(0.1, to(0.4, 1, r), r), r);
  let a = eo(s, null, r);
  if (!r.disableMultiStroke && r.roughness !== 0) {
    const [n] = Jh(i.increment, e, t, i.rx, i.ry, 1.5, 0, r), l = eo(n, null, r);
    a = a.concat(l);
  }
  return { estimatedPoints: o, opset: { type: "path", ops: a } };
}
function Zh(e, t, r, i, s, o, a, n, l) {
  const c = e, h = t;
  ...
  const m = 2 * Math.PI / l.curveStepCount, y = Math.min(m / 2, (g - d) / 2), C = tc(y, c, h, u, f, d, g, 1, l);
  if (!l.disableMultiStroke) {
    const b = tc(y, c, h, u, f, d, g, 1.5, l);
    C.push(...b);
  }
...
function Kh(e, t) {
  ...
  for (const { key: a, data: n } of r) switch (a) {
    ...
    case "C": {
      const [l, c, h, u, f, d] = n;
      i.push(...Cw(l, c, h, u, f, d, o, t)), o = [f, d];
      break;
    }
    case "Z":
...
function vp(e) {
  return e.randomizer || (e.randomizer = new pw(e.seed || 0)), e.randomizer.next();
}
function to(e, t, r, i = 1) {
  return r.roughness * i * (vp(r) * (t - e) + e);
}
function ot(e, t, r = 1) {
  return to(-e, e, t, r);
}
...
class io {
  ...
  rectangle(t, r, i, s, o) {
    const a = this._o(o), n = [], l = yw(t, r, i, s, a);
    if (a.fill) {
  ...
  ellipse(t, r, i, s, o) {
    const a = this._o(o), n = [], l = _p(i, s, a), c = Za(t, r, a, l);
  ...
  curve(t, r) {
    const i = this._o(r), s = [], o = Vh(t, i);
    if (i.fill && i.fill !== oe) if (i.fillStyle === "solid") {
      const a = Vh(t, Object.assign(Object.assign({}, i), { disableMultiStroke: !0, roughness: i.roughness ? i.roughness + i.fillShapeRoughnessGain : 0 }));
      s.push({ type: "fillPath", ops: this._mergedShape(a.ops) });
    } else {
      const a = [], n = t;
      if (n.length) {
        const l = typeof n[0][0] == "number" ? [n] : n;
        for (const c of l) c.length < 3 ? a.push(...c) : c.length === 3 ? a.push(...sa(ec([c[0], c[0], c[1], c[2]]), 10, (1 + i.roughness) / 2)) : a.push(...sa(ec(c), 10, (1 + i.roughness) / 2));
      }
  ...
  path(t, r) {
    ...
    const o = i.fill && i.fill !== "transparent" && i.fill !== oe, a = i.stroke !== oe, n = !!(i.simplification && i.simplification < 1), l = (function(h, u, f) {
      ...
      return w;
    })(t, 1, n ? 4 - 4 * (i.simplification || 1) : (1 + i.roughness) / 2), c = Kh(t, i);
    if (o) if (i.fillStyle === "solid") if (l.length === 1) {
      const h = Kh(t, Object.assign(Object.assign({}, i), { disableMultiStroke: !0, roughness: i.roughness ? i.roughness + i.fillShapeRoughnessGain : 0 }));
...
var G = { canvas: (e, t) => new kw(e, t), svg: (e, t) => new Tw(e, t), generator: (e) => new io(e), newSeed: () => io.newSeed() }, st = /* @__PURE__ */ p(async (e, t, r) => {
  let i;
  ...
  if (s) {
    ...
    await Gf(d, n), u = d.getBoundingClientRect(), g.attr("width", u.width), g.attr("height", u.height);
  }
...
var ww = /* @__PURE__ */ p((e, t) => {
...
}, "intersectRect"), Jr = ww, Sw = /* @__PURE__ */ p(async (e, t, r, i = !1, s = !1) => {
  let o = t || "";
...
}, "createLabel"), Ke = Sw, or = /* @__PURE__ */ p((e, t, r, i, s) => [
  "M",
  e + s,
  t,
  ...
  "Z"
  // Close the path
].join(" "), "createRoundedRectPathD"), Bp = /* @__PURE__ */ p(async (e, t) => {
...
}, "noteGroup"), vw = /* @__PURE__ */ p(async (e, t) => {
...
}, "roundedWithTitle"), Bw = /* @__PURE__ */ p(async (e, t) => {
  P.info("Creating subgraph rect for ", t.id, t);
  ...
  divider: Lw,
  kanbanSection: Bw
}, Lp = /* @__PURE__ */ new Map(), Ew = /* @__PURE__ */ p(async (e, t) => {
  const r = t.shape || "rect", i = await Aw[r](e, t);
  return Lp.set(t.id, i), i;
}, "insertCluster"), RL = /* @__PURE__ */ p(() => {
  Lp = /* @__PURE__ */ new Map();
}, "clear");
function Fp(e, t) {
...
p(Ap, "intersectEllipse");
var Ep = Ap;
function Mp(e, t, r) {
  return Ep(e, t, t, r);
}
p(Mp, "intersectCircle");
var $w = Mp;
function $p(e, t, r, i) {
  {
...
function Ip(e, t, r) {
  ...
  for (let h = 0; h < t.length; h++) {
    let u = t[h], f = t[h < t.length - 1 ? h + 1 : 0], d = Iw(
      e,
      r,
      { x: l + u.x, y: c + u.y },
      { x: l + f.x, y: c + f.y }
...
async function Rp(e, t) {
  ...
  const s = t.padding ?? 0, o = t.look === "neo" ? 16 : s, a = t.look === "neo" ? 12 : s, n = /* @__PURE__ */ p((N) => N + a, "calcTotalHeight"), l = /* @__PURE__ */ p((N) => {
    const D = N / 2;
    return [D / (2.5 + N / 50), D];
  }, "calcEllipseRadius"), { shapeSvg: c, bbox: h } = await st(e, t, tt(t)), u = n(t?.height ? t?.height : h.height), [f, d] = l(u), g = Dp(u, f, d), y = (t?.width ? t?.width : h.width) + o * 2 + g - g, C = u, { cssStyles: b } = t, k = [
    { x: y / 2, y: -C / 2 },
    { x: -y / 2, y: -C / 2 },
...
function Wp(e, t) {
  ...
  t.look !== "handDrawn" && (l.roughness = 0, l.fillStyle = "solid");
  const c = n.circle(0, 0, o * 2, l), h = qp(o), u = n.path(h, l), f = s.insert(() => c, ":first-child");
...
p(Yp, "curvedTrapezoid");
var Dw = /* @__PURE__ */ p((e, t, r, i, s, o) => [
  `M${e},${t + o}`,
  `a${s},${o} 0,0,0 ${r},0`,
  `a${s},${o} 0,0,0 ${-r},0`,
  `l0,${i}`,
  `a${s},${o} 0,0,0 ${r},0`,
  `l0,${-i}`
].join(" "), "createCylinderPathD"), Rw = /* @__PURE__ */ p((e, t, r, i, s, o) => [
  `M${e},${t + o}`,
  `M${e + r},${t + o}`,
  `a${s},${o} 0,0,0 ${-r},0`,
  `l0,${i}`,
  `a${s},${o} 0,0,0 ${r},0`,
  `l0,${-i}`
].join(" "), "createOuterCylinderPathD"), Pw = /* @__PURE__ */ p((e, t, r, i, s, o) => [`M${e - r / 2},${-i / 2}`, `a${s},${o} 0,0,0 ${r},0`].join(" "), "createInnerCylinderPathD"), rc = 8, ic = 8;
async function Gp(e, t) {
  ...
  if (t.width || t.height) {
    const y = t.width ?? 0;
    t.width = (t.width ?? 0) - a, t.width < ic && (t.width = ic);
    const b = y / 2 / (2.5 + y / 50);
    t.height = (t.height ?? 0) - o - b * 3, t.height < rc && (t.height = rc);
  }
  ...
  const { cssStyles: m } = t;
  if (t.look === "handDrawn") {
    const y = G.svg(n), C = Rw(0, 0, h, d, u, f), b = Pw(0, f, h, d, u, f), k = j(t, {}), w = y.path(C, k), S = y.path(b, j(t, { fill: "none" }));
    g = n.insert(() => S, ":first-child"), g = n.insert(() => w, ":first-child"), g.attr("class", "basic label-container"), m && g.attr("style", m);
  } else {
    const y = Dw(0, 0, h, d, u, f);
...
async function Kp(e, t) {
  ...
  (t.width || t.height) && (t.height = t?.height ?? 0, t.height < sc && (t.height = sc), t.width = (t?.width ?? 0) - o - o / 2, t.width < oc && (t.width = oc));
...
function Qp(e, t, { dir: r, config: { state: i, themeVariables: s } }) {
...
async function tg(e, t) {
  ...
  const { cssStyles: C } = t;
  if (t.look === "handDrawn") {
    const b = G.svg(h), k = j(t, {}), w = Nw(0, 0, g, f, d), S = b.path(w, k);
...
p(og, "iconSquare");
async function ag(e, t, { config: { flowchart: r } }) {
  const i = new Image();
...
p(ug, "lightningBolt");
var qw = /* @__PURE__ */ p((e, t, r, i, s, o, a) => [
  `M${e},${t + o}`,
  `a${s},${o} 0,0,0 ${r},0`,
  `a${s},${o} 0,0,0 ${-r},0`,
  `l0,${i}`,
  ...
  `M${e},${t + o + a}`,
  `a${s},${o} 0,0,0 ${r},0`
].join(" "), "createCylinderPathD"), Ww = /* @__PURE__ */ p((e, t, r, i, s, o, a) => [
  `M${e},${t + o}`,
  `M${e + r},${t + o}`,
  `a${s},${o} 0,0,0 ${-r},0`,
  `l0,${i}`,
  ...
  `M${e},${t + o + a}`,
  `a${s},${o} 0,0,0 ${r},0`
].join(" "), "createOuterCylinderPathD"), zw = /* @__PURE__ */ p((e, t, r, i, s, o) => [`M${e - r / 2},${-i / 2}`, `a${s},${o} 0,0,0 ${r},0`].join(" "), "createInnerCylinderPathD"), ac = 10, nc = 10;
async function dg(e, t) {
  ...
  if (t.width || t.height) {
    const C = t.width ?? 0;
    t.width = (t.width ?? 0) - o, t.width < nc && (t.width = nc);
    const k = C / 2 / (2.5 + C / 50);
    t.height = (t.height ?? 0) - a - k * 3, t.height < ac && (t.height = ac);
  }
...
async function yg(e, t) {
  ...
  const { cssStyles: f } = t;
  if (t.look === "handDrawn") {
    const d = G.svg(s), g = j(t, {}), m = Hw(0, 0, l), y = d.path(m, g);
...
p(xg, "rectWithTitle");
async function bg(e, t, { config: { themeVariables: r } }) {
...
function Bg(e, t, { config: { themeVariables: r } }) {
  ...
  let a;
  if (t.look === "handDrawn") {
    const l = G.svg(o).circle(0, 0, t.width, Q2(i));
...
p(Eg, "text");
var Uw = /* @__PURE__ */ p((e, t, r, i, s, o) => `M${e},${t}
    a${s},${o} 0,0,1 0,${-i}
    l${r},0
    a${s},${o} 0,0,1 0,${i}
    M${r},${-i}
    a${s},${o} 0,0,0 0,${i}
    l${-r},0`, "createCylinderPathD"), Yw = /* @__PURE__ */ p((e, t, r, i, s, o) => [
  `M${e},${t}`,
  `M${e + r},${t}`,
  `a${s},${o} 0,0,0 0,${-i}`,
  `l${-r},0`,
  `a${s},${o} 0,0,0 0,${i}`,
  `l${r},0`
].join(" "), "createOuterCylinderPathD"), Gw = /* @__PURE__ */ p((e, t, r, i, s, o) => [`M${e + r / 2},${-i / 2}`, `a${s},${o} 0,0,0 0,${i}`].join(" "), "createInnerCylinderPathD"), lc = 5, hc = 10;
async function Mg(e, t) {
  ...
  if (t.width || t.height) {
    const m = t.height ?? 0;
    t.height = (t.height ?? 0) - o, t.height < lc && (t.height = lc);
    const C = m / 2 / (2.5 + m / 50);
    t.width = (t.width ?? 0) - o - C * 3, t.width < hc && (t.width = hc);
  }
  ...
  let g;
  if (t.look === "handDrawn") {
    const m = G.svg(a), y = Yw(0, 0, f, c, u, h), C = Gw(0, 0, f, c, u, h), b = m.path(y, j(t, {})), k = m.path(C, j(t, { fill: "none" }));
    g = a.insert(() => k, ":first-child"), g = a.insert(() => b, ":first-child"), g.attr("class", "basic label-container"), d && g.attr("style", d);
  } else {
    const m = Uw(0, 0, f, c, u, h);
...
p(Ig, "trapezoidalPentagon");
var cc = 10, uc = 10;
async function Og(e, t) {
  const { labelStyles: r, nodeStyles: i } = V(t);
  t.labelStyle = r;
  const s = t.padding ?? 0, o = t.look === "neo" ? s * 2 : s;
  (t.width || t.height) && (t.width = ((t?.width ?? 0) - o) / 2, t.width < uc && (t.width = uc), t.height = t?.height ?? 0, t.height < cc && (t.height = cc));
...
p(Pg, "windowPane");
var dc = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), jw = /* @__PURE__ */ new Set(["redux", "redux-dark", "redux-color", "redux-dark-color"]);
async function al(e, t) {
  ...
  }), y.select(".name").attr("transform", "translate(" + -C.width / 2 + ", " + (U + u / 2) + ")"), i != null && dc.has(i)) {
...
async function Dr(e, t, r, i = 0, s = 0, o = [], a = "") {
  ...
  t !== rh(t) && (t = rh(t), t = t.replaceAll("<", "&lt;").replaceAll(">", "&gt;"));
...
p(Rr, "lineToPolygon");
async function Ng(e, t, r, i, s = r.class.padding ?? 12) {
...
async function qg(e, t) {
  ...
  const { shapeSvg: c, bbox: h } = await Ng(e, t, r, n, a), { labelStyles: u, nodeStyles: f } = V(t);
...
async function zg(e, t, { config: r }) {
  const { labelStyles: i, nodeStyles: s } = V(t);
  t.labelStyle = i || "";
  ...
  if (t.look === "handDrawn") {
    ...
    if (z) {
      ...
      W.attr("x1", I).attr("y1", F).attr("x2", I).attr("y2", L).attr("stroke-width", "4").attr("stroke", Xw(z));
    }
  }
...
}, "generateShapeMap"), jg = Zw();
function Kw(e) {
  return e in jg;
}
p(Kw, "isValidShape");
var So = /* @__PURE__ */ new Map();
async function Xg(e, t, r) {
  let i, s;
  t.shape === "rect" && (t.rx && t.ry ? t.shape = "roundedRect" : t.shape = "squareRect");
  const o = t.shape ? jg[t.shape] : void 0;
  if (!o)
...
var PL = /* @__PURE__ */ p((e, t) => {
  So.set(t.id, e);
}, "setNodeElem"), NL = /* @__PURE__ */ p(() => {
  So.clear();
}, "clear"), qL = /* @__PURE__ */ p((e) => {
  const t = So.get(e.id);
  P.trace(
    "Transforming node",
    e.diff,
...
}, "positionNode"), Qw = /* @__PURE__ */ p((e, t, r, i, s, o = !1, a) => {
  t.arrowTypeStart && fc(
    e,
    "start",
    t.arrowTypeStart,
  ...
  "dependency",
  "barb"
], fc = /* @__PURE__ */ p((e, t, r, i, s, o, a = !1, n) => {
  const l = Jw[r], c = l && tS.includes(l.type);
  if (!l) {
...
}, "addEdgeMarker"), eS = /* @__PURE__ */ p((e) => typeof e == "string" ? e : gt()?.flowchart?.curve, "resolveEdgeCurveType"), so = /* @__PURE__ */ new Map(), Pt = /* @__PURE__ */ new Map(), WL = /* @__PURE__ */ p(() => {
  so.clear(), Pt.clear();
}, "clear"), gi = /* @__PURE__ */ p((e) => e ? typeof e == "string" ? e : e.reduce((t, r) => t + ";" + r, "") : "", "getLabelStyles"), rS = /* @__PURE__ */ p(async (e, t) => {
  const r = gt();
  let i = Kt(r);
  const { labelStyles: s } = V(t);
  t.labelStyle = s;
...
}, "intersection"), pc = /* @__PURE__ */ p((e, t) => {
  P.warn("abc88 cutPathAtIntersect", e, t);
  let r = [], i = e[0], s = !1;
  return e.forEach((o) => {
    if (P.info("abc88 checking point", o, t), !sS(t, o) && !s) {
      const a = oS(t, i, o);
...
p(Vg, "extractCornerPoints");
var gc = /* @__PURE__ */ p(function(e, t, r) {
  const i = t.x - e.x, s = t.y - e.y, o = Math.sqrt(i * i + s * s), a = r / o;
  return { x: t.x - a * i, y: t.y - a * s };
}, "findAdjacentPoint"), aS = /* @__PURE__ */ p(function(e) {
  const { cornerPointPositions: t } = Vg(e), r = [];
  for (let i = 0; i < e.length; i++)
    if (t.includes(i)) {
      const s = e[i - 1], o = e[i + 1], a = e[i], n = gc(s, a, 5), l = gc(o, a, 5), c = l.x - n.x, h = l.y - n.y;
      r.push(n);
      ...
      r.push(e[i]);
  return r;
}, "fixCorners"), nS = /* @__PURE__ */ p((e, t, r) => {
  const i = e - t - r, s = 2, o = 2, a = s + o, n = Math.floor(i / a), l = Array(n).fill(`${s} ${o}`).join(" ");
  return `0 ${t} ${l} ${r}`;
}, "generateDashArray"), lS = /* @__PURE__ */ p(function(e, t, r, i, s, o, a, n = !1) {
  if (!a)
    throw new Error(
  ...
  for (const M in t.cssCompiledStyles)
    jf(M) || d.push(t.cssCompiledStyles[M]);
  ...
  t.toCluster && (P.info("to cluster abc88", r.get(t.toCluster)), c = pc(t.points, r.get(t.toCluster).node), h = !0), t.fromCluster && (P.debug(
    "from cluster abc88",
    r.get(t.fromCluster),
    JSON.stringify(c, null, 2)
  ), c = pc(c.reverse(), r.get(t.fromCluster).node).reverse(), h = !0);
  ...
  const { x: b, y: k } = e2(t), w = P1().x(b).y(k).curve(C);
  let S;
  switch (t.thickness) {
    case "normal":
  ...
  let v, B = y === "rounded" ? Zg(Kg(m, t), 5) : w(m);
  ...
  if (t.look === "handDrawn") {
    ...
    const U = v.node(), Q = typeof U.getTotalLength == "function" ? U.getTotalLength() : 0, dt = Fh[t.arrowTypeStart] || 0, et = Fh[t.arrowTypeEnd] || 0;
    if (t.look === "neo" && !$) {
      const it = `stroke-dasharray: ${t.pattern === "dotted" || t.pattern === "dashed" ? nS(Q, dt, et) : `0 ${dt} ${Q - dt - et} ${et}`}; stroke-dashoffset: 0;`;
...
var hS = /* @__PURE__ */ p((e, t, r, i) => {
  t.forEach((s) => {
    MS[s](e, r, i);
  });
}, "insertMarkers"), cS = /* @__PURE__ */ p((e, t, r) => {
...
}, "composition"), dS = /* @__PURE__ */ p((e, t, r) => {
...
}, "aggregation"), fS = /* @__PURE__ */ p((e, t, r) => {
...
}, "dependency"), pS = /* @__PURE__ */ p((e, t, r) => {
...
}, "zero_or_one"), TS = /* @__PURE__ */ p((e, t, r) => {
...
}, "one_or_more"), wS = /* @__PURE__ */ p((e, t, r) => {
...
}, "zero_or_more"), SS = /* @__PURE__ */ p((e, t, r) => {
...
}, "only_one_neo"), _S = /* @__PURE__ */ p((e, t, r) => {
...
}, "zero_or_one_neo"), vS = /* @__PURE__ */ p((e, t, r) => {
  const i = Tt(), { themeVariables: s } = i, { strokeWidth: o } = s;
...
}, "one_or_more_neo"), BS = /* @__PURE__ */ p((e, t, r) => {
...
}, "zero_or_more_neo"), LS = /* @__PURE__ */ p((e, t, r) => {
...
}, "requirement_arrow"), FS = /* @__PURE__ */ p((e, t, r) => {
  const i = Tt(), { themeVariables: s } = i, { strokeWidth: o } = s;
...
}, "requirement_arrow_neo"), AS = /* @__PURE__ */ p((e, t, r) => {
...
}, "requirement_contains"), ES = /* @__PURE__ */ p((e, t, r) => {
  ...
  labelHelper: st,
  log: P,
  positionEdgeLabel: iS
}, qi = {}, Qg = /* @__PURE__ */ p((e) => {
  for (const t of e)
    qi[t.name] = t;
}, "registerLayoutLoaders"), OS = /* @__PURE__ */ p(() => {
  Qg([
    {
      name: "dagre",
      loader: /* @__PURE__ */ p(async () => await import("./dagre-BM42HDAG-ceJGbHOu.js"), "loader")
    },
    {
      name: "cose-bilkent",
      loader: /* @__PURE__ */ p(async () => await import("./cose-bilkent-S5V4N54A-DWA-Z5no.js"), "loader")
    }
  ]);
}, "registerDefaultLayoutLoaders");
OS();
var zL = /* @__PURE__ */ p(async (e, t) => {
  ...
  return i.render(e, t, IS, {
    algorithm: r.algorithm
  });
}, "render"), HL = /* @__PURE__ */ p((e = "", { fallback: t = "dagre" } = {}) => {
  if (e in qi)
    return e;
  if (t in qi)
...
}, "getRegisteredLayoutAlgorithm"), nl = "comm", Jg = "rule", tm = "decl", DS = "@media", RS = "@import", PS = "@supports", NS = "@namespace", sn = "@keyframes", em = "@layer", qS = "@scope", rm = Math.abs, ll = String.fromCharCode;
function im(e) {
  return e.trim();
}
function vs(e, t, r) {
...
var _o = 1, Kr = 1, om = 0, ce = 0, Lt = 0, ei = "";
...
function be() {
  return Lt = ce < om ? Hr(ei, ce++) : 0, Kr++, Lt === 10 && (Kr = 1, _o++), Lt;
}
function Qe() {
  return Hr(ei, ce);
}
...
function US(e) {
  return _o = Kr = 1, om = Le(ei = e), ce = 0, [];
}
function YS(e) {
  return ei = "", e;
}
function na(e) {
  return im(vo(ce - 1, on(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function GS(e) {
  for (; (Lt = Qe()) && Lt < 33; )
    be();
...
function ZS(e) {
  return YS(Ls("", null, null, null, [""], e = US(e), 0, [0], e));
}
    ...
    switch (g = b, b = be()) {
      ...
      case 40:
        if (g != 108 && Hr(B, u - 1) == 58) {
          WS(B += vs(na(b), "&", "&\f"), "&\f", rm(c ? n[c - 1] : 0)) != -1 && (C = -1);
          break;
        }
      // " ' [
      case 34:
      ...
      case 47:
        switch (Qe()) {
          case 42:
          case 47:
            ds(KS(XS(be(), Bs()), t, r, l), l), (Wi(g || 1) == 5 || Wi(Qe() || 1) == 5) && Le(B) && Zr(B, -1, void 0) !== " " && (B += " ");
            break;
          default:
            B += "/";
        }
      ...
      case 0:
        switch (b) {
          ...
          // ;
          case 59 + h:
            C == -1 && (B = vs(B, /\f/g, "")), d > 0 && (Le(B) - u || m === 0 && g === 47) && ds(d > 32 ? yc(B + ";", i, r, u - 1, l) : yc(vs(B, " ", "") + ";", i, r, u - 2, l), l);
            break;
          // @ ;
          case 59:
            B += ";";
          // { rule/at-rule
          default:
            if (ds(v = mc(B, t, r, c, h, s, n, k, w = [], S = [], u, o), o), b === 123)
              if (h === 0)
                ...
                h ? Ls(e, v, v, i && ds(mc(e, v, v, 0, 0, s, n, k, s, w = [], u, S), S), s, S, u, n, i ? w : S) : Ls(B, v, v, v, [""], S, 0, n, S);
              }
        }
      ...
      default:
        ...
        switch (B += ll(b), b * m) {
          ...
          // @
          case 64:
            Qe() === 45 && (B += na(be())), f = Qe(), h = u = Le(k = B += VS(Bs())), b++;
            break;
          // -
          case 45:
            g === 45 && Le(B) == 2 && (m = 0);
...
function mc(e, t, r, i, s, o, a, n, l, c, h, u) {
  for (var f = s - 1, d = s === 0 ? o : [""], g = sm(d), m = 0, y = 0, C = 0; m < i; ++m)
    for (var b = 0, k = Zr(e, f + 1, f = rm(y = a[m])), w = e; b < g; ++b)
      (w = im(y > 0 ? d[b] + " " + k : vs(k, /&\f/g, d[b]))) && (l[C++] = w);
  return hl(e, t, r, s === 0 ? Jg : n, l, c, h, u);
}
function KS(e, t, r, i) {
  return hl(e, t, r, nl, ll(zS()), Zr(e, 2, -2), 0, i);
}
function yc(e, t, r, i, s) {
  return hl(e, t, r, tm, Zr(e, 0, i), Zr(e, i + 1, -1), i, s);
}
function an(e, t) {
...
var am = "c4", t_ = /* @__PURE__ */ p((e) => /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(e), "detector"), e_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./c4Diagram-AAUBKEIU-CfvNSQZl.js");
  return { id: am, diagram: e };
}, "loader"), r_ = {
  id: am,
  detector: t_,
  loader: e_
}, i_ = r_, nm = "flowchart", s_ = /* @__PURE__ */ p((e, t) => t?.flowchart?.defaultRenderer === "dagre-wrapper" || t?.flowchart?.defaultRenderer === "elk" ? !1 : /^\s*graph/.test(e), "detector"), o_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./flowDiagram-I6XJVG4X-DnAs3iJg.js");
  return { id: nm, diagram: e };
}, "loader"), a_ = {
  id: nm,
  detector: s_,
  loader: o_
}, n_ = a_, lm = "flowchart-v2", l_ = /* @__PURE__ */ p((e, t) => t?.flowchart?.defaultRenderer === "dagre-d3" ? !1 : (t?.flowchart?.defaultRenderer === "elk" && (t.layout = "elk"), /^\s*graph/.test(e) && t?.flowchart?.defaultRenderer === "dagre-wrapper" ? !0 : /^\s*flowchart/.test(e)), "detector"), h_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./flowDiagram-I6XJVG4X-DnAs3iJg.js");
  ...
  detector: l_,
  loader: h_
}, u_ = c_, hm = "er", d_ = /* @__PURE__ */ p((e) => /^\s*erDiagram/.test(e), "detector"), f_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./erDiagram-TEJ5UH35-DZxHkZBA.js");
  return { id: hm, diagram: e };
}, "loader"), p_ = {
  id: hm,
  detector: d_,
  loader: f_
}, g_ = p_, cm = "gitGraph", m_ = /* @__PURE__ */ p((e) => /^\s*gitGraph/.test(e), "detector"), y_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./gitGraphDiagram-PVQCEYII-DxsTxNqY.js");
  return { id: cm, diagram: e };
}, "loader"), C_ = {
  id: cm,
  detector: m_,
  loader: y_
}, x_ = C_, um = "gantt", b_ = /* @__PURE__ */ p((e) => /^\s*gantt/.test(e), "detector"), k_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./ganttDiagram-6RSMTGT7-nGFLCe5G.js");
  return { id: um, diagram: e };
}, "loader"), T_ = {
  id: um,
  detector: b_,
  loader: k_
}, w_ = T_, dm = "info", S_ = /* @__PURE__ */ p((e) => /^\s*info/.test(e), "detector"), __ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./infoDiagram-5YYISTIA-Em7zed_k.js");
  return { id: dm, diagram: e };
}, "loader"), v_ = {
  id: dm,
  detector: S_,
  loader: __
}, fm = "pie", B_ = /* @__PURE__ */ p((e) => /^\s*pie/.test(e), "detector"), L_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./pieDiagram-4H26LBE5-CrB57XwR.js");
  return { id: fm, diagram: e };
}, "loader"), F_ = {
  id: fm,
  detector: B_,
  loader: L_
}, pm = "quadrantChart", A_ = /* @__PURE__ */ p((e) => /^\s*quadrantChart/.test(e), "detector"), E_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./quadrantDiagram-W4KKPZXB-C3272ENJ.js");
  return { id: pm, diagram: e };
}, "loader"), M_ = {
  id: pm,
  detector: A_,
  loader: E_
}, $_ = M_, gm = "xychart", I_ = /* @__PURE__ */ p((e) => /^\s*xychart(-beta)?/.test(e), "detector"), O_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./xychartDiagram-2RQKCTM6-B4lWz0wI.js");
  return { id: gm, diagram: e };
}, "loader"), D_ = {
  id: gm,
  detector: I_,
  loader: O_
}, R_ = D_, mm = "requirement", P_ = /* @__PURE__ */ p((e) => /^\s*requirement(Diagram)?/.test(e), "detector"), N_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./requirementDiagram-4Y6WPE33-16cmQru3.js");
  return { id: mm, diagram: e };
}, "loader"), q_ = {
  id: mm,
  detector: P_,
  loader: N_
}, W_ = q_, ym = "sequence", z_ = /* @__PURE__ */ p((e) => /^\s*sequenceDiagram/.test(e), "detector"), H_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./sequenceDiagram-3UESZ5HK-Bhr_HK0W.js");
  return { id: ym, diagram: e };
}, "loader"), U_ = {
  id: ym,
  detector: z_,
  loader: H_
}, Y_ = U_, Cm = "class", G_ = /* @__PURE__ */ p((e, t) => t?.class?.defaultRenderer === "dagre-wrapper" ? !1 : /^\s*classDiagram/.test(e), "detector"), j_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./classDiagram-4FO5ZUOK-CkUW4IPd.js");
  return { id: Cm, diagram: e };
}, "loader"), X_ = {
  id: Cm,
  detector: G_,
  loader: j_
}, V_ = X_, xm = "classDiagram", Z_ = /* @__PURE__ */ p((e, t) => /^\s*classDiagram/.test(e) && t?.class?.defaultRenderer === "dagre-wrapper" ? !0 : /^\s*classDiagram-v2/.test(e), "detector"), K_ = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./classDiagram-v2-Q7XG4LA2-CkUW4IPd.js");
  return { id: xm, diagram: e };
}, "loader"), Q_ = {
  id: xm,
  detector: Z_,
  loader: K_
}, J_ = Q_, bm = "state", tv = /* @__PURE__ */ p((e, t) => t?.state?.defaultRenderer === "dagre-wrapper" ? !1 : /^\s*stateDiagram/.test(e), "detector"), ev = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./stateDiagram-AJRCARHV-m-rxEj1R.js");
  return { id: bm, diagram: e };
}, "loader"), rv = {
  id: bm,
  detector: tv,
  loader: ev
}, iv = rv, km = "stateDiagram", sv = /* @__PURE__ */ p((e, t) => !!(/^\s*stateDiagram-v2/.test(e) || /^\s*stateDiagram/.test(e) && t?.state?.defaultRenderer === "dagre-wrapper"), "detector"), ov = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./stateDiagram-v2-BHNVJYJU-Cb4C3CI_.js");
  return { id: km, diagram: e };
}, "loader"), av = {
  id: km,
  detector: sv,
  loader: ov
}, nv = av, Tm = "journey", lv = /* @__PURE__ */ p((e) => /^\s*journey/.test(e), "detector"), hv = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./journeyDiagram-JHISSGLW-NZV1BFn5.js");
  return { id: Tm, diagram: e };
}, "loader"), cv = {
  id: Tm,
  detector: lv,
  loader: hv
}, uv = cv, dv = /* @__PURE__ */ p((e, t, r) => {
  P.debug(`rendering svg for syntax error
`);
  const i = j1(t), s = i.append("g");
  i.attr("viewBox", "0 0 2412 512"), Qc(i, 100, 512, !0), s.append("path").attr("class", "error-icon").attr(
    "d",
...
}, gv = pv, Sm = "flowchart-elk", mv = /* @__PURE__ */ p((e, t = {}) => (
  ...
  detector: mv,
  loader: yv
}, xv = Cv, _m = "timeline", bv = /* @__PURE__ */ p((e) => /^\s*timeline/.test(e), "detector"), kv = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./timeline-definition-PNZ67QCA-CHDMH3gY.js");
  return { id: _m, diagram: e };
}, "loader"), Tv = {
  id: _m,
  detector: bv,
  loader: kv
}, wv = Tv, vm = "mindmap", Sv = /* @__PURE__ */ p((e) => /^\s*mindmap/.test(e), "detector"), _v = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./mindmap-definition-RKZ34NQL-hBjjDKjj.js");
  return { id: vm, diagram: e };
}, "loader"), vv = {
  id: vm,
  detector: Sv,
  loader: _v
}, Bv = vv, Bm = "kanban", Lv = /* @__PURE__ */ p((e) => /^\s*kanban/.test(e), "detector"), Fv = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./kanban-definition-UN3LZRKU-Cmv1KNMg.js");
  return { id: Bm, diagram: e };
}, "loader"), Av = {
  id: Bm,
  detector: Lv,
  loader: Fv
}, Ev = Av, Lm = "sankey", Mv = /* @__PURE__ */ p((e) => /^\s*sankey(-beta)?/.test(e), "detector"), $v = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./sankeyDiagram-5OEKKPKP-CYJJSN9b.js");
  return { id: Lm, diagram: e };
}, "loader"), Iv = {
  id: Lm,
  detector: Mv,
  loader: $v
}, Ov = Iv, Fm = "packet", Dv = /* @__PURE__ */ p((e) => /^\s*packet(-beta)?/.test(e), "detector"), Rv = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./diagram-LMA3HP47-DFWSHHss.js");
  return { id: Fm, diagram: e };
}, "loader"), Pv = {
  id: Fm,
  detector: Dv,
  loader: Rv
}, Am = "radar", Nv = /* @__PURE__ */ p((e) => /^\s*radar-beta/.test(e), "detector"), qv = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./diagram-2AECGRRQ-CnxSkGyE.js");
  return { id: Am, diagram: e };
}, "loader"), Wv = {
  id: Am,
  detector: Nv,
  loader: qv
}, Em = "block", zv = /* @__PURE__ */ p((e) => /^\s*block(-beta)?/.test(e), "detector"), Hv = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./blockDiagram-GPEHLZMM-CeD2S0LH.js");
  return { id: Em, diagram: e };
}, "loader"), Uv = {
  id: Em,
  detector: zv,
  loader: Hv
}, Yv = Uv, Mm = "treeView", Gv = /* @__PURE__ */ p((e) => /^\s*treeView-beta/.test(e), "detector"), jv = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./diagram-5GNKFQAL-CT9A5WUP.js");
  return { id: Mm, diagram: e };
}, "loader"), Xv = {
  id: Mm,
  detector: Gv,
  loader: jv
}, Vv = Xv, $m = "architecture", Zv = /* @__PURE__ */ p((e) => /^\s*architecture/.test(e), "detector"), Kv = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./architectureDiagram-3BPJPVTR-D12PJz_z.js");
  return { id: $m, diagram: e };
}, "loader"), Qv = {
  id: $m,
  detector: Zv,
  loader: Kv
}, Jv = Qv, Im = "eventmodeling", tB = /* @__PURE__ */ p((e) => /^\s*eventmodeling/.test(e), "detector"), eB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./diagram-KO2AKTUF-B10o-FJS.js");
  return { id: Im, diagram: e };
}, "loader"), rB = {
  id: Im,
  detector: tB,
  loader: eB
}, iB = rB, Om = "ishikawa", sB = /* @__PURE__ */ p((e) => /^\s*ishikawa(-beta)?\b/i.test(e), "detector"), oB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./ishikawaDiagram-YF4QCWOH-BqMDsT_z.js");
  return { id: Om, diagram: e };
}, "loader"), aB = {
  id: Om,
  detector: sB,
  loader: oB
}, Dm = "venn", nB = /* @__PURE__ */ p((e) => /^\s*venn-beta/.test(e), "detector"), lB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./vennDiagram-CIIHVFJN-D31jrko2.js");
  return { id: Dm, diagram: e };
}, "loader"), hB = {
  id: Dm,
  detector: nB,
  loader: lB
}, cB = hB, Rm = "treemap", uB = /* @__PURE__ */ p((e) => /^\s*treemap/.test(e), "detector"), dB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./diagram-OG6HWLK6-BIb02fkE.js");
  return { id: Rm, diagram: e };
}, "loader"), fB = {
  id: Rm,
  detector: uB,
  loader: dB
}, Pm = "wardley-beta", pB = /* @__PURE__ */ p((e) => /^\s*wardley-beta/i.test(e), "detector"), gB = /* @__PURE__ */ p(async () => {
  const { diagram: e } = await import("./wardleyDiagram-YWT4CUSO-BjiPAgwN.js");
  return { id: Pm, diagram: e };
}, "loader"), mB = {
  id: Pm,
  detector: pB,
  loader: gB
}, yB = mB, Cc = !1, Bo = /* @__PURE__ */ p(() => {
  Cc || (Cc = !0, $s("error", gv, (e) => e.toLowerCase().trim() === "error"), $s(
    "---",
...
}, "addDiagrams"), CB = /* @__PURE__ */ p(async () => {
...
}, "loadRegisteredDiagrams"), xB = "graphics-document document";
function Nm(e, t) {
  e.attr("role", xB), t !== "" && e.attr("aria-roledescription", t);
}
p(Nm, "setA11yDiagramInfo");
function qm(e, t, r, i) {
  if (e.insert !== void 0) {
    if (r) {
...
p(qm, "addSVGa11yTitleDescription");
var nn = class Wm {
...
`;
    try {
      ...
      const c = fy(s);
      if (!c)
        throw new Rc(`Diagram ${s} not found.`);
      const { id: h, diagram: u } = await c();
      $s(h, u);
    }
    const { db: o, parser: a, renderer: n, init: l } = ma(s);
    return a.parser && (a.parser.yy = o), o.clear?.(), l?.(i), r.title && o.setDiagramTitle?.(r.title), await a.parse(t), new Wm(s, t, o, a, n);
  }
  async render(t, r) {
...
}, "attachFunctions"), kB = /* @__PURE__ */ p((e) => e.replace(/^\s*%%(?!{)[^\n]+\n?/gm, "").trimStart(), "cleanupComments");
function zm(e) {
  const t = e.match(Dc);
  if (!t)
    return {
...
p(zm, "extractFrontMatter");
var TB = /* @__PURE__ */ p((e) => e.replace(/\r\n?/g, `
`).replace(
  /<(\w+)([^>]*)>/g,
  (t, r, i) => "<" + r + i.replace(/="([^"]*)"/g, "='$1'") + ">"
), "cleanupText"), wB = /* @__PURE__ */ p((e) => {
  const { text: t, metadata: r } = zm(e), { displayMode: i, title: s, config: o = {} } = r;
  return i && (o.gantt || (o.gantt = {}), o.gantt.displayMode = i), { title: s, config: o, text: t };
}, "processFrontmatter"), SB = /* @__PURE__ */ p((e) => {
...
function cl(e) {
  const t = TB(e), r = wB(t), i = SB(r.text), s = Yn(r.config, i.directive);
  return e = kB(i.text), {
    code: e,
    title: r.title,
    config: s
...
p(Hm, "toBase64");
var _B = 5e4, vB = "graph TB;a[Maximum text size in diagram exceeded];style a fill:#faa", BB = "sandbox", LB = "loose", FB = "http://www.w3.org/2000/svg", AB = "http://www.w3.org/1999/xlink", EB = "http://www.w3.org/1999/xhtml", MB = "100%", $B = "100%", IB = "border:0;margin:0;", OB = "margin:0", DB = "allow-top-navigation-by-user-activation allow-popups", RB = 'The "iframe" tag is not supported by your browser.', PB = ["foreignobject"], NB = ["dominant-baseline"];
function ul(e) {
  const t = cl(e);
  return Es(), qy(t.config ?? {}), t;
}
...
async function Um(e, t) {
  ...
  try {
    ...
    return { diagramType: (await Gm(r)).type, config: i };
  } catch (r) {
    if (t?.suppressErrors)
      return !1;
    throw r;
...
p(Um, "parse");
var bc = /* @__PURE__ */ p((e, t, r = []) => {
  const i = zc(`{ ${r.join(" !important; ")} !important; }`);
  return `.${e} ${t} ${i}`;
}, "cssImportantStyles"), qB = /* @__PURE__ */ p((e, t = /* @__PURE__ */ new Map()) => {
  ...
  if (e.fontFamily !== void 0 && r.insertRule(
    ...
    t.forEach((l) => {
      Ih(l.styles) || n.forEach((c) => {
        r.insertRule(
          bc(l.id, c, l.styles),
          r.cssRules.length
        );
      }), Ih(l.textStyles) || r.insertRule(
        bc(
          l.id,
          "tspan",
...
`;
  return i + ga(r);
}, "createCssStyles"), WB = /* @__PURE__ */ p((e, t) => an(
  ZS(`${e}{${t}}`),
  JS([
...
), "compileCSS"), zB = /* @__PURE__ */ p((e, t, r, i) => {
  const s = qB(e, r), o = oC(
    t,
    s,
  ...
  const r = t?.viewBox?.baseVal?.height ? t.viewBox.baseVal.height + "px" : $B, i = Hm(`<body style="${OB}">${e}</body>`);
  return `<iframe style="width:${MB};height:${r};${IB}" src="data:text/html;charset=UTF-8;base64,${i}" sandbox="${DB}">
  ${RB}
</iframe>`;
}, "putIntoIFrame"), kc = /* @__PURE__ */ p((e, t, r, i, s) => {
  const o = e.append("div");
  o.attr("id", r), i && o.attr("style", i);
  const a = o.append("svg").attr("id", t).attr("width", "100%").attr("xmlns", FB);
...
var YB = /* @__PURE__ */ p((e, t, r, i) => {
  e.getElementById(t)?.remove(), e.getElementById(r)?.remove(), e.getElementById(i)?.remove();
}, "removeExistingElements"), GB = /* @__PURE__ */ p(async function(e, t, r) {
  Bo();
  const i = ul(t);
  t = i.code;
  const s = Tt();
  P.debug(s), t.length > (s?.maxTextSize ?? _B) && (t = vB);
  const o = `#${e}`, a = "i" + e, n = "#" + a, l = "d" + e, c = "#" + l, h = /* @__PURE__ */ p(() => {
    const W = ct(f ? n : c).node();
    W && "remove" in W && W.remove();
  }, "removeTempElements");
  let u = ct(document.body);
  const f = s.securityLevel === BB, d = s.securityLevel === LB, g = s.fontFamily;
  if (r !== void 0) {
    if (r && (r.innerHTML = ""), f) {
      const z = ln(ct(r), a);
      ...
      u = ct(r);
    kc(u, e, l, `font-family: ${g}`, AB);
  } else {
    if (YB(document, e, l, a), f) {
  ...
  const C = u.select(c).node(), b = m.type, k = C.firstChild, w = k.firstChild, S = m.renderer.getClasses?.(t, m), v = zB(s, b, S, o), B = document.createElement("style");
  ...
  jm(b, O, N, D), u.select(`[id="${e}"]`).selectAll("foreignobject > *").attr("xmlns", EB);
  let $ = u.select(c).node().innerHTML;
  if (P.debug("config.arrowMarkerAbsolute", s.arrowMarkerAbsolute), $ = HB($, f, Ge(s.arrowMarkerAbsolute)), f) {
...
function Ym(e = {}) {
  const t = Mt({}, e);
  t?.fontFamily && !t.themeVariables?.fontFamily && (t.themeVariables || (t.themeVariables = {}), t.themeVariables.fontFamily = t.fontFamily), Py(t), t?.theme && t.theme in We ? t.themeVariables = We[t.theme].getThemeVariables(
    t.themeVariables
  ) : t && (t.themeVariables = We.default.getThemeVariables(t.themeVariables));
  const r = typeof t == "object" ? Ry(t) : Hc();
  hn(r.logLevel), Bo();
}
p(Ym, "initialize");
var Gm = /* @__PURE__ */ p((e, t = {}) => {
  const { code: r } = cl(e);
  return nn.fromText(r, t);
}, "getDiagramFromText");
function jm(e, t, r, i) {
  Nm(t, e), qm(t, r, i, t.attr("id"));
}
p(jm, "addA11yInfo");
var wr = Object.freeze({
  render: GB,
  parse: Um,
  getDiagramFromText: Gm,
  initialize: Ym,
  getConfig: Tt,
  setConfig: Uc,
  getSiteConfig: Hc,
...
var jB = /* @__PURE__ */ p((e, t, r) => {
...
}, "handleError"), Xm = /* @__PURE__ */ p(async function(e = {
...
}, "run"), XB = /* @__PURE__ */ p(async function({ postRenderCallback: e, querySelector: t, nodes: r } = {
  querySelector: ".mermaid"
}) {
  ...
  for (const l of Array.from(s)) {
    ...
    a = l.innerHTML, a = ap(Ce.entityDecode(a)).trim().replace(/<br\s*\/?>/gi, "<br/>");
    const h = Ce.detectInit(a);
    h && P.debug("Detected early reinit: ", h);
    try {
      const { svg: u, bindFunctions: f } = await Qm(c, a, l);
      l.innerHTML = u, e && await e(c), f && f(l);
    } catch (u) {
      jB(u, n, Ye.parseError);
    }
  }
  if (n.length > 0)
    throw n[0];
}, "runThrowsErrors"), Vm = /* @__PURE__ */ p(function(e) {
  wr.initialize(e);
}, "initialize"), VB = /* @__PURE__ */ p(async function(e, t, r) {
  P.warn("mermaid.init is deprecated. Please use run instead."), e && Vm(e);
  const i = { postRenderCallback: r, querySelector: ".mermaid" };
  typeof t == "string" ? i.querySelector = t : t && (t instanceof HTMLElement ? i.nodes = [t] : i.nodes = t), await Xm(i);
}, "init"), ZB = /* @__PURE__ */ p(async (e, {
  lazyLoad: t = !0
} = {}) => {
  Bo(), ua(...e), t === !1 && await CB();
...
var KB = /* @__PURE__ */ p(function(e) {
  Ye.parseError = e;
}, "setParseErrorHandler"), oo = [], la = !1, Km = /* @__PURE__ */ p(async () => {
  if (!la) {
...
}, "executeQueue"), QB = /* @__PURE__ */ p(async (e, t) => new Promise((r, i) => {
  ...
  oo.push(s), Km().catch(i);
}), "parse"), Qm = /* @__PURE__ */ p((e, t, r) => new Promise((i, s) => {
  ...
  oo.push(o), Km().catch(s);
}), "render"), JB = /* @__PURE__ */ p(() => Object.keys(yr).map((e) => ({
  id: e
  ...
  init: VB,
  run: Xm,
  registerExternalDiagrams: ZB,
  registerLayoutLoaders: Qg,
  initialize: Vm,
  parseError: void 0,
  contentLoaded: Zm,
  setParseErrorHandler: KB,
  detectType: cn,
  registerIconPacks: sw,
  getRegisteredDiagramsMetadata: JB
}, fs = Ye;
...
class jt extends k0 {
   ...
   */
  init() {
    T0.INSTANCE.set(jt.eNS_URI, this), this.setEFactoryInstance(dl.eINSTANCE);
    const t = new w0();
    ...
    const i = new Nl();
    i.setName("value"), i.setLowerBound(0), i.setUpperBound(1), t.getEStructuralFeatures().push(i), jt.Literals.MERMAID_WIDGET_SETTINGS__VALUE = i, jt.Literals.MERMAID_WIDGET_SETTINGS__THEME.setEType(ql().getEClassifier("EString")), jt.Literals.MERMAID_WIDGET_SETTINGS__VALUE.setEType(ql().getEClassifier("EString"));
  }
}
class zt extends S0 {
...
const tL = /* @__PURE__ */ wc({
  ...
  setup(e, { expose: t }) {
    const r = Sc(e, "configv"), i = e, { id: s } = p0(i), o = Il(x0.TINY_EMITTER), a = Il(n0), l = C0().params.pageid || "", c = Wo(1);
    class h extends no {
      refresh() {
        m.value = Date.now(), zo(() => {
    ...
    }, { deep: !0, immediate: !0 }), (C, b) => (vc(), _c("div", {
      ref_key: "container",
      ref: g,
      key: m.value,
      onClick: f,
      onContextmenu: m0(d, ["prevent"]),
      class: "w-full h-full"
    }, y0(r.value.value), 33));
  }
}), eL = { class: "settings_container" }, rL = /* @__PURE__ */ wc({
  ...
  for (const [i, s] of t)
    r[i] = s;
  return r;
}, sL = /* @__PURE__ */ iL(rL, [["__scopeId", "data-v-43f12bc1"]]), oL = [
  {
...
`;
var nL = Object.defineProperty, lL = Object.getOwnPropertyDescriptor, fl = (e, t, r, i) => {
  for (var s = i > 1 ? void 0 : i ? lL(t, r) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (s = (i ? a(t, r, s) : a(s)) || s);
  return i && s && nL(t, r, s), s;
}, Tc = (e, t) => (r, i) => t(r, i, e);
jt.eINSTANCE;
...
let ao = class {
  ...
  register() {
    this.events.registerWidget(Pr, oL), this.actions.registerWidgetType(Pr, no, "widget");
  }
  unregister() {
