import { _ as o, l as te, c as H, I as fe, af as ye, ag as be, ah as me, Y as _e, G as Y, i as j, t as ke, J as Ee, V as Se, W as ce, X as le } from "./index-DUg_7Lze.js";
import { g as Ne } from "./chunk-FMBD7UC4-Dg_6cZ9Y.js";
var $ = (function() {
  var e = /* @__PURE__ */ o(function(O, i, n, r) {
    for (n = n || {}, r = O.length; r--; n[O[r]] = i) ;
    return n;
  }, "o"), h = [1, 4], p = [1, 13], s = [1, 12], d = [1, 15], _ = [1, 16], m = [1, 20], l = [1, 19], D = [6, 7, 8], I = [1, 26], g = [1, 24], w = [1, 25], k = [6, 7, 11], F = [1, 31], N = [6, 7, 11, 24], V = [1, 6, 13, 16, 17, 20, 23], f = [1, 35], A = [1, 36], L = [1, 6, 7, 11, 13, 16, 17, 20, 23], M = [1, 38], T = {
    ...
    performAction: /* @__PURE__ */ o(function(i, n, r, a, u, t, U) {
      var c = t.length - 1;
      switch (u) {
        case 6:
        case 7:
    ...
    parse: /* @__PURE__ */ o(function(i) {
      var n = this, r = [0], a = [], u = [null], t = [], U = this.table, c = "", W = 0, se = 0, ue = 2, re = 1, ge = t.slice.call(arguments, 1), b = Object.create(this.lexer), R = { yy: {} };
      ...
      o(ae, "lex");
      for (var E, P, x, Q, G = {}, z, C, oe, X; ; ) {
        if (P = r[r.length - 1], this.defaultActions[P] ? x = this.defaultActions[P] : ((E === null || typeof E > "u") && (E = ae()), x = U[P] && U[P][E]), typeof x > "u" || !x.length || !x[0]) {
          var Z = "";
          X = [];
          for (z in U[P])
...
Expecting ` + X.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : Z = "Parse error on line " + (W + 1) + ": Unexpected " + (E == re ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(Z, {
        ...
        switch (x[0]) {
          case 1:
            ...
            break;
          case 2:
            if (C = this.productions_[x[1]][1], G.$ = u[u.length - C], G._$ = {
              ...
              return Q;
            C && (r = r.slice(0, -1 * C * 2), u = u.slice(0, -1 * C), t = t.slice(0, -1 * C)), r.push(this.productions_[x[1]][0]), u.push(G.$), t.push(G._$), oe = U[r[r.length - 2]][r[r.length - 1]], r.push(oe);
            break;
          case 3:
            return !0;
        }
...
var xe = $, v = [], ne = [], ee = 0, ie = {}, ve = /* @__PURE__ */ o(() => {
  ...
  const _ = H();
  let m = _.mindmap?.padding ?? Y.mindmap.padding;
  switch (s) {
    case y.ROUNDED_RECT:
    case y.RECT:
    case y.HEXAGON:
  ...
  const l = {
    ...
    level: e,
    label: j(p, _),
    width: _.mindmap?.maxNodeWidth ?? Y.mindmap.maxNodeWidth,
    padding: m,
    isGroup: !1
  };
  if (d !== void 0) {
...
` + d + `
  ...
  e.icon && (p.icon = j(e.icon, h)), e.class && (p.cssClasses = j(e.class, h));
  ...
  getLogger: Te,
  getElementById: Re
}, Ve = Pe, Be = /* @__PURE__ */ o(async (e, h, p, s) => {
  te.debug(`Rendering kanban diagram
` + e);
  const _ = s.db.getData(), m = H();
  m.htmlLabels = !1;
  const l = fe(h);
  ...
  for (const f of g) {
    ...
    N = Math.max(N, L?.labelBBox?.height), F.push(L);
  }
  let V = 0;
  for (const f of g) {
    const A = F[V];
    ...
    let T = M;
    const K = _.nodes.filter((i) => i.parentId === f.id);
    for (const i of K) {
      if (i.isGroup)
    ...
    const B = A.cluster.select("rect"), O = Math.max(T - M + 3 * k, 50) + (N - 25);
    B.attr("height", O);
  }
  _e(
    void 0,
    l,
    m.mindmap?.padding ?? Y.kanban.padding,
    m.mindmap?.useMaxWidth ?? Y.kanban.useMaxWidth
  );
}, "draw"), Ge = {
  draw: Be
}, je = /* @__PURE__ */ o((e) => {
