import { _ as g, n as tr, c as $, d as Mt, l as at, j as Ce, e as er, f as rr, k as P, b as ke, s as ar, p as sr, a as ir, g as nr, q as or, t as cr, J as lr, z as hr, i as Bt, u as Z, L as Q, M as wt, N as Me, Z as dr, D as Yt, O as Tr, P as Be } from "./index-DUg_7Lze.js";
import { a as pr, b as ee, g as dt, d as Er, e as re, f as ae } from "./chunk-ND2GUHAM-BlXyBeX7.js";
import { I as ur } from "./chunk-QZHKN3VN-6kwxqH1m.js";
var $t = (function() {
  var e = /* @__PURE__ */ g(function(ut, w, v, k) {
    for (v = v || {}, k = ut.length; k--; v[ut[k]] = w) ;
    return v;
  }, "o"), t = [1, 2], a = [1, 3], r = [1, 4], i = [2, 4], o = [1, 9], s = [1, 11], n = [1, 12], E = [1, 14], T = [1, 15], l = [1, 17], x = [1, 18], u = [1, 19], O = [1, 25], p = [1, 26], f = [1, 27], _ = [1, 28], I = [1, 29], L = [1, 30], b = [1, 31], S = [1, 32], A = [1, 33], N = [1, 34], B = [1, 35], V = [1, 36], q = [1, 37], U = [1, 38], G = [1, 39], X = [1, 40], j = [1, 42], H = [1, 43], st = [1, 44], tt = [1, 45], it = [1, 46], Y = [1, 47], C = [1, 4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 49, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], Nt = [1, 74], m = [1, 80], D = [1, 81], lt = [1, 82], et = [1, 83], W = [1, 84], se = [1, 85], ie = [1, 86], ne = [1, 87], oe = [1, 88], ce = [1, 89], le = [1, 90], he = [1, 91], de = [1, 92], Te = [1, 93], pe = [1, 94], Ee = [1, 95], ue = [1, 96], fe = [1, 97], _e = [1, 98], ge = [1, 99], xe = [1, 100], Ie = [1, 101], ye = [1, 102], Re = [1, 103], Oe = [1, 104], Le = [1, 105], be = [2, 78], mt = [4, 5, 17, 51, 53, 54], Pt = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 51, 53, 54, 56, 61, 62, 63, 64, 73], me = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], Ht = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 49, 51, 53, 54, 56, 61, 62, 63, 64, 73], Ae = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 51, 53, 54, 56, 61, 62, 63, 64, 73], zt = [5, 52], K = [70, 71, 72, 73], ot = [1, 151], Ut = {
...
`;
  ...
  if (pt.has(T) && (b.style("stroke", u[N % u.length]), b.style("fill", x[N % u.length]), S.style("stroke", u[N % u.length]), S.style("fill", x[N % u.length])), t.properties?.icon) {
    const q = t.properties.icon.trim(), U = f.x + f.width - 20, G = f.y + 10;
    q.charAt(0) === "@" ? re(p, U, G, q.substr(1)) : ae(p, U, G, q);
  }
  Et(a, Q(t.description))(
    t.description,
    p,
...
`;
  ...
  const q = N.select("path:last-child");
  if (q.node()) {
    const U = q.node().getBBox();
...
}, "insertArrowCrossHead"), Hr = /* @__PURE__ */ g(function(e, t) {
  const { theme: a } = t;
  ...
  newActivation: /* @__PURE__ */ g(function(e, t, a) {
    const r = a.get(e.from), i = qt(e.from).length || 0, o = r.x + r.width / 2 + (i - 1) * h.activationWidth / 2;
...
var $r = /* @__PURE__ */ g(async function(e, t, a, r, i, o) {
  ...
  if (h.arrowMarkerAbsolute && (I = Tr(!0)), _.attr("stroke-width", 2), _.attr("stroke", "none"), _.style("fill", "none"), (l === r.db.LINETYPE.SOLID_TOP || l === r.db.LINETYPE.SOLID_TOP_DOTTED) && _.attr("marker-end", "url(" + I + "#" + o + "-solidTopArrowHead)"), (l === r.db.LINETYPE.SOLID_BOTTOM || l === r.db.LINETYPE.SOLID_BOTTOM_DOTTED) && _.attr("marker-end", "url(" + I + "#" + o + "-solidBottomArrowHead)"), (l === r.db.LINETYPE.STICK_TOP || l === r.db.LINETYPE.STICK_TOP_DOTTED) && _.attr("marker-end", "url(" + I + "#" + o + "-stickTopArrowHead)"), (l === r.db.LINETYPE.STICK_BOTTOM || l === r.db.LINETYPE.STICK_BOTTOM_DOTTED) && _.attr("marker-end", "url(" + I + "#" + o + "-stickBottomArrowHead)"), (l === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE || l === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED) && _.attr("marker-start", "url(" + I + "#" + o + "-solidBottomArrowHead)"), (l === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE || l === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED) && _.attr("marker-start", "url(" + I + "#" + o + "-solidTopArrowHead)"), (l === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE || l === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED) && _.attr("marker-start", "url(" + I + "#" + o + "-stickBottomArrowHead)"), (l === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE || l === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED) && _.attr("marker-start", "url(" + I + "#" + o + "-stickTopArrowHead)"), (l === r.db.LINETYPE.SOLID || l === r.db.LINETYPE.DOTTED) && _.attr("marker-end", "url(" + I + "#" + o + "-arrowhead)"), (l === r.db.LINETYPE.BIDIRECTIONAL_SOLID || l === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (_.attr("marker-start", "url(" + I + "#" + o + "-arrowhead)"), _.attr("marker-end", "url(" + I + "#" + o + "-arrowhead)")), (l === r.db.LINETYPE.SOLID_POINT || l === r.db.LINETYPE.DOTTED_POINT) && _.attr("marker-end", "url(" + I + "#" + o + "-filled-head)"), (l === r.db.LINETYPE.SOLID_CROSS || l === r.db.LINETYPE.DOTTED_CROSS) && _.attr("marker-end", "url(" + I + "#" + o + "-crosshead)"), u || h.showSequenceNumbers) {
    ...
    let V = 0;
    const q = s === n, U = s <= n;
    q ? V = t.fromBounds + 1 : b ? V = U ? t.toBounds - 1 : t.fromBounds + 1 : V = U ? t.fromBounds + 1 : t.toBounds - 1;
    let G = "12px";
...
}, "drawActorsPopup"), He = /* @__PURE__ */ g(function(e) {
...
var ta = /* @__PURE__ */ g(async function(e, t, a, r) {
  ...
  for (const m of _) {
    ...
    switch (m.type) {
      ...
      case r.db.LINETYPE.AUTONUMBER:
        V = m.message.start || V, q = m.message.step || q, m.message.visible ? r.db.enableSequenceNumbers() : r.db.disableSequenceNumbers();
        break;
    ...
    ].includes(m.type) && (V = Math.round((V + q) * 100) / 100), X++;
  }
  ...
  const j = qe(l, x, f, T), { bounds: H } = R.getBounds();
  H.startx === void 0 && (H.startx = 0), H.starty === void 0 && (H.starty = 0), H.stopx === void 0 && (H.stopx = 0), H.stopy === void 0 && (H.stopy = 0);
  let st = H.stopy - H.starty;
  st < j.maxHeight && (st = j.maxHeight);
  let tt = st + 2 * h.diagramMarginY;
  h.mirrorActors && (tt = tt - h.boxMargin + h.bottomMarginAdj);
  let it = H.stopx - H.startx;
  it < j.maxWidth && (it = j.maxWidth);
  const Y = it + 2 * h.diagramMarginX;
  I && l.append("text").text(I).attr("x", (H.stopx - H.startx) / 2 - 2 * h.diagramMarginX).attr("y", -25), er(l, tt, Y, h.useMaxWidth);
  const C = I ? 40 : 0, Nt = x.size && s === "neo" ? 30 : 0;
  l.attr(
    "viewBox",
    H.startx - h.diagramMarginX + " -" + (h.diagramMarginY + C) + " " + Y + " " + (tt + C + Nt)
...
var ra = /* @__PURE__ */ g(async function(e, t, a) {
  ...
  for (const T of e) {
    switch (T.type) {
      ...
      case r.db.LINETYPE.ACTIVE_START:
        {
          const x = t.get(T.from ? T.from : T.to.actor), u = qt(T.from ? T.from : T.to.actor).length, O = x.x + x.width / 2 + (u - 1) * h.activationWidth / 2, p = {
            startx: O,
            stopx: O + h.activationWidth,
            actor: T.from,
            enabled: !0
