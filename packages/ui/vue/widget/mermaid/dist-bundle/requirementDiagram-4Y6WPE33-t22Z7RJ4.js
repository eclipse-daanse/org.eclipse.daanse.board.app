import { g as ze } from "./chunk-55IACEB6-D82UHEE2.js";
import { s as Ge } from "./chunk-2J33WTMH-CYgUCGiS.js";
import { _ as h, D as Ye, b as Xe, a as Je, s as Ze, g as et, p as tt, q as st, c as Te, l as Ne, z as it, C as rt, o as nt, r as at, u as lt } from "./index-EP6gW4O2.js";
var qe = (function() {
  var e = /* @__PURE__ */ h(function($, r, a, c) {
    ...
    parse: /* @__PURE__ */ h(function(r) {
      var a = this, c = [0], s = [], m = [null], t = [], me = this.table, l = "", Re = 0, Fe = 0, He = 2, $e = 1, Ke = t.slice.call(arguments, 1), y = Object.create(this.lexer), z = { yy: {} };
      for (var Se in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Se) && (z.yy[Se] = this.yy[Se]);
      y.setInput(r, z.yy), z.yy.lexer = y, z.yy.parser = this, typeof y.yylloc > "u" && (y.yylloc = {});
      var be = y.yylloc;
      t.push(be);
      ...
      h(Pe, "lex");
      for (var b, G, N, Ie, J = {}, ge, F, Ue, ye; ; ) {
        if (G = c[c.length - 1], this.defaultActions[G] ? N = this.defaultActions[G] : ((b === null || typeof b > "u") && (b = Pe()), N = me[G] && me[G][b]), typeof N > "u" || !N.length || !N[0]) {
          var ke = "";
          ye = [];
          for (ge in me[G])
...
var mt = /* @__PURE__ */ h(async function(e, u, o, n) {
  ...
  const { securityLevel: i, state: f, layout: _, look: E } = Te(), g = n.db.getData(), S = ze(u, i);
  ...
  ), Ge(S, k, "requirementDiagram", f?.useMaxWidth ?? !0);
}, "draw"), Rt = {
  parser: ct,
  get db() {
    return new ot();
