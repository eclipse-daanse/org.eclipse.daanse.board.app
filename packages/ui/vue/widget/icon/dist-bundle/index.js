...
import { PayloadImpl as B, EventsPackage as te, EVENT_REGISTRY_ID as _e } from "org.eclipse.daanse.board.app.lib.api.events";
import { activate as ae, deactivate as oe, component as re, inject as ie, initTsmRuntime as se } from "@eclipse-daanse/tsm";
import { defineComponent as Z, mergeModels as ne, useCssVars as le, unref as A, toRefs as ce, useModel as H, inject as K, onMounted as Y, computed as k, createElementBlock as O, openBlock as T, Fragment as G, createElementVNode as C, withModifiers as de, mergeProps as ue, toDisplayString as $, ref as S, resolveComponent as N, createVNode as g, withCtx as D, normalizeStyle as pe, renderList as he, normalizeClass as me } from "vue";
import { VariableWrapper as I, useVariableRepository as ge, plainSettings as M } from "org.eclipse.daanse.board.app.ui.vue.composables";
import { BasicEFactory as fe, BasicEPackage as be, EPackageRegistry as X, BasicEClass as F, BasicEReference as we, BasicEAttribute as y, getEcorePackage as v, BasicEObject as ye } from "@emfts/core";
...
function R(l) {
  const e = X.INSTANCE.getEPackage(l);
  if (!e)
...
class o extends be {
   ...
   */
  init() {
    X.INSTANCE.set(o.eNS_URI, this), this.setEFactoryInstance(W.eINSTANCE);
    const e = new F();
...
const Ne = /* @__PURE__ */ Z({
  ...
  setup(l) {
    ...
    const e = l, { id: t } = ce(e), { wrapParameters: s } = ge(), _ = H(l, "configv"), d = new a(), c = K(ve.TINY_EMITTER);
    Y(() => {
      if (_.value) {
    ...
    return (r, i) => (T(), O(G, null, [
      ...
      C("div", {
        class: "icon",
        onClick: p,
        onContextmenu: de(f, ["prevent"]),
        style: { cursor: "pointer" }
      }, [
        C("span", ue(r.$attrs, {
          style: m.value,
          class: "material-symbols-outlined"
        }), $(_.value.currentIcon), 17)
      ], 32)
    ], 64));
  }
}), J = (l, e) => {
  ...
  setup(l) {
    ...
    return (r, i) => {
      const E = N("va-input"), q = N("va-collapse"), Q = N("va-checkbox"), ee = N("va-color-input"), x = N("va-slider");
      return T(), O(G, null, [
        g(q, {
          ...
          default: D(() => [
            C("div", xe, [
              ...
              C("div", {
                ...
                (T(!0), O(G, null, he(f.value, (n) => (T(), O("span", {
                  key: n,
                  onClick: (j) => h(n),
...
}), U = /* @__PURE__ */ J(Te, [["__scopeId", "data-v-a8457eeb"]]), Le = [
  {
    name: "Icon Clicked",
    type: "click",
...
`;
var De = Object.defineProperty, Fe = Object.getOwnPropertyDescriptor, V = (l, e, t, s) => {
  for (var _ = s > 1 ? void 0 : s ? Fe(e, t) : e, d = l.length - 1, c; d >= 0; d--)
    (c = l[d]) && (_ = (s ? c(e, t, _) : c(_)) || _);
  return s && _ && De(e, t, _), _;
}, Re = (l, e) => (t, s) => e(t, s, l);
te.eINSTANCE;
o.eINSTANCE;
const L = "IconWidget";
let z = class {
  ...
  register() {
    this.events.registerWidget(L, Le), se().register(
      "org.eclipse.daanse.board.app.ui.vue.widget.icon",
      { IconWidget: P, IconWidgetSettings: U },
      "0.0.1-next.1",
      "ui.vue.widget.icon"
    );
  }
