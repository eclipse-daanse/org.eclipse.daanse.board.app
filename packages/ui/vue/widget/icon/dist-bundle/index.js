...
function z(c) {
  const e = Z.INSTANCE.getEPackage(c);
  if (!e)
...
class o extends ue {
   ...
   */
  init() {
    Z.INSTANCE.set(o.eNS_URI, this), this.setEFactoryInstance(F.eINSTANCE);
    const e = new L();
    ...
    const r = new w();
    r.setName("iconSize"), r.setLowerBound(0), r.setUpperBound(1), e.getEStructuralFeatures().push(r), o.Literals.ICON_SETTINGS__ICON_SIZE = r;
    const a = new w();
    ...
    const u = new w();
    u.setName("opticSize"), u.setLowerBound(0), u.setUpperBound(1), e.getEStructuralFeatures().push(u), o.Literals.ICON_SETTINGS__OPTIC_SIZE = u;
    const h = new w();
    h.setName("grade"), h.setLowerBound(0), h.setUpperBound(1), e.getEStructuralFeatures().push(h), o.Literals.ICON_SETTINGS__GRADE = h;
    const m = new w();
    m.setName("currentIcon"), m.setLowerBound(0), m.setUpperBound(1), e.getEStructuralFeatures().push(m), o.Literals.ICON_SETTINGS__CURRENT_ICON = m;
    const l = new L();
    l.setName("IconClickPayload"), l.setAbstract(!1), l.setInterface(!1), this.getEClassifiers().push(l), l.setEPackage(this), o.Literals.ICON_CLICK_PAYLOAD = l;
    const n = new w();
    n.setName("iconName"), n.setLowerBound(0), n.setUpperBound(1), l.getEStructuralFeatures().push(n), o.Literals.ICON_CLICK_PAYLOAD__ICON_NAME = n;
    const i = new L();
    i.setName("IconRightClickPayload"), i.setAbstract(!1), i.setInterface(!1), this.getEClassifiers().push(i), i.setEPackage(this), o.Literals.ICON_RIGHT_CLICK_PAYLOAD = i;
    const s = new w();
    s.setName("iconName"), s.setLowerBound(0), s.setUpperBound(1), i.getEStructuralFeatures().push(s), o.Literals.ICON_RIGHT_CLICK_PAYLOAD__ICON_NAME = s, o.Literals.ICON_CLICK_PAYLOAD.getESuperTypes().push(z("http://org.eclipse.daanse.board.app.lib.events").getEClassifier("Payload")), o.Literals.ICON_RIGHT_CLICK_PAYLOAD.getESuperTypes().push(z("http://org.eclipse.daanse.board.app.lib.events").getEClassifier("Payload")), o.Literals.ICON_SETTINGS__ICON_COLOR.setEType(z("org.eclipse.daanse.board.app.ui.vue.composables").getEClassifier("VariableWrapper")), o.Literals.ICON_SETTINGS__ICON_SIZE.setEType(y().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__IS_ICON_FILLED.setEType(y().getEClassifier("EBoolean")), o.Literals.ICON_SETTINGS__STROKE_WEIGHT.setEType(y().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__OPTIC_SIZE.setEType(y().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__GRADE.setEType(y().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__CURRENT_ICON.setEType(y().getEClassifier("EString")), o.Literals.ICON_CLICK_PAYLOAD__ICON_NAME.setEType(y().getEClassifier("EString")), o.Literals.ICON_RIGHT_CLICK_PAYLOAD__ICON_NAME.setEType(y().getEClassifier("EString"));
  }
}
class _ extends he {
  // Feature ID Constants (eLiterals)
...
const ke = /* @__PURE__ */ j({
  ...
  setup(c) {
    ...
    const e = c, { id: t } = ae(e), { wrapParameters: r } = ce(), a = M(c, "configv"), d = new _(), u = P(me.TINY_EMITTER);
    U(() => {
      if (a.value) {
    ...
    const h = () => {
      ...
      console.log("🖱️ Icon Widget: Emitting click event", s), u.emit("widget:IconWidget:click", {
      ...
      console.log("🖱️ Icon Widget: Emitting right-click event", s), u.emit("widget:IconWidget:right_click", {
  ...
  setup(c) {
    const e = P("i18n"), t = (l) => e ? e.t(l) : l, r = M(c, "modelValue");
    T(
      JSON.parse(localStorage.getItem("isDarkTheme") || "false")
    );
    const a = T([]), d = T(""), u = I(() => a.value.filter(
      (l) => l.toLowerCase().includes(d.value.toLowerCase())
    )), h = (l) => {
      l && (r.value.currentIcon = l);
    };
    U(() => {
      a.value = Ce;
    });
    const m = I(() => 'font-variation-settings: "FILL" 0, "wght" 200, "GRAD" 100, "opsz" 48;');
    return (l, n) => (x(), E(D, null, [
      v("section", Ie, [
        v("div", Ne, [
          b(p(ge), {
            modelValue: d.value,
          ...
          v("div", {
            ...
            (x(!0), E(D, null, se(u.value, (i) => (x(), E("span", {
              key: i,
              onClick: (s) => h(i),
              class: ne(["material-symbols-outlined", { "active-icon": i === r.value.currentIcon }])
            }, B(i), 11, Ee))), 128))
          ], 4)
        ])
      ]),
      v("section", {
        class: "settings-section",
        "data-section": t("IconWidget.title")
      }, [
        v("div", Se, [
          b(p(fe), {
            modelValue: r.value.isIconFilled,
            "onUpdate:modelValue": n[1] || (n[1] = (i) => r.value.isIconFilled = i),
            label: t("icon:IconWidget.iconFilled")
          }, null, 8, ["modelValue", "label"]),
          b(p(we), {
            modelValue: r.value.iconColor,
            "onUpdate:modelValue": n[2] || (n[2] = (i) => r.value.iconColor = i),
            label: t("icon:IconWidget.iconColor")
          }, {
            default: le(({ value: i, change: s }) => [
              b(p(be), {
                "model-value": i,
          ...
          b(p(N), {
            ...
            "onUpdate:modelValue": n[3] || (n[3] = (i) => r.value.iconSize = i),
            min: 10,
            max: 1e3,
            step: 10,
            suffix: "px",
          ...
          b(p(N), {
            ...
            "onUpdate:modelValue": n[4] || (n[4] = (i) => r.value.strokeWeight = i),
            min: 100,
            max: 700,
            step: 100,
          ...
          b(p(N), {
            ...
            "onUpdate:modelValue": n[5] || (n[5] = (i) => r.value.opticSize = i),
            min: 20,
            max: 48,
          ...
          b(p(N), {
            ...
            "onUpdate:modelValue": n[6] || (n[6] = (i) => r.value.grade = i),
            min: -25,
            max: 200,
            step: 15,
...
}), q = /* @__PURE__ */ H(Oe, [["__scopeId", "data-v-ef16ad98"]]), Te = [
  {
    name: "Icon Clicked",
    type: "click",
...
`;
var ze = Object.defineProperty, De = Object.getOwnPropertyDescriptor, R = (c, e, t, r) => {
  for (var a = r > 1 ? void 0 : r ? De(e, t) : e, d = c.length - 1, u; d >= 0; d--)
    (u = c[d]) && (a = (r ? u(e, t, a) : u(a)) || a);
  return r && a && ze(e, t, a), a;
}, Fe = (c, e) => (t, r) => e(t, r, c);
K.eINSTANCE;
o.eINSTANCE;
const S = "IconWidget";
let O = class {
  ...
  register() {
    this.events.registerWidget(S, Te), ee().register(
