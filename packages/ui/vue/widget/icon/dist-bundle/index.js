...
import { defineComponent as j, mergeModels as ee, useCssVars as te, unref as l, toRefs as _e, useModel as M, inject as ae, onMounted as P, computed as I, createElementBlock as E, openBlock as x, Fragment as D, createElementVNode as v, withModifiers as oe, mergeProps as re, toDisplayString as U, ref as T, createVNode as b, normalizeStyle as ie, renderList as se, normalizeClass as ne, withCtx as le } from "vue";
import { VariableWrapper as C, useVariableRepository as ce, plainSettings as G, useTranslation as de } from "org.eclipse.daanse.board.app.ui.vue.composables";
import { BasicEFactory as ue, BasicEPackage as pe, EPackageRegistry as B, BasicEClass as L, BasicEReference as he, BasicEAttribute as w, getEcorePackage as y, BasicEObject as me } from "@emfts/core";
...
class g extends V {
  ...
  set iconName(e) {
    ...
    this._iconName = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(g.ICON_NAME),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
...
class o extends pe {
  ...
  init() {
    ...
    const m = new w();
    m.setName("grade"), m.setLowerBound(0), m.setUpperBound(1), e.getEStructuralFeatures().push(m), o.Literals.ICON_SETTINGS__GRADE = m;
    const p = new w();
    ...
    const i = new L();
    i.setName("IconClickPayload"), i.setAbstract(!1), i.setInterface(!1), this.getEClassifiers().push(i), i.setEPackage(this), o.Literals.ICON_CLICK_PAYLOAD = i;
    const r = new w();
    r.setName("iconName"), r.setLowerBound(0), r.setUpperBound(1), i.getEStructuralFeatures().push(r), o.Literals.ICON_CLICK_PAYLOAD__ICON_NAME = r;
    const h = new L();
...
const Ce = /* @__PURE__ */ j({
  ...
  setup(c) {
    ...
    const e = c, { id: t } = _e(e), { wrapParameters: n } = ce(), a = M(c, "configv"), u = new _(), d = ae(ge.TINY_EMITTER);
    P(() => {
      if (a.value) {
  ...
  setup(c) {
    ...
    const m = I(() => 'font-variation-settings: "FILL" 0, "wght" 200, "GRAD" 100, "opsz" 48;');
    return (p, i) => (x(), E(D, null, [
      v("section", Ne, [
        v("div", Ee, [
          b(l(fe), {
            modelValue: a.value,
          ...
          v("div", {
            ...
            (x(!0), E(D, null, se(u.value, (r) => (x(), E("span", {
              key: r,
              onClick: (h) => d(r),
              class: ne(["material-symbols-outlined", { "active-icon": r === t.value.currentIcon }])
            }, U(r), 11, xe))), 128))
          ], 4)
        ])
      ]),
      v("section", {
        ...
        v("div", Oe, [
          b(l(be), {
            ...
            "onUpdate:modelValue": i[1] || (i[1] = (r) => t.value.isIconFilled = r),
            label: l(e)("IconWidget.iconFilled")
          }, null, 8, ["modelValue", "label"]),
          b(l(ye), {
            modelValue: t.value.iconColor,
            "onUpdate:modelValue": i[2] || (i[2] = (r) => t.value.iconColor = r),
            label: l(e)("IconWidget.iconColor")
          }, {
            default: le(({ value: r, change: h }) => [
              b(l(we), {
                "model-value": r,
          ...
          b(l(N), {
            ...
            "onUpdate:modelValue": i[3] || (i[3] = (r) => t.value.iconSize = r),
            min: 10,
            max: 1e3,
            step: 10,
            suffix: "px",
          ...
          b(l(N), {
            ...
            "onUpdate:modelValue": i[4] || (i[4] = (r) => t.value.strokeWeight = r),
            min: 100,
            max: 700,
            step: 100,
          ...
          b(l(N), {
            ...
            "onUpdate:modelValue": i[5] || (i[5] = (r) => t.value.opticSize = r),
            min: 20,
            max: 48,
          ...
          b(l(N), {
            ...
            "onUpdate:modelValue": i[6] || (i[6] = (r) => t.value.grade = r),
            min: -25,
            max: 200,
            step: 15,
...
}), q = /* @__PURE__ */ Z(Te, [["__scopeId", "data-v-b042ae74"]]), Le = [
  {
    name: "Icon Clicked",
    type: "click",
...
], ze = `<?xml version="1.0" encoding="UTF-8"?>
<!--
/*********************************************************************
...
let O = class {
  ...
  register() {
    this.events.registerWidget(S, Le), Q().register(
      "org.eclipse.daanse.board.app.ui.vue.widget.icon",
      { IconWidget: W, IconWidgetSettings: q },
      "0.0.1-next.1",
      "ui.vue.widget.icon"
    );
  }
