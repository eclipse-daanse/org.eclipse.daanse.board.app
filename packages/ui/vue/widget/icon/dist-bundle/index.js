(function(){var i="ui.vue.widget.icon",d=document,s=d.querySelector('style[data-tsm-bundle="'+i+'"]');if(!s){s=d.createElement('style');s.setAttribute('data-tsm-bundle',i);d.head.appendChild(s);}s.textContent=".icon[data-v-46b71af4]{width:100%;height:100%;display:flex;justify-content:center;align-items:center}.material-symbols-outlined[data-v-46b71af4]{font-family:Material Symbols Outlined;font-weight:400;font-style:normal;font-size:var(--v54181688);color:var(--v71fc035f);display:inline-block;line-height:1;text-transform:none;letter-spacing:normal;word-wrap:normal;white-space:nowrap;direction:ltr}.settings-container[data-v-dbca0f42]{display:flex;flex-direction:column;align-items:stretch;gap:1rem}.icons-container[data-v-dbca0f42]{display:flex;flex-wrap:wrap;gap:10px;max-height:220px;overflow-y:auto;overflow-x:hidden;width:100%;cursor:pointer;padding:10px}.material-symbols-outlined[data-v-dbca0f42]{font-family:Material Symbols Outlined;font-weight:400;font-style:inherit;font-size:40px;display:inline-block;line-height:1;text-transform:none;letter-spacing:normal;word-wrap:normal;white-space:nowrap;direction:ltr;border:2px solid transparent;border-radius:5px;transition:border-color .5s ease,transform .5s ease}.material-symbols-outlined[data-v-dbca0f42]:hover{transform:scale(1.1)}.active-icon[data-v-dbca0f42]{border:2px solid rgb(0,121,0)}.slider[data-v-dbca0f42]{padding:0 10px}\n";})();
import { PayloadImpl as P, EventsPackage as J, EVENT_REGISTRY_ID as Q } from "org.eclipse.daanse.board.app.lib.api.events";
import { activate as ee, deactivate as te, component as _e, inject as ae, initTsmRuntime as oe } from "@eclipse-daanse/tsm";
import { defineComponent as U, mergeModels as re, useCssVars as ie, unref as R, toRefs as se, useModel as B, inject as Z, onMounted as H, computed as C, createElementBlock as S, openBlock as O, Fragment as A, createElementVNode as k, withModifiers as ne, mergeProps as le, toDisplayString as K, ref as z, resolveComponent as x, createVNode as w, normalizeStyle as ce, renderList as de, normalizeClass as ue, withCtx as pe } from "vue";
import { VariableWrapper as I, useVariableRepository as he, plainSettings as V } from "org.eclipse.daanse.board.app.ui.vue.composables";
import { BasicEFactory as me, BasicEPackage as ge, EPackageRegistry as Y, BasicEClass as D, BasicEReference as fe, BasicEAttribute as y, getEcorePackage as v, BasicEObject as be } from "@emfts/core";
...
function F(l) {
  const e = Y.INSTANCE.getEPackage(l);
  if (!e)
...
class o extends ge {
   ...
   */
  init() {
    Y.INSTANCE.set(o.eNS_URI, this), this.setEFactoryInstance(G.eINSTANCE);
    const e = new D();
    ...
    const i = new y();
    i.setName("isIconFilled"), i.setLowerBound(0), i.setUpperBound(1), e.getEStructuralFeatures().push(i), o.Literals.ICON_SETTINGS__IS_ICON_FILLED = i;
    const d = new y();
    ...
    const u = new D();
    u.setName("IconClickPayload"), u.setAbstract(!1), u.setInterface(!1), this.getEClassifiers().push(u), u.setEPackage(this), o.Literals.ICON_CLICK_PAYLOAD = u;
    const m = new y();
    m.setName("iconName"), m.setLowerBound(0), m.setUpperBound(1), u.getEStructuralFeatures().push(m), o.Literals.ICON_CLICK_PAYLOAD__ICON_NAME = m;
    const n = new D();
    n.setName("IconRightClickPayload"), n.setAbstract(!1), n.setInterface(!1), this.getEClassifiers().push(n), n.setEPackage(this), o.Literals.ICON_RIGHT_CLICK_PAYLOAD = n;
    const a = new y();
    a.setName("iconName"), a.setLowerBound(0), a.setUpperBound(1), n.getEStructuralFeatures().push(a), o.Literals.ICON_RIGHT_CLICK_PAYLOAD__ICON_NAME = a, o.Literals.ICON_CLICK_PAYLOAD.getESuperTypes().push(F("http://org.eclipse.daanse.board.app.lib.events").getEClassifier("Payload")), o.Literals.ICON_RIGHT_CLICK_PAYLOAD.getESuperTypes().push(F("http://org.eclipse.daanse.board.app.lib.events").getEClassifier("Payload")), o.Literals.ICON_SETTINGS__ICON_COLOR.setEType(F("org.eclipse.daanse.board.app.ui.vue.composables").getEClassifier("VariableWrapper")), o.Literals.ICON_SETTINGS__ICON_SIZE.setEType(v().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__IS_ICON_FILLED.setEType(v().getEClassifier("EBoolean")), o.Literals.ICON_SETTINGS__STROKE_WEIGHT.setEType(v().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__OPTIC_SIZE.setEType(v().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__GRADE.setEType(v().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__CURRENT_ICON.setEType(v().getEClassifier("EString")), o.Literals.ICON_CLICK_PAYLOAD__ICON_NAME.setEType(v().getEClassifier("EString")), o.Literals.ICON_RIGHT_CLICK_PAYLOAD__ICON_NAME.setEType(v().getEClassifier("EString"));
  }
}
class _ extends be {
  // Feature ID Constants (eLiterals)
...
const Ce = /* @__PURE__ */ U({
  ...
  setup(l) {
    ...
    const e = l, { id: t } = se(e), { wrapParameters: r } = he(), i = B(l, "configv"), d = new _(), c = Z(we.TINY_EMITTER);
    H(() => {
      if (i.value) {
        ...
        const a = i.value.iconColor;
        if (!(a instanceof I))
          if (typeof a == "object" && a !== null && "value" in a) {
            const b = a, N = new I(b.value);
            b.variable && (N.variable = b.variable), i.value.iconColor = N;
          } else
            i.value.iconColor = new I(
              typeof a == "string" && a ? a : "var(--color-fg)"
            );
      }
    });
    const p = () => {
      if (!t.value) return;
      const a = {
        iconName: i.value?.currentIcon || "",
        widgetId: t.value,
        timestamp: Date.now()
      };
      console.log("🖱️ Icon Widget: Emitting click event", a), c.emit("widget:IconWidget:click", {
      ...
      console.log("🖱️ Icon Widget: Emitting right-click event", a), c.emit("widget:IconWidget:right_click", {
      ...
      iconColor: C(() => i.value.iconColor?.value || "var(--color-fg)"),
      iconSize: C(() => i.value.iconSize)
    }), n = C(() => {
      if (i.value)
        return `
        font-variation-settings:
            'FILL' ${i.value.isIconFilled ? 1 : 0},
            'wght' ${i.value.strokeWeight},
            'GRAD' ${i.value.grade},
            'opsz' ${i.value.opticSize};
        `;
    });
    return (a, b) => (O(), S(A, null, [
      b[0] || (b[0] = k("link", {
  ...
  setup(l) {
    const e = Z("i18n"), t = (n) => e ? e.t(n) : n, r = B(l, "modelValue"), i = z(
      JSON.parse(localStorage.getItem("isDarkTheme") || "false")
    ), d = z([]), c = z(""), p = C(() => d.value.filter(
      (n) => n.toLowerCase().includes(c.value.toLowerCase())
    )), h = (n) => {
      n && (r.value.currentIcon = n);
    };
    H(() => {
      d.value = Ie;
    });
    const u = C(() => i.value ? "#ffffff" : ""), m = C(() => 'font-variation-settings: "FILL" 0, "wght" 200, "GRAD" 100, "opsz" 48;');
    return (n, a) => {
      const b = x("va-input"), N = x("va-checkbox"), X = x("va-color-input"), E = x("va-slider");
      return O(), S(A, null, [
        k("section", Ne, [
          k("div", Ee, [
            w(b, {
            ...
            k("div", {
              ...
              (O(!0), S(A, null, de(p.value, (s) => (O(), S("span", {
                key: s,
                onClick: (q) => h(s),
                class: ue(["material-symbols-outlined", { "active-icon": s === r.value.currentIcon }])
              }, K(s), 11, xe))), 128))
            ], 4)
          ])
        ]),
        k("section", {
          ...
          k("div", Oe, [
            w(N, {
              ...
              "onUpdate:modelValue": a[1] || (a[1] = (s) => r.value.isIconFilled = s),
              label: t("icon:IconWidget.iconFilled")
            }, null, 8, ["modelValue", "label"]),
            w(R(ye), {
              modelValue: r.value.iconColor,
              "onUpdate:modelValue": a[2] || (a[2] = (s) => r.value.iconColor = s),
              label: t("icon:IconWidget.iconColor")
            }, {
              default: pe(({ value: s, change: q }) => [
                w(X, {
                  "model-value": s,
                  onInput: q,
                  label: t("icon:IconWidget.iconColor")
            ...
            w(E, {
              ...
              "onUpdate:modelValue": a[3] || (a[3] = (s) => r.value.iconSize = s),
              "label-color": u.value,
              "track-label-visible": "",
              min: 10,
              max: 1e3,
            ...
            w(E, {
              ...
              "onUpdate:modelValue": a[4] || (a[4] = (s) => r.value.strokeWeight = s),
              "label-color": u.value,
              "track-label-visible": "",
              min: 100,
              max: 700,
            ...
            w(E, {
              ...
              "onUpdate:modelValue": a[5] || (a[5] = (s) => r.value.opticSize = s),
              "label-color": u.value,
              "track-label-visible": "",
              min: 20,
              max: 48,
            ...
            w(E, {
              ...
              "onUpdate:modelValue": a[6] || (a[6] = (s) => r.value.grade = s),
              "label-color": u.value,
              "track-label-visible": "",
              min: -25,
              max: 200,
...
}), M = /* @__PURE__ */ $(Te, [["__scopeId", "data-v-dbca0f42"]]), Le = [
  {
    name: "Icon Clicked",
    type: "click",
...
`;
var De = Object.defineProperty, Fe = Object.getOwnPropertyDescriptor, W = (l, e, t, r) => {
  for (var i = r > 1 ? void 0 : r ? Fe(e, t) : e, d = l.length - 1, c; d >= 0; d--)
    (c = l[d]) && (i = (r ? c(e, t, i) : c(i)) || i);
...
let L = class {
  ...
  register() {
    this.events.registerWidget(T, Le), oe().register(
      "org.eclipse.daanse.board.app.ui.vue.widget.icon",
      { IconWidget: j, IconWidgetSettings: M },
      "0.0.1-next.1",
      "ui.vue.widget.icon"
    );
  }
  unregister() {
    this.events.unregisterWidget(T);
  }
};
W([
  ee()
], L.prototype, "register", 1);
W([
  te()
], L.prototype, "unregister", 1);
L = W([
  _e({
    service: [ve],
...
export {
  ...
  j as IconWidget,
  L as IconWidgetProvider,
  M as IconWidgetSettings,
