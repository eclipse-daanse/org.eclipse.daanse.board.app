...
function O(n) {
  ...
  if (!e)
    throw new Error(`EPackage '${n}' is not registered. Access the eINSTANCE of that model's generated package (or register it via EPackageRegistry.INSTANCE.registerPackage) before initializing IconSettingsPackage.`);
  return e;
}
class o extends ce {
   ...
   */
  init() {
    U.INSTANCE.set(o.eNS_URI, this), this.setEFactoryInstance(L.eINSTANCE);
    const e = new S();
    ...
    const i = new f();
    i.setName("iconSize"), i.setLowerBound(0), i.setUpperBound(1), e.getEStructuralFeatures().push(i), o.Literals.ICON_SETTINGS__ICON_SIZE = i;
    const a = new f();
    ...
    const c = new f();
    c.setName("strokeWeight"), c.setLowerBound(0), c.setUpperBound(1), e.getEStructuralFeatures().push(c), o.Literals.ICON_SETTINGS__STROKE_WEIGHT = c;
    const d = new f();
    ...
    const u = new f();
    u.setName("grade"), u.setLowerBound(0), u.setUpperBound(1), e.getEStructuralFeatures().push(u), o.Literals.ICON_SETTINGS__GRADE = u;
    const h = new f();
    h.setName("currentIcon"), h.setLowerBound(0), h.setUpperBound(1), e.getEStructuralFeatures().push(h), o.Literals.ICON_SETTINGS__CURRENT_ICON = h;
    const s = new S();
    s.setName("IconClickPayload"), s.setAbstract(!1), s.setInterface(!1), this.getEClassifiers().push(s), s.setEPackage(this), o.Literals.ICON_CLICK_PAYLOAD = s;
    const p = new f();
    p.setName("iconName"), p.setLowerBound(0), p.setUpperBound(1), s.getEStructuralFeatures().push(p), o.Literals.ICON_CLICK_PAYLOAD__ICON_NAME = p;
    const l = new S();
    l.setName("IconRightClickPayload"), l.setAbstract(!1), l.setInterface(!1), this.getEClassifiers().push(l), l.setEPackage(this), o.Literals.ICON_RIGHT_CLICK_PAYLOAD = l;
    const r = new f();
    r.setName("iconName"), r.setLowerBound(0), r.setUpperBound(1), l.getEStructuralFeatures().push(r), o.Literals.ICON_RIGHT_CLICK_PAYLOAD__ICON_NAME = r, o.Literals.ICON_CLICK_PAYLOAD.getESuperTypes().push(O("http://org.eclipse.daanse.board.app.lib.events").getEClassifier("Payload")), o.Literals.ICON_RIGHT_CLICK_PAYLOAD.getESuperTypes().push(O("http://org.eclipse.daanse.board.app.lib.events").getEClassifier("Payload")), o.Literals.ICON_SETTINGS__ICON_COLOR.setEType(O("org.eclipse.daanse.board.app.ui.vue.composables").getEClassifier("VariableWrapper")), o.Literals.ICON_SETTINGS__ICON_SIZE.setEType(b().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__IS_ICON_FILLED.setEType(b().getEClassifier("EBoolean")), o.Literals.ICON_SETTINGS__STROKE_WEIGHT.setEType(b().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__OPTIC_SIZE.setEType(b().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__GRADE.setEType(b().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__CURRENT_ICON.setEType(b().getEClassifier("EString")), o.Literals.ICON_CLICK_PAYLOAD__ICON_NAME.setEType(b().getEClassifier("EString")), o.Literals.ICON_RIGHT_CLICK_PAYLOAD__ICON_NAME.setEType(b().getEClassifier("EString"));
  }
}
class _ extends pe {
  // Feature ID Constants (eLiterals)
...
const fe = /* @__PURE__ */ q({
  ...
  setup(n) {
    ...
    const e = n, { id: t } = te(e), { wrapParameters: i } = ne(), a = W(n, "configv"), c = new _(), d = j(ue.TINY_EMITTER);
    M(() => {
      if (a.value) {
        ...
        const r = a.value.iconColor;
        if (!(r instanceof y))
          if (typeof r == "object" && r !== null && "value" in r) {
            const w = r, D = new y(w.value);
            w.variable && (D.variable = w.variable), a.value.iconColor = D;
          } else
            a.value.iconColor = new y(
    ...
    const u = () => {
      ...
      console.log("🖱️ Icon Widget: Emitting click event", r), d.emit("widget:IconWidget:click", {
      ...
      console.log("🖱️ Icon Widget: Emitting right-click event", r), d.emit("widget:IconWidget:right_click", {
      ...
      iconColor: v(() => a.value.iconColor?.value || "var(--color-fg)"),
      iconSize: v(() => a.value.iconSize)
    }), l = v(() => {
      if (a.value)
        return `
    ...
    return (r, w) => (N(), C(P, null, [
      ...
      k("div", {
        class: "icon",
        onClick: u,
        onContextmenu: _e(h, ["prevent"]),
        style: { cursor: "pointer" }
      }, [
        k("span", ae(r.$attrs, {
          style: l.value,
          class: "material-symbols-outlined"
        }), V(a.value.currentIcon), 17)
      ], 32)
    ], 64));
  }
}), B = (n, e) => {
  ...
  setup(n) {
    const e = j("i18n"), t = (s) => e ? e.t(s) : s, i = W(n, "modelValue");
    x(
      JSON.parse(localStorage.getItem("isDarkTheme") || "false")
    );
    const a = x([]), c = x(""), d = v(() => a.value.filter(
      (s) => s.toLowerCase().includes(c.value.toLowerCase())
    )), u = (s) => {
      s && (i.value.currentIcon = s);
    };
    M(() => {
      a.value = be;
    });
    const h = v(() => 'font-variation-settings: "FILL" 0, "wght" 200, "GRAD" 100, "opsz" 48;');
    return (s, p) => (N(), C("section", we, [
      k("div", ye, [
        oe(T(he), {
          modelValue: c.value,
        ...
        k("div", {
          ...
          (N(!0), C(P, null, ie(d.value, (l) => (N(), C("span", {
            key: l,
            onClick: (r) => u(l),
            class: se(["material-symbols-outlined", { "active-icon": l === i.value.currentIcon }])
          }, V(l), 11, ve))), 128))
        ], 4)
      ])
    ]));
  }
}), A = /* @__PURE__ */ B(ke, [["__scopeId", "data-v-8447c49b"]]), Ce = [
  {
    name: "Icon Clicked",
    type: "click",
...
`;
var Ie = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, z = (n, e, t, i) => {
  for (var a = i > 1 ? void 0 : i ? Ee(e, t) : e, c = n.length - 1, d; c >= 0; c--)
    (d = n[c]) && (a = (i ? d(e, t, a) : d(a)) || a);
  return i && a && Ie(e, t, a), a;
}, xe = (n, e) => (t, i) => e(t, i, n);
Z.eINSTANCE;
o.eINSTANCE;
const I = "IconWidget";
let E = class {
  ...
  register() {
    this.events.registerWidget(I, Ce), J().register(
      "org.eclipse.daanse.board.app.ui.vue.widget.icon",
      { IconWidget: R, IconWidgetSettings: A },
      "0.0.1-next.1",
      "ui.vue.widget.icon"
    );
  }
  unregister() {
    this.events.unregisterWidget(I);
  }
};
z([
  K()
], E.prototype, "register", 1);
z([
  Y()
], E.prototype, "unregister", 1);
E = z([
  $({
    service: [ge],
...
export {
  ...
  R as IconWidget,
  E as IconWidgetProvider,
  A as IconWidgetSettings,
  Ne as iconSettingsFormXmi
};
