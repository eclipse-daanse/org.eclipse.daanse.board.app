...
const ke = /* @__PURE__ */ L({
    ...
    U(() => {
      if (e.value && (Object.assign(e.value, { ...s, ...e.value }), !(e.value.iconColor instanceof v))) {
        ...
        if (typeof o == "object" && o !== null && "value" in o) {
          const r = new v(o.value);
          "variable" in o && (r.variable = o.variable), e.value.iconColor = r;
        } else
          e.value.iconColor = new v(o || "var(--color-fg)");
      }
    });
    const b = () => {
      if (!_.value) return;
      const o = {
        iconName: e.value?.currentIcon || "",
        widgetId: _.value,
        timestamp: Date.now()
      };
      console.log("🖱️ Icon Widget: Emitting click event", o), l.emit("widget:IconWidget:click", {
      ...
      console.log("🖱️ Icon Widget: Emitting right-click event", o), l.emit("widget:IconWidget:right_click", {
      ...
      iconColor: h(() => e.value.iconColor?.value || "var(--color-fg)"),
      iconSize: h(() => e.value.iconSize)
    }), W = h(() => {
      if (e.value)
        return `
        font-variation-settings:
            'FILL' ${e.value.isIconFilled ? 1 : 0},
            'wght' ${e.value.strokeWeight},
            'GRAD' ${e.value.grade},
            'opsz' ${e.value.opticSize};
        `;
    });
    return (o, r) => (C(), x(O, null, [
      r[0] || (r[0] = f("link", {
  ...
  setup(n) {
    const a = H("i18n"), _ = (o) => a ? a.t(o) : o, t = k({
      /* The picker opens first: choosing the symbol is what you came for */
      pickerSection: !0,
      widgetSection: !1,
      storeSection: !1
    }), e = F(n, "modelValue"), s = k(
      JSON.parse(localStorage.getItem("isDarkTheme") || "false")
    ), l = k([]), b = k(""), V = h(() => l.value.filter(
      (o) => o.toLowerCase().includes(b.value.toLowerCase())
    )), S = (o) => {
      o && (e.value.currentIcon = o);
    };
    U(() => {
      l.value = xe;
    }), ce(() => e.value, (o) => {
      o && (o.iconColor instanceof v || (o.iconColor = de(new v(o.iconColor || "#000000"))));
    }, { immediate: !0, deep: !0 });
    const g = h(() => s.value ? "#ffffff" : ""), W = h(() => 'font-variation-settings: "FILL" 0, "wght" 200, "GRAD" 100, "opsz" 48;');
    return (o, r) => {
          ...
          default: P(() => [
            f("div", Ce, [
              c(J, {
                ...
                label: _("icon:IconWidget.iconSearch")
              }, null, 8, ["modelValue", "label"]),
              f("div", {
                class: "icons-container",
                style: pe(W.value)
              }, [
                (C(!0), x(O, null, ue(V.value, (i) => (C(), x("span", {
                  key: i,
                  onClick: (E) => S(i),
                  class: me(["material-symbols-outlined", { "active-icon": i === e.value.currentIcon }])
                }, Z(i), 11, ze))), 128))
              ], 4)
            ])
          ]),
...
}), R = /* @__PURE__ */ A(qe, [["__scopeId", "data-v-53b4981a"]]);
var je = Object.defineProperty, Ve = Object.getOwnPropertyDescriptor, B = (n, a, _, t) => {
  for (var e = t > 1 ? void 0 : t ? Ve(a, _) : a, s = n.length - 1, l; s >= 0; s--)
    (l = n[s]) && (e = (t ? l(a, _, e) : l(e)) || e);
  return t && e && je(a, _, e), e;
};
...
var Se = Object.defineProperty, We = Object.getOwnPropertyDescriptor, Y = (n, a, _, t) => {
  for (var e = t > 1 ? void 0 : t ? We(a, _) : a, s = n.length - 1, l; s >= 0; s--)
    (l = n[s]) && (e = (t ? l(a, _, e) : l(e)) || e);
  return t && e && Se(a, _, e), e;
};
...
var De = Object.defineProperty, Oe = Object.getOwnPropertyDescriptor, T = (n, a, _, t) => {
  for (var e = t > 1 ? void 0 : t ? Oe(a, _) : a, s = n.length - 1, l; s >= 0; s--)
    (l = n[s]) && (e = (t ? l(a, _, e) : l(e)) || e);
  return t && e && De(a, _, e), e;
}, Me = (n, a) => (_, t) => a(_, t, n);
const z = "IconWidget";
let j = class {
  constructor(n) {
  ...
  name = "Icon";
  register() {
    this.events.registerWidget(z, Pe), ae().register(
      "org.eclipse.daanse.board.app.ui.vue.widget.icon",
      { IconWidget: N, IconWidgetSettings: R },
      "0.0.1-next.1",
      "ui.vue.widget.icon"
    );
  }
  unregister() {
    this.events.unregisterWidget(z);
  }
};
T([
  ee()
...
export {
  N as IconWidget,
  j as IconWidgetProvider,
  R as IconWidgetSettings
};
