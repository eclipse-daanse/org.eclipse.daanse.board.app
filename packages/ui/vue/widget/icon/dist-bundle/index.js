...
class m extends V {
  ...
  set iconName(e) {
    ...
    this._iconName = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(m.ICON_NAME),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
...
class f extends V {
  ...
  set iconName(e) {
    ...
    this._iconName = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(f.ICON_NAME),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
...
function L(c) {
  const e = B.INSTANCE.getEPackage(c);
  if (!e)
    throw new Error(`EPackage '${c}' is not registered. Access the eINSTANCE of that model's generated package (or register it via EPackageRegistry.INSTANCE.registerPackage) before initializing IconSettingsPackage.`);
  return e;
}
class o extends pe {
   ...
   */
  init() {
    B.INSTANCE.set(o.eNS_URI, this), this.setEFactoryInstance(F.eINSTANCE);
    const e = new z();
    ...
    const n = new w();
    n.setName("iconSize"), n.setLowerBound(0), n.setUpperBound(1), e.getEStructuralFeatures().push(n), o.Literals.ICON_SETTINGS__ICON_SIZE = n;
    const a = new w();
    a.setName("isIconFilled"), a.setLowerBound(0), a.setUpperBound(1), e.getEStructuralFeatures().push(a), o.Literals.ICON_SETTINGS__IS_ICON_FILLED = a;
    const u = new w();
    u.setName("strokeWeight"), u.setLowerBound(0), u.setUpperBound(1), e.getEStructuralFeatures().push(u), o.Literals.ICON_SETTINGS__STROKE_WEIGHT = u;
    const d = new w();
    d.setName("opticSize"), d.setLowerBound(0), d.setUpperBound(1), e.getEStructuralFeatures().push(d), o.Literals.ICON_SETTINGS__OPTIC_SIZE = d;
    const g = new w();
    g.setName("grade"), g.setLowerBound(0), g.setUpperBound(1), e.getEStructuralFeatures().push(g), o.Literals.ICON_SETTINGS__GRADE = g;
    const p = new w();
    p.setName("currentIcon"), p.setLowerBound(0), p.setUpperBound(1), e.getEStructuralFeatures().push(p), o.Literals.ICON_SETTINGS__CURRENT_ICON = p;
    const r = new z();
    r.setName("IconClickPayload"), r.setAbstract(!1), r.setInterface(!1), this.getEClassifiers().push(r), r.setEPackage(this), o.Literals.ICON_CLICK_PAYLOAD = r;
    const i = new w();
    i.setName("iconName"), i.setLowerBound(0), i.setUpperBound(1), r.getEStructuralFeatures().push(i), o.Literals.ICON_CLICK_PAYLOAD__ICON_NAME = i;
    const h = new z();
    ...
    const s = new w();
    s.setName("iconName"), s.setLowerBound(0), s.setUpperBound(1), h.getEStructuralFeatures().push(s), o.Literals.ICON_RIGHT_CLICK_PAYLOAD__ICON_NAME = s, o.Literals.ICON_CLICK_PAYLOAD.getESuperTypes().push(L("http://org.eclipse.daanse.board.app.lib.events").getEClassifier("Payload")), o.Literals.ICON_RIGHT_CLICK_PAYLOAD.getESuperTypes().push(L("http://org.eclipse.daanse.board.app.lib.events").getEClassifier("Payload")), o.Literals.ICON_SETTINGS__ICON_COLOR.setEType(L("org.eclipse.daanse.board.app.ui.vue.composables").getEClassifier("VariableWrapper")), o.Literals.ICON_SETTINGS__ICON_SIZE.setEType(y().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__IS_ICON_FILLED.setEType(y().getEClassifier("EBoolean")), o.Literals.ICON_SETTINGS__STROKE_WEIGHT.setEType(y().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__OPTIC_SIZE.setEType(y().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__GRADE.setEType(y().getEClassifier("EInt")), o.Literals.ICON_SETTINGS__CURRENT_ICON.setEType(y().getEClassifier("EString")), o.Literals.ICON_CLICK_PAYLOAD__ICON_NAME.setEType(y().getEClassifier("EString")), o.Literals.ICON_RIGHT_CLICK_PAYLOAD__ICON_NAME.setEType(y().getEClassifier("EString"));
  }
}
class _ extends ge {
  // Feature ID Constants (eLiterals)
  ...
  set iconColor(e) {
    ...
    this._iconColor = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(_.ICON_COLOR),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
  ...
  set iconSize(e) {
    ...
    this._iconSize = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(_.ICON_SIZE),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
  ...
  set isIconFilled(e) {
    ...
    this._isIconFilled = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(_.IS_ICON_FILLED),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
  ...
  set strokeWeight(e) {
    ...
    this._strokeWeight = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(_.STROKE_WEIGHT),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
  ...
  set opticSize(e) {
    ...
    this._opticSize = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(_.OPTIC_SIZE),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
  ...
  set grade(e) {
    ...
    this._grade = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(_.GRADE),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
  ...
  set currentIcon(e) {
    ...
    this._currentIcon = e, this.eDeliver() && this.eNotify({
      ...
      getEventType: () => 1,
      // SET
      getFeature: () => this.eClass().getEStructuralFeature(_.CURRENT_ICON),
      getOldValue: () => t,
      getNewValue: () => e,
      getPosition: () => -1,
      wasSet: () => !0,
  ...
  eGet(e) {
    switch (this.eClass().getFeatureID(e)) {
      ...
      case _.IS_ICON_FILLED:
        return this.isIconFilled;
      case _.STROKE_WEIGHT:
...
const Ce = /* @__PURE__ */ j({
  ...
  setup(c) {
    ...
    const e = c, { id: t } = _e(e), { wrapParameters: n } = ce(), a = M(c, "configv"), u = new _(), d = ae(me.TINY_EMITTER);
    P(() => {
      if (a.value) {
        ...
        const s = a.value.iconColor;
        if (!(s instanceof C))
          if (typeof s == "object" && s !== null && "value" in s) {
            const k = s, A = new C(k.value);
            k.variable && (A.variable = k.variable), a.value.iconColor = A;
          } else
            a.value.iconColor = new C(
              typeof s == "string" && s ? s : "var(--color-fg)"
            );
      }
    });
    const g = () => {
      if (!t.value) return;
      const s = {
        iconName: a.value?.currentIcon || "",
        widgetId: t.value,
        timestamp: Date.now()
      };
      console.log("🖱️ Icon Widget: Emitting click event", s), d.emit("widget:IconWidget:click", {
      ...
      console.log("🖱️ Icon Widget: Emitting right-click event", s), d.emit("widget:IconWidget:right_click", {
      ...
      iconColor: I(() => a.value.iconColor?.value || "var(--color-fg)"),
      iconSize: I(() => a.value.iconSize)
    }), h = I(() => {
      if (a.value)
        return `
        font-variation-settings:
            'FILL' ${a.value.isIconFilled ? 1 : 0},
            'wght' ${a.value.strokeWeight},
            'GRAD' ${a.value.grade},
            'opsz' ${a.value.opticSize};
        `;
    });
    return (s, k) => (x(), E(D, null, [
      k[0] || (k[0] = v("link", {
      ...
      v("div", {
        class: "icon",
        onClick: g,
        onContextmenu: oe(p, ["prevent"]),
        style: { cursor: "pointer" }
      }, [
        v("span", ie(s.$attrs, {
          style: h.value,
          class: "material-symbols-outlined"
        }), U(a.value.currentIcon), 17)
      ], 32)
    ], 64));
  }
}), Z = (c, e) => {
  ...
  setup(c) {
    const { t: e } = de("icon"), t = M(c, "modelValue");
    T(
      JSON.parse(localStorage.getItem("isDarkTheme") || "false")
    );
    const n = T([]), a = T(""), u = I(() => n.value.filter(
      (p) => p.toLowerCase().includes(a.value.toLowerCase())
    )), d = (p) => {
      p && (t.value.currentIcon = p);
    };
    P(() => {
      n.value = Ie;
    });
    const g = I(() => 'font-variation-settings: "FILL" 0, "wght" 200, "GRAD" 100, "opsz" 48;');
    return (p, r) => (x(), E(D, null, [
      v("section", Ne, [
        v("div", Ee, [
          b(l(fe), {
            modelValue: a.value,
            ...
            label: l(e)("IconWidget.iconSearch")
          }, null, 8, ["modelValue", "label"]),
          v("div", {
            class: "icons-container",
            style: re(g.value)
          }, [
            (x(!0), E(D, null, se(u.value, (i) => (x(), E("span", {
              key: i,
              onClick: (h) => d(i),
              class: ne(["material-symbols-outlined", { "active-icon": i === t.value.currentIcon }])
            }, U(i), 11, xe))), 128))
          ], 4)
        ])
      ]),
      v("section", {
        class: "settings-section",
        "data-section": l(e)("IconWidget.title")
      }, [
        v("div", Oe, [
          b(l(be), {
            modelValue: t.value.isIconFilled,
            "onUpdate:modelValue": r[1] || (r[1] = (i) => t.value.isIconFilled = i),
            label: l(e)("IconWidget.iconFilled")
          }, null, 8, ["modelValue", "label"]),
          b(l(ye), {
            modelValue: t.value.iconColor,
            "onUpdate:modelValue": r[2] || (r[2] = (i) => t.value.iconColor = i),
            label: l(e)("IconWidget.iconColor")
          }, {
            default: le(({ value: i, change: h }) => [
              b(l(we), {
                "model-value": i,
          ...
          b(l(N), {
            modelValue: t.value.iconSize,
            "onUpdate:modelValue": r[3] || (r[3] = (i) => t.value.iconSize = i),
            min: 10,
            max: 1e3,
            step: 10,
            suffix: "px",
            label: l(e)("IconWidget.iconSize")
          }, null, 8, ["modelValue", "label"]),
          b(l(N), {
            modelValue: t.value.strokeWeight,
            "onUpdate:modelValue": r[4] || (r[4] = (i) => t.value.strokeWeight = i),
            min: 100,
            max: 700,
            step: 100,
            label: l(e)("IconWidget.strokeWeight")
          }, null, 8, ["modelValue", "label"]),
          b(l(N), {
            modelValue: t.value.opticSize,
            "onUpdate:modelValue": r[5] || (r[5] = (i) => t.value.opticSize = i),
            min: 20,
            max: 48,
            label: l(e)("IconWidget.opticSize")
          }, null, 8, ["modelValue", "label"]),
          b(l(N), {
            modelValue: t.value.grade,
            "onUpdate:modelValue": r[6] || (r[6] = (i) => t.value.grade = i),
            min: -25,
            max: 200,
            step: 15,
            label: l(e)("IconWidget.grade")
          }, null, 8, ["modelValue", "label"])
        ])
      ], 8, Se)
    ], 64));
  }
}), q = /* @__PURE__ */ Z(Te, [["__scopeId", "data-v-b042ae74"]]), ze = [
  {
    name: "Icon Clicked",
    type: "click",
...
<uimodel:UIModel
  ...
  <components xsi:type="uimodel:FormView" name="IconSettingsFormView">
    ...
    <fields xsi:type="uimodel:GroupWidget" name="appearanceGroup" layout="VERTICAL" label="icon:IconWidget.appearance">
      <fields xsi:type="uimodel:CheckboxWidget"
          ...
          label="icon:IconWidget.iconFilled"/>
      <fields xsi:type="uimodel:InputWidget"
          name="iconColor"
          feature="http://org.eclipse.daanse.board.app.ui.vue.widget.icon#//IconSettings/iconColor"
          label="icon:IconWidget.iconColor"/>
      <fields xsi:type="uimodel:NumberWidget"
          name="iconSize"
          feature="http://org.eclipse.daanse.board.app.ui.vue.widget.icon#//IconSettings/iconSize"
          label="icon:IconWidget.iconSize" min="10" max="1000" step="10"/>
    </fields>

    <fields xsi:type="uimodel:GroupWidget" name="fontGroup" layout="VERTICAL" label="icon:IconWidget.fontAxes">
      <fields xsi:type="uimodel:NumberWidget"
          name="strokeWeight"
          feature="http://org.eclipse.daanse.board.app.ui.vue.widget.icon#//IconSettings/strokeWeight"
          label="icon:IconWidget.strokeWeight" min="100" max="700" step="100"/>
      <fields xsi:type="uimodel:NumberWidget"
          name="opticSize"
          feature="http://org.eclipse.daanse.board.app.ui.vue.widget.icon#//IconSettings/opticSize"
          label="icon:IconWidget.opticSize" min="20" max="48" step="1"/>
      <fields xsi:type="uimodel:NumberWidget"
          name="grade"
          feature="http://org.eclipse.daanse.board.app.ui.vue.widget.icon#//IconSettings/grade"
          label="icon:IconWidget.grade" min="-25" max="200" step="15"/>
    </fields>

  </components>
</uimodel:UIModel>
`;
var De = Object.defineProperty, Fe = Object.getOwnPropertyDescriptor, R = (c, e, t, n) => {
  for (var a = n > 1 ? void 0 : n ? Fe(e, t) : e, u = c.length - 1, d; u >= 0; u--)
    (d = c[u]) && (a = (n ? d(e, t, a) : d(a)) || a);
  return n && a && De(e, t, a), a;
}, Re = (c, e) => (t, n) => e(t, n, c);
H.eINSTANCE;
o.eINSTANCE;
const S = "IconWidget";
let O = class {
  ...
  register() {
    this.events.registerWidget(S, ze), Q().register(
      "org.eclipse.daanse.board.app.ui.vue.widget.icon",
      { IconWidget: G, IconWidgetSettings: q },
      "0.0.1-next.1",
      "ui.vue.widget.icon"
    );
  }
...
export {
  _ as IconSettingsImpl,
  o as IconSettingsPackage,
  G as IconWidget,
  O as IconWidgetProvider,
  q as IconWidgetSettings,
