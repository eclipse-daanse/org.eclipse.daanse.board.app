...
<template>
    <va-collapse v-model="opened.widgetSection" :header="t('IconWidget.title')">
        <div class="settings-container">
            ...
            <va-slider class="slider" v-model="widgetSettings.iconSize" :label-color="fontColor" track-label-visible
                :min="10" :max="1000" :step="10" :label="t('IconWidget.iconSize')" />
            <va-slider class="slider" v-model="widgetSettings.strokeWeight" :label-color="fontColor" track-label-visible
                :min="100" :max="700" :step="100" :label="t('IconWidget.strokeWeight')" />
            <va-slider class="slider" v-model="widgetSettings.opticSize" :label-color="fontColor" track-label-visible
                :min="20" :max="48" :label="t('IconWidget.opticSize')" />
            <va-slider class="slider" v-model="widgetSettings.grade" :label-color="fontColor" track-label-visible
