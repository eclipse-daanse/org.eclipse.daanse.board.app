...
const { WidgetAction, WidgetActionInterface, Payload, EVENT_ACTIONS_REGISTRY, EVENT_REGISTRY_ID } = __tsm__.require("org.eclipse.daanse.board.app.lib.events");
...
const { SET_WAYPOINTS } = __tsm__.require("org.eclipse.daanse.board.app.lib.datasource.valhalla");
