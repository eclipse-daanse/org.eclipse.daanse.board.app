...
async function useFilterTreeDataSource(element, api, catalog) {
  ...
  function computePartialSelection(treeNode) {
    var _a;
    if (!((_a = treeNode.children) == null ? void 0 : _a.some((e) => !e.isLoading))) {
      const currentSelectionDesc = treeSelection.find(
        (s) => s.UName === treeNode.UName
      );
      if (currentSelectionDesc == null ? void 0 : currentSelectionDesc.hasChild) {
  ...
  function optimizeSelection(treeNode) {
    var _a;
    if (!((_a = treeNode.children) == null ? void 0 : _a.some((e) => !e.isLoading))) return;
    treeNode.children.forEach((childNode) => {
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const {
      ...
      changeSelection,
      setSelectAll
    } = ([__temp, __restore] = withAsyncContext(() => useFilterTreeDataSource(props2.rootHierarchy, props2.api, props2.catalog)), __temp = await __temp, __restore(), __temp);
    const {
      filteredTree,
      levels,
      searchBy,
    ...
    } = ([__temp, __restore] = withAsyncContext(() => useSearchResultTreeData(props2.rootHierarchy, props2.api)), __temp = await __temp, __restore(), __temp);
    const treeData = ref({
      nodes: tree,
    ...
    const multipleChoise = ref(
      ((_b = (_a = props2.rootHierarchy) == null ? void 0 : _a.filters) == null ? void 0 : _b.multipleChoise) ?? false
    );
    ...
    const emitSelectFunc = () => {
      if (searchValue.value) {
        emit2("set-selection", {
          ...
          originalItem: props2.rootHierarchy.item
        });
      } else {
        emit2("set-selection", {
          enabled: true,
    ...
    onMounted(() => {
      var _a2;
      if (props2.rootHierarchy.filters.enabled && !props2.rootHierarchy.filters.multipleChoise && ((_a2 = props2.rootHierarchy.filters.selectedItem) == null ? void 0 : _a2.id)) {
        singleSelection.value = props2.rootHierarchy.filters.selectedItem;
      }
    });
    return (_ctx, _cache) => {
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    function resetSelection() {
      var _a;
      const exposed = (_a = filterTreeView.value) == null ? void 0 : _a.$.exposed;
...
const _hoisted_2 = { class: "hierarchy-caption" };
const _hoisted_3 = { class: "filter-caption" };
const _hoisted_4 = {
  key: 1,
  class: "hierarchies-section"
};
const _hoisted_5 = { class: "hierarchy-caption" };
const _hoisted_6 = { class: "filter-caption" };
const _hoisted_7 = {
  key: 2,
  class: "hierarchies-section"
};
const _hoisted_8 = { class: "hierarchy-caption" };
const _hoisted_9 = { class: "filter-caption" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const emitChange = (id, area, filterData) => {
      if (!widgetId?.value) return;
      eventBus.emit("widget:FiltersWidget:change", {
        type: "widget:FiltersWidget:change",
        widgetId: widgetId.value,
        payload: { widgetId: widgetId.value, timestamp: Date.now(), id, area, filterData }
      });
    };
    const rows = ref([]);
    const columns = ref([]);
    ...
    const getApi = async () => {
      ...
      const api2 = await connection.getApi();
    ...
    const getHierarchies = () => {
      ...
      try {
        const rows2 = datasource.requestParams.rows.map((row) => {
          const filtersCaption = row.filters.enabled ? row.filters.multipleChoise ? row.filters.selectAll ? `Multiple choice filter, all selected` : `Multiple choice filter (${row.filters.selectedItems.length} selected, ${row.filters.deselectedItems.length} deselected)` : `Single choice filter (${row.filters.selectedItem ? row.filters.selectedItem.Caption : "none selected"})` : "No filter applied";
          return {
            ...row,
            filtersCaption
          };
        });
        const columns2 = datasource.requestParams.columns.map((col) => {
          const filtersCaption = col.filters.enabled ? col.filters.multipleChoise ? col.filters.selectAll ? `Multiple choice filter, all selected` : `Multiple choice filter (${col.filters.selectedItems.length} selected, ${col.filters.deselectedItems.length} deselected)` : `Single choice filter (${col.filters.selectedItem ? col.filters.selectedItem.Caption : "none selected"})` : "No filter applied";
          return {
            ...col,
            filtersCaption
          };
        });
        const filters2 = datasource.requestParams.filters.map((filter) => {
          const filtersCaption = filter.filters.enabled ? filter.filters.multipleChoise ? filter.filters.selectAll ? `Multiple choice filter, all selected` : `Multiple choice filter (${filter.filters.selectedItems.length} selected, ${filter.filters.deselectedItems.length} deselected)` : `Single choice filter (${filter.filters.selectedItem ? filter.filters.selectedItem.Caption : "none selected"})` : "No filter applied";
          return {
            ...filter,
            filtersCaption
          };
    ...
    onMounted(async () => {
      ...
      columns.value = hierarchies.columns;
      filters.value = hierarchies.filters;
      props2.config.settings.showFilters = props2.config.settings.showFilters ?? true;
      props2.config.settings.showRows = props2.config.settings.showRows ?? true;
      props2.config.settings.showColumns = props2.config.settings.showColumns ?? true;
    });
    ...
    const configureFilter = async (type, element) => {
      ...
      const { filters: filters2 } = await filterModal.value.run({
        element,
        filters: element.filters,
        api
      });
      if (!filters2) return;
      emitChange(element.id, type, filters2);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createElementVNode("div", {
          ...
          props2.config.settings.showRows && rows.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
            _cache[0] || (_cache[0] = createElementVNode("h4", null, "Rows:", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (hierarchy) => {
              return openBlock(), createElementBlock("div", {
                key: hierarchy.originalItem.HIERARCHY_UNIQUE_NAME,
                class: "hierarchy-item"
              }, [
                createElementVNode("p", _hoisted_2, toDisplayString(hierarchy.originalItem.HIERARCHY_NAME) + " (" + toDisplayString(hierarchy.originalItem.HIERARCHY_UNIQUE_NAME) + ")", 1),
                createElementVNode("p", _hoisted_3, toDisplayString(hierarchy.filtersCaption), 1),
                createVNode(_component_va_icon, {
                  ...
                  onClick: ($event) => configureFilter("rows", hierarchy)
                }, null, 8, ["style", "onClick"])
              ]);
            }), 128))
          ])) : createCommentVNode("", true),
          props2.config.settings.showColumns && columns.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_4, [
            _cache[1] || (_cache[1] = createElementVNode("h4", null, "Columns:", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (hierarchy) => {
              return openBlock(), createElementBlock("div", {
                key: hierarchy.originalItem.HIERARCHY_UNIQUE_NAME,
                class: "hierarchy-item"
              }, [
                createElementVNode("p", _hoisted_5, toDisplayString(hierarchy.originalItem.HIERARCHY_NAME) + " (" + toDisplayString(hierarchy.originalItem.HIERARCHY_UNIQUE_NAME) + ")", 1),
                createElementVNode("p", _hoisted_6, toDisplayString(hierarchy.filtersCaption), 1),
                createVNode(_component_va_icon, {
                  class: "filter-icon ml-2",
                  name: "filter_list",
                  size: "small",
                  ...
                  onClick: ($event) => configureFilter("columns", hierarchy)
                }, null, 8, ["style", "onClick"])
              ]);
            }), 128))
          ])) : createCommentVNode("", true),
          props2.config.settings.showFilters && filters.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_7, [
            _cache[2] || (_cache[2] = createElementVNode("h4", null, "Filters:", -1)),
            (openBlock(true), createElementBlock(Fragment, null, renderList(filters.value, (hierarchy) => {
              return openBlock(), createElementBlock("div", {
                key: hierarchy.originalItem.HIERARCHY_UNIQUE_NAME,
                class: "hierarchy-item"
              }, [
                createElementVNode("p", _hoisted_8, toDisplayString(hierarchy.originalItem.HIERARCHY_NAME) + " (" + toDisplayString(hierarchy.originalItem.HIERARCHY_UNIQUE_NAME) + ")", 1),
                createElementVNode("p", _hoisted_9, toDisplayString(hierarchy.filtersCaption), 1),
                createVNode(_component_va_icon, {
                  class: "filter-icon ml-2",
                  name: "filter_list",
                  size: "small",
                  ...
                  onClick: ($event) => configureFilter("filters", hierarchy)
                }, null, 8, ["style", "onClick"])
              ]);
            }), 128))
          ])) : createCommentVNode("", true)
        ], 32),
        api.value && catalog.value ? (openBlock(), createBlock(unref(_sfc_main$7), {
          key: 0,
          ref_key: "filterModal",
          ref: filterModal,
          api: api.value,
          catalog: catalog.value
        }, null, 8, ["api", "catalog"])) : createCommentVNode("", true)
      ], 64);
    };
  }
});
...
const FiltersWidget = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-eebe957d"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_va_collapse, {
        ...
        "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => opened.value = $event),
        ...
        default: withCtx(() => [
          createElementVNode("div", _hoisted_1, [
            createVNode(_component_VaCheckbox, {
              modelValue: widgetSettings.value.settings.showRows,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => widgetSettings.value.settings.showRows = $event),
              label: "Show rows",
              style: { "margin": "0.5rem 0" }
            }, null, 8, ["modelValue"]),
            createVNode(_component_VaCheckbox, {
              modelValue: widgetSettings.value.settings.showColumns,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => widgetSettings.value.settings.showColumns = $event),
              label: "Show columns",
              style: { "margin": "0.5rem 0" }
            }, null, 8, ["modelValue"]),
            createVNode(_component_VaCheckbox, {
              modelValue: widgetSettings.value.settings.showFilters,
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => widgetSettings.value.settings.showFilters = $event),
              label: "Show filters",
              style: { "margin": "0.5rem 0" }
            }, null, 8, ["modelValue"])
          ])
...
const FiltersWidgetSettings = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a4d8cb41"]]);
const FiltersWidgetEvents = [
...
let FiltersWidgetProvider = class {
  constructor(events2) {
    this.events = events2;
  }
  type = WIDGET_TYPE;
...
__decorateClass([
  activate()
], FiltersWidgetProvider.prototype, "register", 1);
__decorateClass([
  deactivate()
], FiltersWidgetProvider.prototype, "unregister", 1);
FiltersWidgetProvider = __decorateClass([
  component({
    service: [WIDGET_SERVICE],
    properties: { "widget.type": WIDGET_TYPE }
  }),
  __decorateParam(0, inject("EventRegistry"))
], FiltersWidgetProvider);
export {
  FiltersWidget,
  FiltersWidgetProvider,
  FiltersWidgetSettings
};
