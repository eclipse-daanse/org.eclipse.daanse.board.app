...
import { defineComponent, toRefs, inject as inject$1, ref, watch, onMounted, resolveComponent, createElementBlock, openBlock, Fragment, createElementVNode, createBlock, createCommentVNode, withModifiers, renderList, createVNode, toDisplayString, normalizeStyle, unref, useModel, withCtx } from "vue";
const { useDatasourceRepository } = __tsm__.require("org.eclipse.daanse.board.app.ui.vue.composables");
const { FiltersModal } = __tsm__.require("org.eclipse.daanse.board.app.ui.vue.common.xmla");
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createElementVNode("div", {
          ...
          props.config.settings.showRows && rows.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
          ...
          props.config.settings.showColumns && columns.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_4, [
          ...
          props.config.settings.showFilters && filters.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_7, [
        ...
        api.value && catalog.value ? (openBlock(), createBlock(unref(FiltersModal), {
          key: 0,
          ref_key: "filterModal",
          ref: filterModal,
          api: api.value,
