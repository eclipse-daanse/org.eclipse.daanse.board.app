(function(){var i="ui.vue.layouts.grid",d=document,s=d.querySelector('style[data-tsm-bundle="'+i+'"]');if(!s){s=d.createElement('style');s.setAttribute('data-tsm-bundle',i);d.head.appendChild(s);}s.textContent="\n.view_grid_layout[data-v-3f926a75]{\n  padding-left:60px;\n}\n.vgl-layout[data-v-3f926a75] {\n  --vgl-placeholder-bg: #aaa;\n  min-height:100vh;\n}\n/* Grid background disabled in view mode */\n.vgl-layout[data-v-3f926a75]::before {\n  display: none;\n}\n[data-v-3f926a75] .vgl-item:not(.vgl-item--placeholder) {\n\n  /*border: 1px dashed #ccc;*/\n}\n[data-v-3f926a75] .vgl-item--resizing {\n  opacity: 90%;\n}\n[data-v-3f926a75] .vgl-item--static {\n  background-color: #cce;\n}\n.text[data-v-3f926a75] {\n  position: absolute;\n  inset: 0;\n  width: 100%;\n  height: 100%;\n  margin: auto;\n  font-size: 24px;\n  text-align: center;\n}\n\n.alayout[data-v-1d0be460]{\n  padding-left:60px;\n}\n.vgl-layout[data-v-1d0be460] {\n  --vgl-placeholder-bg: #aaa;\n  min-height: 100vh;\n}\n.vgl-layout[data-v-1d0be460]::before {\n  position: absolute;\n  width: calc(100% - 5px);\n  height: calc(100% - 5px);\n  margin: 5px;\n  content: '';\n  background-image:\n    linear-gradient(to right, #e9e9e9 1px, transparent 1px),\n    linear-gradient(to bottom, #e9e9e9 1px, transparent 1px);\n  background-repeat: repeat;\n  background-size: calc(calc(100% - 5px) / var(--grid-cols, 12)) calc(var(--grid-row-height, 30px) + 10px);\n}\n[data-v-1d0be460] .vgl-item--placeholder {\n  outline: 2px dashed #888;\n  background-color: rgba(136,136,136,0.15);\n}\n[data-v-1d0be460] .vgl-item--resizing { opacity: 90%;\n}\n[data-v-1d0be460] .vgl-item--static { background-color: #cce;\n}\n.text[data-v-1d0be460] {\n  position: absolute; inset: 0; width: 100%; height: 100%;\n  margin: auto; font-size: 24px; text-align: center;\n}\n\n/* Overlay */\n.invisible-dropzone[data-v-1d0be460] {\n  position: absolute;\n  inset: 0;\n  z-index: 1000;\n  pointer-events: auto;\n}\n.invisible-dropzone[data-v-1d0be460] > * { opacity: 0;\n}\n\n/* Copy/Paste */\n.widget-item-wrapper[data-v-1d0be460] {\n  width: 100%;\n  height: 100%;\n}\n.dropdown-buttons-container[data-v-1d0be460] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n  z-index: 99999;\n}\n.widget-context-menu[data-v-1d0be460],\n.canvas-context-menu[data-v-1d0be460] {\n  position: fixed;\n  background: white;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  padding: 4px;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15);\n  z-index: 100000;\n}\n\n.grid-settings[data-v-2078e072] {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n.grid-settings-title[data-v-2078e072] {\n  font-size: 14px;\n  font-weight: 600;\n  margin: 0;\n}\n.grid-settings-subtitle[data-v-2078e072] {\n  font-size: 13px;\n  font-weight: 500;\n  margin: 8px 0 0 0;\n}\n.cols-grid[data-v-2078e072] {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.col-input[data-v-2078e072] {\n  width: 100%;\n}\n";})();
...
const View = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-3f926a75"]]);
...
const Edit = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1d0be460"]]);
