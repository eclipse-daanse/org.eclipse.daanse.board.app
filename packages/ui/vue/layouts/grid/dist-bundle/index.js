(function(){var i="ui.vue.layouts.grid",d=document,s=d.querySelector('style[data-tsm-bundle="'+i+'"]');if(!s){s=d.createElement('style');s.setAttribute('data-tsm-bundle',i);d.head.appendChild(s);}s.textContent=".view_grid_layout[data-v-49a3f0ec]{padding-left:60px}.vgl-layout[data-v-49a3f0ec]{--vgl-placeholder-bg: var(--color-outline);min-height:100vh}.vgl-layout[data-v-49a3f0ec]:before{display:none}[data-v-49a3f0ec] .vgl-item--resizing{opacity:90%}[data-v-49a3f0ec] .vgl-item--static{background-color:color-mix(in srgb,var(--color-accent) 18%,transparent)}.text[data-v-49a3f0ec]{position:absolute;inset:0;width:100%;height:100%;margin:auto;font-size:24px;text-align:center}.alayout[data-v-8d90936a]{padding-left:60px}.vgl-layout[data-v-8d90936a]{--vgl-placeholder-bg: #aaa;min-height:100vh}.vgl-layout[data-v-8d90936a]:before{position:absolute;width:calc(100% - 5px);height:calc(100% - 5px);margin:5px;content:\"\";background-image:linear-gradient(to right,#e9e9e9 1px,transparent 1px),linear-gradient(to bottom,#e9e9e9 1px,transparent 1px);background-repeat:repeat;background-size:calc(calc(100% - 5px) / var(--grid-cols, 12)) calc(var(--grid-row-height, 30px) + 10px)}[data-v-8d90936a] .vgl-item--placeholder{outline:2px dashed #888;background-color:#88888826}[data-v-8d90936a] .vgl-item--resizing{opacity:90%}[data-v-8d90936a] .vgl-item--static{background-color:color-mix(in srgb,var(--color-accent) 18%,transparent)}.text[data-v-8d90936a]{position:absolute;inset:0;width:100%;height:100%;margin:auto;font-size:24px;text-align:center}.invisible-dropzone[data-v-8d90936a]{position:absolute;inset:0;z-index:1000;pointer-events:auto}.invisible-dropzone[data-v-8d90936a]>*{opacity:0}.widget-item-wrapper[data-v-8d90936a]{width:100%;height:100%}.dropdown-buttons-container[data-v-8d90936a]{display:flex;flex-direction:column;gap:.5rem;z-index:99999}.widget-context-menu[data-v-8d90936a],.canvas-context-menu[data-v-8d90936a]{position:fixed;background:var(--color-pane);border:1px solid var(--color-divider);border-radius:var(--radius-sm);padding:4px;box-shadow:var(--shadow-e2);z-index:100000}.grid-settings[data-v-2078e072]{display:flex;flex-direction:column;gap:12px}.grid-settings-title[data-v-2078e072]{font-size:14px;font-weight:600;margin:0}.grid-settings-subtitle[data-v-2078e072]{font-size:13px;font-weight:500;margin:8px 0 0}.cols-grid[data-v-2078e072]{display:flex;flex-direction:column;gap:8px}.col-input[data-v-2078e072]{width:100%}\n";})();
...
}), ky = /* @__PURE__ */ bu(Cy, [["__scopeId", "data-v-8d90936a"]]), Dy = { class: "grid-settings" }, Ly = { class: "cols-grid" }, By = /* @__PURE__ */ Ji({
