...
import { defineComponent, ref, inject, onMounted, markRaw, nextTick, provide, onBeforeUnmount, h as h$1, watch, onUnmounted, reactive, computed, render, toRefs, createElementBlock, createCommentVNode, openBlock, Fragment, renderList, createBlock, unref, withCtx, createVNode, useModel, resolveComponent, createElementVNode, createTextVNode, toDisplayString } from "vue";
...
defineComponent({
  ...
  setup(e, o) {
    ...
    onMounted(async () => {
      e.useGlobalLeaflet && (b.L = b.L || await import("./leaflet-src-7RCH06Jr.js").then((n2) => n2.l));
