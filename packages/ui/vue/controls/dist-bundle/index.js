...
}), Ve = /* @__PURE__ */ x(ul, [["__scopeId", "data-v-ddd4c454"]]), cl = ["for"], fl = { class: "field__control row" }, vl = ["id", "min", "max", "step", "disabled"], ml = ["min", "max", "step", "disabled", "aria-label"], bl = {
  key: 0,
  class: "suffix"
}, hl = /* @__PURE__ */ g({
  __name: "DSlider",
