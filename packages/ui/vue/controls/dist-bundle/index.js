...
const Ne = ["type", "disabled", "aria-busy"], Te = {
  ...
  setup(e) {
    return (t, d) => (l(), i("button", {
      ...
      class: y([
        ...
        `btn--${e.intent}`,
        `btn--${e.size}`,
        { "btn--block": e.block, "btn--busy": e.busy, "btn--glow": e.glow }
      ]),
  ...
  for (const [o, c] of t)
    d[o] = c;
  return d;
}, ce = /* @__PURE__ */ x(Ue, [["__scopeId", "data-v-56b43b95"]]), Xe = {
  key: 0,
  class: "card__head"
...
}), me = /* @__PURE__ */ x(je, [["__scopeId", "data-v-5fb92780"]]), Ge = /* @__PURE__ */ w({
  __name: "DChip",
  props: {
...
}), ve = /* @__PURE__ */ x(Ge, [["__scopeId", "data-v-30700fa0"]]), _e = ["for"], Je = { class: "field__control" }, Ze = { class: "row" }, Qe = ["id", "value", "disabled", "aria-label"], pe = ["disabled", "aria-label"], et = {
  key: 0,
  class: "field__hint"
}, tt = /* @__PURE__ */ w({
  __name: "DColorInput",
...
const wt = ["aria-label"], xt = ["aria-label"], gt = { class: "fw__title" }, Mt = ["aria-label"], Dt = { class: "fw__body" }, Bt = ["aria-label"], O = 24, Vt = /* @__PURE__ */ w({
  ...
  setup(e, { expose: t, emit: d }) {
    ...
    const z = H(() => o.rememberAs ?? o.title), E = G({ width: 0, height: 0 });
    function U() {
    ...
    function X(a, f) {
      ...
      u.dock || _(a, K(u.w)), le(z.value, a, B, o.minHeight), n.value = { ...u, dock: a, freeY: $, freeH: B }, U();
    }
    function Q() {
      const a = n.value;
    ...
    se(() => {
      if (n.value.dock) {
        const a = L();
        E.value = a, _(n.value.dock, K(n.value.w)), le(z.value, n.value.dock, n.value.freeH, o.minHeight);
      }
  ...
  class: "field__required",
  "aria-hidden": "true"
}, Pt = { class: "field__control" }, jt = ["aria-label"], Gt = ["name", "value", "disabled", "required"], _t = { class: "choice__label" }, Jt = {
  key: 0,
  class: "field__error",
  role: "alert"
}, Zt = {
