 ...
 */
import MODEL_ECORE from 'org.eclipse.daanse.board.app.lib.datasource.graphql/model/GraphqlDataSourceModel.ecore?raw'
import {
  type DatasourceRepository,
  DATASOURCE_REPOSITORY,
} from 'org.eclipse.daanse.board.app.lib.api.datasource'
import type { ActivationContext } from 'org.eclipse.daanse.board.app.lib.core'
// Service id of lib.datasource.graphql; Symbol.for is global, so this literal
...
export function activate({ services }: ActivationContext) {
  services.register('GraphqlPreview', Preview)
  services.register('GraphqlSettings', Settings)
...
export function deactivate({ services }: ActivationContext) {
  services
    .getRequired<DatasourceRepository>(DATASOURCE_REPOSITORY)
    .unregisterDatasourceType('graphql')
