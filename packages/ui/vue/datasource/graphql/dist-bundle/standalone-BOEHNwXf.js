...
var dn = no((of, ln) => {
  var yt, bt, At, _t, xt, $e, bu, Ke, Bt, cn, Tt, Ve, Nt, St, wt, pe, fn, Ot, Pt;
  ...
  cn = RegExp(Ke.source);
  ln.exports = function* (e, { jsx: t = false } = {}) {
...
function Wr(e, t, u) {
  ...
  for (let i of t) {
    ...
    if (D >= a || D > r) continue;
    let f = Number.isFinite(a) ? Math.min(a, r) : r, l = f === void 0 ? ct(e, i) : ct(e, i, { maxDistance: f });
    if (l > r) continue;
    let d = l;
...
function En(e, t, u = {}) {
  let o = _a(), n = e.split(Fn), { start: a, end: s, markerLines: i } = xa(t, n, u), D = t.start && typeof t.start.column == "number", f = String(s).length, d = e.split(Fn, s).slice(a, s).map((c, p) => {
