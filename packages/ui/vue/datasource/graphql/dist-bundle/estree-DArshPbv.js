...
var se = Symbol("MODE_BREAK"), Te = Symbol("MODE_FLAT"), kn = Symbol("DOC_FILL_PRINTED_LENGTH");
...
function Zu(e, t, n) {
  ...
  let f = Y(r.right), F = l.findIndex((T) => typeof T != "string" && !Array.isArray(T) && T.type === fe), B = l.slice(0, F === -1 ? 1 : F + 1), C = l.slice(B.length, f ? -1 : void 0), v = Symbol("logicalChain-" + ++cl), S = c([...B, E(C)], { id: v });
  if (!f) return S;
  let h = O(0, l, -1);
...
function lr(e, t, n) {
  ...
  if (p.length === 0) u.push(El(e, t, a, s));
    ...
    let l = O(0, p, -1), y = l?.type !== "RestElement" && !r.inexact, D = l === null, d = Symbol("array"), f = !t.__inJestEach && p.length > 1 && p.every((C, v, S) => {
      let h = C?.type;
...
function wc(e, t, n, r = {}) {
  ...
  let y = !Ee(t.originalText, l) && (kc(l) || Nc(l, a, t) || !o && Ta(l)), D = e.key === "callee" && yt(e.parent), d = Symbol("arrow-chain"), f = jc(e, r, { signatureDocs: u, shouldBreak: o }), F = !1, B = !1, C = !1;
...
function fD(e) {
  ...
  if (t.type !== n.type || !Gs(t, n)) return !1;
