import { g as getDefaultExportFromCjs } from "./index-B1rT-hwY.js";
...
function requireGraphql() {
  ...
  (function(module, exports$1) {
    (function(f) {
      ...
      var ye = { type: _e };
      function y(e, t = {}) {
        return Y(t.expandedStates), { type: Ne, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates };
      }
      function I(e, t = "", n = {}) {
        return { type: xe, breakContents: e, flatContents: t, groupId: n.groupId };
      }
      function E(e, t) {
        let n = [];
...
`) && (t.value = e.value.trim());
      ...
      var $e = { bracketSpacing: { category: "Common", type: "boolean", default: true, description: "Print spaces between brackets.", oppositeDescription: "Do not print spaces between brackets." } };
      ...
      function M(e, t) {
        ...
        for (let r of e.body.matchAll(Ft)) {
          if (typeof r.index == "number" || Je(), r.index >= t) break;
