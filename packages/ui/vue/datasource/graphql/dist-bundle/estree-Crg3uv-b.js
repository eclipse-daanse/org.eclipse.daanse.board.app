...
var si = Object.freeze({ character: "'", codePoint: 39 }), ii = Object.freeze({ character: '"', codePoint: 34 }), Ua = Object.freeze({ preferred: si, alternate: ii }), Ya = Object.freeze({ preferred: ii, alternate: si });
function Ha(e, t) {
...
var pe = tp;
var rp = k(["Block", "CommentBlock", "MultiLine"]), ce = rp;
var np = k(["AnyTypeAnnotation", "ThisTypeAnnotation", "NumberTypeAnnotation", "VoidTypeAnnotation", "BooleanTypeAnnotation", "BigIntTypeAnnotation", "SymbolTypeAnnotation", "StringTypeAnnotation", "NeverTypeAnnotation", "UndefinedTypeAnnotation", "UnknownTypeAnnotation", "EmptyTypeAnnotation", "MixedTypeAnnotation"]), Nr = np;
var sp = k(["Line", "CommentLine", "SingleLine", "HashbangComment", "HTMLOpen", "HTMLClose", "Hashbang", "InterpreterDirective"]), At = sp;
function ip(e, t) {
  let r = t.split(".");
...
var Di = k(["ExportDefaultDeclaration", "DeclareExportDeclaration", "ExportNamedDeclaration", "ExportAllDeclaration", "DeclareExportAllDeclaration"]), q = k(["ArrayExpression"]), se = k(["ObjectExpression"]);
function fi(e) {
...
var Jr = k(["Literal", "BooleanLiteral", "BigIntLiteral", "DirectiveLiteral", "NullLiteral", "NumericLiteral", "RegExpLiteral", "StringLiteral"]), pp = k(["Identifier", "ThisExpression", "Super", "PrivateName", "PrivateIdentifier"]), Je = k(["ObjectTypeAnnotation", "TSTypeLiteral", "TSMappedType"]), Ht = k(["FunctionExpression", "ArrowFunctionExpression"]);
function cp(e) {
...
var li = { "==": true, "!=": true, "===": true, "!==": true }, vr = { "*": true, "/": true, "%": true }, Yn = { ">>": true, ">>>": true, "<<": true };
function dr(e, t) {
...
var x = { Leading: 2, Trailing: 4, Dangling: 8, Block: 16, Line: 32, PrettierIgnore: 64, First: 128, Last: 256 }, gi = (e, t) => {
...
var Ae = k(["TSAsExpression", "TSSatisfiesExpression", "AsExpression", "AsConstExpression", "SatisfiesExpression"]), Se = k(["TSUnionType", "UnionTypeAnnotation"]), xt = k(["TSIntersectionType", "IntersectionTypeAnnotation"]), Ue = k(["TSConditionalType", "ConditionalTypeAnnotation"]), hi = (e) => e?.type === "TSAsExpression" && e.typeAnnotation.type === "TSTypeReference" && e.typeAnnotation.typeName.type === "Identifier" && e.typeAnnotation.typeName.name === "const", Cr = k(["TSTypeAliasDeclaration", "TypeAlias"]);
function Yr({ key: e, parent: t }) {
  return !(e === "types" && Se(t) || e === "types" && xt(t));
}
var dp = /* @__PURE__ */ new Set(["range", "raw", "comments", "leadingComments", "trailingComments", "innerComments", "extra", "start", "end", "loc", "flags", "errors", "tokens"]), Kt = (e) => {
...
var Xp = k(["VariableDeclarator", "AssignmentExpression", "TypeAlias", "TSTypeAliasDeclaration"]), Vp = k(["ObjectExpression", "ArrayExpression", "TemplateLiteral", "TaggedTemplateExpression", "ObjectTypeAnnotation", "TSTypeLiteral"]);
...
var Ri = k(["ArrowFunctionExpression", "FunctionExpression", "FunctionDeclaration", "ObjectMethod", "ClassMethod", "TSDeclareFunction", "TSCallSignatureDeclaration", "TSConstructSignatureDeclaration", "TSMethodSignature", "TSConstructorType", "TSFunctionType", "TSDeclareMethod"]), nc = { endOfLine: Ip, ownLine: kp, remaining: Lp }, Ji = nc;
...
var Wi = oc;
var Ye = "string", Be = "array", tt = "cursor", He = "indent", Xe = "align", rt = "trim", Fe = "group", Me = "fill", be = "if-break", Ve = "indent-if-break", $e = "line-suffix", Ge = "line-suffix-boundary", me = "line", Pe = "label", Ne = "break-parent", Xr = /* @__PURE__ */ new Set([tt, He, Xe, rt, Fe, Me, be, Ve, $e, Ge, me, Pe, Ne]);
function uc(e) {
...
var Tr = { type: tt };
function zr(e) {
  return { type: Me, parts: e };
}
function l(e, t = {}) {
  return Kr(t.expandedStates), { type: Fe, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates };
}
function nt(e, t) {
...
function yt(e, t) {
  return { type: Ve, contents: e, groupId: t.groupId, negate: t.negate };
}
function L(e, t) {
  let r = [];
...
function pt(e, t) {
  return e ? { type: Pe, label: e, contents: t } : t;
}
var A = { type: me }, f = { type: me, soft: true }, os = { type: me, hard: true }, E = [os, ke], yc = { type: me, hard: true, literal: true }, $r = [yc, ke];
function us(e) {
...
var xc = { type: 0 }, gc = { type: 1 }, as = { value: "", length: 0, queue: [], get root() {
  return as;
} };
function eo(e, t, r) {
...
function Sr(e, t, r) {
  ...
  return !s || s === "init" || s === "method" || s === "constructor" ? i.async && o.push("async ") : o.push(s, " "), i.generator && o.push("*"), o.push(Ct(e, t, r), n.optional ? "?" : "", n === i ? Dn(e, t, r) : r("value")), o;
}
function Dn(e, t, r) {
...
var hu = k(["ClassProperty", "PropertyDefinition", "ClassPrivateProperty", "ClassAccessorProperty", "AccessorProperty", "TSAbstractPropertyDefinition", "TSAbstractAccessorProperty"]), Bu = (e) => {
...
var bm = gu("heritageGroup"), Pm = k(["TSInterfaceDeclaration", "DeclareInterface", "InterfaceDeclaration", "InterfaceTypeAnnotation"]);
function sr(e, t, r) {
...
var Jt = Nm;
var ju = k(["ImportDeclaration", "ExportDefaultDeclaration", "ExportNamedDeclaration", "ExportAllDeclaration", "DeclareExportDeclaration", "DeclareExportAllDeclaration"]), jm = k(["EnumBooleanBody", "EnumNumberBody", "EnumBigIntBody", "EnumStringBody", "EnumSymbolBody"]);
function ir(e, t, r) {
...
var ar = [[]], Ea = { JsonRoot: ["node"], ArrayExpression: ["elements"], ObjectExpression: ["properties"], ObjectProperty: ["key", "value"], UnaryExpression: ["argument"], NullLiteral: ar[0], BooleanLiteral: ar[0], StringLiteral: ar[0], NumericLiteral: ar[0], Identifier: ar[0], TemplateLiteral: ["quasis"], TemplateElement: ar[0] };
var fD = _r(Ea), Fa = fD;
function yD(e, t, r) {
  let { node: n } = e;
  switch (n.type) {
