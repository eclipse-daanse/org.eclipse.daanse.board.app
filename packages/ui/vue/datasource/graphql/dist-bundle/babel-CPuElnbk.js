import { g as ya } from "./index-DTN42Zdm.js";
function xa(ee, Ee) {
  for (var R = 0; R < Ee.length; R++) {
    const U = Ee[R];
    if (typeof U != "string" && !Array.isArray(U)) {
      for (const L in U)
        if (L !== "default" && !(L in ee)) {
          const te = Object.getOwnPropertyDescriptor(U, L);
          te && Object.defineProperty(ee, L, te.get ? te : {
            enumerable: !0,
            get: () => U[L]
          });
        }
...
function Pa() {
  return ds || (ds = 1, (function(ee, Ee) {
    (function(R) {
      ...
      var R = Object.defineProperty, U = Object.getOwnPropertyDescriptor, L = Object.getOwnPropertyNames, te = Object.prototype.hasOwnProperty, Ce = (t, e) => {
        for (var s in e) R(t, s, { get: e[s], enumerable: !0 });
      }, ys = (t, e, s, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of L(e)) !te.call(t, i) && i !== s && R(t, i, { get: () => e[i], enumerable: !(r = U(e, i)) || r.enumerable });
        return t;
      }, xs = (t) => ys(R({}, "__esModule", { value: !0 }), t), at = {};
      Ce(at, { parsers: () => fa });
      var nt = {};
      Ce(nt, { __babel_estree: () => la, __js_expression: () => os, __ts_expression: () => ls, __vue_event_binding: () => as, __vue_expression: () => os, __vue_ts_event_binding: () => ns, __vue_ts_expression: () => ls, babel: () => as, "babel-flow": () => hs, "babel-ts": () => ns });
      function Ps(t, e) {
        if (t == null) return {};
        var s = {};
...
- Did you mean \`import { "${t}" as foo }\`?`, ImportCallArity: "`import()` requires exactly one or two arguments.", ImportCallNotNewExpression: "Cannot use new with import(...).", ImportCallSpreadArgument: "`...` is not allowed in `import()`.", ImportJSONBindingNotDefault: "A JSON module can only be imported with `default`.", ImportReflectionHasAssertion: "`import module x` cannot have assertions.", ImportReflectionNotBinding: 'Only `import module x from "./module"` is valid.', IncompatibleRegExpUVFlags: "The 'u' and 'v' regular expression flags cannot be enabled at the same time.", InvalidBigIntLiteral: "Invalid BigIntLiteral.", InvalidCodePoint: "Code point out of bounds.", InvalidCoverDiscardElement: "'void' must be followed by an expression when not used in a binding position.", InvalidCoverInitializedName: "Invalid shorthand property initializer.", InvalidDecimal: "Invalid decimal.", InvalidDigit: ({ radix: t }) => `Expected number in radix ${t}.`, InvalidEscapeSequence: "Bad character escape sequence.", InvalidEscapeSequenceTemplate: "Invalid escape sequence in template.", InvalidEscapedReservedWord: ({ reservedWord: t }) => `Escape sequence in keyword ${t}.`, InvalidIdentifier: ({ identifierName: t }) => `Invalid identifier ${t}.`, InvalidLhs: ({ ancestor: t }) => `Invalid left-hand side in ${ce(t)}.`, InvalidLhsBinding: ({ ancestor: t }) => `Binding invalid left-hand side in ${ce(t)}.`, InvalidLhsOptionalChaining: ({ ancestor: t }) => `Invalid optional chaining in the left-hand side of ${ce(t)}.`, InvalidNumber: "Invalid number.", InvalidOrMissingExponent: "Floating-point numbers require a valid exponent after the 'e'.", InvalidOrUnexpectedToken: ({ unexpected: t }) => `Unexpected character '${t}'.`, InvalidParenthesizedAssignment: "Invalid parenthesized assignment pattern.", InvalidPrivateFieldResolution: ({ identifierName: t }) => `Private name #${t} is not defined.`, InvalidPropertyBindingPattern: "Binding member expression.", InvalidRecordProperty: "Only properties and spread elements are allowed in record definitions.", InvalidRestAssignmentPattern: "Invalid rest operator's argument.", LabelRedeclaration: ({ labelName: t }) => `Label '${t}' is already declared.`, LetInLexicalBinding: "'let' is disallowed as a lexically bound name.", LineTerminatorBeforeArrow: "No line break is allowed before '=>'.", MalformedRegExpFlags: "Invalid regular expression flag.", MissingClassName: "A class name is required.", MissingEqInAssignment: "Only '=' operator can be used for specifying default value.", MissingSemicolon: "Missing semicolon.", MissingPlugin: ({ missingPlugin: t }) => `This experimental syntax requires enabling the parser plugin: ${t.map((e) => JSON.stringify(e)).join(", ")}.`, MissingOneOfPlugins: ({ missingPlugin: t }) => `This experimental syntax requires enabling one of the following parser plugin(s): ${t.map((e) => JSON.stringify(e)).join(", ")}.`, MissingUnicodeEscape: "Expecting Unicode escape sequence \\uXXXX.", MixingCoalesceWithLogical: "Nullish coalescing operator(??) requires parens when mixing with logical operators.", ModuleAttributeDifferentFromType: "The only accepted module attribute is `type`.", ModuleAttributeInvalidValue: "Only string literals are allowed as module attribute values.", ModuleAttributesWithDuplicateKeys: ({ key: t }) => `Duplicate key "${t}" is not allowed in module attributes.`, ModuleExportNameHasLoneSurrogate: ({ surrogateCharCode: t }) => `An export name cannot include a lone surrogate, found '\\u${t.toString(16)}'.`, ModuleExportUndefined: ({ localName: t }) => `Export '${t}' is not defined.`, MultipleDefaultsInSwitch: "Multiple default clauses.", NewlineAfterThrow: "Illegal newline after throw.", NoCatchOrFinally: "Missing catch or finally clause.", NumberIdentifier: "Identifier directly after number.", NumericSeparatorInEscapeSequence: "Numeric separators are not allowed inside unicode escape sequences or hex escape sequences.", ObsoleteAwaitStar: "'await*' has been removed from the async functions proposal. Use Promise.all() instead.", OptionalChainingNoNew: "Constructors in/after an Optional Chain are not allowed.", OptionalChainingNoTemplate: "Tagged Template Literals are not allowed in optionalChain.", OverrideOnConstructor: "'override' modifier cannot appear on a constructor declaration.", ParamDupe: "Argument name clash.", PatternHasAccessor: "Object pattern can't contain getter or setter.", PatternHasMethod: "Object pattern can't contain methods.", PrivateInExpectedIn: ({ identifierName: t }) => `Private names are only allowed in property accesses (\`obj.#${t}\`) or in \`in\` expressions (\`#${t} in obj\`).`, PrivateNameRedeclaration: ({ identifierName: t }) => `Duplicate private name #${t}.`, RecordExpressionBarIncorrectEndSyntaxType: "Record expressions ending with '|}' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionBarIncorrectStartSyntaxType: "Record expressions starting with '{|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionHashIncorrectStartSyntaxType: "Record expressions starting with '#{' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", RecordNoProto: "'__proto__' is not allowed in Record expressions.", RestTrailingComma: "Unexpected trailing comma after rest element.", SloppyFunction: "In non-strict mode code, functions can only be declared at top level or inside a block.", SloppyFunctionAnnexB: "In non-strict mode code, functions can only be declared at top level, inside a block, or as the body of an if statement.", SourcePhaseImportRequiresDefault: 'Only `import source x from "./module"` is valid.', StaticPrototype: "Classes may not have static property named prototype.", SuperNotAllowed: "`super()` is only valid inside a class constructor of a subclass. Maybe a typo in the method name ('constructor') or not extending another class?", SuperPrivateField: "Private fields can't be accessed on super.", TrailingDecorator: "Decorators must be attached to a class element.", TupleExpressionBarIncorrectEndSyntaxType: "Tuple expressions ending with '|]' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionBarIncorrectStartSyntaxType: "Tuple expressions starting with '[|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionHashIncorrectStartSyntaxType: "Tuple expressions starting with '#[' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", UnexpectedArgumentPlaceholder: "Unexpected argument placeholder.", UnexpectedAwaitAfterPipelineBody: 'Unexpected "await" after pipeline body; await must have parentheses in minimal proposal.', UnexpectedDigitAfterHash: "Unexpected digit after hash token.", UnexpectedImportExport: "'import' and 'export' may only appear at the top level.", UnexpectedKeyword: ({ keyword: t }) => `Unexpected keyword '${t}'.`, UnexpectedLeadingDecorator: "Leading decorators must be attached to a class declaration.", UnexpectedLexicalDeclaration: "Lexical declaration cannot appear in a single-statement context.", UnexpectedNewTarget: "`new.target` can only be used in functions or class properties.", UnexpectedNumericSeparator: "A numeric separator is only allowed between two digits.", UnexpectedPrivateField: "Unexpected private name.", UnexpectedReservedWord: ({ reservedWord: t }) => `Unexpected reserved word '${t}'.`, UnexpectedSuper: "'super' is only allowed in object methods and classes.", UnexpectedToken: ({ expected: t, unexpected: e }) => `Unexpected token${e ? ` '${e}'.` : ""}${t ? `, expected "${t}"` : ""}`, UnexpectedTokenUnaryExponentiation: "Illegal expression. Wrap left hand side or entire exponentiation in parentheses.", UnexpectedUsingDeclaration: "Using declaration cannot appear in the top level when source type is `script` or in the bare case statement.", UnexpectedVoidPattern: "Unexpected void binding.", UnsupportedBind: "Binding should be performed on object property.", UnsupportedDecoratorExport: "A decorated export must export a class declaration.", UnsupportedDefaultExport: "Only expressions, functions or classes are allowed as the `default` export.", UnsupportedImport: "`import` can only be used in `import()` or `import.meta`.", UnsupportedMetaProperty: ({ target: t, onlyValidPropertyName: e }) => `The only valid meta property for ${t} is ${t}.${e}.`, UnsupportedParameterDecorator: "Decorators cannot be used to decorate parameters.", UnsupportedPropertyDecorator: "Decorators cannot be used to decorate object literal properties.", UnsupportedSuper: "'super' can only be used with function calls (i.e. super()) or in property accesses (i.e. super.prop or super[prop]).", UnterminatedComment: "Unterminated comment.", UnterminatedRegExp: "Unterminated regular expression.", UnterminatedString: "Unterminated string constant.", UnterminatedTemplate: "Unterminated template.", UsingDeclarationExport: "Using declaration cannot be exported.", UsingDeclarationHasBindingPattern: "Using declaration cannot have destructuring patterns.", VarRedeclaration: ({ identifierName: t }) => `Identifier '${t}' has already been declared.`, VoidPatternCatchClauseParam: "A void binding can not be the catch clause parameter. Use `try { ... } catch { ... }` if you want to discard the caught error.", VoidPatternInitializer: "A void binding may not have an initializer.", YieldBindingIdentifier: "Can not use 'yield' as identifier inside a generator.", YieldInParameter: "Yield expression is not allowed in formal parameters.", YieldNotInGeneratorFunction: "'yield' is only allowed within generator functions.", ZeroDigitNumericSeparator: "Numeric separator can not be used after leading 0." }, Ts = { StrictDelete: "Deleting local variable in strict mode.", StrictEvalArguments: ({ referenceName: t }) => `Assigning to '${t}' in strict mode.`, StrictEvalArgumentsBinding: ({ bindingName: t }) => `Binding '${t}' in strict mode.`, StrictFunction: "In strict mode code, functions can only be declared at top level or inside a block.", StrictNumericEscape: "The only valid numeric escape in strict mode is '\\0'.", StrictOctalLiteral: "Legacy octal literals are not allowed in strict mode.", StrictWith: "'with' in strict mode." }, bs = { ParseExpressionEmptyInput: "Unexpected parseExpression() input: The input is empty or contains only comments.", ParseExpressionExpectsEOF: ({ unexpected: t }) => `Unexpected parseExpression() input: The input should contain exactly one expression, but the first expression is followed by the unexpected character \`${String.fromCodePoint(t)}\`.` }, Es = /* @__PURE__ */ new Set(["ArrowFunctionExpression", "AssignmentExpression", "ConditionalExpression", "YieldExpression"]), Cs = Object.assign({ PipeBodyIsTighter: "Unexpected yield after pipeline body; any yield expression acting as Hack-style pipe body must be parenthesized due to its loose operator precedence.", PipeTopicRequiresHackPipes: 'Topic references are only supported when using the `"proposal": "hack"` version of the pipeline proposal.', PipeTopicUnbound: "Topic reference is unbound; it must be inside a pipe body.", PipeTopicUnconfiguredToken: ({ token: t }) => `Invalid topic token ${t}. In order to use ${t} as a topic reference, the pipelineOperator plugin must be configured with { "proposal": "hack", "topicToken": "${t}" }.`, PipeTopicUnused: "Hack-style pipe body does not contain a topic reference; Hack-style pipes must use topic at least once.", PipeUnparenthesizedBody: ({ type: t }) => `Hack-style pipe body cannot be an unparenthesized ${ce({ type: t })}; please wrap it in parentheses.` }, {}), Ss = ["message"];
      ...
      function M(t, e) {
        if (Array.isArray(t)) return (r) => M(r, t[0]);
        let s = {};
        for (let r of Object.keys(t)) {
          let i = t[r], a = typeof i == "string" ? { message: () => i } : typeof i == "function" ? { message: i } : i, { message: n } = a, o = Ps(a, Ss), p = typeof n == "string" ? () => n : n;
          s[r] = ws(Object.assign({ code: "BABEL_PARSER_SYNTAX_ERROR", reasonCode: r, toMessage: p }, e ? { syntaxPlugin: e } : {}, o));
        }
        return s;
      }
      var u = Object.assign({}, M(As), M(gs), M(Ts), M(bs), M`pipelineOperator`(Cs));
      function Is() {
      ...
      function Ns(t) {
        ...
        else if (t.startColumn == null || t.startIndex == null) throw new Error("With a `startLine > 1` you must also specify `startIndex` and `startColumn`.");
        if (e.sourceType === "commonjs") {
          if (t.allowAwaitOutsideFunction != null) throw new Error("The `allowAwaitOutsideFunction` option cannot be used with `sourceType: 'commonjs'`.");
          if (t.allowReturnOutsideFunction != null) throw new Error("`sourceType: 'commonjs'` implies `allowReturnOutsideFunction: true`, please remove the `allowReturnOutsideFunction` option or use `sourceType: 'script'`.");
          if (t.allowNewTargetOutsideFunction != null) throw new Error("`sourceType: 'commonjs'` implies `allowNewTargetOutsideFunction: true`, please remove the `allowNewTargetOutsideFunction` option or use `sourceType: 'script'`.");
        }
        return e;
      }
      var { defineProperty: ks } = Object, pt = (t, e) => {
        t && ks(t, e, { enumerable: !1, value: t[e] });
      };
      function se(t) {
        return pt(t.loc.start, "index"), pt(t.loc.end, "index"), t;
      }
      var vs = (t) => class extends t {
        parse() {
          let e = se(super.parse());
          return this.optionFlags & 256 && (e.tokens = e.tokens.map(se)), e;
        }
        ...
        parseMethod(e, s, r, i, a, n, o = !1) {
          ...
          let c = this.castNodeTo(p, this.hasPlugin("typescript") && !p.body ? "TSEmptyBodyFunctionExpression" : "FunctionExpression");
          return e.value = c, n === "ClassPrivateMethod" && (e.computed = !1), this.hasPlugin("typescript") && e.abstract ? (delete e.abstract, this.finishNode(e, "TSAbstractMethodDefinition")) : n === "ObjectMethod" ? (e.kind === "method" && (e.kind = "init"), e.shorthand = !1, this.finishNode(e, "Property")) : this.finishNode(e, "MethodDefinition");
        }
        nameIsConstructor(e) {
        ...
        isValidLVal(e, s, r, i) {
          return e === "Property" ? "value" : super.isValidLVal(e, s, r, i);
        }
        isAssignable(e, s) {
        ...
        finishCallExpression(e, s) {
          ...
          return r.callee.type === "Import" ? (this.castNodeTo(r, "ImportExpression"), r.source = r.arguments[0], r.options = r.arguments[1] ?? null, delete r.arguments, delete r.callee) : r.type === "OptionalCallExpression" ? this.castNodeTo(r, "CallExpression") : r.optional = !1, r;
        }
        ...
        parseExport(e, s) {
          ...
          switch (i.type) {
            ...
            case "ExportDefaultDeclaration":
              {
                let { declaration: a } = i;
                a?.type === "ClassDeclaration" && a.decorators?.length > 0 && a.start === i.start && this.resetStartLocation(i, r);
              }
              break;
          }
          return i;
        ...
        finishNodeAt(e, s, r) {
          return se(super.finishNodeAt(e, s, r));
        }
        finishNode(e, s) {
        ...
        resetStartLocation(e, s) {
          super.resetStartLocation(e, s), se(e);
        }
        resetEndLocation(e, s = this.state.lastTokEndLoc) {
          super.resetEndLocation(e, s), se(e);
        }
      }, de = class {
        constructor(t, e) {
        ...
        token;
        preserveSpace;
      }, C = { brace: new de("{"), j_oTag: new de("<tag"), j_cTag: new de("</tag"), j_expr: new de("<tag>...</tag>", !0) }, g = !0, m = !0, Se = !0, re = !0, H = !0, Ds = !0, ut = class {
        label;
        keyword;
        beforeExpr;
        startsExpr;
      ...
      function k(t, e) {
        return y(t, { beforeExpr: g, binop: e });
      }
      var ie = -1, Ie = [], Ne = [], ke = [], ve = [], De = [], Fe = [];
      function y(t, e = {}) {
        return ++ie, Ne.push(t), ke.push(e.binop ?? -1), ve.push(e.beforeExpr ?? !1), De.push(e.startsExpr ?? !1), Fe.push(e.prefix ?? !1), Ie.push(new ut(t, e)), ie;
      }
      function T(t, e = {}) {
        return ++ie, we.set(t, ie), Ne.push(t), ke.push(e.binop ?? -1), ve.push(e.beforeExpr ?? !1), De.push(e.startsExpr ?? !1), Fe.push(e.prefix ?? !1), Ie.push(new ut("name", e)), ie;
      }
      var Fs = { bracketL: y("[", { beforeExpr: g, startsExpr: m }), bracketHashL: y("#[", { beforeExpr: g, startsExpr: m }), bracketBarL: y("[|", { beforeExpr: g, startsExpr: m }), bracketR: y("]"), bracketBarR: y("|]"), braceL: y("{", { beforeExpr: g, startsExpr: m }), braceBarL: y("{|", { beforeExpr: g, startsExpr: m }), braceHashL: y("#{", { beforeExpr: g, startsExpr: m }), braceR: y("}"), braceBarR: y("|}"), parenL: y("(", { beforeExpr: g, startsExpr: m }), parenR: y(")"), comma: y(",", { beforeExpr: g }), semi: y(";", { beforeExpr: g }), colon: y(":", { beforeExpr: g }), doubleColon: y("::", { beforeExpr: g }), dot: y("."), question: y("?", { beforeExpr: g }), questionDot: y("?."), arrow: y("=>", { beforeExpr: g }), template: y("template"), ellipsis: y("...", { beforeExpr: g }), backQuote: y("`", { startsExpr: m }), dollarBraceL: y("${", { beforeExpr: g, startsExpr: m }), templateTail: y("...`", { startsExpr: m }), templateNonTail: y("...${", { beforeExpr: g, startsExpr: m }), at: y("@"), hash: y("#", { startsExpr: m }), interpreterDirective: y("#!..."), eq: y("=", { beforeExpr: g, isAssign: re }), assign: y("_=", { beforeExpr: g, isAssign: re }), slashAssign: y("_=", { beforeExpr: g, isAssign: re }), xorAssign: y("_=", { beforeExpr: g, isAssign: re }), moduloAssign: y("_=", { beforeExpr: g, isAssign: re }), incDec: y("++/--", { prefix: H, postfix: Ds, startsExpr: m }), bang: y("!", { beforeExpr: g, prefix: H, startsExpr: m }), tilde: y("~", { beforeExpr: g, prefix: H, startsExpr: m }), doubleCaret: y("^^", { startsExpr: m }), doubleAt: y("@@", { startsExpr: m }), pipeline: k("|>", 0), nullishCoalescing: k("??", 1), logicalOR: k("||", 1), logicalAND: k("&&", 2), bitwiseOR: k("|", 3), bitwiseXOR: k("^", 4), bitwiseAND: k("&", 5), equality: k("==/!=/===/!==", 6), lt: k("</>/<=/>=", 7), gt: k("</>/<=/>=", 7), relational: k("</>/<=/>=", 7), bitShift: k("<</>>/>>>", 8), bitShiftL: k("<</>>/>>>", 8), bitShiftR: k("<</>>/>>>", 8), plusMin: y("+/-", { beforeExpr: g, binop: 9, prefix: H, startsExpr: m }), modulo: y("%", { binop: 10, startsExpr: m }), star: y("*", { binop: 10 }), slash: k("/", 10), exponent: y("**", { beforeExpr: g, binop: 11, rightAssociative: !0 }), _in: b("in", { beforeExpr: g, binop: 7 }), _instanceof: b("instanceof", { beforeExpr: g, binop: 7 }), _break: b("break"), _case: b("case", { beforeExpr: g }), _catch: b("catch"), _continue: b("continue"), _debugger: b("debugger"), _default: b("default", { beforeExpr: g }), _else: b("else", { beforeExpr: g }), _finally: b("finally"), _function: b("function", { startsExpr: m }), _if: b("if"), _return: b("return", { beforeExpr: g }), _switch: b("switch"), _throw: b("throw", { beforeExpr: g, prefix: H, startsExpr: m }), _try: b("try"), _var: b("var"), _const: b("const"), _with: b("with"), _new: b("new", { beforeExpr: g, startsExpr: m }), _this: b("this", { startsExpr: m }), _super: b("super", { startsExpr: m }), _class: b("class", { startsExpr: m }), _extends: b("extends", { beforeExpr: g }), _export: b("export"), _import: b("import", { startsExpr: m }), _null: b("null", { startsExpr: m }), _true: b("true", { startsExpr: m }), _false: b("false", { startsExpr: m }), _typeof: b("typeof", { beforeExpr: g, prefix: H, startsExpr: m }), _void: b("void", { beforeExpr: g, prefix: H, startsExpr: m }), _delete: b("delete", { beforeExpr: g, prefix: H, startsExpr: m }), _do: b("do", { isLoop: Se, beforeExpr: g }), _for: b("for", { isLoop: Se }), _while: b("while", { isLoop: Se }), _as: T("as", { startsExpr: m }), _assert: T("assert", { startsExpr: m }), _async: T("async", { startsExpr: m }), _await: T("await", { startsExpr: m }), _defer: T("defer", { startsExpr: m }), _from: T("from", { startsExpr: m }), _get: T("get", { startsExpr: m }), _let: T("let", { startsExpr: m }), _meta: T("meta", { startsExpr: m }), _of: T("of", { startsExpr: m }), _sent: T("sent", { startsExpr: m }), _set: T("set", { startsExpr: m }), _source: T("source", { startsExpr: m }), _static: T("static", { startsExpr: m }), _using: T("using", { startsExpr: m }), _yield: T("yield", { startsExpr: m }), _asserts: T("asserts", { startsExpr: m }), _checks: T("checks", { startsExpr: m }), _exports: T("exports", { startsExpr: m }), _global: T("global", { startsExpr: m }), _implements: T("implements", { startsExpr: m }), _intrinsic: T("intrinsic", { startsExpr: m }), _infer: T("infer", { startsExpr: m }), _is: T("is", { startsExpr: m }), _mixins: T("mixins", { startsExpr: m }), _proto: T("proto", { startsExpr: m }), _require: T("require", { startsExpr: m }), _satisfies: T("satisfies", { startsExpr: m }), _keyof: T("keyof", { startsExpr: m }), _readonly: T("readonly", { startsExpr: m }), _unique: T("unique", { startsExpr: m }), _abstract: T("abstract", { startsExpr: m }), _declare: T("declare", { startsExpr: m }), _enum: T("enum", { startsExpr: m }), _module: T("module", { startsExpr: m }), _namespace: T("namespace", { startsExpr: m }), _interface: T("interface", { startsExpr: m }), _type: T("type", { startsExpr: m }), _opaque: T("opaque", { startsExpr: m }), name: y("name", { startsExpr: m }), placeholder: y("%%", { startsExpr: m }), string: y("string", { startsExpr: m }), num: y("num", { startsExpr: m }), bigint: y("bigint", { startsExpr: m }), decimal: y("decimal", { startsExpr: m }), regexp: y("regexp", { startsExpr: m }), privateName: y("#name", { startsExpr: m }), eof: y("eof"), jsxName: y("jsxName"), jsxText: y("jsxText", { beforeExpr: g }), jsxTagStart: y("jsxTagStart", { startsExpr: m }), jsxTagEnd: y("jsxTagEnd") };
      function E(t) {
        return t >= 93 && t <= 133;
      }
      function Ls(t) {
      ...
      function B(t) {
        return t < 65 ? t === 36 : t <= 90 ? !0 : t < 97 ? t === 95 : t <= 122 ? !0 : t <= 65535 ? t >= 170 && Hs.test(String.fromCharCode(t)) : Oe(t, yt);
      }
      function J(t) {
        return t < 48 ? t === 36 : t < 58 ? !0 : t < 65 ? !1 : t <= 90 ? !0 : t < 97 ? t === 95 : t <= 122 ? !0 : t <= 65535 ? t >= 170 && $s.test(String.fromCharCode(t)) : Oe(t, yt) || Oe(t, qs);
      }
      var Re = { keyword: ["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete"], strict: ["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield"], strictBind: ["eval", "arguments"] }, Ks = new Set(Re.keyword), Js = new Set(Re.strict), Ws = new Set(Re.strictBind);
      function xt(t, e) {
        return e && t === "await" || t === "enum";
      }
      function Pt(t, e) {
        return xt(t, e) || Js.has(t);
      }
      function At(t) {
        return Ws.has(t);
      }
      ...
      function Gs(t, e, s) {
        return t === 64 && e === 64 && B(s);
      }
      var Ys = /* @__PURE__ */ new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "eval", "arguments", "enum", "await"]);
      function Qs(t) {
        return Ys.has(t);
      }
      var Ue = class {
      ...
      var rr = { const: "declare export var", let: "declare export var", type: "export type", interface: "export interface" };
      function ir(t, e) {
        let s = [], r = [];
        for (let i = 0; i < t.length; i++) (e(t[i], i, t) ? s : r).push(t[i]);
        return [s, r];
      }
      var ar = /\*?\s*@((?:no)?flow)\b/, nr = (t) => class extends t {
        flowPragma = void 0;
        getScopeHandler() {
          return er;
        }
        ...
        flowParsePredicate() {
          ...
          return this.next(), this.expectContextual(110), this.state.lastTokStartLoc.index > s.index + 1 && this.raise(x.UnexpectedSpaceBetweenModuloChecks, s), this.eat(10) ? (e.value = super.parseExpression(), this.expect(11), this.finishNode(e, "DeclaredPredicate")) : this.finishNode(e, "InferredPredicate");
        }
        ...
        flowParseDeclare(e, s) {
          ...
          if (this.eatContextual(127)) return this.match(16) ? this.flowParseDeclareModuleExports(e) : (s && this.raise(x.NestedDeclareModule, this.state.lastTokStartLoc), this.flowParseDeclareModule(e));
        ...
        flowParseDeclareModule(e) {
          ...
          for (this.expect(5); !this.match(8); ) {
            ...
            this.match(83) ? (this.next(), !this.isContextual(130) && !this.match(87) && this.raise(x.InvalidNonTypeImportInDeclareModule, this.state.lastTokStartLoc), r.push(super.parseImport(n))) : (this.expectContextual(125, x.UnsupportedStatementInDeclareModule), r.push(this.flowParseDeclare(n, !0)));
          }
          this.scope.exit(), this.expect(8), this.finishNode(s, "BlockStatement");
          let i = null, a = !1;
          return r.forEach((n) => {
            sr(n) ? (i === "CommonJS" && this.raise(x.AmbiguousDeclareModuleKind, n), i = "ES") : n.type === "DeclareModuleExports" && (a && this.raise(x.DuplicateDeclareModuleExports, n), i === "ES" && this.raise(x.AmbiguousDeclareModuleKind, n), i = "CommonJS", a = !0);
        ...
        flowParseDeclareExportDeclaration(e, s) {
          ...
          if (this.match(75) || this.isLet() || (this.isContextual(130) || this.isContextual(129)) && !s) {
            ...
            throw this.raise(x.UnsupportedDeclareExportKind, this.state.startLoc, { unsupportedExportKind: r, suggestion: rr[r] });
          }
        ...
        checkNotUnderscore(e) {
          e === "_" && this.raise(x.UnexpectedReservedUnderscore, this.state.startLoc);
        }
        checkReservedType(e, s, r) {
          tr.has(e) && this.raise(r ? x.AssignReservedType : x.UnexpectedReservedType, s, { reservedType: e });
        }
        ...
        flowParseTypeParameter(e = !1) {
          ...
          return r.name = a.name, r.variance = i, r.bound = a.typeAnnotation, this.match(29) ? (this.eat(29), r.default = this.flowParseType()) : e && this.raise(x.MissingTypeParamDefault, s), this.finishNode(r, "TypeParameter");
        }
        ...
        flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: r, allowProto: i, allowInexact: a }) {
          ...
          for (s && this.match(6) ? (this.expect(6), p = 9, l = !0) : (this.expect(5), p = 8, l = !1), o.exact = l; !this.match(p); ) {
            let P = !1, A = null, I = null, N = this.startNode();
            if (i && this.isContextual(118)) {
              let w = this.lookahead();
              w.type !== 14 && w.type !== 17 && (this.next(), A = this.state.startLoc, e = !1);
            }
            if (e && this.isContextual(106)) {
              let w = this.lookahead();
              w.type !== 14 && w.type !== 17 && (this.next(), P = !0);
            }
            let S = this.flowParseVariance();
            if (this.eat(0)) A != null && this.unexpected(A), this.eat(0) ? (S && this.unexpected(S.loc.start), o.internalSlots.push(this.flowParseObjectTypeInternalSlot(N, P))) : o.indexers.push(this.flowParseObjectTypeIndexer(N, P, S));
            else if (this.match(10) || this.match(47)) A != null && this.unexpected(A), S && this.unexpected(S.loc.start), o.callProperties.push(this.flowParseObjectTypeCallProperty(N, P));
            else {
              let w = "init";
              if (this.isContextual(99) || this.isContextual(104)) {
                let st = this.lookahead();
                ct(st.type) && (w = this.state.value, this.next());
              }
              let v = this.flowParseObjectTypeProperty(N, P, A, S, w, r, a ?? !l);
              v === null ? (c = !0, I = this.state.lastTokStartLoc) : o.properties.push(v);
            }
            this.flowObjectTypeSemicolon(), I && !this.match(8) && !this.match(9) && this.raise(x.UnexpectedExplicitInexactInObject, I);
          }
          this.expect(p), r && (o.inexact = c);
          let d = this.finishNode(o, "ObjectTypeAnnotation");
          return this.state.inType = n, d;
        }
        flowParseObjectTypeProperty(e, s, r, i, a, n, o) {
          if (this.eat(21)) return this.match(12) || this.match(13) || this.match(8) || this.match(9) ? (n ? o || this.raise(x.InexactInsideExact, this.state.lastTokStartLoc) : this.raise(x.InexactInsideNonObject, this.state.lastTokStartLoc), i && this.raise(x.InexactVariance, i), null) : (n || this.raise(x.UnexpectedSpreadType, this.state.lastTokStartLoc), r != null && this.unexpected(r), i && this.raise(x.SpreadVariance, i), e.argument = this.flowParseType(), this.finishNode(e, "ObjectTypeSpreadProperty"));
          {
            e.key = this.flowParseObjectPropertyKey(), e.static = s, e.proto = r != null, e.kind = a;
            let p = !1;
            return this.match(47) || this.match(10) ? (e.method = !0, r != null && this.unexpected(r), i && this.unexpected(i.loc.start), e.value = this.flowParseObjectTypeMethodish(this.startNodeAt(e.loc.start)), (a === "get" || a === "set") && this.flowCheckGetterSetterParams(e), !n && e.key.name === "constructor" && e.value.this && this.raise(x.ThisParamBannedInConstructor, e.value.this)) : (a !== "init" && this.unexpected(), e.method = !1, this.eat(17) && (p = !0), e.value = this.flowParseTypeInitialiser(), e.variance = i), e.optional = p, this.finishNode(e, "ObjectTypeProperty");
          }
        }
        flowCheckGetterSetterParams(e) {
          let s = e.kind === "get" ? 0 : 1, r = e.value.params.length + (e.value.rest ? 1 : 0);
          e.value.this && this.raise(e.kind === "get" ? x.GetterMayNotHaveThisParam : x.SetterMayNotHaveThisParam, e.value.this), r !== s && this.raise(e.kind === "get" ? u.BadGetterArity : u.BadSetterArity, e), e.kind === "set" && e.value.rest && this.raise(u.BadSetterRestParameter, e);
        }
        ...
        flowParseFunctionTypeParam(e) {
          ...
          return n.type === 14 || n.type === 17 ? (o && !e && this.raise(x.ThisParamMustBeFirst, a), s = this.parseIdentifier(o), this.eat(17) && (r = !0, o && this.raise(x.ThisParamMayNotBeOptional, a)), i = this.flowParseTypeInitialiser()) : i = this.flowParseType(), a.name = s, a.optional = r, a.typeAnnotation = i, this.finishNode(a, "FunctionTypeParam");
        }
          ...
          switch (this.state.type) {
            ...
            case 53:
              if (this.state.value === "-") {
                ...
                throw this.raise(x.UnexpectedSubtractionOperand, this.state.startLoc);
              }
              throw this.unexpected();
            case 135:
        ...
        parseConditional(e, s, r) {
          ...
          if (this.state.maybeInArrowParameters) {
            ...
            if (d === 44 || d === 61 || d === 58 || d === 41) return this.setOptionalParametersError(r), e;
          }
          this.expect(17);
          let i = this.state.clone(), a = this.state.noArrowAt, n = this.startNodeAt(s), { consequent: o, failed: p } = this.tryParseConditionalConsequent(), [l, c] = this.getArrowLikeExpressions(o);
          if (p || c.length > 0) {
            let d = [...a];
            if (c.length > 0) {
              this.state = i, this.state.noArrowAt = d;
              for (let P = 0; P < c.length; P++) d.push(c[P].start);
              ({ consequent: o, failed: p } = this.tryParseConditionalConsequent()), [l, c] = this.getArrowLikeExpressions(o);
            }
            p && l.length > 1 && this.raise(x.AmbiguousConditionalArrow, i.startLoc), p && l.length === 1 && (this.state = i, d.push(l[0].start), this.state.noArrowAt = d, { consequent: o, failed: p } = this.tryParseConditionalConsequent());
          }
        ...
        getArrowLikeExpressions(e, s) {
          ...
          return s ? (i.forEach((a) => this.finishArrowValidation(a)), [i, []]) : ir(i, (a) => a.params.every((n) => this.isAssignable(n, !0)));
        }
        ...
        parseClassMember(e, s, r) {
          ...
          super.parseClassMember(e, s, r), s.declare && (s.type !== "ClassProperty" && s.type !== "ClassPrivateProperty" && s.type !== "PropertyDefinition" ? this.raise(x.DeclareClassElement, i) : s.value && this.raise(x.DeclareClassFieldInitializer, s.value));
        }
        isIterator(e) {
        ...
        getTokenFromCode(e) {
          ...
          e === 123 && s === 124 ? this.finishOp(6, 2) : this.state.inType && (e === 62 || e === 60) ? this.finishOp(e === 62 ? 48 : 47, 1) : this.state.inType && e === 63 ? s === 46 ? this.finishOp(18, 2) : this.finishOp(17, 1) : Gs(e, s, this.input.charCodeAt(this.state.pos + 2)) ? (this.state.pos += 2, this.readIterator()) : super.getTokenFromCode(e);
        }
        isAssignable(e, s) {
        ...
        toAssignableList(e, s, r) {
          for (let i = 0; i < e.length; i++) {
            let a = e[i];
            a?.type === "TypeCastExpression" && (e[i] = this.typeCastToParameter(a));
          }
        ...
        toReferencedList(e, s) {
          for (let r = 0; r < e.length; r++) {
            let i = e[r];
            i && i.type === "TypeCastExpression" && !i.extra?.parenthesized && (e.length > 1 || !s) && this.raise(x.TypeCastInPattern, i.typeAnnotation);
          }
          return e;
        }
        parseArrayLike(e, s, r) {
          let i = super.parseArrayLike(e, s, r);
          return r != null && !this.state.maybeInArrowParameters && this.toReferencedList(i.elements), i;
        }
        isValidLVal(e, s, r, i) {
          return e === "TypeCastExpression" || super.isValidLVal(e, s, r, i);
        }
        parseClassProperty(e) {
        ...
        pushClassMethod(e, s, r, i, a, n) {
          if (s.variance && this.unexpected(s.variance.loc.start), delete s.variance, this.match(47) && (s.typeParameters = this.flowParseTypeParameterDeclaration()), super.pushClassMethod(e, s, r, i, a, n), s.params && a) {
            let o = s.params;
            o.length > 0 && this.isThisParam(o[0]) && this.raise(x.ThisParamBannedInConstructor, s);
        ...
        checkGetterSetterParams(e) {
          ...
          if (s.length > 0) {
            let r = s[0];
            this.isThisParam(r) && e.kind === "get" ? this.raise(x.GetterMayNotHaveThisParam, r) : this.isThisParam(r) && this.raise(x.SetterMayNotHaveThisParam, r);
          }
        }
        ...
        parseFunctionParamType(e) {
          return this.eat(17) && (e.type !== "Identifier" && this.raise(x.PatternIsOptional, e), this.isThisParam(e) && this.raise(x.ThisParamMayNotBeOptional, e), e.optional = !0), this.match(14) ? e.typeAnnotation = this.flowParseTypeAnnotation() : this.isThisParam(e) && this.raise(x.ThisParamAnnotationRequired, e), this.match(29) && this.isThisParam(e) && this.raise(x.ThisParamNoDefault, e), this.resetEndLocation(e), e;
        }
        parseMaybeDefault(e, s) {
          let r = super.parseMaybeDefault(e, s);
          return r.type === "AssignmentPattern" && r.typeAnnotation && r.right.start < r.typeAnnotation.start && this.raise(x.TypeBeforeInitializer, r.typeAnnotation), r;
        }
        ...
        parseImportSpecifierLocal(e, s, r) {
          s.local = Tt(e) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(s, r));
        }
        ...
        parseImportSpecifier(e, s, r, i, a) {
          ...
          if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
            ...
            o !== null && !F(this.state.type) ? (e.imported = c, e.importKind = o, e.local = this.cloneIdentifier(c)) : (e.imported = n, e.importKind = null, e.local = this.parseIdentifier());
          } else {
            if (o !== null && F(this.state.type)) e.imported = this.parseIdentifier(!0), e.importKind = o;
            else {
          ...
          let l = Tt(e);
          return r && l && this.raise(x.ImportTypeShorthandOnlyInPureImport, e), (r || l) && this.checkReservedType(e.local.name, e.local.loc.start, !0), p && !r && !l && this.checkReservedWord(e.local.name, e.loc.start, !0, !0), this.finishImportSpecifier(e, "ImportSpecifier");
        }
        parseBindingAtom() {
          switch (this.state.type) {
            case 78:
        ...
        parseMaybeAssign(e, s) {
          ...
          if (this.hasPlugin("jsx") && (this.match(143) || this.match(47))) {
            if (r = this.state.clone(), i = this.tryParse(() => super.parseMaybeAssign(e, s), r), !i.error) return i.node;
            let { context: a } = this.state, n = a[a.length - 1];
            (n === C.j_oTag || n === C.j_expr) && a.pop();
          }
          if (i?.error || this.match(47)) {
            r = r || this.state.clone();
            let a, n = this.tryParse((p) => {
              a = this.flowParseTypeParameterDeclaration();
              let l = this.forwardNoArrowParamsConversionAt(a, () => {
                let d = super.parseMaybeAssign(e, s);
                return this.resetStartLocationFromNode(d, a), d;
              });
              l.extra?.parenthesized && p();
              let c = this.maybeUnwrapTypeCastExpression(l);
              return c.type !== "ArrowFunctionExpression" && p(), c.typeParameters = a, this.resetStartLocationFromNode(c, a), l;
            }, r), o = null;
            if (n.node && this.maybeUnwrapTypeCastExpression(n.node).type === "ArrowFunctionExpression") {
              if (!n.error && !n.aborted) return n.node.async && this.raise(x.UnexpectedTypeParameterBeforeAsyncArrowFunction, a), n.node;
              o = n.node;
            }
            if (i?.node) return this.state = i.failState, i.node;
            if (o) return this.state = n.failState, o;
            throw i?.thrown ? i.error : n.thrown ? n.error : this.raise(x.UnexpectedTokenAfterTypeParameter, a);
          }
        ...
        checkParams(e, s, r, i = !0) {
          if (!(r && this.state.noArrowParamsConversionAt.includes(this.offsetToSourcePos(e.start)))) {
            for (let a = 0; a < e.params.length; a++) this.isThisParam(e.params[a]) && a > 0 && this.raise(x.ThisParamMustBeFirst, e.params[a]);
        ...
        parseSubscripts(e, s, r) {
          if (e.type === "Identifier" && e.name === "async" && this.state.noArrowAt.includes(s.index)) {
            this.next();
            let i = this.startNodeAt(s);
            i.callee = e, i.arguments = super.parseCallExpressionArguments(), e = this.finishNode(i, "CallExpression");
        ...
        parseSubscript(e, s, r, i) {
          if (this.match(18) && this.isLookaheadToken_lt()) {
            ...
            return a.callee = e, a.typeArguments = this.flowParseTypeParameterInstantiationInExpression(), this.expect(10), a.arguments = this.parseCallExpressionArguments(), a.optional = !0, this.finishCallExpression(a, !0);
          } else if (!r && this.shouldParseTypes() && (this.match(47) || this.match(51))) {
            let a = this.startNodeAt(s);
            a.callee = e;
            let n = this.tryParse(() => (a.typeArguments = this.flowParseTypeParameterInstantiationCallOrNew(), this.expect(10), a.arguments = super.parseCallExpressionArguments(), i.optionalChainMember && (a.optional = !1), this.finishCallExpression(a, i.optionalChainMember)));
        ...
        parseTopLevel(e, s) {
          ...
          return this.state.hasFlowComment && this.raise(x.UnterminatedFlowComment, this.state.curPosition()), r;
        }
        skipBlockComment() {
          if (this.hasPlugin("flowComments") && this.skipFlowComment()) {
            if (this.state.hasFlowComment) throw this.raise(x.NestedFlowComment, this.state.startLoc);
        ...
        flowEnumErrorBooleanMemberNotInitialized(e, { enumName: s, memberName: r }) {
          this.raise(x.EnumBooleanMemberNotInitialized, e, { memberName: r, enumName: s });
        }
        flowEnumErrorInvalidMemberInitializer(e, s) {
          return this.raise(s.explicitType ? s.explicitType === "symbol" ? x.EnumInvalidMemberInitializerSymbolType : x.EnumInvalidMemberInitializerPrimaryType : x.EnumInvalidMemberInitializerUnknownType, e, s);
        }
        flowEnumErrorNumberMemberNotInitialized(e, s) {
          this.raise(x.EnumNumberMemberNotInitialized, e, s);
        }
        flowEnumErrorStringMemberInconsistentlyInitialized(e, s) {
          this.raise(x.EnumStringMemberInconsistentlyInitialized, e, s);
        }
        flowEnumMemberInit() {
        ...
        flowEnumMembers({ enumName: e, explicitType: s }) {
          ...
          for (; !this.match(8); ) {
            ...
            if (l === "") continue;
            /^[a-z]/.test(l) && this.raise(x.EnumInvalidMemberName, o, { memberName: l, suggestion: l[0].toUpperCase() + l.slice(1), enumName: e }), r.has(l) && this.raise(x.EnumDuplicateMemberName, o, { memberName: l, enumName: e }), r.add(l);
            let c = { enumName: e, explicitType: s, memberName: l };
            switch (n.id = o, p.type) {
              case "boolean": {
                this.flowEnumCheckExplicitTypeMismatch(p.loc, c, "boolean"), n.init = p.value, i.booleanMembers.push(this.finishNode(n, "EnumBooleanMember"));
                break;
              }
              case "number": {
                this.flowEnumCheckExplicitTypeMismatch(p.loc, c, "number"), n.init = p.value, i.numberMembers.push(this.finishNode(n, "EnumNumberMember"));
                break;
              }
              case "string": {
                this.flowEnumCheckExplicitTypeMismatch(p.loc, c, "string"), n.init = p.value, i.stringMembers.push(this.finishNode(n, "EnumStringMember"));
                break;
              }
              case "invalid":
                throw this.flowEnumErrorInvalidMemberInitializer(p.loc, c);
              case "none":
                switch (s) {
                  case "boolean":
                    this.flowEnumErrorBooleanMemberNotInitialized(p.loc, c);
                    break;
                  case "number":
                    this.flowEnumErrorNumberMemberNotInitialized(p.loc, c);
                    break;
                  default:
        ...
        flowEnumParseExplicitType({ enumName: e }) {
          ...
          if (!E(this.state.type)) throw this.raise(x.EnumInvalidExplicitTypeUnknownSupplied, this.state.startLoc, { enumName: e });
          let { value: s } = this.state;
          return this.next(), s !== "boolean" && s !== "number" && s !== "string" && s !== "symbol" && this.raise(x.EnumInvalidExplicitType, this.state.startLoc, { enumName: e, invalidEnumType: s }), s;
        }
        flowEnumBody(e, s) {
          ...
          switch (e.hasUnknownMembers = o, a) {
            ...
            default: {
              ...
              e.explicitType = !1;
              let l = n.booleanMembers.length, c = n.numberMembers.length, d = n.stringMembers.length, P = n.defaultedMembers.length;
              if (!l && !c && !d && !P) return p();
              if (!l && !c) return e.members = this.flowEnumStringMembers(n.stringMembers, n.defaultedMembers, { enumName: r }), this.expect(8), this.finishNode(e, "EnumStringBody");
              if (!c && !d && l >= P) {
                for (let A of n.defaultedMembers) this.flowEnumErrorBooleanMemberNotInitialized(A.loc.start, { enumName: r, memberName: A.id.name });
                return e.members = n.booleanMembers, this.expect(8), this.finishNode(e, "EnumBooleanBody");
              } else if (!l && !d && c >= P) {
                for (let A of n.defaultedMembers) this.flowEnumErrorNumberMemberNotInitialized(A.loc.start, { enumName: r, memberName: A.id.name });
                return e.members = n.numberMembers, this.expect(8), this.finishNode(e, "EnumNumberBody");
              } else return this.raise(x.EnumInconsistentMemberValues, i, { enumName: r }), p();
            }
          }
        }
      ...
      function bt(t, e, s) {
        for (let r = e; r < s; r++) if (X(t.charCodeAt(r))) return !0;
        return !1;
      }
      var _e = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, Ve = /(?:[^\S\n\r\u2028\u2029]|\/\/.*|\/\*.*?\*\/)*/g;
      function lr(t) {
      ...
      function G(t) {
        ...
        if (t.type === "JSXMemberExpression") return G(t.object) + "." + G(t.property);
        throw new Error("Node had unexpected type: " + t.type);
      }
      var hr = (t) => class extends t {
        jsxReadToken() {
          ...
          for (; ; ) {
            ...
            switch (r) {
              ...
              case 62:
              case 125:
                this.raise(j.UnexpectedToken, this.state.curPosition(), { unexpected: this.input[this.state.pos], HTMLEntity: r === 125 ? "&rbrace;" : "&gt;" });
              default:
                X(r) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(!0), s = this.state.pos) : ++this.state.pos;
            }
          }
        }
        jsxReadNewLine(e) {
...
`) : r = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, r;
        ...
        jsxReadString(e) {
          ...
          for (; ; ) {
            ...
            if (i === e) break;
            i === 38 ? (s += this.input.slice(r, this.state.pos), s += this.jsxReadEntity(), r = this.state.pos) : X(i) ? (s += this.input.slice(r, this.state.pos), s += this.jsxReadNewLine(!1), r = this.state.pos) : ++this.state.pos;
          }
        ...
        jsxParseIdentifier() {
          let e = this.startNode();
          return this.match(141) ? e.name = this.state.value : Le(this.state.type) ? e.name = $(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
        }
        ...
        jsxParseExpressionContainer(e, s) {
          if (this.match(8)) e.expression = this.jsxParseEmptyExpression();
            ...
            r.type === "SequenceExpression" && !r.extra?.parenthesized && this.raise(j.UnexpectedSequenceExpression, r.expressions[1]), e.expression = r;
          }
        ...
        jsxParseElementAt(e) {
          ...
          if (!i.selfClosing) {
            e: for (; ; ) switch (this.state.type) {
              ...
              case 5: {
                let n = this.startNode();
                this.setContext(C.brace), this.next(), this.match(21) ? r.push(this.jsxParseSpreadChild(n)) : r.push(this.jsxParseExpressionContainer(n, C.j_expr));
                break;
              }
              default:
                this.unexpected();
            }
            q(i) && !q(a) && a !== null ? this.raise(j.MissingClosingTagFragment, a) : !q(i) && q(a) ? this.raise(j.MissingClosingTagElement, a, { openingTagName: G(i.name) }) : !q(i) && !q(a) && G(a.name) !== G(i.name) && this.raise(j.MissingClosingTagElement, a, { openingTagName: G(i.name) });
          }
          if (q(i) ? (s.openingFragment = i, s.closingFragment = a) : (s.openingElement = i, s.closingElement = a), s.children = r, this.match(47)) throw this.raise(j.UnwrappedAdjacentJSXElements, this.state.startLoc);
        ...
        updateContext(e) {
          ...
          if (r === 56 && e === 143) s.splice(-2, 2, C.j_cTag), this.state.canStartJSXElement = !1;
          else if (r === 143) s.push(C.j_oTag);
          else if (r === 144) {
            let i = s[s.length - 1];
            i === C.j_oTag && e === 56 || i === C.j_cTag ? (s.pop(), this.state.canStartJSXElement = s[s.length - 1] === C.j_expr) : (this.setContext(C.j_expr), this.state.canStartJSXElement = !0);
          } else this.state.canStartJSXElement = Ms(r);
        }
      }, pr = class extends Ue {
        ...
        importsStack = [];
        createScope(t) {
          return this.importsStack.push(/* @__PURE__ */ new Set()), new pr(t);
        }
        enter(t) {
      ...
      function W(t, e, s) {
        ...
        r === null || r.start > s.start ? Y(t, s.comments) : Et(r, s.comments);
      }
      var fr = class extends dr {
        ...
        finalizeComment(t) {
          let { comments: e } = t;
          if (t.leadingNode !== null || t.trailingNode !== null) t.leadingNode !== null && Et(t.leadingNode, e), t.trailingNode !== null && mr(t.trailingNode, e);
          else {
            let s = t.containingNode, r = t.start;
            if (this.input.charCodeAt(this.offsetToSourcePos(r) - 1) === 44) switch (s.type) {
        ...
        init({ strictMode: e, sourceType: s, startIndex: r, startLine: i, startColumn: a }) {
          this.strict = e === !1 ? !1 : e === !0 ? !0 : s === "module", this.startIndex = r, this.curLine = i, this.lineStart = -a, this.startLoc = this.endLoc = new z(i, a, r);
        }
        errors = [];
        potentialArrowAt = -1;
        noArrowAt = [];
        ...
        tokensLength = 0;
        curPosition() {
          return new z(this.curLine, this.pos - this.lineStart, this.pos + this.startIndex);
        }
        clone() {
          let e = new ms();
        ...
        return t >= 48 && t <= 57;
      }, Ct = { decBinOct: /* @__PURE__ */ new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: /* @__PURE__ */ new Set([46, 88, 95, 120]) }, xe = { bin: (t) => t === 48 || t === 49, oct: (t) => t >= 48 && t <= 55, dec: (t) => t >= 48 && t <= 57, hex: (t) => t >= 48 && t <= 57 || t >= 65 && t <= 70 || t >= 97 && t <= 102 };
      function St(t, e, s, r, i, a) {
        let n = s, o = r, p = i, l = "", c = null, d = s, { length: P } = e;
        for (; ; ) {
          if (s >= P) {
            a.unterminated(n, o, p), l += e.slice(d, s);
            break;
          }
          ...
          if (A === 92) {
            l += e.slice(d, s);
            let I = Ar(e, s, r, i, t === "template", a);
            I.ch === null && !c ? c = { pos: s, lineStart: r, curLine: i } : l += I.ch, { pos: s, lineStart: r, curLine: i } = I, d = s;
          } else A === 8232 || A === 8233 ? (++s, ++i, r = s) : A === 10 || A === 13 ? t === "template" ? (l += e.slice(d, s) + `
`, ++s, A === 13 && e.charCodeAt(s) === 10 && ++s, ++i, d = r = s) : a.unterminated(n, o, p) : ++s;
        }
        return { pos: s, str: l, firstInvalidLoc: c, lineStart: r, curLine: i };
      }
      function Pr(t, e, s, r) {
        return t === "template" ? e === 96 || e === 36 && s.charCodeAt(r + 1) === 123 : e === (t === "double" ? 34 : 39);
      }
      function Ar(t, e, s, r, i, a) {
        let n = !i;
        e++;
...
`);
          ...
          case 120: {
            let l;
            return { code: l, pos: e } = ze(t, e, s, r, 2, !1, n, a), o(l === null ? null : String.fromCharCode(l));
          }
          case 117: {
            let l;
            return { code: l, pos: e } = It(t, e, s, r, n, a), o(l === null ? null : String.fromCodePoint(l));
          }
          case 116:
            return o("	");
          case 98:
          ...
          default:
            if (p >= 48 && p <= 55) {
              let l = e - 1, c = /^[0-7]+/.exec(t.slice(l, e + 2))[0], d = parseInt(c, 8);
              d > 255 && (c = c.slice(0, -1), d = parseInt(c, 8)), e += c.length - 1;
      ...
      function ze(t, e, s, r, i, a, n, o) {
        let p = e, l;
        return { n: l, pos: e } = wt(t, e, s, r, 16, i, a, !1, o, !n), l === null && (n ? o.invalidEscapeSequence(p, s, r) : e = p - 1), { code: l, pos: e };
      }
      function wt(t, e, s, r, i, a, n, o, p, l) {
        let c = e, d = i === 16 ? Ct.hex : Ct.decBinOct, P = i === 16 ? xe.hex : i === 10 ? xe.dec : i === 8 ? xe.oct : xe.bin, A = !1, I = 0;
        for (let N = 0, S = a ?? 1 / 0; N < S; ++N) {
          let w = t.charCodeAt(e), v;
          if (w === 95 && o !== "bail") {
            let st = t.charCodeAt(e - 1), rt = t.charCodeAt(e + 1);
            if (o) {
              if (Number.isNaN(rt) || !P(rt) || d.has(st) || d.has(rt)) {
          ...
          if (w >= 97 ? v = w - 97 + 10 : w >= 65 ? v = w - 65 + 10 : xr(w) ? v = w - 48 : v = 1 / 0, v >= i) {
            if (v <= 9 && l) return { n: null, pos: e };
            if (v <= 9 && p.invalidDigit(e, s, r, i)) v = 0;
            else if (n) v = 0, A = !0;
            else break;
          }
          ++e, I = I * i + v;
        }
        return e === c || a != null && e - c !== a || A ? { n: null, pos: e } : { n: I, pos: e };
      }
      function It(t, e, s, r, i, a) {
        let n = t.charCodeAt(e), o;
        if (n === 123) {
          if (++e, { code: o, pos: e } = ze(t, e, s, r, t.indexOf("}", e) - e, !0, i, a), ++e, o !== null && o > 1114111) if (i) a.invalidCodePoint(e, s, r);
          else return { code: null, pos: e };
        } else ({ code: o, pos: e } = ze(t, e, s, r, 4, !1, i, a));
        return { code: o, pos: e };
      }
      function ne(t, e, s) {
        return new z(s, t - e, t);
      }
      var gr = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), Tr = class {
        constructor(t) {
          let e = t.startIndex || 0;
          this.type = t.type, this.value = t.value, this.start = e + t.start, this.end = e + t.end, this.loc = new ue(t.startLoc, t.endLoc);
        }
      }, br = class extends fr {
        isLookahead;
        tokens = [];
        constructor(t, e) {
          super(), this.state = new yr(), this.state.init(t), this.input = e, this.length = e.length, this.comments = [], this.isLookahead = !1;
        }
        pushToken(t) {
        ...
        skipBlockComment(t) {
          ...
          for (this.state.pos = r + t.length, fe.lastIndex = s + 2; fe.test(this.input) && fe.lastIndex <= r; ) ++this.state.curLine, this.state.lineStart = fe.lastIndex;
          if (this.isLookahead) return;
          let i = { type: "CommentBlock", value: this.input.slice(s + 2, r), start: this.sourceToOffsetPos(s), end: this.sourceToOffsetPos(r + t.length), loc: new ue(e, this.state.curPosition()) };
        ...
        skipLineComment(t) {
          ...
          if (this.state.pos < this.length) for (; !X(r) && ++this.state.pos < this.length; ) r = this.input.charCodeAt(this.state.pos);
          if (this.isLookahead) return;
          let i = this.state.pos, a = { type: "CommentLine", value: this.input.slice(e + t, i), start: this.sourceToOffsetPos(e), end: this.sourceToOffsetPos(i), loc: new ue(s, this.state.curPosition()) };
        ...
        readToken_interpreter() {
          ...
          if (t !== 33) return !1;
          let e = this.state.pos;
          for (this.state.pos += 1; !X(t) && ++this.state.pos < this.length; ) t = this.input.charCodeAt(this.state.pos);
        ...
        readRegexp() {
          ...
          for (; ; ++i) {
            if (i >= this.length) throw this.raise(u.UnterminatedRegExp, D(t, 1));
            let p = this.input.charCodeAt(i);
            if (X(p)) throw this.raise(u.UnterminatedRegExp, D(t, 1));
            if (s) s = !1;
            else {
              if (p === 91) r = !0;
              else if (p === 93 && r) r = !1;
          ...
          for (; i < this.length; ) {
            ...
            if (gr.has(p)) p === 118 ? n.includes("u") && this.raise(u.IncompatibleRegExpUVFlags, o()) : p === 117 && n.includes("v") && this.raise(u.IncompatibleRegExpUVFlags, o()), n.includes(l) && this.raise(u.DuplicateRegExpFlags, o());
            else if (J(p) || p === 92) this.raise(u.MalformedRegExpFlags, o());
            else break;
            ++i, n += l;
          }
        ...
        readInt(t, e, s = !1, r = !0) {
          let { n: i, pos: a } = wt(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, e, s, r, this.errorHandlers_readInt, !1);
        ...
        readRadixNumber(t) {
          ...
          i == null && this.raise(u.InvalidDigit, D(s, 2), { radix: t });
          let a = this.input.charCodeAt(this.state.pos);
          if (a === 110) ++this.state.pos, r = !0;
          else if (a === 109) throw this.raise(u.InvalidDecimal, s);
          if (B(this.codePointAtPos(this.state.pos))) throw this.raise(u.NumberIdentifier, this.state.curPosition());
          if (r) {
        ...
        readNumber(t) {
          let e = this.state.pos, s = this.state.curPosition(), r = !1, i = !1, a = !1;
          !t && this.readInt(10) === null && this.raise(u.InvalidNumber, this.state.curPosition());
          let n = this.state.pos - e >= 2 && this.input.charCodeAt(e) === 48;
          if (n) {
            let c = this.input.slice(e, this.state.pos);
            if (this.recordStrictModeErrors(u.StrictOctalLiteral, s), !this.state.strict) {
              let d = c.indexOf("_");
              d > 0 && this.raise(u.ZeroDigitNumericSeparator, D(s, d));
            }
            a = n && !/[89]/.test(c);
          }
          let o = this.input.charCodeAt(this.state.pos);
          if (o === 46 && !a && (++this.state.pos, this.readInt(10), r = !0, o = this.input.charCodeAt(this.state.pos)), (o === 69 || o === 101) && !a && (o = this.input.charCodeAt(++this.state.pos), (o === 43 || o === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(u.InvalidOrMissingExponent, s), r = !0, o = this.input.charCodeAt(this.state.pos)), o === 110 && ((r || n) && this.raise(u.InvalidBigIntLiteral, s), ++this.state.pos, i = !0), B(this.codePointAtPos(this.state.pos))) throw this.raise(u.NumberIdentifier, this.state.curPosition());
          let p = this.input.slice(e, this.state.pos).replace(/[_mn]/g, "");
          if (i) {
            this.finishToken(136, p);
            return;
          }
          let l = a ? parseInt(p, 8) : parseFloat(p);
          this.finishToken(135, l);
        }
        readCodePoint(t) {
          let { code: e, pos: s } = It(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, this.errorHandlers_readCodePoint);
          return this.state.pos = s, e;
        }
        readString(t) {
          let { str: e, pos: s, curLine: r, lineStart: i } = St(t === 34 ? "double" : "single", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_string);
        ...
        readTemplateToken() {
          let t = this.input[this.state.pos], { str: e, firstInvalidLoc: s, pos: r, curLine: i, lineStart: a } = St("template", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_template);
          this.state.pos = r + 1, this.state.lineStart = a, this.state.curLine = i, s && (this.state.firstInvalidTemplateEscapePos = new z(s.curLine, s.pos - s.lineStart, this.sourceToOffsetPos(s.pos))), this.input.codePointAt(r) === 96 ? this.finishToken(24, s ? null : t + e + "`") : (this.state.pos++, this.finishToken(25, s ? null : t + e + "${"));
        }
        ...
        readWord1(t) {
          ...
          for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
            ...
            if (J(i)) this.state.pos += i <= 65535 ? 1 : 2;
            else if (i === 92) {
              this.state.containsEsc = !0, e += this.input.slice(r, this.state.pos);
              let a = this.state.curPosition(), n = this.state.pos === s ? B : J;
        ...
        readWord(t) {
          let e = this.readWord1(t), s = we.get(e);
          s !== void 0 ? this.finishToken(s, $(s)) : this.finishToken(132, e);
        }
        checkKeywordEscapes() {
          let { type: t } = this.state;
          Le(t) && this.state.containsEsc && this.raise(u.InvalidEscapedReservedWord, this.state.startLoc, { reservedWord: $(t) });
        }
        raise(t, e, s = {}) {
          let r = e instanceof z ? e : e.loc.start, i = t(r, s);
          if (!(this.optionFlags & 2048)) throw i;
          return this.isLookahead || this.state.errors.push(i), i;
        }
        raiseOverwrite(t, e, s = {}) {
          let r = e instanceof z ? e : e.loc.start, i = r.index, a = this.state.errors;
        ...
        unexpected(t, e) {
          throw this.raise(u.UnexpectedToken, t ?? this.state.startLoc, { expected: e ? $(e) : null });
        }
        expectPlugin(t, e) {
        ...
        errorBuilder(t) {
          return (e, s, r) => {
            this.raise(t, ne(e, s, r));
          };
        }
        errorHandlers_readInt = { invalidDigit: (t, e, s, r) => this.optionFlags & 2048 ? (this.raise(u.InvalidDigit, ne(t, e, s), { radix: r }), !0) : !1, numericSeparatorInEscapeSequence: this.errorBuilder(u.NumericSeparatorInEscapeSequence), unexpectedNumericSeparator: this.errorBuilder(u.UnexpectedNumericSeparator) };
        errorHandlers_readCodePoint = Object.assign({}, this.errorHandlers_readInt, { invalidEscapeSequence: this.errorBuilder(u.InvalidEscapeSequence), invalidCodePoint: this.errorBuilder(u.InvalidCodePoint) });
        errorHandlers_readStringContents_string = Object.assign({}, this.errorHandlers_readCodePoint, { strictNumericEscape: (t, e, s) => {
          this.recordStrictModeErrors(u.StrictNumericEscape, ne(t, e, s));
        }, unterminated: (t, e, s) => {
          throw this.raise(u.UnterminatedString, ne(t - 1, e, s));
        } });
        errorHandlers_readStringContents_template = Object.assign({}, this.errorHandlers_readCodePoint, { strictNumericEscape: this.errorBuilder(u.StrictNumericEscape), unterminated: (t, e, s) => {
          throw this.raise(u.UnterminatedTemplate, ne(t, e, s));
        } });
      }, Er = class {
        ...
        declarePrivateName(t, e, s) {
          ...
          if (e & 3) {
            let o = n && i.get(t);
            if (o) {
              let p = o & 4, l = e & 4, c = o & 3, d = e & 3;
              n = c === d || p !== l, n || i.delete(t);
            } else n || i.set(t, e);
          }
      ...
      var kr = class extends br {
        ...
        hasPrecedingLineBreak() {
          return bt(this.input, this.offsetToSourcePos(this.state.lastTokEndLoc.index), this.state.start);
        }
        hasFollowingLineBreak() {
          return bt(this.input, this.state.end, this.nextTokenStart());
        }
        isLineTerminator() {
        ...
        checkExpressionErrors(t, e) {
          if (!t) return !1;
          let { shorthandAssignLoc: s, doubleProtoLoc: r, privateKeyLoc: i, optionalParametersLoc: a, voidPatternLoc: n } = t, o = !!s || !!r || !!a || !!i || !!n;
          if (!e) return o;
          s != null && this.raise(u.InvalidCoverInitializedName, s), r != null && this.raise(u.DuplicateProto, r), i != null && this.raise(u.UnexpectedPrivateField, i), a != null && this.unexpected(a), n != null && this.raise(u.InvalidCoverDiscardElement, n);
        }
        isLiteralPropertyName() {
          return ct(this.state.type);
        }
        isPrivateName(t) {
        ...
        initializeScopes(t = this.options.sourceType === "module") {
          ...
          this.prodParam = new cr();
          let o = this.classScope;
          this.classScope = new Cr(this);
          let p = this.expressionScope;
          return this.expressionScope = new Sr(this), () => {
        ...
        constructor(t, e, s) {
          this.start = e, this.end = 0, this.loc = new ue(s), t?.optionFlags & 128 && (this.range = [e, 0]), t?.filename && (this.loc.filename = t.filename);
        }
        type = "";
      }, vt = He.prototype, vr = class extends kr {
        startNode() {
          let t = this.state.startLoc;
          return new He(this, t.index, t);
        }
        startNodeAt(t) {
          return new He(this, t.index, t);
        }
        ...
        cloneIdentifier(t) {
          let { type: e, start: s, end: r, loc: i, range: a, name: n } = t, o = Object.create(vt);
          return o.type = e, o.start = s, o.end = r, o.loc = i, o.range = a, o.name = n, t.extra && (o.extra = t.extra), o;
        }
        cloneStringLiteral(t) {
          let { type: e, start: s, end: r, loc: i, range: a, extra: n } = t, o = Object.create(vt);
          return o.type = e, o.start = s, o.end = r, o.loc = i, o.range = a, o.extra = n, o.value = t.value, o;
        }
      }, $e = (t) => t.type === "ParenthesizedExpression" ? $e(t.expression) : t, Dr = class extends vr {
        toAssignable(t, e = !1) {
          let s;
          switch ((t.type === "ParenthesizedExpression" || t.extra?.parenthesized) && (s = $e(t), e ? s.type === "Identifier" ? this.expressionScope.recordArrowParameterBindingError(u.InvalidParenthesizedAssignment, t) : s.type !== "CallExpression" && s.type !== "MemberExpression" && !this.isOptionalMemberExpression(s) && this.raise(u.InvalidParenthesizedAssignment, t) : this.raise(u.InvalidParenthesizedAssignment, t)), t.type) {
            case "Identifier":
            case "ObjectPattern":
            case "ArrayPattern":
            ...
            case "ObjectExpression":
              ...
              for (let r = 0, i = t.properties.length, a = i - 1; r < i; r++) {
                let n = t.properties[r], o = r === a;
                this.toAssignableObjectExpressionProp(n, o, e), o && n.type === "RestElement" && t.extra?.trailingCommaLoc && this.raise(u.RestTrailingComma, t.extra.trailingCommaLoc);
              }
              break;
            case "ObjectProperty": {
              let { key: r, value: i } = t;
              this.isPrivateName(r) && this.classScope.usePrivateName(this.getPrivateNameSV(r), r.loc.start), this.toAssignable(i, e);
              break;
            }
            case "SpreadElement":
            ...
            case "AssignmentExpression":
              t.operator !== "=" && this.raise(u.MissingEqInAssignment, t.left.loc.end), this.castNodeTo(t, "AssignmentPattern"), delete t.operator, t.left.type === "VoidPattern" && this.raise(u.VoidPatternInitializer, t.left), this.toAssignable(t.left, e);
              break;
        ...
        parseRestBinding() {
          ...
          return e.type === "VoidPattern" && this.raise(u.UnexpectedVoidPattern, e), t.argument = e, this.finishNode(t, "RestElement");
        }
        parseBindingAtom() {
          switch (this.state.type) {
            case 0: {
        ...
        parseBindingList(t, e, s) {
          ...
          for (; !this.eat(t); ) if (a ? a = !1 : this.expect(12), r && this.match(12)) i.push(null);
            ...
            if (this.match(21)) {
              ...
              if (s & 2 && (n = this.parseFunctionParamType(n)), i.push(n), !this.checkCommaAfterRest(e)) {
                this.expect(t);
                break;
              }
            } else {
        ...
        parseBindingRestProperty(t) {
          return this.next(), this.hasPlugin("discardBinding") && this.match(88) ? (t.argument = this.parseVoidPattern(null), this.raise(u.UnexpectedVoidPattern, t.argument)) : t.argument = this.parseIdentifier(), this.checkCommaAfterRest(125), this.finishNode(t, "RestElement");
        }
        ...
        parseMaybeDefault(t, e) {
          ...
          return e.type === "VoidPattern" && this.raise(u.VoidPatternInitializer, e), s.left = e, s.right = this.parseMaybeAssignAllowIn(), this.finishNode(s, "AssignmentPattern");
        }
        isValidLVal(t, e, s, r) {
          switch (t) {
            case "AssignmentPattern":
        ...
        checkLVal(t, e, s = 64, r = !1, i = !1, a = !1, n = !1) {
          let o = t.type;
          ...
          if (o === "Identifier") {
            ...
            return;
          } else o === "VoidPattern" && e.type === "CatchClause" && this.raise(u.VoidPatternCatchClauseParam, t);
          let l = $e(t);
          n || (n = l.type === "CallExpression" && (l.callee.type === "Import" || l.callee.type === "Super"));
          let c = this.isValidLVal(o, n, !(a || t.extra?.parenthesized) && e.type === "AssignmentExpression", s);
          if (c === !0) return;
          if (c === !1) {
          ...
          let d, P;
          typeof c == "string" ? (d = c, P = o === "ParenthesizedExpression") : [d, P] = c;
          let A = o === "ArrayPattern" || o === "ObjectPattern" ? { type: o } : e, I = t[d];
          if (Array.isArray(I)) for (let N of I) N && this.checkLVal(N, A, s, r, i, P, !0);
          else I && this.checkLVal(I, A, s, r, i, P, n);
        }
        checkIdentifier(t, e, s = !1) {
          this.state.strict && (s ? gt(t.name, this.inModule) : At(t.name)) && (e === 64 ? this.raise(u.StrictEvalArguments, t, { referenceName: t.name }) : this.raise(u.StrictEvalArgumentsBinding, t, { bindingName: t.name })), e & 8192 && t.name === "let" && this.raise(u.LetInLexicalBinding, t), e & 64 || this.declareNameFromIdentifier(t, e);
        }
      ...
      function Ke(t) {
        ...
        switch (t.type) {
          case "Identifier":
            return !0;
          case "MemberExpression":
            return !t.computed && Ke(t.object);
          case "TSInstantiationExpression":
            return Ke(t.expression);
          default:
            return !1;
        }
      }
      var Br = (t) => class extends t {
        getScopeHandler() {
          return ur;
        }
        tsIsIdentifier() {
        ...
        tsParseModifiers({ allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: r, errorTemplate: i = f.InvalidModifierOnTypeMember }, a) {
          let n = (p, l, c, d) => {
            l === c && a[d] && this.raise(f.InvalidModifiersOrder, p, { orderedModifiers: [c, d] });
          }, o = (p, l, c, d) => {
            (a[c] && l === d || a[d] && l === c) && this.raise(f.IncompatibleModifiers, p, { modifiers: [c, d] });
          };
          for (; ; ) {
            let { startLoc: p } = this.state, l = this.tsParseModifier(e.concat(s ?? []), r, a.static);
            if (!l) break;
            Ft(l) ? a.accessibility ? this.raise(f.DuplicateAccessibilityModifier, p, { modifier: l }) : (n(p, l, l, "override"), n(p, l, l, "static"), n(p, l, l, "readonly"), a.accessibility = l) : Mr(l) ? (a[l] && this.raise(f.DuplicateModifier, p, { modifier: l }), a[l] = !0, n(p, l, "in", "out")) : (Object.prototype.hasOwnProperty.call(a, l) ? this.raise(f.DuplicateModifier, p, { modifier: l }) : (n(p, l, "static", "readonly"), n(p, l, "static", "override"), n(p, l, "override", "readonly"), n(p, l, "abstract", "override"), o(p, l, "declare", "override"), o(p, l, "static", "abstract")), a[l] = !0), s?.includes(l) && this.raise(i, p, { modifier: l });
          }
        }
        ...
        tsParseDelimitedList(e, s, r) {
          return Fr(this.tsParseDelimitedListWorker(e, s, !0, r));
        }
        ...
        tsParseImportTypeWithPropertyValue() {
          ...
          for (this.expect(5); !this.match(8); ) {
            ...
            E(r) || r === 134 ? s.push(super.parsePropertyDefinition(null)) : this.unexpected(), this.eat(12);
          }
        ...
        tsParseInOutModifiers = this.tsParseModifiers.bind(this, { allowedModifiers: ["in", "out"], disallowedModifiers: ["const", "public", "private", "protected", "readonly", "declare", "abstract", "override"], errorTemplate: f.InvalidModifierOnTypeParameter });
        tsParseConstModifier = this.tsParseModifiers.bind(this, { allowedModifiers: ["const"], disallowedModifiers: ["in", "out"], errorTemplate: f.InvalidModifierOnTypeParameterPositions });
        tsParseInOutConstModifiers = this.tsParseModifiers.bind(this, { allowedModifiers: ["in", "out", "const"], disallowedModifiers: ["public", "private", "protected", "readonly", "declare", "abstract", "override"], errorTemplate: f.InvalidModifierOnTypeParameter });
        ...
        tsParseTypeParameters(e) {
          ...
          let r = { value: -1 };
          return s.params = this.tsParseBracketedList("TypeParametersOrArguments", this.tsParseTypeParameter.bind(this, e), !1, !0, r), s.params.length === 0 && this.raise(f.EmptyTypeParameters, s), r.value !== -1 && this.addExtra(s, "trailingComma", r.value), this.finishNode(s, "TSTypeParameterDeclaration");
        }
        tsFillSignature(e, s) {
          let r = e === 19, i = "params", a = "returnType";
        ...
        tsParseBindingListForSignature() {
          ...
          for (let s of e) {
            let { type: r } = s;
            (r === "AssignmentPattern" || r === "TSParameterProperty") && this.raise(f.UnsupportedSignatureParameterKind, s, { type: r });
          }
          return e;
        }
        ...
        tsParsePropertyOrMethodSignature(e, s) {
          if (this.eat(17) && (e.optional = !0), this.match(10) || this.match(47)) {
            s && this.raise(f.ReadonlyForMethodSignature, e);
            let r = e;
            r.kind && this.match(47) && this.raise(f.AccessorCannotHaveTypeParameters, this.state.curPosition()), this.tsFillSignature(14, r), this.tsParseTypeMemberSemicolon();
            let i = "params", a = "returnType";
            if (r.kind === "get") r[i].length > 0 && (this.raise(u.BadGetterArity, this.state.curPosition()), this.isThisParam(r[i][0]) && this.raise(f.AccessorCannotDeclareThisParameter, this.state.curPosition()));
            else if (r.kind === "set") {
              if (r[i].length !== 1) this.raise(u.BadSetterArity, this.state.curPosition());
              else {
                let n = r[i][0];
                this.isThisParam(n) && this.raise(f.AccessorCannotDeclareThisParameter, this.state.curPosition()), n.type === "Identifier" && n.optional && this.raise(f.SetAccessorCannotHaveOptionalParameter, this.state.curPosition()), n.type === "RestElement" && this.raise(f.SetAccessorCannotHaveRestParameter, this.state.curPosition());
              }
              r[a] && this.raise(f.SetAccessorCannotHaveReturnType, r[a]);
            } else r.kind = "method";
        ...
        tsParseTupleType() {
          ...
          return e.elementTypes.forEach((r) => {
            let { type: i } = r;
            s && i !== "TSRestType" && i !== "TSOptionalType" && !(i === "TSNamedTupleMember" && r.optional) && this.raise(f.OptionalTypeBeforeRequired, r), s || (s = i === "TSNamedTupleMember" && r.optional || i === "TSOptionalType");
          }), this.finishNode(e, "TSTupleType");
        }
        tsParseTupleElementType() {
          let e = this.state.startLoc, s = this.eat(21), { startLoc: r } = this.state, i, a, n, o, p = F(this.state.type) ? this.lookaheadCharCode() : null;
          if (p === 58) i = !0, n = !1, a = this.parseIdentifier(!0), this.expect(14), o = this.tsParseType();
          else if (p === 63) {
            n = !0;
            let l = this.state.value, c = this.tsParseNonArrayType();
            this.lookaheadCharCode() === 58 ? (i = !0, a = this.createIdentifier(this.startNodeAt(r), l), this.expect(17), this.expect(14), o = this.tsParseType()) : (i = !1, o = c, this.expect(17));
          } else o = this.tsParseType(), n = this.eat(17), i = this.eat(14);
          if (i) {
            let l;
            a ? (l = this.startNodeAt(r), l.optional = n, l.label = a, l.elementType = o, this.eat(17) && (l.optional = !0, this.raise(f.TupleOptionalAfterType, this.state.lastTokStartLoc))) : (l = this.startNodeAt(r), l.optional = n, this.raise(f.InvalidTupleMemberLabel, o), l.label = o, l.elementType = this.tsParseType()), o = this.finishNode(l, "TSNamedTupleMember");
          } else if (n) {
        ...
        tsParseTemplateLiteralType() {
          {
            let e = this.state.startLoc, s = this.parseTemplateElement(!1), r = [s];
            if (s.tail) {
              let i = this.startNodeAt(e), a = this.startNodeAt(e);
              return a.expressions = [], a.quasis = r, i.literal = this.finishNode(a, "TemplateLiteral"), this.finishNode(i, "TSLiteralType");
            } else {
              let i = [];
              for (; !s.tail; ) i.push(this.tsParseType()), this.readTemplateContinuation(), r.push(s = this.parseTemplateElement(!1));
              let a = this.startNodeAt(e);
              return a.types = i, a.quasis = r, this.finishNode(a, "TSTemplateLiteralType");
            }
          }
        }
        ...
        tsParseNonArrayType() {
          switch (this.state.type) {
            ...
            default: {
              let { type: e } = this.state;
              if (E(e) || e === 88 || e === 84) {
                let s = e === 88 ? "TSVoidKeyword" : e === 84 ? "TSNullKeyword" : Lr(this.state.value);
        ...
        tsCheckTypeAnnotationForReadOnly(e) {
          switch (e.typeAnnotation.type) {
            ...
            case "TSArrayType":
              return;
            default:
              this.raise(f.UnexpectedReadonly, e);
          }
        }
        tsParseInferType() {
          let e = this.startNode();
        ...
        tsParseTypeOperatorOrHigher() {
          return _s(this.state.type) && !this.state.containsEsc ? this.tsParseTypeOperator() : this.isContextual(115) ? this.tsParseInferType() : this.tsInAllowConditionalTypesContext(() => this.tsParseArrayTypeOrHigher());
        }
        ...
        tsParseTypePredicateAsserts() {
          ...
          return this.next(), !E(this.state.type) && !this.match(78) ? !1 : (e && this.raise(u.InvalidEscapedReservedWord, this.state.lastTokStartLoc, { reservedWord: "asserts" }), !0);
        }
        ...
        tsParseTypeAssertion() {
          this.getPluginOption("typescript", "disallowAmbiguousJSXLike") && this.raise(f.ReservedTypeAssertion, this.state.startLoc);
          let e = this.startNode();
        ...
        tsParseHeritageClause(e) {
          let s = this.state.startLoc, r = this.tsParseDelimitedList("HeritageClauseElement", () => {
            {
              let i = super.parseExprSubscripts();
              Ke(i) || this.raise(f.InvalidHeritageClauseType, i.loc.start, { token: e });
              let a = e === "extends" ? "TSInterfaceHeritage" : "TSClassImplements";
              if (i.type === "TSInstantiationExpression") return i.type = a, i;
              let n = this.startNodeAtNode(i);
              return n.expression = i, (this.match(47) || this.match(51)) && (n.typeArguments = this.tsParseTypeArgumentsInExpression()), this.finishNode(n, a);
            }
          });
          return r.length || this.raise(f.EmptyHeritageClauseType, s, { token: e }), r;
        }
        tsParseInterfaceDeclaration(e, s = {}) {
          if (this.hasFollowingLineBreak()) return null;
          this.expectContextual(129), s.declare && (e.declare = !0), E(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, 130)) : (e.id = null, this.raise(f.MissingInterfaceName, this.state.startLoc)), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutConstModifiers), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
          let r = this.startNode();
        ...
        tsParseImportEqualsDeclaration(e, s, r) {
          ...
          return e.importKind === "type" && i.type !== "TSExternalModuleReference" && this.raise(f.ImportAliasHasImportType, i), e.moduleReference = i, this.semicolon(), this.finishNode(e, "TSImportEqualsDeclaration");
        }
        ...
        tsTryParseDeclare(e) {
          ...
          return this.tsInAmbientContext(() => {
            switch (s) {
              ...
              case 107:
                if (this.isUsing()) return this.raise(f.InvalidModifierOnUsingDeclaration, this.state.startLoc, "declare"), e.declare = !0, this.parseVarStatement(e, "using", !0);
                break;
              case 96:
                if (this.isAwaitUsing()) return this.raise(f.InvalidModifierOnAwaitUsingDeclaration, this.state.startLoc, "declare"), e.declare = !0, this.next(), this.parseVarStatement(e, "await using", !0);
                break;
              case 129: {
              ...
              default:
                if (E(s)) return this.tsParseDeclaration(e, this.state.type, !0, null);
            }
          });
        }
        ...
        tsParseDeclaration(e, s, r, i) {
          switch (s) {
            case 124:
              if (this.tsCheckLineTerminator(r) && (this.match(80) || E(this.state.type))) return this.tsParseAbstractDeclaration(e, i);
              break;
            case 127:
              ...
              break;
            case 128:
              if (this.tsCheckLineTerminator(r) && E(this.state.type)) return e.kind = "namespace", this.tsParseModuleOrNamespaceDeclaration(e);
              break;
            case 130:
              if (this.tsCheckLineTerminator(r) && E(this.state.type)) return this.tsParseTypeAliasDeclaration(e);
              break;
          }
        }
        ...
        tsParseTypeArguments() {
          let e = this.startNode();
          return e.params = this.tsInType(() => this.tsInTopLevelContext(() => (this.expect(47), this.tsParseDelimitedList("TypeParametersOrArguments", this.tsParseType.bind(this))))), e.params.length === 0 ? this.raise(f.EmptyTypeArguments, e) : !this.state.inType && this.curContext() === C.brace && this.reScan_lt_gt(), this.expect(48), this.finishNode(e, "TSTypeParameterInstantiation");
        }
        tsIsDeclarationStart() {
          return Vs(this.state.type);
        }
        isExportDefaultSpecifier() {
        ...
        parseBindingElement(e, s) {
          ...
          !(e & 4) && (a || o || n) && this.raise(f.UnexpectedParameterModifier, r);
          ...
          if (a || o || n) {
            ...
            return s.length && (c.decorators = s), a && (c.accessibility = a), o && (c.readonly = o), n && (c.override = n), l.type !== "Identifier" && l.type !== "AssignmentPattern" && this.raise(f.UnsupportedParameterPropertyKind, c), c.parameter = l, this.finishNode(c, "TSParameterProperty");
          }
        ...
        tsDisallowOptionalPattern(e) {
          for (let s of e.params) s.type !== "Identifier" && s.optional && !this.state.isAmbientContext && this.raise(f.PatternIsOptional, s);
        }
        ...
        parseFunctionBodyAndFinish(e, s, r = !1) {
          ...
          return i && !this.match(5) && this.isLineTerminator() ? this.finishNode(e, i) : i === "TSDeclareFunction" && this.state.isAmbientContext && (this.raise(f.DeclareFunctionHasImplementation, e), e.declare) ? super.parseFunctionBodyAndFinish(e, i, r) : (this.tsDisallowOptionalPattern(e), super.parseFunctionBodyAndFinish(e, s, r));
        }
        ...
        tsCheckForInvalidTypeCasts(e) {
          e.forEach((s) => {
            s?.type === "TSTypeCastExpression" && this.raise(f.UnexpectedTypeAnnotation, s.typeAnnotation);
          });
        }
        toReferencedList(e, s) {
          ...
          if (this.match(47) || this.match(51)) {
            let n, o = this.tsTryParseAndCatch(() => {
              ...
              if (Me(this.state.type)) {
                let d = super.parseTaggedTemplateExpression(e, s, i);
                return d.typeArguments = p, d;
              }
              if (!r && this.eat(10)) {
                let d = this.startNodeAt(s);
                return d.callee = e, d.arguments = this.parseCallExpressionArguments(), this.tsCheckForInvalidTypeCasts(d.arguments), d.typeArguments = p, i.optionalChainMember && (d.optional = a), this.finishCallExpression(d, i.optionalChainMember);
              }
              let l = this.state.type;
              if (l === 48 || l === 52 || l !== 10 && ae(l) && !this.hasPrecedingLineBreak()) return;
              let c = this.startNodeAt(s);
              return c.expression = e, c.typeArguments = p, this.finishNode(c, "TSInstantiationExpression");
            });
            if (n && this.unexpected(n, 10), o) return o.type === "TSInstantiationExpression" && ((this.match(16) || this.match(18) && this.lookaheadCharCode() !== 40) && this.raise(f.InvalidPropertyAccessAfterInstantiationExpression, this.state.startLoc), !this.match(16) && !this.match(18) && (o.expression = super.stopParseSubscript(e, i))), o;
          }
          return super.parseSubscript(e, s, r, i);
        }
        parseNewCallee(e) {
        ...
        parseExprOp(e, s, r) {
          let i;
          if (me(58) > r && !this.hasPrecedingLineBreak() && (this.isContextual(93) || (i = this.isContextual(120)))) {
            let a = this.startNodeAt(s);
        ...
        checkImportReflection(e) {
          super.checkImportReflection(e), e.module && e.importKind !== "value" && this.raise(f.ImportReflectionHasImportType, e.specifiers[0].loc.start);
        }
        ...
        parseImport(e) {
          ...
          return s.importKind === "type" && s.specifiers.length > 1 && s.specifiers[0].type === "ImportDefaultSpecifier" && this.raise(f.TypeImportCannotSpecifyDefaultAndNamed, s), s;
        }
        parseExport(e, s) {
          if (this.match(83)) {
            let r = this.startNode();
            this.next();
            let i = null;
            this.isContextual(130) && this.isPotentialImportPhase(!1) ? i = this.parseMaybeImportPhase(r, !1) : r.importKind = "value";
            let a = this.tsParseImportEqualsDeclaration(r, i, !0);
            return e.attributes = [], e.declaration = a, e.exportKind = "value", e.source = null, e.specifiers = [], this.finishNode(e, "ExportNamedDeclaration");
          } else if (this.eat(29)) {
            let r = e;
        ...
        parseVarStatement(e, s, r = !1) {
          ...
          if (!i) return a;
          if (!e.declare && (s === "using" || s === "await using")) return this.raiseOverwrite(f.UsingDeclarationInAmbientContext, e, s), a;
          for (let { id: n, init: o } of a.declarations) o && (s === "var" || s === "let" || n.typeAnnotation ? this.raise(f.InitializerNotAllowedInAmbientContext, o) : Rr(o, this.hasPlugin("estree")) || this.raise(f.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference, o));
          return a;
        }
          ...
          if (!this.state.containsEsc) switch (this.state.type) {
            ...
            case 125: {
              if (this.nextTokenIsIdentifierAndNotTSRelationalOperatorOnSameLine()) {
                let r = this.state.type, i = this.startNode();
                this.next();
                let a = r === 125 ? this.tsTryParseDeclare(i) : this.tsParseAbstractDeclaration(i, s);
                return a ? (r === 125 && (a.declare = !0), a) : (i.expression = this.createIdentifier(this.startNodeAt(i.loc.start), r === 125 ? "declare" : "abstract"), this.semicolon(!1), this.finishNode(i, "ExpressionStatement"));
              }
              break;
            }
            case 126:
            ...
            case 127: {
              if (this.nextTokenIsIdentifierOrStringLiteralOnSameLine()) {
                let r = this.startNode();
                return this.next(), this.tsParseDeclaration(r, 127, !1, s);
              }
              break;
            }
            case 128: {
              if (this.nextTokenIsIdentifierOnSameLine()) {
                let r = this.startNode();
                return this.next(), this.tsParseDeclaration(r, 128, !1, s);
              }
              break;
            }
            case 130: {
              if (this.nextTokenIsIdentifierOnSameLine()) {
                let r = this.startNode();
                return this.next(), this.tsParseTypeAliasDeclaration(r);
              }
              break;
            }
          }
        ...
        tsHasSomeModifiers(e, s) {
          return s.some((r) => Ft(r) ? e.accessibility === r : !!e[r]);
        }
        ...
        parseClassMember(e, s, r) {
          ...
          this.tsParseModifiers({ allowedModifiers: i, disallowedModifiers: ["in", "out"], stopOnStartOfClassStaticBlock: !0, errorTemplate: f.InvalidModifierOnTypeParameterPositions }, s);
          let a = () => {
            this.tsIsStartOfStaticBlocks() ? (this.next(), this.next(), this.tsHasSomeModifiers(s, i) && this.raise(f.StaticBlockCannotHaveModifier, this.state.curPosition()), super.parseClassStaticBlock(e, s)) : this.parseClassMemberWithIsStatic(e, s, r, !!s.static);
          };
        ...
        parseClassMemberWithIsStatic(e, s, r, i) {
          ...
          if (a) {
            e.body.push(a), s.abstract && this.raise(f.IndexSignatureHasAbstract, s), s.accessibility && this.raise(f.IndexSignatureHasAccessibility, s, { modifier: s.accessibility }), s.declare && this.raise(f.IndexSignatureHasDeclare, s), s.override && this.raise(f.IndexSignatureHasOverride, s);
            return;
          }
          !this.state.inAbstractClass && s.abstract && this.raise(f.NonAbstractClassHasAbstractMethod, s), s.override && (r.hadSuperClass || this.raise(f.OverrideNotInSubClass, s)), super.parseClassMemberWithIsStatic(e, s, r, i);
        }
        parsePostMemberNameModifiers(e) {
          this.eat(17) && (e.optional = !0), e.readonly && this.match(10) && this.raise(f.ClassMethodHasReadonly, e), e.declare && this.match(10) && this.raise(f.ClassMethodHasDeclare, e);
        }
        shouldParseExportDeclaration() {
        ...
        parseExportDeclaration(e) {
          ...
          if (r && (this.isContextual(125) || !this.shouldParseExportDeclaration())) throw this.raise(f.ExpectedAmbientAfterExportDeclare, this.state.startLoc);
          let i = E(this.state.type) && this.tsTryParseExportDeclaration() || super.parseExportDeclaration(e);
        ...
        parseClassProperty(e) {
          if (this.parseClassPropertyAnnotation(e), this.state.isAmbientContext && !(e.readonly && !e.typeAnnotation) && this.match(29) && this.raise(f.DeclareClassFieldHasInitializer, this.state.startLoc), e.abstract && this.match(29)) {
            let { key: s } = e;
            this.raise(f.AbstractPropertyHasInitializer, this.state.startLoc, { propertyName: s.type === "Identifier" && !e.computed ? s.name : `[${this.input.slice(this.offsetToSourcePos(s.start), this.offsetToSourcePos(s.end))}]` });
          }
          return super.parseClassProperty(e);
        }
        parseClassPrivateProperty(e) {
          return e.abstract && this.raise(f.PrivateElementHasAbstract, e), e.accessibility && this.raise(f.PrivateElementHasAccessibility, e, { modifier: e.accessibility }), this.parseClassPropertyAnnotation(e), super.parseClassPrivateProperty(e);
        }
        parseClassAccessorProperty(e) {
          return this.parseClassPropertyAnnotation(e), e.optional && this.raise(f.AccessorCannotBeOptional, e), super.parseClassAccessorProperty(e);
        }
        pushClassMethod(e, s, r, i, a, n) {
          let o = this.tsTryParseTypeParameters(this.tsParseConstModifier);
          o && a && this.raise(f.ConstructorHasTypeParameters, o);
          let { declare: p = !1, kind: l } = s;
          p && (l === "get" || l === "set") && this.raise(f.DeclareAccessor, s, { kind: l }), o && (s.typeParameters = o), super.pushClassMethod(e, s, r, i, a, n);
        }
        pushClassPrivateMethod(e, s, r, i) {
        ...
        parseMaybeAssign(e, s) {
          ...
          if (this.hasPlugin("jsx") && (this.match(143) || this.match(47))) {
            ...
            (l === C.j_oTag || l === C.j_expr) && p.pop();
          }
          if (!i?.error && !this.match(47)) return super.parseMaybeAssign(e, s);
          (!r || r === this.state) && (r = this.state.clone());
          let n, o = this.tryParse((p) => {
            n = this.tsParseTypeParameters(this.tsParseConstModifier);
            let l = super.parseMaybeAssign(e, s);
            if ((l.type !== "ArrowFunctionExpression" || l.extra?.parenthesized) && p(), n?.params.length !== 0 && this.resetStartLocationFromNode(l, n), l.typeParameters = n, this.hasPlugin("jsx") && l.typeParameters.params.length === 1 && !l.typeParameters.extra?.trailingComma) {
              let c = l.typeParameters.params[0];
              c.constraint || this.raise(f.SingleTypeParameterWithoutTrailingComma, D(c.loc.end, 1), { typeParameterName: c.name.name });
            }
            return l;
          }, r);
          if (!o.error && !o.aborted) return n && this.reportReservedArrowTypeParam(n), o.node;
          if (!i && (Dt(!this.hasPlugin("jsx")), a = this.tryParse(() => super.parseMaybeAssign(e, s), r), !a.error)) return a.node;
          if (i?.node) return this.state = i.failState, i.node;
          if (o.node) return this.state = o.failState, n && this.reportReservedArrowTypeParam(n), o.node;
          if (a?.node) return this.state = a.failState, a.node;
          throw i?.error || o.error || a?.error;
        }
        reportReservedArrowTypeParam(e) {
          e.params.length === 1 && !e.params[0].constraint && !e.extra?.trailingComma && this.getPluginOption("typescript", "disallowAmbiguousJSXLike") && this.raise(f.ReservedArrowTypeParam, e);
        }
        parseMaybeUnary(e, s) {
        ...
        toAssignable(e, s = !1) {
          switch (e.type) {
            ...
            case "TSTypeAssertion":
              s ? this.expressionScope.recordArrowParameterBindingError(f.UnexpectedTypeCastInParameter, e) : this.raise(f.UnexpectedTypeCastInParameter, e), this.toAssignable(e.expression, s);
              break;
            case "AssignmentExpression":
        ...
        isValidLVal(e, s, r, i) {
          switch (e) {
            ...
            case "TSSatisfiesExpression":
            case "TSTypeAssertion":
              return (i !== 64 || !r) && ["expression", !0];
            default:
              return super.isValidLVal(e, s, r, i);
          }
        }
        parseBindingAtom() {
        ...
        parseMaybeDefault(e, s) {
          let r = super.parseMaybeDefault(e, s);
          return r.type === "AssignmentPattern" && r.typeAnnotation && r.right.start < r.typeAnnotation.start && this.raise(f.TypeAnnotationAfterAssign, r.typeAnnotation), r;
        }
        getTokenFromCode(e) {
        ...
        tsParseAbstractDeclaration(e, s) {
          ...
          if (this.isContextual(129)) return this.hasFollowingLineBreak() ? null : (e.abstract = !0, this.raise(f.NonClassMethodPropertyHasAbstractModifier, e), this.tsParseInterfaceDeclaration(e));
        ...
        parseMethod(e, s, r, i, a, n, o) {
          ...
          if ((p.abstract || p.type === "TSAbstractMethodDefinition") && (this.hasPlugin("estree") ? p.value : p).body) {
            let { key: l } = p;
            this.raise(f.AbstractMethodHasImplementation, p, { methodName: l.type === "Identifier" && !p.computed ? l.name : `[${this.input.slice(this.offsetToSourcePos(l.start), this.offsetToSourcePos(l.end))}]` });
          }
          return p;
        }
        ...
        parseTypeOnlyImportExportSpecifier(e, s, r) {
          let i = s ? "imported" : "local", a = s ? "local" : "exported", n = e[i], o, p = !1, l = !0, c = n.loc.start;
          if (this.isContextual(93)) {
            let P = this.parseIdentifier();
            if (this.isContextual(93)) {
              let A = this.parseIdentifier();
              F(this.state.type) ? (p = !0, n = P, o = s ? this.parseIdentifier() : this.parseModuleExportName(), l = !1) : (o = A, l = !1);
            } else F(this.state.type) ? (l = !1, o = s ? this.parseIdentifier() : this.parseModuleExportName()) : (p = !0, n = P);
          } else F(this.state.type) && (p = !0, s ? (n = this.parseIdentifier(!0), this.isContextual(93) || this.checkReservedWord(n.name, n.loc.start, !0, !0)) : n = this.parseModuleExportName());
          p && r && this.raise(s ? f.TypeModifierIsUsedInTypeImports : f.TypeModifierIsUsedInTypeExports, c), e[i] = n, e[a] = o;
          let d = s ? "importKind" : "exportKind";
          e[d] = p ? "type" : "value", l && this.eatContextual(93) && (e[a] = s ? this.parseIdentifier() : this.parseModuleExportName()), e[a] || (e[a] = this.cloneIdentifier(e[i])), s && this.checkIdentifier(e[a], p ? 4098 : 4096);
        }
        fillOptionalPropertiesForTSESLint(e) {
          switch (e.type) {
        ...
        chStartsBindingIdentifierAndNotRelationalOperator(e, s) {
          if (B(e)) {
            if (qe.lastIndex = s, qe.test(this.input)) {
              let r = this.codePointAtPos(qe.lastIndex);
              if (!J(r) && r !== 92) return !1;
            }
            return !0;
          } else return e === 92;
        }
      ...
      function Or(t) {
        ...
        return e && s.type !== "StringLiteral" && (s.type !== "TemplateLiteral" || s.expressions.length > 0) ? !1 : Mt(t.object);
      }
      function Rr(t, e) {
        let { type: s } = t;
        if (t.extra?.parenthesized) return !1;
        ...
        return !!(Lt(t, e) || Ur(t, e) || s === "TemplateLiteral" && t.expressions.length === 0 || Or(t));
      }
      function Lt(t, e) {
      ...
      function Ur(t, e) {
        if (t.type === "UnaryExpression") {
          ...
          if (s === "-" && Lt(r, e)) return !0;
        }
        return !1;
      }
      function Mt(t) {
        return t.type === "Identifier" ? !0 : t.type !== "MemberExpression" || t.computed ? !1 : Mt(t.object);
      }
      var Bt = M`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), jr = (t) => class extends t {
        parsePlaceholder(e) {
          if (this.match(133)) {
            let s = this.startNode();
        ...
        isValidLVal(e, s, r, i) {
          return e === "Placeholder" || super.isValidLVal(e, s, r, i);
        }
        toAssignable(e, s) {
        ...
        isExportDefaultSpecifier() {
          if (this.match(65)) {
            let e = this.nextTokenStart();
            if (this.isUnparsedContextual(e, "from") && this.input.startsWith($(133), this.nextTokenStartSince(e + 4))) return !0;
          }
        ...
        checkExport(e) {
          let { specifiers: s } = e;
          s?.length && (e.specifiers = s.filter((r) => r.exported.type === "Placeholder")), super.checkExport(e), e.specifiers = s;
        }
        parseImport(e) {
      ...
      function Vr(t) {
        ...
        if (t.has("pipelineOperator")) {
          let e = t.get("pipelineOperator").proposal;
          if (!Ot.includes(e)) {
            let s = Ot.map((r) => `"${r}"`).join(", ");
          ...
          if (e === "hack") {
            ...
            let s = t.get("pipelineOperator").topicToken;
            if (!Rt.includes(s)) {
              let r = Rt.map((i) => `"${i}"`).join(", ");
              throw new Error(`"pipelineOperator" in "proposal": "hack" mode also requires a "topicToken" option whose value must be one of: ${r}.`);
            }
          }
        }
        if (t.has("moduleAttributes")) throw new Error("`moduleAttributes` has been removed in Babel 8, please migrate to import attributes instead.");
        if (t.has("importAssertions")) throw new Error("`importAssertions` has been removed in Babel 8, please use import attributes instead. To use the non-standard `assert` syntax you can enable the `deprecatedImportAssert` parser plugin.");
        if (!t.has("deprecatedImportAssert") && t.has("importAttributes") && t.get("importAttributes").deprecatedAssertSyntax) throw new Error("The 'importAttributes' plugin has been removed in Babel 8. If you need to enable support for the deprecated `assert` syntax, you can enable the `deprecatedImportAssert` parser plugin.");
        if (t.has("recordAndTuple")) throw new Error("The 'recordAndTuple' plugin has been removed in Babel 8. Please remove it from your configuration.");
        ...
        {
          if (t.has("decimal")) throw new Error("The 'decimal' plugin has been removed in Babel 8. Please remove it from your configuration.");
          if (t.has("importReflection")) throw new Error("The 'importReflection' plugin has been removed in Babel 8. Use 'sourcePhaseImports' instead, and replace 'import module' with 'import source' in your code.");
        }
      }
      var Ut = { estree: vs, jsx: hr, flow: nr, typescript: Br, v8intrinsic: _r, placeholders: jr }, zr = Object.keys(Ut), Hr = class extends Dr {
        checkProto(t, e, s, r) {
        ...
        parseMaybeAssign(t, e) {
          ...
          (a === 10 || E(a)) && (this.state.potentialArrowAt = this.state.start);
          let n = this.parseMaybeConditional(t);
          if (e && (n = e.call(this, n, s)), Bs(this.state.type)) {
            let o = this.startNodeAt(s), p = this.state.value;
            if (o.operator = p, this.match(29)) {
              this.toAssignable(n, !0), o.left = n;
              let l = s.index;
              t.doubleProtoLoc != null && t.doubleProtoLoc.index >= l && (t.doubleProtoLoc = null), t.shorthandAssignLoc != null && t.shorthandAssignLoc.index >= l && (t.shorthandAssignLoc = null), t.privateKeyLoc != null && t.privateKeyLoc.index >= l && (this.checkDestructuringPrivate(t), t.privateKeyLoc = null), t.voidPatternLoc != null && t.voidPatternLoc.index >= l && (t.voidPatternLoc = null);
            } else o.left = n;
            return this.next(), o.right = this.parseMaybeAssign(), this.checkLVal(n, this.finishNode(o, "AssignmentExpression"), void 0, void 0, void 0, void 0, p === "||=" || p === "&&=" || p === "??="), o;
          } else i && this.checkExpressionErrors(t, !0);
          if (r) {
            let { type: o } = this.state;
            if ((this.hasPlugin("v8intrinsic") ? ae(o) : ae(o) && !this.match(54)) && !this.isAmbiguousPrefixOrIdentifier()) return this.raiseOverwrite(u.YieldNotInGeneratorFunction, s), this.parseYield(s);
          }
          return n;
        }
        ...
        parseExprOp(t, e, s) {
          if (this.isPrivateName(t)) {
            ...
            (s >= me(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(u.PrivateInExpectedIn, t, { identifierName: i }), this.classScope.usePrivateName(i, t.loc.start);
          }
          let r = this.state.type;
          if (Rs(r) && (this.prodParam.hasIn || !this.match(58))) {
            let i = me(r);
            if (i > s) {
              if (r === 39) {
              ...
              o && (i = me(42)), this.next(), a.right = this.parseExprOpRightExpr(r, i);
        ...
        parseExprOpBaseRightExpr(t, e) {
          ...
          return this.parseExprOp(this.parseMaybeUnaryOrPrivate(), s, zs(t) ? e - 1 : e);
        }
        parseHackPipeBody() {
          let { startLoc: t } = this.state, e = this.parseMaybeAssign();
          return Es.has(e.type) && !e.extra?.parenthesized && this.raise(u.PipeUnparenthesizedBody, t, { type: e.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(u.PipeTopicUnused, t), e;
        }
        ...
        parseMaybeUnary(t, e) {
          ...
          if (r) {
            let { type: o } = this.state;
            if ((this.hasPlugin("v8intrinsic") ? ae(o) : ae(o) && !this.match(54)) && !this.isAmbiguousPrefixOrIdentifier()) return this.raiseOverwrite(u.AwaitNotInAsyncContext, s), this.parseAwait(s);
          }
          return n;
        }
        parseUpdate(t, e, s) {
          ...
          for (; Us(this.state.type) && !this.canInsertSemicolon(); ) {
        ...
        parseSubscript(t, e, s, r) {
          ...
          if (Me(i)) return this.parseTaggedTemplateExpression(t, e, r);
          let a = !1;
          if (i === 18) {
        ...
        parseCoverCallAndAsyncArrowHead(t, e, s, r) {
          ...
          o && (this.expressionScope.enter(Nr()), a = new Ae()), p && (n.optional = r), r ? n.arguments = this.parseCallExpressionArguments() : n.arguments = this.parseCallExpressionArguments(t.type !== "Super", n, a);
        ...
        parseCallExpressionArguments(t, e, s) {
          let r = [], i = !0, a = this.state.inFSharpPipelineDirectBody;
          for (this.state.inFSharpPipelineDirectBody = !1; !this.eat(11); ) {
            ...
            r.push(this.parseExprListItem(11, !1, s, t));
          }
        ...
        parseAsyncArrowFromCallExpression(t, e) {
          return this.resetPreviousNodeTrailingComments(e), this.expect(19), this.parseArrowExpression(t, e.arguments, !0, e.extra?.trailingCommaLoc), e.innerComments && Y(t, e.innerComments), e.callee.trailingComments && Y(t, e.callee.trailingComments), t;
        }
        parseNoCallExpr() {
          let t = this.state.startLoc;
        ...
        parseExprAtom(t) {
          ...
          switch (r) {
            ...
            case 47: {
              ...
              throw B(i) || i === 62 ? this.expectOnePlugin(["jsx", "flow", "typescript"]) : this.unexpected();
            }
            default:
              if (E(r)) {
                ...
                if (!a && n.name === "async" && !this.canInsertSemicolon()) {
                  ...
                  if (E(o)) return this.lookaheadCharCode() === 61 ? this.parseAsyncArrowUnaryFunction(this.startNodeAtNode(n)) : n;
        ...
        finishTopicReference(t, e, s, r) {
          if (this.testTopicReferenceConfiguration(s, e, r)) return this.topicReferenceIsAllowedInCurrentContext() || this.raise(u.PipeTopicUnbound, e), this.registerTopicReference(), this.finishNode(t, "TopicReference");
          throw this.raise(u.PipeTopicUnconfiguredToken, e, { token: $(r) });
        }
        testTopicReferenceConfiguration(t, e, s) {
          switch (t) {
            case "hack":
              return this.hasPlugin(["pipelineOperator", { topicToken: $(s) }]);
            case "smart":
              return s === 27;
            default:
        ...
        parseAsyncArrowUnaryFunction(t) {
          this.prodParam.enter(ye(!0, this.prodParam.hasYield));
          let e = [this.parseIdentifier()];
        ...
        parseSuper() {
          let t = this.startNode();
          return this.next(), this.match(10) && !this.scope.allowDirectSuper ? this.raise(u.SuperNotAllowed, t) : this.scope.allowSuper || this.raise(u.UnexpectedSuper, t), !this.match(10) && !this.match(0) && !this.match(16) && this.raise(u.UnsupportedSuper, t), this.finishNode(t, "Super");
        }
        parsePrivateName() {
        ...
        parseTemplateElement(t) {
          let { start: e, startLoc: s, end: r, value: i } = this.state, a = e + 1, n = this.startNodeAt(D(s, 1));
          i === null && (t || this.raise(u.InvalidEscapeSequenceTemplate, D(this.state.firstInvalidTemplateEscapePos, 1)));
...
`), cooked: i === null ? null : i.slice(1, p) }, n.tail = o, this.next();
          let c = this.finishNode(n, "TemplateElement");
          return this.resetEndLocation(c, D(this.state.lastTokEndLoc, p)), c;
        }
        parseTemplate(t) {
        ...
        parseObjectLike(t, e, s, r) {
          ...
          for (o.properties = [], this.next(); !this.match(t); ) {
            ...
            let l;
            e ? l = this.parseBindingProperty() : (l = this.parsePropertyDefinition(r), a = this.checkProto(l, s, a, r)), s && !this.isObjectProperty(l) && l.type !== "SpreadElement" && this.raise(u.InvalidRecordProperty, l), o.properties.push(l);
          }
        ...
        checkGetterSetterParams(t) {
          ...
          s.length !== e && this.raise(t.kind === "get" ? u.BadGetterArity : u.BadSetterArity, t), t.kind === "set" && s[s.length - 1]?.type === "RestElement" && this.raise(u.BadSetterRestParameter, t);
        }
        ...
        parseObjectProperty(t, e, s, r) {
          if (t.shorthand = !1, this.eat(14)) return t.value = s ? this.parseMaybeDefault(this.state.startLoc) : this.parseMaybeAssignAllowInOrVoidPattern(8, r), this.finishObjectProperty(t);
        ...
        parsePropertyName(t, e) {
          if (this.eat(0)) t.computed = !0, t.key = this.parseMaybeAssignAllowIn(), this.expect(3);
            ...
            if (F(s)) i = this.parseIdentifier(!0);
            else switch (s) {
              case 135:
        ...
        parseMethod(t, e, s, r, i, a, n = !1) {
          this.initFunction(t, s), t.generator = e, this.scope.enter(530 | (n ? 576 : 0) | (i ? 32 : 0)), this.prodParam.enter(ye(s, t.generator)), this.parseFunctionParams(t, r);
        ...
        parseArrayLike(t, e, s) {
          ...
          this.state.inFSharpPipelineDirectBody = !1;
          let i = this.startNode();
          return this.next(), i.elements = this.parseExprList(t, !e, s, i), this.state.inFSharpPipelineDirectBody = r, this.finishNode(i, e ? "TupleExpression" : "ArrayExpression");
        }
        ...
        parseFunctionBody(t, e, s = !1) {
          ...
          if (this.expressionScope.enter(kt()), r) t.body = this.parseMaybeAssign(), this.checkParams(t, !1, e, !1);
          else {
        ...
        parseExprList(t, e, s, r) {
          ...
          for (; !this.eat(t); ) {
            ...
            i.push(this.parseExprListItem(t, e, s));
          }
          return i;
        }
        parseExprListItem(t, e, s, r) {
          let i;
          if (this.match(12)) e || this.raise(u.UnexpectedToken, this.state.curPosition(), { unexpected: "," }), i = null;
          else if (this.match(21)) {
            let a = this.state.startLoc;
            i = this.parseParenItem(this.parseSpread(s), a);
          } else if (this.match(17)) {
            this.expectPlugin("partialApplication"), r || this.raise(u.UnexpectedArgumentPlaceholder, this.state.startLoc);
            let a = this.startNode();
            this.next(), i = this.finishNode(a, "ArgumentPlaceholder");
          } else i = this.parseMaybeAssignAllowInOrVoidPattern(t, s, this.parseParenItem);
          return i;
        }
        parseIdentifier(t) {
        ...
        parseIdentifierName(t) {
          ...
          F(r) ? e = this.state.value : this.unexpected();
          let i = Ls(r);
        ...
        checkReservedWord(t, e, s, r) {
          if (!(t.length > 10 || !Qs(t))) {
            ...
            if ((this.state.strict ? r ? gt : Pt : xt)(t, this.inModule)) {
        ...
        isAmbiguousPrefixOrIdentifier() {
          ...
          let { type: t } = this.state;
          return t === 53 || t === 10 || t === 0 || Me(t) || t === 102 && !this.state.containsEsc || t === 138 || t === 56 || this.hasPlugin("v8intrinsic") && t === 54;
        }
        parseYield(t) {
          let e = this.startNodeAt(t);
        ...
        parseMaybeAssignAllowInOrVoidPattern(t, e, s) {
          if (e != null && this.match(88)) {
            ...
            if (r === 44 || r === (t === 3 ? 93 : t === 8 ? 125 : 41) || r === 61) return this.parseMaybeDefault(this.state.startLoc, this.parseVoidPattern(e));
          }
          return this.parseMaybeAssignAllowIn(e, s);
        }
        parsePropertyNamePrefixOperator(t) {
        }
      }, Je = { kind: 1 }, $r = { kind: 2 }, qr = /[\uD800-\uDFFF]/u, We = /in(?:stanceof)?/y;
      function Kr(t, e, s) {
        for (let r = 0; r < t.length; r++) {
          let i = t[r], { type: a } = i;
          typeof a == "number" && (i.type = mt(a));
        }
        return t;
      }
      var Jr = class extends Hr {
        parseTopLevel(t, e) {
          return t.program = this.parseProgram(e, 140, this.options.sourceType === "module" ? "module" : "script"), t.comments = this.comments, this.optionFlags & 256 && (t.tokens = Kr(this.tokens, this.input, this.startIndex)), this.finishNode(t, "File");
        }
        parseProgram(t, e, s) {
          ...
          let r;
          return e === 140 ? r = this.finishNode(t, "Program") : r = this.finishNodeAt(t, "Program", D(this.state.startLoc, -1)), r;
        }
        stmtToDirective(t) {
        ...
        parseStatementContent(t, e) {
          ...
          switch (s) {
            ...
            case 107:
              ...
              return this.allowsUsing() ? i || this.raise(u.UnexpectedLexicalDeclaration, this.state.startLoc) : this.raise(u.UnexpectedUsingDeclaration, this.state.startLoc), this.parseVarStatement(r, "using");
            case 100: {
              if (this.state.containsEsc) break;
              let l = this.nextTokenStart(), c = this.codePointAtPos(l);
              if (c !== 91 && (!i && this.hasFollowingLineBreak() || !this.chStartsBindingIdentifier(c, l) && c !== 123)) break;
            }
            case 75:
          ...
          return E(s) && p.type === "Identifier" && this.eat(14) ? this.parseLabeledStatement(r, o, p, t) : this.parseExpressionStatement(r, p, e);
        }
        ...
        maybeTakeDecorators(t, e, s) {
          return t && (e.decorators?.length ? (typeof this.getPluginOption("decorators", "decoratorsBeforeExport") != "boolean" && this.raise(u.DecoratorsBeforeAfterExport, e.decorators[0]), e.decorators.unshift(...t)) : e.decorators = t, this.resetStartLocationFromNode(e, t[0]), s && this.resetStartLocationFromNode(s, e)), e;
        }
        canHaveLeadingDecorator() {
        ...
        parseDoWhileStatement(t) {
          return this.next(), this.state.labels.push(Je), t.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement()), this.state.labels.pop(), this.expect(92), t.test = this.parseHeaderExpression(), this.eat(13), this.finishNode(t, "DoWhileStatement");
        }
        parseForStatement(t) {
          this.next(), this.state.labels.push(Je);
          let e = null;
          ...
          let s = this.isContextual(100);
          {
            ...
            if (this.match(74) || this.match(75) || l) {
              let c = this.startNode(), d;
              o ? (d = "await using", this.recordAwaitIfAllowed() || this.raise(u.AwaitUsingNotInAsyncContext, this.state.startLoc), this.next()) : d = this.state.value, this.next(), this.parseVar(c, !0, d);
              let P = this.finishNode(c, "VariableDeclaration"), A = this.match(58);
              return A && p && this.raise(u.ForInUsing, P), (A || this.isContextual(102)) && P.declarations.length === 1 ? this.parseForIn(t, P, e) : (e !== null && this.unexpected(e), this.parseFor(t, P));
            }
          }
          let r = this.isContextual(95), i = new Ae(), a = this.parseExpression(!0, i), n = this.isContextual(102);
        ...
        parseSwitchStatement(t) {
          ...
          let e = t.cases = [];
          this.expect(5), this.state.labels.push($r), this.scope.enter(256);
          let s;
        ...
        parseWhileStatement(t) {
          return this.next(), t.test = this.parseHeaderExpression(), this.state.labels.push(Je), t.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement()), this.state.labels.pop(), this.finishNode(t, "WhileStatement");
        }
        ...
        parseLabeledStatement(t, e, s, r) {
          ...
          let i = Os(this.state.type) ? 1 : this.match(71) ? 2 : null;
        ...
        parseBlockOrModuleBlockBody(t, e, s, r, i) {
          ...
          i?.call(this, n), a || this.setStrict(!1), this.next();
        }
        parseFor(t, e) {
        ...
        parseVarId(t, e) {
          ...
          e === "using" || e === "await using" ? (s.type === "ArrayPattern" || s.type === "ObjectPattern") && this.raise(u.UsingDeclarationHasBindingPattern, s.loc.start) : s.type === "VoidPattern" && this.raise(u.UnexpectedVoidPattern, s.loc.start), this.checkLVal(s, { type: "VariableDeclarator" }, e === "var" ? 5 : 8201), t.id = s;
        }
        ...
        parseFunction(t, e = 0) {
          ...
          return this.state.maybeInArrowParameters = !1, this.scope.enter(514), this.prodParam.enter(ye(a, t.generator)), r || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, !1), this.withSmartMixTopicForbiddingContext(() => {
        ...
        parseFunctionParams(t, e) {
          this.expect(10), this.expressionScope.enter(wr()), t.params = this.parseBindingList(11, 41, 2 | (e ? 4 : 0)), this.expressionScope.exit();
        }
        ...
        parseClassMemberWithIsStatic(t, e, s, r) {
          let i = e, a = e, n = e, o = e, p = e, l = i, c = i;
          if (e.static = r, this.parsePropertyNamePrefixOperator(e), this.eat(55)) {
            l.kind = "method";
            let S = this.match(139);
            if (this.parseClassElementName(l), this.parsePostMemberNameModifiers(l), S) {
          ...
          let d = !this.state.containsEsc && E(this.state.type), P = this.parseClassElementName(e), A = d ? P.name : null, I = this.isPrivateName(P), N = this.state.startLoc;
          if (this.parsePostMemberNameModifiers(c), this.isClassMethod()) {
            if (l.kind = "method", I) {
              this.pushClassPrivateMethod(t, a, !1, !1);
              return;
            }
            let S = this.isNonstaticConstructor(i), w = !1;
            S && (i.kind = "constructor", s.hadConstructor && !this.hasPlugin("typescript") && this.raise(u.DuplicateConstructor, P), S && this.hasPlugin("typescript") && e.override && this.raise(u.OverrideOnConstructor, P), s.hadConstructor = !0, w = s.hadSuperClass), this.pushClassMethod(t, i, !1, !1, S, w);
          } else if (this.isClassProperty()) I ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, n);
          else if (A === "async" && !this.isLineTerminator()) {
            this.resetPreviousNodeTrailingComments(P);
            let S = this.eat(55);
            c.optional && this.unexpected(N), l.kind = "method";
            let w = this.match(139);
            this.parseClassElementName(l), this.parsePostMemberNameModifiers(c), w ? this.pushClassPrivateMethod(t, a, S, !0) : (this.isNonstaticConstructor(i) && this.raise(u.ConstructorIsAsync, i.key), this.pushClassMethod(t, i, S, !0, !1, !1));
          } else if ((A === "get" || A === "set") && !(this.match(55) && this.isLineTerminator())) {
            this.resetPreviousNodeTrailingComments(P), l.kind = A;
            let S = this.match(139);
            this.parseClassElementName(i), S ? this.pushClassPrivateMethod(t, a, !1, !1) : (this.isNonstaticConstructor(i) && this.raise(u.ConstructorIsAccessor, i.key), this.pushClassMethod(t, i, !1, !1, !1, !1)), this.checkGetterSetterParams(i);
            ...
            let S = this.match(139);
            this.parseClassElementName(n), this.pushClassAccessorProperty(t, p, S);
          } else this.isLineTerminator() ? I ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, n) : this.unexpected();
        }
        ...
        parseClassStaticBlock(t, e) {
          ...
          let r = e.body = [];
          this.parseBlockOrModuleBlockBody(r, void 0, !1, 8), this.prodParam.exit(), this.scope.exit(), this.state.labels = s, t.body.push(this.finishNode(e, "StaticBlock")), e.decorators?.length && this.raise(u.DecoratorStaticBlock, e);
        }
        ...
        parseInitializer(t) {
          this.scope.enter(592), this.expressionScope.enter(kt()), this.prodParam.enter(0), t.value = this.eat(29) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
        }
        parseClassId(t, e, s, r = 8331) {
          if (E(this.state.type)) t.id = this.parseIdentifier(), e && this.declareNameFromIdentifier(t.id, r);
        ...
        parseExport(t, e) {
          ...
          let c;
          if (p || l) {
            if (c = !1, e) throw this.raise(u.UnsupportedDecoratorExport, t);
          ...
          if (this.eat(65)) {
            let d = t, P = this.parseExportDefaultExpression();
            if (d.declaration = P, P.type === "ClassDeclaration") this.maybeTakeDecorators(e, P, d);
            else if (e) throw this.raise(u.UnsupportedDecoratorExport, t);
        ...
        parseExportDefaultExpression() {
          ...
          if (this.match(75) || this.match(74) || this.isLet() || this.isUsing() || this.isAwaitUsing()) throw this.raise(u.UnsupportedDefaultExport, this.state.startLoc);
          ...
          if (e) {
            if (s) {
              if (this.checkDuplicateExports(t, "default"), this.hasPlugin("exportDefaultFrom")) {
                let i = t.declaration;
                i.type === "Identifier" && i.name === "from" && i.end - i.start === 4 && !i.extra?.parenthesized && this.raise(u.ExportDefaultFromAsIdentifier, i);
              }
            } else if (t.specifiers?.length) for (let i of t.specifiers) {
              let { exported: a } = i, n = a.type === "Identifier" ? a.name : a.value;
              if (this.checkDuplicateExports(i, n), !r && i.local) {
                let { local: o } = i;
                o.type !== "Identifier" ? this.raise(u.ExportBindingIsString, i, { localName: o.value, exportName: n }) : (this.checkReservedWord(o.name, o.loc.start, !0, !1), this.scope.checkLocalExport(o));
              }
            }
              ...
              } else if (i.type === "VariableDeclaration") for (let a of i.declarations) this.checkDeclaration(a.id);
            }
          }
        }
        checkDeclaration(t) {
        ...
        parseModuleExportName() {
          if (this.match(134)) {
            let t = this.parseStringLiteral(this.state.value), e = qr.exec(t.value);
        ...
        checkImportReflection(t) {
          ...
          t.phase === "source" ? s !== "ImportDefaultSpecifier" && this.raise(u.SourcePhaseImportRequiresDefault, e[0].loc.start) : t.phase === "defer" ? s !== "ImportNamespaceSpecifier" && this.raise(u.DeferImportRequiresNamespace, e[0].loc.start) : t.module && (s !== "ImportDefaultSpecifier" && this.raise(u.ImportReflectionNotBinding, e[0].loc.start), t.assertions?.length > 0 && this.raise(u.ImportReflectionHasAssertion, e[0].loc.start));
        }
        ...
        applyImportPhase(t, e, s, r) {
          e || (this.hasPlugin("importReflection") && (t.module = !1), s === "source" ? (this.expectPlugin("sourcePhaseImports", r), t.phase = "source") : s === "defer" ? (this.expectPlugin("deferredImportEvaluation", r), t.phase = "defer") : this.hasPlugin("sourcePhaseImports") && (t.phase = null));
        }
        parseMaybeImportPhase(t, e) {
          ...
          return (F(i) ? i !== 98 || this.lookaheadCharCode() === 102 : i !== 12) ? (this.applyImportPhase(t, e, r, s.loc.start), null) : (this.applyImportPhase(t, e, null), this.createIdentifier(s, r));
        }
        ...
        maybeParseImportAttributes(t) {
          ...
          } else this.isContextual(94) && !this.hasPrecedingLineBreak() ? (this.hasPlugin("deprecatedImportAssert") || this.raise(u.ImportAttributesUseAssert, this.state.startLoc), this.addExtra(t, "deprecatedAssertSyntax", !0), this.next(), e = this.parseImportAttributes()) : e = [];
          t.attributes = e;
        }
        maybeParseDefaultImportSpecifier(t, e) {
          ...
          } else if (F(this.state.type)) return this.parseImportSpecifierLocal(t, this.startNode(), "ImportDefaultSpecifier"), !0;
          return !1;
        }
        ...
        constructor(t, e, s) {
          let r = Ns(t);
          super(r, e), this.options = r, this.initializeScopes(), this.plugins = s, this.filename = r.sourceFilename, this.startIndex = r.startIndex;
          let i = 0;
          r.allowAwaitOutsideFunction && (i |= 1), r.allowReturnOutsideFunction && (i |= 2), r.allowImportExportEverywhere && (i |= 8), r.allowSuperOutsideMethod && (i |= 16), r.allowUndeclaredExports && (i |= 64), r.allowNewTargetOutsideFunction && (i |= 4), r.allowYieldOutsideFunction && (i |= 32), r.ranges && (i |= 128), r.tokens && (i |= 256), r.createImportExpressions && (i |= 512), r.createParenthesizedExpressions && (i |= 1024), r.errorRecovery && (i |= 2048), r.attachComment && (i |= 4096), r.annexB && (i |= 8192), this.optionFlags = i;
        }
        getScopeHandler() {
          return je;
        }
      ...
      function Wr(t) {
        let e = {};
        for (let s of Object.keys(t)) e[s] = mt(t[s]);
        return e;
      }
      Wr(Fs);
      function oe(t, e) {
        let s = jt, r = /* @__PURE__ */ new Map();
        if (t?.plugins) {
      ...
      function Xr(t) {
        let e = [];
        for (let i of zr) t.has(i) && e.push(i);
        let s = e.join("|"), r = zt.get(s);
        if (!r) {
          r = jt;
          for (let i of e) r = Ut[i](r);
          zt.set(s, r);
        }
        return r;
      }
...
`) return e + 2;
      ...
      var ti = ei;
      function si(t, e) {
        return e === !1 ? !1 : t.charAt(e) === "/" && t.charAt(e + 1) === "/" ? Yr(t, e) : e;
      }
      var ri = si;
      function ii(t, e) {
        let s = null, r = e;
        for (; r !== s; ) s = r, r = Gr(t, r), r = Zr(t, r), r = ri(t, r), r = ti(t, r);
        return r;
      }
      var ai = ii;
      function ni(t) {
...
`);
      ...
      var qt = oi, Xe = (t, e) => (s, r, ...i) => s | 1 && r == null ? void 0 : (e.call(r) ?? r[t]).apply(r, i), li = Array.prototype.findLast ?? function(t) {
        for (let e = this.length - 1; e >= 0; e--) {
          let s = this[e];
          if (t(s, e, this)) return s;
        }
      }, hi = Xe("findLast", function() {
        if (Array.isArray(this)) return li;
      }), pi = hi;
      function ui(t) {
        return this[t < 0 ? this.length + t : t];
      }
      var ci = Xe("at", function() {
        if (Array.isArray(this) || typeof this == "string") return ui;
      }), di = ci;
      function _(t) {
        let e = t.range?.[0] ?? t.start, s = (t.declaration?.decorators ?? t.decorators)?.[0];
        return s ? Math.min(_(s), e) : e;
      }
      function O(t) {
      ...
      function mi(t) {
        let e = new Set(t);
        return (s) => e.has(s?.type);
      }
      var Ge = mi, fi = Ge(["Block", "CommentBlock", "MultiLine"]), Ye = fi, yi = Ge(["Line", "CommentLine", "SingleLine", "HashbangComment", "HTMLOpen", "HTMLClose", "Hashbang", "InterpreterDirective"]), xi = yi, Qe = /* @__PURE__ */ new WeakMap();
      function Pi(t) {
        return Qe.has(t) || Qe.set(t, Ye(t) && t.value[0] === "*" && /@(?:type|satisfies)\b/u.test(t.value)), Qe.get(t);
      }
      var Ai = Pi;
      function gi(t) {
        if (!Ye(t)) return !1;
...
`);
      ...
      function Ti(t) {
        return Ze.has(t) || Ze.set(t, gi(t)), Ze.get(t);
      }
      var Kt = Ti;
      function bi(t) {
        ...
        for (let s = t.length - 1; s >= 0; s--) {
          let r = t[s];
          if (e && O(r) === _(e) && Kt(r) && Kt(e) && (t.splice(s + 1, 1), r.value += "*//*" + e.value, r.range = [_(r), O(e)]), !xi(r) && !Ye(r)) throw new TypeError(`Unknown comment type: "${r.type}".`);
          e = r;
        }
      }
      var Ei = bi;
      ...
      function he(t) {
        if (le !== null && typeof le.property) {
          let e = le;
          return le = he.prototype = null, e;
        }
        return le = he.prototype = t ?? /* @__PURE__ */ Object.create(null), new he();
      }
      var wi = 10;
      for (let t = 0; t <= wi; t++) he();
      function Ii(t) {
        return he(t);
      }
      function Ni(t, e = "type") {
        Ii(t);
        function s(r) {
          let i = r[e], a = t[i];
          if (!Array.isArray(a)) throw Object.assign(new Error(`Missing visitor keys for '${i}'.`), { node: r });
          return a;
        }
        return s;
      }
      var ki = Ni, h = [["decorators", "key", "typeAnnotation", "value"], [], ["elementType"], ["expression"], ["expression", "typeAnnotation"], ["left", "right"], ["argument"], ["directives", "body"], ["label"], ["callee", "typeArguments", "arguments"], ["body"], ["decorators", "id", "typeParameters", "superClass", "superTypeArguments", "mixins", "implements", "body", "superTypeParameters"], ["id", "typeParameters"], ["decorators", "key", "typeParameters", "params", "returnType", "body"], ["decorators", "variance", "key", "typeAnnotation", "value"], ["name", "typeAnnotation"], ["test", "consequent", "alternate"], ["checkType", "extendsType", "trueType", "falseType"], ["value"], ["id", "body"], ["declaration", "specifiers", "source", "attributes"], ["id"], ["id", "typeParameters", "extends", "body"], ["typeAnnotation"], ["id", "typeParameters", "right"], ["body", "test"], ["members"], ["id", "init"], ["exported"], ["left", "right", "body"], ["id", "typeParameters", "params", "predicate", "returnType", "body"], ["id", "params", "body", "typeParameters", "returnType"], ["key", "value"], ["local"], ["objectType", "indexType"], ["typeParameter"], ["types"], ["node"], ["object", "property"], ["argument", "cases"], ["pattern", "body", "guard"], ["literal"], ["decorators", "key", "value"], ["expressions"], ["qualification", "id"], ["decorators", "key", "typeAnnotation"], ["typeParameters", "params", "returnType"], ["expression", "typeArguments"], ["params"], ["parameterName", "typeAnnotation"]], vi = { AccessorProperty: h[0], AnyTypeAnnotation: h[1], ArgumentPlaceholder: h[1], ArrayExpression: ["elements"], ArrayPattern: ["elements", "typeAnnotation", "decorators"], ArrayTypeAnnotation: h[2], ArrowFunctionExpression: ["typeParameters", "params", "predicate", "returnType", "body"], AsConstExpression: h[3], AsExpression: h[4], AssignmentExpression: h[5], AssignmentPattern: ["left", "right", "decorators", "typeAnnotation"], AwaitExpression: h[6], BigIntLiteral: h[1], BigIntLiteralTypeAnnotation: h[1], BigIntTypeAnnotation: h[1], BinaryExpression: h[5], BindExpression: ["object", "callee"], BlockStatement: h[7], BooleanLiteral: h[1], BooleanLiteralTypeAnnotation: h[1], BooleanTypeAnnotation: h[1], BreakStatement: h[8], CallExpression: h[9], CatchClause: ["param", "body"], ChainExpression: h[3], ClassAccessorProperty: h[0], ClassBody: h[10], ClassDeclaration: h[11], ClassExpression: h[11], ClassImplements: h[12], ClassMethod: h[13], ClassPrivateMethod: h[13], ClassPrivateProperty: h[14], ClassProperty: h[14], ComponentDeclaration: ["id", "params", "body", "typeParameters", "rendersType"], ComponentParameter: ["name", "local"], ComponentTypeAnnotation: ["params", "rest", "typeParameters", "rendersType"], ComponentTypeParameter: h[15], ConditionalExpression: h[16], ConditionalTypeAnnotation: h[17], ContinueStatement: h[8], DebuggerStatement: h[1], DeclareClass: ["id", "typeParameters", "extends", "mixins", "implements", "body"], DeclareComponent: ["id", "params", "rest", "typeParameters", "rendersType"], DeclaredPredicate: h[18], DeclareEnum: h[19], DeclareExportAllDeclaration: ["source", "attributes"], DeclareExportDeclaration: h[20], DeclareFunction: ["id", "predicate"], DeclareHook: h[21], DeclareInterface: h[22], DeclareModule: h[19], DeclareModuleExports: h[23], DeclareNamespace: h[19], DeclareOpaqueType: ["id", "typeParameters", "supertype", "lowerBound", "upperBound"], DeclareTypeAlias: h[24], DeclareVariable: h[21], Decorator: h[3], Directive: h[18], DirectiveLiteral: h[1], DoExpression: h[10], DoWhileStatement: h[25], EmptyStatement: h[1], EmptyTypeAnnotation: h[1], EnumBigIntBody: h[26], EnumBigIntMember: h[27], EnumBooleanBody: h[26], EnumBooleanMember: h[27], EnumDeclaration: h[19], EnumDefaultedMember: h[21], EnumNumberBody: h[26], EnumNumberMember: h[27], EnumStringBody: h[26], EnumStringMember: h[27], EnumSymbolBody: h[26], ExistsTypeAnnotation: h[1], ExperimentalRestProperty: h[6], ExperimentalSpreadProperty: h[6], ExportAllDeclaration: ["source", "attributes", "exported"], ExportDefaultDeclaration: ["declaration"], ExportDefaultSpecifier: h[28], ExportNamedDeclaration: h[20], ExportNamespaceSpecifier: h[28], ExportSpecifier: ["local", "exported"], ExpressionStatement: h[3], File: ["program"], ForInStatement: h[29], ForOfStatement: h[29], ForStatement: ["init", "test", "update", "body"], FunctionDeclaration: h[30], FunctionExpression: h[30], FunctionTypeAnnotation: ["typeParameters", "this", "params", "rest", "returnType"], FunctionTypeParam: h[15], GenericTypeAnnotation: h[12], HookDeclaration: h[31], HookTypeAnnotation: ["params", "returnType", "rest", "typeParameters"], Identifier: ["typeAnnotation", "decorators"], IfStatement: h[16], ImportAttribute: h[32], ImportDeclaration: ["specifiers", "source", "attributes"], ImportDefaultSpecifier: h[33], ImportExpression: ["source", "options"], ImportNamespaceSpecifier: h[33], ImportSpecifier: ["imported", "local"], IndexedAccessType: h[34], InferredPredicate: h[1], InferTypeAnnotation: h[35], InterfaceDeclaration: h[22], InterfaceExtends: h[12], InterfaceTypeAnnotation: ["extends", "body"], InterpreterDirective: h[1], IntersectionTypeAnnotation: h[36], JsExpressionRoot: h[37], JsonRoot: h[37], JSXAttribute: ["name", "value"], JSXClosingElement: ["name"], JSXClosingFragment: h[1], JSXElement: ["openingElement", "children", "closingElement"], JSXEmptyExpression: h[1], JSXExpressionContainer: h[3], JSXFragment: ["openingFragment", "children", "closingFragment"], JSXIdentifier: h[1], JSXMemberExpression: h[38], JSXNamespacedName: ["namespace", "name"], JSXOpeningElement: ["name", "typeArguments", "attributes"], JSXOpeningFragment: h[1], JSXSpreadAttribute: h[6], JSXSpreadChild: h[3], JSXText: h[1], KeyofTypeAnnotation: h[6], LabeledStatement: ["label", "body"], Literal: h[1], LogicalExpression: h[5], MatchArrayPattern: ["elements", "rest"], MatchAsPattern: ["pattern", "target"], MatchBindingPattern: h[21], MatchExpression: h[39], MatchExpressionCase: h[40], MatchIdentifierPattern: h[21], MatchLiteralPattern: h[41], MatchMemberPattern: ["base", "property"], MatchObjectPattern: ["properties", "rest"], MatchObjectPatternProperty: ["key", "pattern"], MatchOrPattern: ["patterns"], MatchRestPattern: h[6], MatchStatement: h[39], MatchStatementCase: h[40], MatchUnaryPattern: h[6], MatchWildcardPattern: h[1], MemberExpression: h[38], MetaProperty: ["meta", "property"], MethodDefinition: h[42], MixedTypeAnnotation: h[1], ModuleExpression: h[10], NeverTypeAnnotation: h[1], NewExpression: h[9], NGChainedExpression: h[43], NGEmptyExpression: h[1], NGMicrosyntax: h[10], NGMicrosyntaxAs: ["key", "alias"], NGMicrosyntaxExpression: ["expression", "alias"], NGMicrosyntaxKey: h[1], NGMicrosyntaxKeyedExpression: ["key", "expression"], NGMicrosyntaxLet: h[32], NGPipeExpression: ["left", "right", "arguments"], NGRoot: h[37], NullableTypeAnnotation: h[23], NullLiteral: h[1], NullLiteralTypeAnnotation: h[1], NumberLiteralTypeAnnotation: h[1], NumberTypeAnnotation: h[1], NumericLiteral: h[1], ObjectExpression: ["properties"], ObjectMethod: h[13], ObjectPattern: ["decorators", "properties", "typeAnnotation"], ObjectProperty: h[42], ObjectTypeAnnotation: ["properties", "indexers", "callProperties", "internalSlots"], ObjectTypeCallProperty: h[18], ObjectTypeIndexer: ["variance", "id", "key", "value"], ObjectTypeInternalSlot: ["id", "value"], ObjectTypeMappedTypeProperty: ["keyTparam", "propType", "sourceType", "variance"], ObjectTypeProperty: ["key", "value", "variance"], ObjectTypeSpreadProperty: h[6], OpaqueType: ["id", "typeParameters", "supertype", "impltype", "lowerBound", "upperBound"], OptionalCallExpression: h[9], OptionalIndexedAccessType: h[34], OptionalMemberExpression: h[38], ParenthesizedExpression: h[3], PipelineBareFunction: ["callee"], PipelinePrimaryTopicReference: h[1], PipelineTopicExpression: h[3], Placeholder: h[1], PrivateIdentifier: h[1], PrivateName: h[21], Program: h[7], Property: h[32], PropertyDefinition: h[14], QualifiedTypeIdentifier: h[44], QualifiedTypeofIdentifier: h[44], RegExpLiteral: h[1], RestElement: ["argument", "typeAnnotation", "decorators"], ReturnStatement: h[6], SatisfiesExpression: h[4], SequenceExpression: h[43], SpreadElement: h[6], StaticBlock: h[10], StringLiteral: h[1], StringLiteralTypeAnnotation: h[1], StringTypeAnnotation: h[1], Super: h[1], SwitchCase: ["test", "consequent"], SwitchStatement: ["discriminant", "cases"], SymbolTypeAnnotation: h[1], TaggedTemplateExpression: ["tag", "typeArguments", "quasi"], TemplateElement: h[1], TemplateLiteral: ["quasis", "expressions"], ThisExpression: h[1], ThisTypeAnnotation: h[1], ThrowStatement: h[6], TopicReference: h[1], TryStatement: ["block", "handler", "finalizer"], TSAbstractAccessorProperty: h[45], TSAbstractKeyword: h[1], TSAbstractMethodDefinition: h[32], TSAbstractPropertyDefinition: h[45], TSAnyKeyword: h[1], TSArrayType: h[2], TSAsExpression: h[4], TSAsyncKeyword: h[1], TSBigIntKeyword: h[1], TSBooleanKeyword: h[1], TSCallSignatureDeclaration: h[46], TSClassImplements: h[47], TSConditionalType: h[17], TSConstructorType: h[46], TSConstructSignatureDeclaration: h[46], TSDeclareFunction: h[31], TSDeclareKeyword: h[1], TSDeclareMethod: ["decorators", "key", "typeParameters", "params", "returnType"], TSEmptyBodyFunctionExpression: ["id", "typeParameters", "params", "returnType"], TSEnumBody: h[26], TSEnumDeclaration: h[19], TSEnumMember: ["id", "initializer"], TSExportAssignment: h[3], TSExportKeyword: h[1], TSExternalModuleReference: h[3], TSFunctionType: h[46], TSImportEqualsDeclaration: ["id", "moduleReference"], TSImportType: ["options", "qualifier", "typeArguments", "source"], TSIndexedAccessType: h[34], TSIndexSignature: ["parameters", "typeAnnotation"], TSInferType: h[35], TSInstantiationExpression: h[47], TSInterfaceBody: h[10], TSInterfaceDeclaration: h[22], TSInterfaceHeritage: h[47], TSIntersectionType: h[36], TSIntrinsicKeyword: h[1], TSJSDocAllType: h[1], TSJSDocNonNullableType: h[23], TSJSDocNullableType: h[23], TSJSDocUnknownType: h[1], TSLiteralType: h[41], TSMappedType: ["key", "constraint", "nameType", "typeAnnotation"], TSMethodSignature: ["key", "typeParameters", "params", "returnType"], TSModuleBlock: h[10], TSModuleDeclaration: h[19], TSNamedTupleMember: ["label", "elementType"], TSNamespaceExportDeclaration: h[21], TSNeverKeyword: h[1], TSNonNullExpression: h[3], TSNullKeyword: h[1], TSNumberKeyword: h[1], TSObjectKeyword: h[1], TSOptionalType: h[23], TSParameterProperty: ["parameter", "decorators"], TSParenthesizedType: h[23], TSPrivateKeyword: h[1], TSPropertySignature: ["key", "typeAnnotation"], TSProtectedKeyword: h[1], TSPublicKeyword: h[1], TSQualifiedName: h[5], TSReadonlyKeyword: h[1], TSRestType: h[23], TSSatisfiesExpression: h[4], TSStaticKeyword: h[1], TSStringKeyword: h[1], TSSymbolKeyword: h[1], TSTemplateLiteralType: ["quasis", "types"], TSThisType: h[1], TSTupleType: ["elementTypes"], TSTypeAliasDeclaration: ["id", "typeParameters", "typeAnnotation"], TSTypeAnnotation: h[23], TSTypeAssertion: h[4], TSTypeLiteral: h[26], TSTypeOperator: h[23], TSTypeParameter: ["name", "constraint", "default"], TSTypeParameterDeclaration: h[48], TSTypeParameterInstantiation: h[48], TSTypePredicate: h[49], TSTypeQuery: ["exprName", "typeArguments"], TSTypeReference: ["typeName", "typeArguments"], TSUndefinedKeyword: h[1], TSUnionType: h[36], TSUnknownKeyword: h[1], TSVoidKeyword: h[1], TupleTypeAnnotation: ["types", "elementTypes"], TupleTypeLabeledElement: ["label", "elementType", "variance"], TupleTypeSpreadElement: ["label", "typeAnnotation"], TypeAlias: h[24], TypeAnnotation: h[23], TypeCastExpression: h[4], TypeofTypeAnnotation: ["argument", "typeArguments"], TypeOperator: h[23], TypeParameter: ["bound", "default", "variance"], TypeParameterDeclaration: h[48], TypeParameterInstantiation: h[48], TypePredicate: h[49], UnaryExpression: h[6], UndefinedTypeAnnotation: h[1], UnionTypeAnnotation: h[36], UnknownTypeAnnotation: h[1], UpdateExpression: h[6], V8IntrinsicIdentifier: h[1], VariableDeclaration: ["declarations"], VariableDeclarator: h[27], Variance: h[1], VoidPattern: h[1], VoidTypeAnnotation: h[1], WhileStatement: h[25], WithStatement: ["object", "body"], YieldExpression: h[6] }, Di = ki(vi), Fi = Di;
      function ge(t, e) {
        if (!Si(t)) return t;
        if (Array.isArray(t)) {
          for (let r = 0; r < t.length; r++) t[r] = ge(t[r], e);
          return t;
        }
        if (e.onEnter) {
          let r = e.onEnter(t) ?? t;
          if (r !== t) return ge(r, e);
          t = r;
        }
        let s = Fi(t);
        for (let r = 0; r < s.length; r++) t[s[r]] = ge(t[s[r]], e);
        return e.onLeave && (t = e.onLeave(t) || t), t;
      }
      var Li = ge;
      Ge(["RegExpLiteral", "BigIntLiteral", "NumericLiteral", "StringLiteral", "DirectiveLiteral", "Literal", "JSXText", "TemplateElement", "StringLiteralTypeAnnotation", "NumberLiteralTypeAnnotation", "BigIntLiteralTypeAnnotation"]);
      function Mi(t, e) {
        let { parser: s, text: r } = e, { comments: i } = t, a = s === "oxc" && e.oxcAstType === "ts";
        Ei(i);
        let n = t.type === "File" ? t.program : t;
        n.interpreter && (i.unshift(n.interpreter), delete n.interpreter), a && t.hashbang && (i.unshift(t.hashbang), delete t.hashbang), t.type === "Program" && (t.range = [0, r.length]);
        let o;
        return t = Li(t, { onEnter(p) {
          switch (p.type) {
            case "ParenthesizedExpression": {
              let { expression: l } = p, c = _(p);
              if (l.type === "TypeCastExpression") return l.range = [c, O(p)], l;
              let d = !1;
              if (!a) {
                if (!o) {
                  o = [];
                  for (let A of i) Ai(A) && o.push(O(A));
                }
                let P = pi(0, o, (A) => A <= c);
                d = P && r.slice(P, c).trim().length === 0;
              }
              return d ? void 0 : (l.extra = { ...l.extra, parenthesized: !0 }, l);
            }
            case "TemplateLiteral":
              if (p.expressions.length !== p.quasis.length - 1) throw new Error("Malformed template literal.");
              break;
            case "TemplateElement":
              if (s === "flow" || s === "hermes" || s === "espree" || s === "typescript" || a) {
                let l = _(p) + 1, c = O(p) - (p.tail ? 1 : 2);
                p.range = [l, c];
              }
              break;
            case "VariableDeclaration": {
              let l = di(0, p.declarations, -1);
              l?.init && r[O(l)] !== ";" && (p.range = [_(p), O(l)]);
              break;
            }
            ...
            case "TSIntersectionType":
              if (p.types.length === 1) return p.types[0];
              break;
            case "ImportExpression":
              s === "hermes" && p.attributes && !p.options && (p.options = p.attributes);
              break;
          }
        }, onLeave(p) {
          switch (p.type) {
            case "LogicalExpression":
              ...
              break;
            case "TSImportType":
              !p.source && p.argument.type === "TSLiteralType" && (p.source = p.argument.literal, delete p.argument);
              break;
          }
        } }), t;
      }
      ...
      function et(t) {
        return Jt(t) ? et({ type: "LogicalExpression", operator: t.operator, left: et({ type: "LogicalExpression", operator: t.operator, left: t.left, right: t.right.left, range: [_(t.left), O(t.right.left)] }), right: t.right.right, range: [_(t), O(t)] }) : t;
      }
      var Bi = Mi;
      function Oi(t, e) {
      ...
      var Wt = Oi, Xt = "Unexpected parseExpression() input: ";
      function Ri(t) {
        let { message: e, loc: s, reasonCode: r } = t;
        if (!s) return t;
        let { line: i, column: a } = s, n = t;
        (r === "MissingPlugin" || r === "MissingOneOfPlugins") && (e = "Unexpected token.", n = void 0);
        let o = ` (${i}:${a})`;
        return e.endsWith(o) && (e = e.slice(0, -o.length)), e.startsWith(Xt) && (e = e.slice(Xt.length)), Wt(e, { loc: { start: { line: i, column: a + 1 } }, cause: n });
      }
      var Gt = Ri, Ui = String.prototype.replaceAll ?? function(t, e) {
        return t.global ? this.replace(t, e) : this.split(t).join(e);
      }, ji = Xe("replaceAll", function() {
        if (typeof this == "string") return Ui;
      }), Te = ji, _i = /\*\/$/, Vi = /^\/\*\*?/, zi = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/, Hi = /(^|\s+)\/\/([^\n\r]*)/g, Yt = /^(\r?\n)+/, $i = /(?:^|\r?\n) *(@[^\n\r]*?) *\r?\n *(?![^\n\r@]*\/\/[^]*)([^\s@][^\n\r@]+?) *\r?\n/g, Qt = /(?:^|\r?\n) *@(\S+) *([^\n\r]*)/g, qi = /(\r?\n|^) *\* ?/g, Ki = [];
      function Ji(t) {
        let e = t.match(zi);
      ...
      function Wi(t) {
        t = Te(0, t.replace(Vi, "").replace(_i, ""), qi, "$1");
        let e = "";
        for (; e !== t; ) e = t, t = Te(0, t, $i, `
$1 $2
`);
        t = t.replace(Yt, "").trimEnd();
        let s = /* @__PURE__ */ Object.create(null), r = Te(0, t, Qt, "").replace(Yt, "").trimEnd(), i;
        for (; i = Qt.exec(t); ) {
          let a = Te(0, i[2], Hi, "");
          if (typeof s[i[1]] == "string" || Array.isArray(s[i[1]])) {
            let n = s[i[1]];
            s[i[1]] = [...Ki, ...Array.isArray(n) ? n : [n], a];
          } else s[i[1]] = a;
        }
        return { comments: r, pragmas: s };
      }
      var Xi = ["noformat", "noprettier"], Gi = ["format", "prettier"];
      function Zt(t) {
        let e = qt(t);
        e && (t = t.slice(e.length + 1));
        let s = Ji(t), { pragmas: r, comments: i } = Wi(s);
        return { shebang: e, text: t, pragmas: r, comments: i };
      }
      function Yi(t) {
        let { pragmas: e } = Zt(t);
        return Gi.some((s) => Object.prototype.hasOwnProperty.call(e, s));
      }
      function Qi(t) {
        let { pragmas: e } = Zt(t);
        return Xi.some((s) => Object.prototype.hasOwnProperty.call(e, s));
      }
      function Zi(t) {
        return t = typeof t == "function" ? { parse: t } : t, { astFormat: "estree", hasPragma: Yi, hasIgnorePragma: Qi, locStart: _, locEnd: O, ...t };
      }
      var pe = Zi, tt = "module", es = "commonjs";
      function ea(t) {
        if (typeof t == "string") {
          if (t = t.toLowerCase(), /\.(?:mjs|mts)$/iu.test(t)) return tt;
          if (/\.(?:cjs|cts)$/iu.test(t)) return es;
        }
      }
      function ta(t, e) {
        let { type: s = "JsExpressionRoot", rootMarker: r, text: i } = e, { tokens: a, comments: n } = t;
        return delete t.tokens, delete t.comments, { tokens: a, comments: n, type: s, node: t, range: [0, i.length], rootMarker: r };
      }
      var ts = ta, Q = (t) => pe(na(t)), sa = { sourceType: tt, allowImportExportEverywhere: !0, allowReturnOutsideFunction: !0, allowNewTargetOutsideFunction: !0, allowSuperOutsideMethod: !0, allowUndeclaredExports: !0, errorRecovery: !0, createParenthesizedExpressions: !0, attachComment: !1, plugins: ["doExpressions", "exportDefaultFrom", "functionBind", "functionSent", "throwExpressions", "partialApplication", "decorators", "moduleBlocks", "asyncDoExpressions", "destructuringPrivate", "decoratorAutoAccessors", "sourcePhaseImports", "deferredImportEvaluation", ["optionalChainingAssign", { version: "2023-07" }], ["discardBinding", { syntaxType: "void" }]], tokens: !1, ranges: !1 }, ss = "v8intrinsic", rs = [["pipelineOperator", { proposal: "hack", topicToken: "%" }], ["pipelineOperator", { proposal: "fsharp" }]], V = (t, e = sa) => ({ ...e, plugins: [...e.plugins, ...t] }), ra = /@(?:no)?flow\b/u;
      function ia(t, e) {
        if (e?.endsWith(".js.flow")) return !0;
        let s = qt(t);
        s && (t = t.slice(s.length));
        let r = ai(t, 0);
        return r !== !1 && (t = t.slice(0, r)), ra.test(t);
      }
      function aa(t, e, s) {
        let r = t(e, s), i = r.errors.find((a) => !oa.has(a.reasonCode));
        if (i) throw i;
        return r;
      }
      function na({ isExpression: t = !1, optionsCombinations: e }) {
        return (s, r = {}) => {
          let { filepath: i } = r;
          if (typeof i != "string" && (i = void 0), (r.parser === "babel" || r.parser === "__babel_estree") && ia(s, i)) return r.parser = "babel-flow", hs.parse(s, r);
          let a = e, n = r.__babelSourceType ?? ea(i);
          n && n !== tt && (a = a.map((c) => ({ ...c, sourceType: n, ...n === es ? { allowReturnOutsideFunction: void 0, allowNewTargetOutsideFunction: void 0 } : void 0 })));
          let o = /%[A-Z]/u.test(s);
          s.includes("|>") ? a = (o ? [...rs, ss] : rs).flatMap((c) => a.map((d) => V([c], d))) : o && (a = a.map((c) => V([ss], c)));
          let p = t ? Vt : _t, l;
          try {
            l = ni(a.map((c) => () => aa(p, s, c)));
          } catch ({ errors: [c] }) {
            throw Gt(c);
          }
          return t && (l = ts(l, { text: s, rootMarker: r.rootMarker })), Bi(l, { text: s });
        };
      }
      var oa = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "ForInOfLoopInitializer", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "OptionalTypeBeforeRequired", "PatternIsOptional", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport", "ImportAttributesUseAssert", "DeclarationMissingInitializer"]), is = [V(["jsx"])], as = Q({ optionsCombinations: is }), ns = Q({ optionsCombinations: [V(["jsx", "typescript"]), V(["typescript"])] }), os = Q({ isExpression: !0, optionsCombinations: [V(["jsx"])] }), ls = Q({ isExpression: !0, optionsCombinations: [V(["typescript"])] }), hs = Q({ optionsCombinations: [V(["jsx", ["flow", { all: !0 }], "flowComments"])] }), la = Q({ optionsCombinations: is.map((t) => V(["estree"], t)) }), ps = {};
      Ce(ps, { json: () => ua, "json-stringify": () => ma, json5: () => ca, jsonc: () => da });
      function ha(t) {
        return Array.isArray(t) && t.length > 0;
      }
      var us = ha, cs = { tokens: !1, ranges: !1, attachComment: !1, createParenthesizedExpressions: !0 };
      function pa(t) {
        let e = _t(t, cs), { program: s } = e;
        if (s.body.length === 0 && s.directives.length === 0 && !s.interpreter) return e;
      }
      function be(t, e = {}) {
        let { allowComments: s = !0, allowEmpty: r = !1 } = e, i;
        try {
          i = Vt(t, cs);
        } catch (a) {
          if (r && a.code === "BABEL_PARSER_SYNTAX_ERROR" && a.reasonCode === "ParseExpressionEmptyInput") try {
            i = pa(t);
          } catch {
          }
          if (!i) throw Gt(a);
        }
        if (!s && us(i.comments)) throw K(i.comments[0], "Comment");
        return i = ts(i, { type: "JsonRoot", text: t }), i.node.type === "File" ? delete i.node : Z(i.node), i;
      }
      function K(t, e) {
        let [s, r] = [t.loc.start, t.loc.end].map(({ line: i, column: a }) => ({ line: i, column: a + 1 }));
        return Wt(`${e} is not allowed in JSON.`, { loc: { start: s, end: r } });
      }
      function Z(t) {
        switch (t.type) {
          case "ArrayExpression":
            for (let e of t.elements) e !== null && Z(e);
            return;
          case "ObjectExpression":
            for (let e of t.properties) Z(e);
            return;
          case "ObjectProperty":
            if (t.computed) throw K(t.key, "Computed key");
            if (t.shorthand) throw K(t.key, "Shorthand property");
            t.key.type !== "Identifier" && Z(t.key), Z(t.value);
            return;
          case "UnaryExpression": {
            let { operator: e, argument: s } = t;
            if (e !== "+" && e !== "-") throw K(t, `Operator '${t.operator}'`);
            if (s.type === "NumericLiteral" || s.type === "Identifier" && (s.name === "Infinity" || s.name === "NaN")) return;
            throw K(s, `Operator '${e}' before '${s.type}'`);
          }
          case "Identifier":
            if (t.name !== "Infinity" && t.name !== "NaN" && t.name !== "undefined") throw K(t, `Identifier '${t.name}'`);
            return;
          case "TemplateLiteral":
            if (us(t.expressions)) throw K(t.expressions[0], "'TemplateLiteral' with expression");
            for (let e of t.quasis) Z(e);
            return;
          case "NullLiteral":
          case "BooleanLiteral":
          case "NumericLiteral":
      ...
      var ua = pe({ parse: (t) => be(t), hasPragma: () => !0, hasIgnorePragma: () => !1 }), ca = pe((t) => be(t)), da = pe((t) => be(t, { allowEmpty: !0 })), ma = pe({ parse: (t) => be(t, { allowComments: !1 }), astFormat: "estree-json" }), fa = { ...nt, ...ps };
      return xs(at);
    });
  })(it)), it.exports;
}
var fs = /* @__PURE__ */ Pa();
const Aa = /* @__PURE__ */ ya(fs), Ta = /* @__PURE__ */ xa({
  __proto__: null,
  default: Aa
}, [fs]);
export {
