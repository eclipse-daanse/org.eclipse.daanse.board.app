...
import { defineComponent, ref, shallowRef, watch, onMounted, onBeforeUnmount, createElementBlock, openBlock, computed, Fragment, createVNode, createBlock, createCommentVNode, unref } from "vue";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const editorStack = () => Promise.all([
      import("./index-DG4hJIMk.js").then((n) => n.t),
      import("./client-D4THOqjT.js").then((n) => n.c),
      import("./index-CMIQd0YI.js").then((n) => n.bG),
      Promise.resolve({          })
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const connectionsFiltered = computed(() => {
      return __props.connections.filter((c) => c.type === "graphql");
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(unref(DSwitch), {
          ...
          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => __props.config.pollingEnabled = $event),
          label: "Regelmäßig neu laden"
        }, null, 8, ["modelValue"]),
        __props.config.pollingEnabled ? (openBlock(), createBlock(unref(DInput), {
          key: 0,
          modelValue: innerInterval.value,
          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => innerInterval.value = $event),
          label: "Abstand (ms)"
...
const GraphqlDatasourceIdentifier = Symbol.for("GraphQLStoreFactory");
const previewSymbol = Symbol.for("GraphqlPreview");
const settingsSymbol = Symbol.for("GraphqlSettings");
function activate({ services }) {
  services.register("GraphqlPreview", _sfc_main$1);
  services.register("GraphqlSettings", _sfc_main);
  services.getRequired(DATASOURCE_REPOSITORY).registerDatasourceType("graphql", {
    connections: ["graphql"],
    Model: MODEL_ECORE,
...
function deactivate({ services }) {
  services.getRequired(DATASOURCE_REPOSITORY).unregisterDatasourceType("graphql");
