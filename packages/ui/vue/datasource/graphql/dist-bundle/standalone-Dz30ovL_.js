...
var O = Symbol("MODE_BREAK"), J = Symbol("MODE_FLAT"), We = Symbol("DOC_FILL_PRINTED_LENGTH");
...
}, Fu = Symbol.for("vnopts.VALUE_NOT_EXIST"), we = Symbol.for("vnopts.VALUE_UNCHANGED"), mt = " ".repeat(2), jn = (e, t, u) => {
...
}), gu = fD, FD = Symbol.for("PRETTIER_IS_FRONT_MATTER"), dD = [];
function pD(e) {
  return !!e?.[FD];
}
...
async function Au(e, t) {
  let u = e.comments ?? [];
  t[Symbol.for("comments")] = u, t[Symbol.for("printedComments")] = /* @__PURE__ */ new Set(), ln(e, t);
