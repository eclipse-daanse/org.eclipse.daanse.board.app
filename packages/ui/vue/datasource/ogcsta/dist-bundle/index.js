      ...
      return tempStore.value && data.value ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
        createElementVNode("div", _hoisted_2$1, [
          createVNode(unref(DButton), {
            intent: viewMode.value === "tree" ? "primary" : "default",
            size: "sm",
          ...
          createVNode(unref(DButton), {
            intent: viewMode.value === "json" ? "primary" : "default",
            size: "sm",
          ...
          createVNode(unref(DDivider), { vertical: "" }),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(hierarchicalData.value, (thing) => {
              return openBlock(), createElementBlock("div", {
                ...
                createElementVNode("div", {
                  ...
                  thing.Locations?.[0]?.location || thing.location ? (openBlock(), createBlock(unref(DIcon), {
                    key: 0,
                    name: "location_on",
                    size: "sm",
                    tone: "color-warn",
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(thing.datastreams, (ds) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createElementVNode("div", {
                        ...
                        ds.observations && ds.observations.length > 0 ? (openBlock(), createBlock(unref(DIcon), {
                          key: 1,
                          name: "show_chart",
                          size: "small",
                          color: "info",
                      ...
                      expandedDatastreams.value.has(ds.iotId || ds["@iot.id"]) ? (openBlock(), createElementBlock("div", _hoisted_19$1, [
                        ds.description ? (openBlock(), createElementBlock("div", _hoisted_20$1, [
...
const MapPreview = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e115ec43"]]);
const _hoisted_1 = { class: "ogcsta-settings-wrapper" };
const _hoisted_2 = { class: "ogcsta-scroll-container" };
const _hoisted_3 = { class: "ogcsta-settings" };
const _hoisted_4 = { class: "setting-group" };
const _hoisted_5 = { class: "setting-group" };
const _hoisted_6 = ["open"];
const _hoisted_7 = { class: "history-settings" };
const _hoisted_8 = { class: "setting-group" };
const _hoisted_9 = { class: "filter-header" };
const _hoisted_10 = { class: "datetime-picker-group" };
const _hoisted_11 = { class: "datetime-picker-group" };
const _hoisted_12 = { class: "setting-group" };
const _hoisted_13 = { class: "filter-header" };
const _hoisted_14 = { class: "datetime-picker-group" };
const _hoisted_15 = { class: "datetime-picker-group" };
const _hoisted_16 = { class: "setting-group" };
const _hoisted_17 = { class: "filter-header" };
const _hoisted_18 = { class: "datetime-picker-group" };
const _hoisted_19 = { class: "datetime-picker-group" };
const _hoisted_20 = { class: "setting-group" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_DIcon = resolveComponent("DIcon");
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createElementVNode("div", _hoisted_2, [
          createElementVNode("div", _hoisted_3, [
            ...
            createElementVNode("details", {
              class: "history",
              open: __props.config.history.enabled
            }, [
              createElementVNode("summary", {
                class: "history__head",
                onClick: _cache[2] || (_cache[2] = withModifiers(($event) => __props.config.history.enabled = !__props.config.history.enabled, ["prevent"]))
              }, [
                createVNode(_component_DIcon, {
                  name: "history",
                  size: "sm",
                  tone: "color-dim"
                }),
                _cache[24] || (_cache[24] = createTextVNode("Verlaufsdaten ", -1))
              ]),
              createElementVNode("div", _hoisted_7, [
                createElementVNode("div", _hoisted_8, [
                  createElementVNode("div", _hoisted_9, [
                    _cache[25] || (_cache[25] = createElementVNode("h4", null, "Time Range Filter", -1)),
                    createVNode(unref(DButton), {
                      intent: "danger",
                      size: "sm",
                  ...
                  createVNode(unref(VariableInput), {
                    ...
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => timeWrappers.timeRangeStart = $event),
                    label: "Startzeit"
                  }, {
                      ...
                      createElementVNode("div", _hoisted_10, [
                        ...
                        createVNode(unref(DDateInput), {
                          ...
                          "onUpdate:modelValue": [
                            ...
                            _cache[4] || (_cache[4] = ($event) => unref(timeRangeStartDT).updateWrapper())
                          ],
                          label: "Startzeit"
                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                      ])
                  ...
                  createVNode(unref(VariableInput), {
                    ...
                    "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => timeWrappers.timeRangeEnd = $event),
                    label: "Endzeit"
                  }, {
                    default: withCtx(({ value, change }) => [
                      createElementVNode("div", _hoisted_11, [
                        ...
                        createVNode(unref(DDateInput), {
                          ...
                          "onUpdate:modelValue": [
                            ...
                            _cache[7] || (_cache[7] = ($event) => unref(timeRangeEndDT).updateWrapper())
                          ],
                          label: "Endzeit"
                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                      ])
                ...
                createElementVNode("div", _hoisted_12, [
                  createElementVNode("div", _hoisted_13, [
                    _cache[26] || (_cache[26] = createElementVNode("h4", null, "Phenomenon Time Filter", -1)),
                    createVNode(unref(DButton), {
                      intent: "danger",
                      size: "sm",
                  ...
                  createVNode(unref(VariableInput), {
                    ...
                    "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => timeWrappers.phenomenonTimeStart = $event),
                    label: "Startzeit"
                  }, {
                    default: withCtx(({ value, change }) => [
                      createElementVNode("div", _hoisted_14, [
                        ...
                        createVNode(unref(DDateInput), {
                          ...
                          "onUpdate:modelValue": [
                            ...
                            _cache[10] || (_cache[10] = ($event) => unref(phenomenonTimeStartDT).updateWrapper())
                          ],
                          label: "Startzeit"
                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                      ])
                  ...
                  createVNode(unref(VariableInput), {
                    ...
                    "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => timeWrappers.phenomenonTimeEnd = $event),
                    label: "Endzeit"
                  }, {
                    default: withCtx(({ value, change }) => [
                      createElementVNode("div", _hoisted_15, [
                        ...
                        createVNode(unref(DDateInput), {
                          ...
                          "onUpdate:modelValue": [
                            ...
                            _cache[13] || (_cache[13] = ($event) => unref(phenomenonTimeEndDT).updateWrapper())
                          ],
                          label: "Endzeit"
                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                      ])
                ...
                createElementVNode("div", _hoisted_16, [
                  createElementVNode("div", _hoisted_17, [
                    _cache[27] || (_cache[27] = createElementVNode("h4", null, "Result Time Filter", -1)),
                    createVNode(unref(DButton), {
                      intent: "danger",
                      size: "sm",
                  ...
                  createVNode(unref(VariableInput), {
                    ...
                    "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => timeWrappers.resultTimeStart = $event),
                    label: "Startzeit"
                  }, {
                    default: withCtx(({ value, change }) => [
                      createElementVNode("div", _hoisted_18, [
                        ...
                        createVNode(unref(DDateInput), {
                          ...
                          "onUpdate:modelValue": [
                            ...
                            _cache[16] || (_cache[16] = ($event) => unref(resultTimeStartDT).updateWrapper())
                          ],
                          label: "Startzeit"
                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                      ])
                  ...
                  createVNode(unref(VariableInput), {
                    ...
                    "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => timeWrappers.resultTimeEnd = $event),
                    label: "Endzeit"
                  }, {
                    default: withCtx(({ value, change }) => [
                      createElementVNode("div", _hoisted_19, [
                        ...
                        createVNode(unref(DDateInput), {
                          ...
                          "onUpdate:modelValue": [
                            ...
                            _cache[19] || (_cache[19] = ($event) => unref(resultTimeEndDT).updateWrapper())
                          ],
                          label: "Endzeit"
                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                      ])
                ...
                createElementVNode("div", _hoisted_20, [
                  _cache[29] || (_cache[29] = createElementVNode("h4", null, "Query Settings", -1)),
                  createVNode(unref(DSelect), {
                    modelValue: __props.config.history.orderBy,
                    "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => __props.config.history.orderBy = $event),
                    options: [
                  ...
                  createVNode(unref(DInput), {
                    ...
                    "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => __props.config.history.limit = $event),
                  ...
                  createVNode(unref(DCheckbox), {
                    ...
                    "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => __props.config.useCurrentLocationInsteadOfHistorical = $event),
                    ...
                    label: withCtx(() => [..._cache[28] || (_cache[28] = [
                      ...
                      createElementVNode("div", { style: { "font-size": "0.75rem", "color": "var(--color-dim)", "margin-top": "0.25rem" } }, " Reuse already loaded current locations instead of fetching historical locations via API ", -1)
                    ])]),
                    _: 1
                  }, 8, ["modelValue"])
                ])
...
const OGCSTAStoreSettings = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9ef421c2"]]);
