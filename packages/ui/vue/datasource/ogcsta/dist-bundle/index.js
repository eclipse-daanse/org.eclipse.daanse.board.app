...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let variableRepository = null;
    try {
      variableRepository = container.get(identifier);
    } catch (error) {
...
const OGCSTAStoreSettings = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4b5efe7e"]]);
