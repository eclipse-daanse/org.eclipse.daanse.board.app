...
function Yo() {
  return pn || (pn = 1, (function(J, qt) {
    (function(l, nt) {
      ...
      function Ke(t, e) {
        return t = y(t), t.alt !== void 0 ? [Q(t.lng, e), Q(t.lat, e), Q(t.alt, e)] : [Q(t.lng, e), Q(t.lat, e)];
      }
      function re(t, e, i, n) {
      ...
      w.addInitHook("addHandler", "touchZoom", fn), w.BoxZoom = rn, w.DoubleClickZoom = an, w.Drag = hn, w.Keyboard = un, w.ScrollWheelZoom = ln, w.TapHold = cn, w.TouchZoom = fn, l.Bounds = z, l.Browser = f, l.CRS = st, l.Canvas = en, l.Circle = qe, l.CircleMarker = ne, l.Class = ot, l.Control = Y, l.DivIcon = Qi, l.DivOverlay = it, l.DomEvent = $n, l.DomUtil = Jn, l.Draggable = ft, l.Evented = kt, l.FeatureGroup = rt, l.GeoJSON = ht, l.GridLayer = Wt, l.Handler = et, l.Icon = Tt, l.ImageOverlay = he, l.LatLng = b, l.LatLngBounds = H, l.Layer = X, l.LayerGroup = Lt, l.LineUtil = fo, l.Map = w, l.Marker = ie, l.Mixin = ro, l.Path = dt, l.Point = m, l.PolyUtil = ao, l.Polygon = bt, l.Polyline = at, l.Popup = ue, l.PosAnimation = Ii, l.Projection = _o, l.Rectangle = sn, l.Renderer = ut, l.SVG = Gt, l.SVGOverlay = Ji, l.TileLayer = St, l.Tooltip = le, l.Transformation = ge, l.Util = yn, l.VideoOverlay = Xi, l.bind = S, l.bounds = F, l.canvas = nn, l.circle = Po, l.circleMarker = xo, l.control = Dt, l.divIcon = Eo, l.extend = x, l.featureGroup = go, l.geoJSON = Yi, l.geoJson = bo, l.gridLayer = Zo, l.icon = yo, l.imageOverlay = Mo, l.latLng = y, l.latLngBounds = O, l.layerGroup = vo, l.map = to, l.marker = wo, l.point = _, l.polygon = To, l.polyline = Lo, l.popup = zo, l.rectangle = Ao, l.setOptions = C, l.stamp = P, l.svg = on, l.svgOverlay = Co, l.tileLayer = $i, l.tooltip = ko, l.transformation = Et, l.version = nt, l.videoOverlay = So;
      var No = window.L;
