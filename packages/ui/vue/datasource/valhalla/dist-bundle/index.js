...
const ze = (e, a) => {
...
}, de = (e) => ({ options: e.options, methods: {} }), oe = {
  ...ce,
  pane: {
    type: String
  },
  ...
  const n = S($), s = S(je), { options: l, methods: o } = de(e), r = k(
    e,
    oe,
    l
  ...
  const { options: n, methods: s } = Nt(e, a, t), l = k(
    e,
    Re,
    n
  ), o = S(je), r = {
  ...
  const { options: n, methods: s } = Xe(e, a, t), l = k(
    e,
    et,
    n
  ), o = {
...
C({
  ...
  props: et,
  setup(e, a) {
    const t = c(), n = c(!1), s = A(P), l = S($), { options: o, methods: r } = It(e, t, a);
    return R(async () => {
      const { circle: i } = s ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js");
      t.value = _(i(e.latLng, o));
      const { listeners: u } = V(a.attrs);
      t.value.on(u), x(r, t.value, e), l({
        ...e,
        ...r,
...
const zt = C({
  ...
  props: Ae,
  setup(e, a) {
    const t = c(), n = c(!1), s = A(P), l = S($), { options: o, methods: r } = Xe(
      e,
      t,
      a
    );
...
C({
  ...
  setup(e, a) {
    const t = c(), n = c(), s = A(P), l = S(ue), { options: o, methods: r } = ve(e, t);
    return R(async () => {
      ...
      t.value = _(new v(o)), x(r, t.value, e), l({ leafletObject: t.value }), e.disableClickPropagation && n.value && u.disableClickPropagation(n.value), e.disableScrollPropagation && n.value && u.disableScrollPropagation(n.value), j(() => a.emit("ready", t.value));
...
C({
  ...
  props: tt,
  setup(e, a) {
    const t = c(), n = A(P), s = S(ue), { options: l, methods: o } = Dt(e, t);
    return R(async () => {
      const { control: r } = n ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js");
      t.value = _(
        r.attribution(l)
      ), x(o, t.value, e), s({ leafletObject: t.value }), j(() => a.emit("ready", t.value));
    }), { leafletObject: t };
  },
  render() {
    return null;
...
C({
  ...
  props: at,
  setup(e, a) {
    const t = c(), n = A(P), s = S(Ue), { options: l, methods: o } = $t(e, t);
    return R(async () => {
      const { control: r } = n ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js");
      t.value = _(
        r.layers(void 0, void 0, l)
      ), x(o, t.value, e), s({
        ...e,
        ...o,
        leafletObject: t.value
...
C({
  ...
  props: nt,
  setup(e, a) {
    const t = c(), n = A(P), s = S(ue), { options: l, methods: o } = Ft(e, t);
    return R(async () => {
      const { control: r } = n ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js");
      t.value = _(r.scale(l)), x(o, t.value, e), s({ leafletObject: t.value }), j(() => a.emit("ready", t.value));
    }), { leafletObject: t };
  },
  render() {
    return null;
...
C({
  ...
  props: ot,
  setup(e, a) {
    const t = c(), n = A(P), s = S(ue), { options: l, methods: o } = Mt(e, t);
    return R(async () => {
      const { control: r } = n ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js");
      t.value = _(r.zoom(l)), x(o, t.value, e), s({ leafletObject: t.value }), j(() => a.emit("ready", t.value));
    }), { leafletObject: t };
  },
  render() {
    return null;
...
const Ce = {
  ...
  return G($, o.addLayer), G(je, o.removeLayer), { options: l, methods: o };
}, lt = {
  ...Ce
}, Et = (e, a, t) => {
...
C({
  props: lt,
  setup(e, a) {
    const t = c(), n = c(!1), s = A(P), l = S($), { methods: o, options: r } = Et(
      e,
      t,
      a
    );
...
const st = {
  ...
  props: st,
  setup(e, a) {
    const t = c(), n = c(!1), s = A(P), l = S($), { methods: o, options: r } = Ut(e, t, a);
    return R(async () => {
  ...
  createTile(s) {
    const l = this._tileCoordsToKey(s);
    this.tileComponents[l] = a.create("div");
    const o = te({ setup: n, props: ["coords"] }, { coords: s });
    return Tt(o, this.tileComponents[l]), this.tileComponents[l];
  },
  _unloadTile(s) {
    const l = this._tileCoordsToKey(s.coords);
...
C({
  ...
  setup(e, a) {
    const t = c(), n = c(null), s = c(!1), l = A(P), o = S($), { options: r, methods: i } = rt(e, t, a);
    return R(async () => {
      const { GridLayer: u, DomUtil: v, Util: y } = l ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js"), z = qt(
        u,
        v,
        y,
        e.childRender
...
C({
  ...
  setup(e, a) {
    const t = c(), n = A(P), s = S(Ze), l = S(qe), o = S(We);
    let r, i, u, v, y;
    const z = (D, B, N) => {
      ...
      F && (Z.html = F), y = Z.html ? u(Z) : v(Z), r(y, H), o(y);
    }, L = () => {
      j(() => z(t.value, !0, !1));
    }, q = () => {
      j(() => z(t.value, !1, !0));
...
C({
  ...
  props: it,
  setup(e, a) {
    const t = c(), n = c(!1), s = A(P), l = S($), { options: o, methods: r } = Wt(
      e,
      t,
      a
    );
...
C({
  props: Ce,
  setup(e, a) {
    const t = c(), n = c(!1), s = A(P), l = S($), { methods: o } = xe(e, t, a);
    return R(async () => {
...
function ut(e, a, t) {
  ...
  var o = (n = t.isImmediate) != null && n, r = (s = t.callback) != null && s, i = t.maxWait, u = Date.now(), v = [];
  function y() {
    if (i !== void 0) {
      var L = Date.now() - u;
      if (L + a >= i)
  ...
  return z.cancel = function(L) {
    l !== void 0 && clearTimeout(l), v.forEach(function(q) {
      return (0, q.reject)(L);
    }), v = [];
  }, z;
}
const De = {
  ...
  setup(e, a) {
    const t = c(), n = Ct({
      ...
      De,
      s
    ), { listeners: o, attrs: r } = V(a.attrs), i = be($), u = be(je), v = be(ue), y = be(
      Ue
    );
    ...
    R(async () => {
      ...
      await _t(F);
      const me = typeof l.crs == "string" ? N[l.crs] : l.crs;
      l.crs = me || N.EPSG3857;
      const ee = {
        addLayer(m) {
      ...
      Se(i, ee.addLayer), Se(u, ee.removeLayer), Se(v, ee.registerControl), Se(y, ee.registerLayerControl), n.leafletRef = _(B(t.value, l)), x(ee, n.leafletRef, e), ze(n.leafletRef, q), ze(n.leafletRef, o), n.ready = !0, j(() => a.emit("ready", n.leafletRef));
    }), ie(() => {
...
C({
  ...
  setup(e, a) {
    ...
    const { options: o, methods: r } = Ht(e, t, a), i = {
      moveHandler: ut(r.latLngSync)
    };
    return R(async () => {
      const { marker: u, divIcon: v } = s ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js");
      Yt(o, a) && (o.icon = v({ className: "" })), t.value = _(u(e.latLng, o));
      const { listeners: y } = V(a.attrs);
      t.value.on(y), t.value.on("move", i.moveHandler), x(r, t.value, e), l({
        ...e,
        ...r,
        leafletObject: t.value
      }), n.value = !0, j(() => a.emit("ready", t.value));
...
C({
  ...
  props: we,
  setup(e, a) {
    const t = c(), n = c(!1), s = A(P), l = S($), { options: o, methods: r } = pt(e, t, a);
    return R(async () => {
      const { polygon: i } = s ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js");
      t.value = _(i(e.latLngs, o));
      const { listeners: u } = V(a.attrs);
      t.value.on(u), x(r, t.value, e), l({
        ...e,
        ...r,
...
C({
  ...
  props: _e,
  setup(e, a) {
    const t = c(), n = c(!1), s = A(P), l = S($), { options: o, methods: r } = dt(e, t, a);
    return R(async () => {
...
const vt = {
  ...
  props: Xt,
  setup(e, a) {
    const t = c(), n = c(null), s = A(P), l = S(Ge), o = S(Ke), { options: r, methods: i } = ea(e, t);
    return R(async () => {
      ...
      t.value.on(v), t.value.setContent(e.content || n.value || ""), l(t.value), j(() => a.emit("ready", t.value));
    }), ie(() => {
      o();
    }), { root: n, leafletObject: t };
  },
...
const Ne = {
  ...
  const { options: n, methods: s } = rt(e, a, t), l = k(
    e,
    Ne,
    n
  ), o = {
  ...
  props: Ne,
  setup(e, a) {
    const t = c(), n = A(P), s = S($), { options: l, methods: o } = gt(e, t, a);
    return R(async () => {
      const { tileLayer: r } = n ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js");
      t.value = _(r(e.url, l));
      const { listeners: i } = V(a.attrs);
      t.value.on(i), x(o, t.value, e), s({
        ...e,
        ...o,
        leafletObject: t.value
      }), j(() => a.emit("ready", t.value));
...
C({
  ...
  props: oa,
  setup(e, a) {
    const t = c(), n = c(null), s = A(P), l = S(Je), { options: o, methods: r } = la(e, t);
    return R(async () => {
      const { tooltip: i } = s ? w.L : await import("./leaflet-src.esm-BnEQV3J-.js");
      t.value = _(i(o)), x(r, t.value, e);
      const { listeners: u } = V(a.attrs);
      t.value.on(u), t.value.setContent(e.content || n.value || ""), l(t.value), j(() => a.emit("ready", t.value));
    }), { root: n, leafletObject: t };
  },
  render() {
    return yt(this.$slots);
...
C({
  props: ht,
  setup(e, a) {
    const t = c(), n = A(P), s = S($), { options: l, methods: o } = sa(
      e,
      t,
      a
    );
...
const ra = { class: "valhalla-preview" }, ia = { class: "sidebar" }, ua = { class: "search-section" }, ca = { class: "search-box" }, da = {
  ...
  setup(e) {
    const a = e, t = c(null), n = kt(null), s = c(a.dataSource), { update: l } = xt(a.dataSource.type, s, n), o = c([]), r = c(a.dataSource.config?.costing || "auto"), i = c(""), u = c([]), v = c(!1);
    let y = null;
    ...
    function ae(p) {
      return p === 0 ? "#4caf50" : p === o.value.length - 1 ? "#f44336" : "#2196f3";
    }
    function Z(p) {
      return p === 0 ? "Start" : p === o.value.length - 1 ? "Ziel" : `Stop ${p}`;
    }
    Oe(n, async () => {
    ...
    function m(p) {
      ...
      o.value.push(d), i.value = "", u.value = [], Te();
    }
    function T(p) {
      const { lat: d, lng: f } = p.latlng;
      o.value.push({ lat: d, lon: f, name: `${d.toFixed(4)}, ${f.toFixed(4)}` });
    }
    function ye(p) {
      o.value.splice(p, 1);
    }
    function bt() {
      o.value = [], t.value = null, n.value && n.value.callEvent($e, { waypoints: [], costing: r.value });
    }
    function Ie(p, d) {
      if (d < 0 || d >= o.value.length) return;
      const f = o.value.splice(p, 1)[0];
      o.value.splice(d, 0, f);
    }
    async function St() {
      if (!(!n.value || o.value.length < 2)) {
        ...
        try {
          await n.value.callEvent($e, {
            waypoints: o.value.map((p) => ({ lat: p.lat, lon: p.lon, name: p.name })),
            costing: r.value
          }), Te();
        } finally {
          D.value = !1;
      ...
      if (!(!n.value || o.value.length < 3)) {
        ...
        try {
          await n.value.callEvent(Ia, {
            waypoints: o.value.map((d) => ({ lat: d.lat, lon: d.lon, name: d.name })),
            costing: r.value
          });
          const p = await n.value.getData("object");
          p?.waypoints && (o.value = p.waypoints.map((d) => ({
            lat: d.lat,
            lon: d.lon,
    ...
    function Te() {
      o.value.length !== 0 && j(() => {
        ...
        if (p)
          if (o.value.length === 1)
            p.setView([o.value[0].lat, o.value[0].lon], 14);
          else {
            const d = o.value.map((h) => h.lat), f = o.value.map((h) => h.lon);
            p.fitBounds(
    ...
    function wt(p, d) {
      ...
      const f = M.value, h = o.value.splice(f, 1)[0];
      o.value.splice(d, 0, h), M.value = d;
    }
    function jt() {
      M.value = null;
    }
    ...
    return (p, d) => (I(), E("div", ra, [
      g("div", ia, [
        ...
        g("div", ma, [
          g("div", ya, [
            g("span", fa, "Wegpunkte (" + U(o.value.length) + ")", 1),
            d[3] || (d[3] = g("span", { class: "hint" }, "Klick auf Karte = Wegpunkt hinzufügen", -1))
          ]),
          (I(!0), E(re, null, fe(o.value, (f, h) => (I(), E("div", {
            key: h,
          ...
          o.value.length === 0 ? (I(), E("div", wa, " Noch keine Wegpunkte. Klicke auf die Karte oder suche eine Adresse. ")) : Y("", !0)
        ]),
        o.value.length >= 2 ? (I(), E("div", ja, [
          O(b(ne), {
            intent: "primary",
            busy: D.value,
            onClick: St
      ...
      g("div", Na, [
        O(b(Gt), {
          ...
          default: K(() => [
            ...
            (I(!0), E(re, null, fe(o.value, (f, h) => (I(), ge(b(zt), {
              key: "wp-" + h,
              "lat-lng": [f.lat, f.lon],
              radius: 10,
              "fill-color": ae(h),
  ...
  setup(e) {
    ...
    return e.config.costing || (e.config.costing = "auto"), e.config.units || (e.config.units = "kilometers"), e.config.language || (e.config.language = "de-DE"), (s, l) => (I(), E(re, null, [
      O(b(Le), {
        modelValue: e.config.connection,
        "onUpdate:modelValue": l[0] || (l[0] = (o) => e.config.connection = o),
      ...
      O(b(Le), {
        ...
        "onUpdate:modelValue": l[1] || (l[1] = (o) => e.config.costing = o),
      ...
      O(b(Le), {
        ...
        "onUpdate:modelValue": l[2] || (l[2] = (o) => e.config.units = o),
        label: "Einheiten",
        options: n,
        "label-key": "text",
        "value-key": "value"
      ...
      O(b(Me), {
        ...
        "onUpdate:modelValue": l[3] || (l[3] = (o) => e.config.language = o),
