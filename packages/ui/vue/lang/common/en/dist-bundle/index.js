...
function n({ services: e }) {
  e.getRequired(r).addResourceBundle(a, i, te);
}
function l({ services: e }) {
  e.getRequired(r).removeResourceBundle(a, i);
}
const oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  activate: n,
  deactivate: l
}, Symbol.toStringTag, { value: "Module" })), o = "org.eclipse.daanse.board.app.ui.vue.lang.common.en", re = "0.0.1-next.1";
async function ie(e) {
  const t = globalThis.__tsm__;
  if (!t)
    throw new Error(`${o}: tsm runtime is not initialized`);
  t.register(o, oe, re, "ui.vue.lang.common.en"), await n?.(e);
}
async function ne(e) {
  await l?.(e);
}
