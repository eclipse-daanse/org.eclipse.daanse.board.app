...
const { defineComponent, shallowRef, h, ref, onMounted, onUnmounted, watch, toRaw, nextTick, version: version$1, isProxy, resolveComponent, createElementBlock, createCommentVNode, openBlock, createElementVNode, createVNode, createBlock, unref, inject, computed, Fragment } = __tsm__.require("vue");
...
const _hoisted_2 = { class: "h50 overflow-hidden" };
const _hoisted_3 = { class: "h50" };
...
const Preview = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-3662bbd8"]]);
...
class ChartComposer extends BaseDatasource {
  ...
  constructor(datasourceRepository) {
    ...
    __publicField(this, "usedSets", []);
    __publicField(this, "labelColumn", "");
  ...
  parseToChartData(data) {
    ...
    chartData.datasets = this.usedSets.map((set2) => {
      return {
        label: set2,
        data: data.items.map((e) => --e[set2]),
        backgroundColor: "red"
      };
    });
    return chartData;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const datasourcesFiltered = computed(() => {
      return __props.dataSources.filter((ds) => ds.type === "csv" || ds.type === "xmla" || ds.type === "rest");
    });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(_component_VaSelect, {
          modelValue: __props.config.usedSets,
          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => __props.config.usedSets = $event),
          label: "Series",
          options: composeByOptions.value,
          multiple: ""
        }, null, 8, ["modelValue", "options"]),
        createVNode(_component_VaSelect, {
          modelValue: __props.config.labelColumn,
          "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => __props.config.labelColumn = $event),
          label: "Label Column",
          options: composeByOptions.value
        }, null, 8, ["modelValue", "options"])
      ], 64);
...
function deactivate({ services }) {
  services.getRequired(DATASOURCE_REPOSITORY).unregisterDatasourceType("chart");
