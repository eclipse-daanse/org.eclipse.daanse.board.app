(function(){var i="ui.vue.composer.ogcsta2chart",d=document,s=d.querySelector('style[data-tsm-bundle="'+i+'"]');if(!s){s=d.createElement('style');s.setAttribute('data-tsm-bundle',i);d.head.appendChild(s);}s.textContent="\n.h50[data-v-795437d5]{\n  height: 50%;\n}\n.preview-placeholder[data-v-795437d5] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 100%;\n  color: #6c757d;\n  font-style: italic;\n}\n\n.ogcsta2chart-composer-settings[data-v-5e91cbc1] {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n  padding: 16px;\n  max-height: 600px;\n  overflow-y: auto;\n}\n.datastreams-section[data-v-5e91cbc1] {\n  border: 1px solid #dee2e6;\n  border-radius: 8px;\n  padding: 16px;\n  background: #f8f9fa;\n}\n.section-header[data-v-5e91cbc1] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 16px;\n}\n.section-header h3[data-v-5e91cbc1] {\n  margin: 0;\n  color: #495057;\n  font-size: 1.1em;\n}\n.loading-indicator[data-v-5e91cbc1],\n.no-datastreams[data-v-5e91cbc1] {\n  padding: 16px;\n  text-align: center;\n  color: #6c757d;\n  font-style: italic;\n}\n.datastream-list[data-v-5e91cbc1] {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n  max-height: 300px;\n  overflow-y: auto;\n}\n.datastream-item[data-v-5e91cbc1] {\n  display: flex;\n  gap: 8px;\n  align-items: flex-start;\n  padding: 12px;\n  background: white;\n  border: 1px solid #dee2e6;\n  border-radius: 6px;\n}\n.datastream-fields[data-v-5e91cbc1] {\n  flex: 1;\n  display: grid;\n  grid-template-columns: 2fr 1fr auto;\n  gap: 12px;\n  align-items: start;\n}\n.datastream-select[data-v-5e91cbc1] {\n  grid-column: 1 / 2;\n}\n.datastream-label[data-v-5e91cbc1] {\n  grid-column: 2 / 3;\n}\n.datastream-color[data-v-5e91cbc1] {\n  grid-column: 3 / 4;\n  width: 100px;\n}\n.remove-button[data-v-5e91cbc1] {\n  margin-top: 8px;\n}\n";})();
import { identifier, DATASOURCE_REPOSITORY } from "org.eclipse.daanse.board.app.lib.api.datasource";
import { OGCSTAToChartComposer, symbol } from "org.eclipse.daanse.board.app.lib.composer.ogcsta2chart";
import { defineComponent, shallowRef, h, ref, onMounted, onUnmounted, watch, toRaw, nextTick, version as version$1, isProxy, createElementBlock, openBlock, createElementVNode, createVNode, unref, createBlock, createCommentVNode, computed, resolveComponent, withCtx, createTextVNode, Fragment, renderList, inject } from "vue";
import { DTable, DSelect, DButton, DInput, DColorInput } from "org.eclipse.daanse.board.app.ui.vue.controls";
...
const _hoisted_2$1 = { class: "h50 overflow-hidden" };
const _hoisted_3$1 = { class: "h50" };
const _hoisted_4$1 = {
  key: 1,
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    Chart$1.register(plugin_title, plugin_tooltip, plugin_legend, BarElement, CategoryScale, LinearScale);
    ...
    return (_ctx, _cache) => {
      return tempStore.value && data.value ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        createElementVNode("div", _hoisted_3$1, [
          chartData.value && chartOptions.value ? (openBlock(), createBlock(unref(Bar), {
            key: 0,
      ...
      ])) : (openBlock(), createElementBlock("div", _hoisted_4$1, [..._cache[0] || (_cache[0] = [
        createElementVNode("p", null, "Configure datasources and datastreams to see preview", -1)
      ])]));
    };
  }
});
...
const Preview = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-795437d5"]]);
const _hoisted_1 = { class: "ogcsta2chart-composer-settings" };
const _hoisted_2 = { class: "datastreams-section" };
...
const _hoisted_7 = { class: "datastream-fields" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const availableDatastreams = ref([]);
    const isLoadingThings = ref(false);
    const isLoadingDatastreams = ref(false);
    console.log("🔧 Settings.vue mounted with config:", JSON.stringify(__props.config, null, 2));
    if (!Array.isArray(__props.config.datastreams)) {
      console.log("⚠️ datastreams is not an array, initializing:", __props.config.datastreams);
      __props.config.datastreams = [];
    } else {
      console.log("✅ datastreams initialized with", __props.config.datastreams.length, "items:", __props.config.datastreams);
    }
    if (!Array.isArray(__props.config.thingIds)) {
      console.log("⚠️ thingIds is not an array, initializing:", __props.config.thingIds);
      __props.config.thingIds = [];
    } else {
      console.log("✅ thingIds initialized:", __props.config.thingIds);
    }
    if (!Array.isArray(__props.config.connectedDatasources)) {
      console.log("⚠️ connectedDatasources is not an array, initializing:", __props.config.connectedDatasources);
      __props.config.connectedDatasources = [];
    } else {
      console.log("✅ connectedDatasources initialized:", __props.config.connectedDatasources);
      const cleaned = __props.config.connectedDatasources.filter((id) => id != null && id !== void 0);
      if (cleaned.length !== __props.config.connectedDatasources.length) {
        console.log("🧹 Cleaning connectedDatasources, removed", __props.config.connectedDatasources.length - cleaned.length, "invalid values");
        __props.config.connectedDatasources = cleaned;
      }
    }
    const loadThings = async () => {
      ...
      const validDatasources = __props.config.connectedDatasources.filter((id) => id != null && id !== void 0);
    ...
    const loadDatastreams = async () => {
      ...
      if (!__props.config.thingIds || __props.config.thingIds.length === 0) {
        availableDatastreams.value = [];
        return;
      }
    ...
    watch(() => __props.config.connectedDatasources, () => {
      console.log(__props.config.connectedDatasources);
      loadThings();
    }, { deep: true });
    watch(() => __props.config.thingIds, () => {
      console.log(__props.config.thingIds);
      loadDatastreams();
    }, { deep: true });
    const addDatastream = () => {
      if (!__props.config.datastreams) {
        __props.config.datastreams = [];
      }
      __props.config.datastreams.push({
        datastreamId: "",
        label: "",
        color: generateRandomColor()
      });
    };
    const removeDatastream = (index) => {
      __props.config.datastreams.splice(index, 1);
    };
    ...
    onMounted(() => {
      ...
      if (__props.config.thingIds && __props.config.thingIds.length > 0 && __props.config.connectedDatasources && __props.config.connectedDatasources.length > 0) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createVNode(unref(DSelect), {
          modelValue: __props.config.thingIds,
          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => __props.config.thingIds = $event),
        ...
        createElementVNode("div", _hoisted_2, [
          createElementVNode("div", _hoisted_3, [
            _cache[3] || (_cache[3] = createElementVNode("h3", null, "Selected Datastreams", -1)),
            createVNode(unref(DButton), {
              size: "sm",
              onClick: addDatastream,
              disabled: isLoadingDatastreams.value || availableDatastreams.value.length === 0
            }, {
              default: withCtx(() => [..._cache[2] || (_cache[2] = [
                createTextVNode(" Add Datastream ", -1)
              ])]),
              _: 1
            }, 8, ["disabled"])
          ]),
          isLoadingDatastreams.value ? (openBlock(), createElementBlock("div", _hoisted_4, " Loading available datastreams... ")) : createCommentVNode("", true),
          availableDatastreams.value.length === 0 && __props.config.datastreams.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_5, " No datastreams available. Please select an OGC STA datasource and one or more Things first. ")) : createCommentVNode("", true),
          __props.config.datastreams.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_6, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.config.datastreams, (datastream, index) => {
              return openBlock(), createElementBlock("div", {
                ...
                createElementVNode("div", _hoisted_7, [
                  createVNode(unref(DSelect), {
                    modelValue: datastream.datastreamId,
                    "onUpdate:modelValue": ($event) => datastream.datastreamId = $event,
                    label: "Datenstrom",
                    options: availableDatastreams.value,
                    "label-key": "name",
                    "value-key": "id",
                    class: "datastream-select",
                    loading: isLoadingDatastreams.value,
                    "no-options-text": "No datastreams found"
                  }, null, 8, ["modelValue", "onUpdate:modelValue", "options", "loading"]),
                  createVNode(unref(DInput), {
                    modelValue: datastream.label,
                    "onUpdate:modelValue": ($event) => datastream.label = $event,
                    label: "Label (Optional)",
                    placeholder: "Custom label for chart",
                    class: "datastream-label"
                  }, null, 8, ["modelValue", "onUpdate:modelValue"]),
                  createVNode(unref(DColorInput), {
                    modelValue: datastream.color,
                    "onUpdate:modelValue": ($event) => datastream.color = $event,
                    label: "Farbe",
                ...
                createVNode(unref(DButton), {
                  intent: "danger",
                  size: "sm",
                  onClick: ($event) => removeDatastream(index),
                  class: "remove-button"
                }, {
                  default: withCtx(() => [
...
const Settings = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5e91cbc1"]]);
...
function activate({ services }) {
  ...
  services.getRequired(DATASOURCE_REPOSITORY).registerDatasourceType("ogcsta2chart", {
    kind: "composer",
    Store: symbol,
...
function deactivate({ services }) {
  services.getRequired(DATASOURCE_REPOSITORY).unregisterDatasourceType("ogcsta2chart");
