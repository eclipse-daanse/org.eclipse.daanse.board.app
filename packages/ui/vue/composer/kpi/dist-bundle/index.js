...
const { defineComponent, ref, computed, createElementBlock, openBlock, createElementVNode, createCommentVNode, Fragment, renderList, createBlock, resolveComponent, normalizeClass, withModifiers, normalizeStyle, toDisplayString, createVNode, inject: inject$1, unref, watch, shallowRef } = __tsm__.require("vue");
...
function a(t2, n, e, u) {
  Reflect.defineMetadata(n, e, t2, u);
}
...
function G(t2) {
  const i$1 = c(t2, "design:paramtypes");
  void 0 !== i$1 && i(t2, h, g, /* @__PURE__ */ (function(e) {
    return (t3) => (e.forEach((e2, n) => {
      var i2;
      void 0 !== t3.constructorArguments[n] || (i2 = e2, q.includes(i2)) || (t3.constructorArguments[n] = (function(e3) {
  ...
  resolveFragmentInPackage(pkg, fragment) {
    ...
    for (let i2 = 0; i2 < segments.length - 1; i2++) {
      ...
      for (let j = 0; j < subPackages.length; j++) {
        if (subPackages.get(j).getName() === segments[i2]) {
            ...
            if (eFactory) {
              ...
              for (const f2 of parentClass.getEAllStructuralFeatures()) {
                if (f2.isTransient() || f2.isDerived())
                  continue;
                const v = parent.eGet(f2);
                if (v !== null && v !== void 0) {
                  try {
                    concreteObject.eSet(f2, v);
                  } catch {
                  }
                }
              }
...
var __decorateClass$7$1 = (decorators, target, key, kind) => {
...
WidgetActionInterface = __decorateClass$7$1([
...
let KpiComposer = class extends BaseDatasource {
  ...
  async getData(type) {
    ...
    const datasourceRepository = container.get(identifier$2);
