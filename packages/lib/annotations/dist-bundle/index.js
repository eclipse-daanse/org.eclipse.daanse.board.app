...
function Fe() {
  ...
  return (function(M) {
    (function(y) {
      var b = typeof globalThis == "object" ? globalThis : typeof oe == "object" ? oe : typeof self == "object" ? self : typeof this == "object" ? this : D(), k = T(M);
      typeof b.Reflect < "u" && (k = T(b.Reflect, k)), y(k, b), typeof b.Reflect > "u" && (b.Reflect = M);
      function T(R, I) {
        return function(m, j) {
      ...
      y("getMetadataKeys", _e);
      function Me(e, t) {
        if (!w(e))
          throw new TypeError();
        return s(t) || (t = O(t)), J(e, t);
      }
      y("getOwnMetadataKeys", Me);
      function be(e, t, r) {
        if (!w(t))
          throw new TypeError();
        if (s(r) || (r = O(r)), !w(t))
      ...
      function $(e, t) {
        ...
        if (r.length <= 0)
          return u;
        for (var h = new U(), p = [], c = 0, a = r; c < a.length; c++) {
          var i = a[c], f = h.has(i);
          f || (h.add(i), p.push(i));
        }
      ...
      function Pe() {
        var e;
        !s(P) && typeof b.Reflect < "u" && !(P in b.Reflect) && typeof b.Reflect.defineMetadata == "function" && (e = je(b.Reflect));
        var t, r, n, u = new W(), h = {
          registerProvider: p,
          getProvider: a,
          setProvider: f
      ...
      function Se() {
        var e;
        return !s(P) && w(b.Reflect) && Object.isExtensible(b.Reflect) && (e = b.Reflect[P]), s(e) && (e = Pe()), !s(P) && w(b.Reflect) && Object.isExtensible(b.Reflect) && Object.defineProperty(b.Reflect, P, {
          enumerable: !1,
          configurable: !1,
          writable: !1,
          value: e
      ...
      function je(e) {
        var t = e.defineMetadata, r = e.hasOwnMetadata, n = e.getOwnMetadata, u = e.getOwnMetadataKeys, h = e.deleteMetadata, p = new W(), c = {
          isProviderFor: function(a, i) {
            var f = p.get(a);
            return !s(f) && f.has(i) ? !0 : u(a, i).length ? (s(f) && (f = new U(), p.set(a, f)), f.add(i), !0) : !1;
          },
...
function Ue() {
  return function(_, M) {
    Reflect.defineMetadata("Attribute", !0, _, M);
  };
}
function We(_) {
  return function(M, y) {
    Reflect.defineMetadata("Reference", _, M, y);
  };
}
function He(_) {
  return function(M, y) {
    Reflect.defineMetadata("Enum", _, M, y);
  };
}
function Ve(_) {
  return function(M) {
    Reflect.defineMetadata("ModelClass", _, M, "modelClass");
  };
}
function ze(_) {
  return function(M, y) {
    y === void 0 ? Reflect.defineMetadata("Documentation", _, M) : Reflect.defineMetadata("Documentation", _, M, y);
  };
}
...
async function Le(_) {
  ...
  M.register(ce, Be, qe, "lib.annotations"), await void 0;
}
async function Ne(_) {
  await void 0;
}
