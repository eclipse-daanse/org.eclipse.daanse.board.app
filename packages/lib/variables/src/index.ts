...
import { PAGE_CONTEXT, type PageContextServiceI } from 'org.eclipse.daanse.board.app.lib.api.pagecontext'
import { VARIABLE_REPOSITORY, type VariableRepository } from 'org.eclipse.daanse.board.app.lib.api.variable'
