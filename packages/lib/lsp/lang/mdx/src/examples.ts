...
`,
  ...
  },
  {
    ...
    label: 'Named sets',
    description:
      'Calculated member with properties and two named sets — try go-to-definition.',
  ...
  },
  {
    ...
    description:
      'DIMENSION PROPERTIES on an axis, CELL PROPERTIES after the slicer.',
  ...
  },
  {
    ...
    description:
      'Precedence torture test and a wide sweep of the function library.',
