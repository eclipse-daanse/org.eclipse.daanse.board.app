...
// Chevrotain, the grammar, the scope provider and the validators are all
// bundled into this one chunk. That is the point — the worker resolves no bare
// import at runtime, and none of it reaches a consuming application's main
// bundle.
//
