...
export class EClassifierImpl extends ENamedElementImpl implements EClassifier {
    ...
    protected _eTypeParameters: EList<ETypeParameter>
    ...
    get eTypeParameters(): EList<ETypeParameter> {
        if (this._eTypeParameters == null) {
            this._eTypeParameters = new BasicEObjectList(
                this,
                EcoreConstants.ECLASSIFIER__ETYPE_PARAMETERS,
                -1,
                true,
                true,
                false,
    ...
    eGetFromID(featureID: number, resolve: boolean): any {
        switch (featureID) {
            ...
            case EcoreConstants.ECLASSIFIER__ETYPE_PARAMETERS: {
    ...
    eBasicInverseRemove(otherEnd: EObject, featureID: number, notifications: ENotificationChain): ENotificationChain {
        switch (featureID) {
            ...
            case EcoreConstants.ECLASSIFIER__ETYPE_PARAMETERS: {
                return this._eTypeParameters.basicRemove(otherEnd, notifications)
            }
            default: {
