...
export class EcoreConstants {
    ...
    // ETYPED_ELEMENT__EGENERIC_TYPE is the feature id for the ETypedElement 'EGenericType' containment reference.
    // Using a high number to avoid conflicts
    public static readonly ETYPED_ELEMENT__EGENERIC_TYPE: number = 1000
    ...
    // ECLASSIFIER__ETYPE_PARAMETERS is the feature id for the EClassifier 'ETypeParameters' containment reference list.
    public static readonly ECLASSIFIER__ETYPE_PARAMETERS: number = 8

    // ECLASSIFIER_FEATURE_COUNT is the number of structural features of the class EClassifier.
    public static readonly ECLASSIFIER_FEATURE_COUNT: number = 9
