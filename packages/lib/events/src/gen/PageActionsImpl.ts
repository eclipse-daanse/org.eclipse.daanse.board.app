...
import type { PageActions } from './PageActions.js';
 ...
 * @generated
 */
export class PageActionsImpl extends BasicEObject implements PageActions {
  ...
  override eClass(): EClass {
    return SystemactionsPackage.Literals.PAGE_ACTIONS;
  }
