const g = typeof Symbol > "u" ? "__ͼ" : Symbol.for("ͼ"), S = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), m = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {};
class C {
...
`);
  ...
  static mount(e, l, i) {
    let n = e[S], s = i && i.nonce;
    n ? s && n.setNonce(s) : n = new b(e, s), n.mount(Array.isArray(l) ? l : [l], e);
  }
}
