...
const _hoisted_18$3 = { class: "create__hint" };
        ...
        createElementVNode("section", _hoisted_14$6, [
          ...
          creating.value ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            ...
            createElementVNode("form", {
              ...
              createElementVNode("p", _hoisted_18$3, " Abgelegt wird der gesamte Arbeitsstand: " + toDisplayString(pending.value.boards) + " " + toDisplayString(pending.value.boards === 1 ? "Seite" : "Seiten") + " mit " + toDisplayString(pending.value.widgets) + " Widgets, dazu Verbindungen, Datenquellen und Variablen. ", 1)
            ], 32)
