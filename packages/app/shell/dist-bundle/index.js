...
import { DIcon, DButton, DField, DSwitch, DInput, DChip, DModal, DSelect, DTabs, DColorInput, DFloatingWindow, DDateInput, DSlider, DCheckbox, DDivider } from "org.eclipse.daanse.board.app.ui.vue.controls";
...
const _hoisted_5$f = ["aria-expanded"];
const _hoisted_6$d = { class: "pages__name" };
const _hoisted_7$c = {
  key: 0,
  class: "pages__menu",
  role: "menu"
...
const _hoisted_9$a = ["title", "aria-label", "onClick"];
        ...
        createElementVNode("header", _hoisted_1$l, [
          ...
          createElementVNode("nav", _hoisted_2$j, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(crumb.value, (part, i) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                }, toDisplayString(part.label), 9, _hoisted_4$g)) : (openBlock(), createElementBlock("span", {
                  key: 2,
          ...
          showModes.value ? (openBlock(), createElementBlock("div", {
            ...
            createElementVNode("button", {
              ...
              createElementVNode("span", _hoisted_6$d, toDisplayString(currentPageName.value), 1),
          ...
          showModes.value ? (openBlock(), createElementBlock("div", _hoisted_15$6, [
            createElementVNode("button", {
              type: "button",
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-7fa027b5"]]);
const TOKEN_GROUPS = [
  {
    id: "surfaces",
    label: "Flächen",
...
const _hoisted_4$f = ["aria-current"];
const _hoisted_5$e = ["aria-current"];
const _hoisted_6$c = ["aria-current", "title", "onClick"];
const _hoisted_7$b = { class: "sr-only" };
const _hoisted_8$b = { class: "content" };
          ...
          !isLauncher.value ? (openBlock(), createElementBlock("nav", _hoisted_3$f, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(navigationItems.value, (item) => {
              return openBlock(), createElementBlock("button", {
                ...
                createElementVNode("span", _hoisted_7$b, toDisplayString(item.label), 1)
              ], 10, _hoisted_6$c);
            }), 128)),
            _cache[5] || (_cache[5] = createElementVNode("span", { class: "rail-spacer" }, null, -1))
          ])) : createCommentVNode("", true),
          createElementVNode("main", _hoisted_8$b, [
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-27fec35c"]]);
...
const _hoisted_5$d = { class: "no-layout-message__text" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        isLoading.value ? (openBlock(), createElementBlock("div", _hoisted_1$j, [..._cache[0] || (_cache[0] = [
          ...
          createElementVNode("p", _hoisted_5$d, [
            createVNode(unref(DIcon), {
              name: "warning",
              size: "lg",
              tone: "color-warn"
            }),
            !currentPage.value ? (openBlock(), createElementBlock("span", _hoisted_6$b, " Die Seite „" + toDisplayString(props.pageId) + '" gibt es nicht. ', 1)) : !currentLayout.value ? (openBlock(), createElementBlock("span", _hoisted_7$a, " Für „" + toDisplayString(currentPage.value.name || props.pageId) + '" ist kein Layout eingestellt. ', 1)) : (openBlock(), createElementBlock("span", _hoisted_8$a, [
...
const LayoutRenderer = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-965fd8c7"]]);
const _hoisted_1$i = {
  class: "floorplan",
  "aria-hidden": "true"
};
...
const BoardFloorplan = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-0eecd73b"]]);
...
const _hoisted_4$d = ["aria-expanded", "onClick"];
const _hoisted_5$c = { class: "row__twist" };
const _hoisted_6$a = { class: "row__name" };
...
const _hoisted_18$5 = { class: "create__hint" };
const _hoisted_19$5 = { class: "detail__head" };
const _hoisted_20$4 = { class: "detail__name" };
const _hoisted_21$4 = {
  key: 0,
  class: "detail__badge"
};
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(places.value, (place) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                createElementVNode("button", {
                  ...
                  createElementVNode("span", _hoisted_5$c, toDisplayString(expanded.value.has(key(place)) ? "▾" : "▸"), 1),
                  createElementVNode("span", _hoisted_6$a, toDisplayString(place.name), 1),
        ...
        createElementVNode("section", _hoisted_14$5, [
          ...
          creating.value ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            ...
            createElementVNode("form", {
              ...
              createElementVNode("p", _hoisted_18$5, " Abgelegt wird der gesamte Arbeitsstand: " + toDisplayString(pending.value.boards) + " " + toDisplayString(pending.value.boards === 1 ? "Board" : "Boards") + " mit " + toDisplayString(pending.value.widgets) + " Widgets, dazu Verbindungen, Datenquellen und Variablen. ", 1)
            ], 32)
            ...
            createElementVNode("header", _hoisted_19$5, [
...
const WorkspaceStorage = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-82d034f3"]]);
...
const _hoisted_5$b = ["aria-selected"];
const _hoisted_6$9 = {
  key: 0,
  class: "boards__count"
};
const _hoisted_7$8 = ["aria-selected"];
const _hoisted_8$8 = {
  key: 0,
  class: "boards__tools"
};
const _hoisted_9$8 = { class: "boards__body" };
const _hoisted_10$8 = {
  key: 0,
  class: "boards__empty"
};
const _hoisted_11$6 = { class: "boards__empty-actions" };
const _hoisted_12$6 = {
  key: 1,
  class: "boards__grid"
};
...
const _hoisted_16$4 = { class: "board__meta" };
const _hoisted_17$4 = {
  key: 0,
  class: "board__usage"
};
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$g, [
        createElementVNode("div", _hoisted_2$e, [
          createElementVNode("header", _hoisted_3$c, [
            createElementVNode("div", _hoisted_4$c, [
              createElementVNode("button", {
                ...
                boards.value.length ? (openBlock(), createElementBlock("span", _hoisted_6$9, toDisplayString(boards.value.length), 1)) : createCommentVNode("", true)
              ], 10, _hoisted_5$b),
              createElementVNode("button", {
                type: "button",
                role: "tab",
              ...
              }, " Speicher ", 10, _hoisted_7$8)
            ]),
            view.value === "boards" ? (openBlock(), createElementBlock("div", _hoisted_8$8, [
              withDirectives(createElementVNode("input", {
          ...
          createElementVNode("div", _hoisted_9$8, [
            view.value === "boards" && boards.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_10$8, [
              createVNode(BoardFloorplan, {
            ...
            ])) : view.value === "boards" ? (openBlock(), createElementBlock("div", _hoisted_12$6, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(visibleBoards.value, (board) => {
                return openBlock(), createElementBlock("article", {
                  ...
                  createElementVNode("div", _hoisted_14$4, [
                    ...
                    createElementVNode("p", _hoisted_16$4, [
                    ...
                    unref(usageOf)(board.id) ? (openBlock(), createElementBlock("p", _hoisted_17$4, toDisplayString(unref(usageOf)(board.id)?.count) + "× geöffnet · zuletzt " + toDisplayString(unref(lastOpenedLabel)(board.id)), 1)) : createCommentVNode("", true),
                    board.kinds.length ? (openBlock(), createElementBlock("ul", _hoisted_18$4, [
                      ...
                      board.kinds.length > 3 ? (openBlock(), createElementBlock("li", _hoisted_19$4, " +" + toDisplayString(board.kinds.length - 3), 1)) : createCommentVNode("", true)
                    ])) : createCommentVNode("", true)
                  ]),
                  createElementVNode("button", {
                    class: "board__edit",
...
const BoardsHome = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-4c11f243"]]);
...
const ViewReport = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-3ecae506"]]);
      ...
      return openBlock(), createBlock(unref(DField), {
        ...
        default: withCtx(() => [
          createElementVNode("div", _hoisted_1$d, [
            ...
            suggestions.value.length ? (openBlock(), createElementBlock("div", _hoisted_3$b, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(suggestions.value, (tag) => {
                ...
                }, toDisplayString(tag), 41, _hoisted_4$b);
              }), 128))
            ])) : createCommentVNode("", true)
          ])
        ]),
...
const TagInput = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-4395a1c9"]]);
const _hoisted_1$c = { class: "new" };
const _hoisted_2$b = { class: "new__step" };
const _hoisted_3$a = { class: "types" };
const _hoisted_4$a = ["onClick"];
const _hoisted_5$a = { class: "type__name" };
const _hoisted_6$8 = {
  key: 0,
  class: "type__what"
};
...
const _hoisted_9$7 = { class: "new__icon" };
const _hoisted_10$7 = {
  class: "new__icon-preview",
  "aria-hidden": "true"
};
const _hoisted_11$5 = {
  key: 2,
  ...
  setup(__props, { emit: __emit }) {
    ...
    const missing = computed(
      () => (doc.value?.features ?? []).filter((f) => !f.optional && !["name", "type", "uid"].includes(f.name)).filter((f) => {
        const held2 = config.value[f.name];
        return held2 === void 0 || held2 === null || held2 === "";
      }).map((f) => f.name)
    );
      ...
      return openBlock(), createBlock(unref(DModal), {
        ...
        default: withCtx(() => [
          createElementVNode("div", _hoisted_1$c, [
            createElementVNode("section", _hoisted_2$b, [
              _cache[6] || (_cache[6] = createElementVNode("h3", { class: "new__label" }, "Typ", -1)),
              _cache[7] || (_cache[7] = createElementVNode("p", { class: "new__lead" }, "Womit soll gesprochen werden? Die Beschreibung stammt aus dem Modell des Typs.", -1)),
              createElementVNode("ul", _hoisted_3$a, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(types.value, (each) => {
                  return openBlock(), createElementBlock("li", { key: each }, [
                    createElementVNode("button", {
                      type: "button",
                      class: normalizeClass(["type", { "type--on": type.value === each }]),
                      onClick: ($event) => type.value = each
                    }, [
                      createElementVNode("span", _hoisted_5$a, [
                        createTextVNode(toDisplayString(each) + " ", 1),
                      ...
                      summaries.value[each] ? (openBlock(), createElementBlock("span", _hoisted_6$8, toDisplayString(summaries.value[each]), 1)) : createCommentVNode("", true)
                    ], 10, _hoisted_4$a)
                  ]);
                }), 128))
              ])
            ]),
            type.value ? (openBlock(), createElementBlock("section", _hoisted_7$7, [
              _cache[8] || (_cache[8] = createElementVNode("h3", { class: "new__label" }, "Name", -1)),
            ...
            type.value ? (openBlock(), createElementBlock("section", _hoisted_8$7, [
              _cache[9] || (_cache[9] = createElementVNode("h3", { class: "new__label" }, "Einordnung", -1)),
              createElementVNode("div", _hoisted_9$7, [
                createElementVNode("span", _hoisted_10$7, [
                  createVNode(unref(DIcon), {
                    name: icon.value.trim() || typeIcon.value,
                    size: "lg"
                  }, null, 8, ["name"])
                ]),
                createVNode(unref(DInput), {
            ...
            type.value ? (openBlock(), createElementBlock("section", _hoisted_11$5, [
              _cache[10] || (_cache[10] = createElementVNode("h3", { class: "new__label" }, "Einstellungen", -1)),
              doc.value?.documentation ? (openBlock(), createElementBlock("p", _hoisted_12$5, toDisplayString(doc.value.documentation), 1)) : createCommentVNode("", true),
...
const NewConnectionDialog = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-6a3cd36b"]]);
const _hoisted_1$b = { class: "new" };
const _hoisted_2$a = { class: "new__step" };
const _hoisted_3$9 = { class: "types" };
const _hoisted_4$9 = ["onClick"];
const _hoisted_5$9 = { class: "type__name" };
const _hoisted_6$7 = {
  key: 0,
  class: "type__what"
};
const _hoisted_7$6 = { class: "types" };
const _hoisted_8$6 = ["onClick"];
const _hoisted_9$6 = { class: "type__name" };
const _hoisted_10$6 = {
  key: 0,
  class: "type__what"
};
...
const _hoisted_16$3 = { class: "new__icon" };
const _hoisted_17$3 = {
  class: "new__icon-preview",
  "aria-hidden": "true"
};
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(DModal), {
        ...
        size: "lg",
        onCancel: _cache[6] || (_cache[6] = ($event) => open.value = false)
      }, {
        actions: withCtx(() => [
          createVNode(unref(DButton), {
            intent: "quiet",
        ...
        default: withCtx(() => [
          createElementVNode("div", _hoisted_1$b, [
            createElementVNode("section", _hoisted_2$a, [
              _cache[8] || (_cache[8] = createElementVNode("h3", { class: "new__label" }, "Typ", -1)),
              _cache[9] || (_cache[9] = createElementVNode("p", { class: "new__lead" }, "Was für Daten sollen gelesen werden? Die Beschreibung stammt aus dem Modell des Typs.", -1)),
              _cache[10] || (_cache[10] = createElementVNode("h4", { class: "new__rubric" }, "Aus einer Verbindung lesen", -1)),
              createElementVNode("ul", _hoisted_3$9, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(sourceTypes.value, (each) => {
                  return openBlock(), createElementBlock("li", { key: each }, [
                    createElementVNode("button", {
                      type: "button",
                      class: normalizeClass(["type", { "type--on": type.value === each }]),
                      ...
                      summaries.value[each] ? (openBlock(), createElementBlock("span", _hoisted_6$7, toDisplayString(summaries.value[each]), 1)) : createCommentVNode("", true)
                    ], 10, _hoisted_4$9)
                  ]);
                }), 128))
              ]),
              composerTypes.value.length ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                _cache[7] || (_cache[7] = createElementVNode("h4", { class: "new__rubric" }, "Aus vorhandenen Datenquellen zusammensetzen", -1)),
                createElementVNode("ul", _hoisted_7$6, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(composerTypes.value, (each) => {
                    return openBlock(), createElementBlock("li", { key: each }, [
                      createElementVNode("button", {
                        type: "button",
                        class: normalizeClass(["type", { "type--on": type.value === each }]),
                        ...
                        summaries.value[each] ? (openBlock(), createElementBlock("span", _hoisted_10$6, toDisplayString(summaries.value[each]), 1)) : createCommentVNode("", true)
                      ], 10, _hoisted_8$6)
                    ]);
                  }), 128))
                ])
            ...
            type.value ? (openBlock(), createElementBlock("section", _hoisted_11$4, [
              _cache[11] || (_cache[11] = createElementVNode("h3", { class: "new__label" }, "Name", -1)),
              createVNode(unref(DInput), {
                modelValue: name.value,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => name.value = $event),
            ...
            type.value && needsConnection.value ? (openBlock(), createElementBlock("section", _hoisted_12$4, [
              _cache[12] || (_cache[12] = createElementVNode("h3", { class: "new__label" }, "Verbindung", -1)),
              !connectionOptions.value.length ? (openBlock(), createElementBlock("p", _hoisted_13$3, " Es gibt noch keine Verbindung. Lege zuerst eine an — ohne sie hat die Datenquelle nichts, woraus sie lesen kann. ")) : nothingSuits.value ? (openBlock(), createElementBlock("p", _hoisted_14$3, " Keine der vorhandenen Verbindungen ist von diesem Typ vorgesehen. Du kannst trotzdem eine wählen — die Angabe ist ein Hinweis, keine Regel. ")) : createCommentVNode("", true),
              connectionOptions.value.length ? (openBlock(), createBlock(unref(DSelect), {
                key: 2,
            ...
            type.value ? (openBlock(), createElementBlock("section", _hoisted_15$3, [
              _cache[13] || (_cache[13] = createElementVNode("h3", { class: "new__label" }, "Einordnung", -1)),
              createElementVNode("div", _hoisted_16$3, [
                createElementVNode("span", _hoisted_17$3, [
                  createVNode(unref(DIcon), {
                    name: icon.value.trim() || typeIcon.value,
                    size: "lg"
                  }, null, 8, ["name"])
            ...
            type.value ? (openBlock(), createElementBlock("section", _hoisted_18$3, [
              _cache[14] || (_cache[14] = createElementVNode("h3", { class: "new__label" }, "Einstellungen", -1)),
              doc.value?.documentation ? (openBlock(), createElementBlock("p", _hoisted_19$3, toDisplayString(doc.value.documentation), 1)) : createCommentVNode("", true),
              createVNode(ModelFields, {
                doc: doc.value,
                config: config.value,
                omit: ["connection"]
...
const NewDatasourceDialog = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-dc50b679"]]);
...
const _hoisted_15$2 = { class: "row__twist row__twist--none" };
const _hoisted_16$2 = ["onClick"];
const _hoisted_17$2 = { class: "row__name" };
const _hoisted_18$2 = { class: "row__what" };
const _hoisted_19$2 = {
  key: 0,
  class: "row__tag row__tag--more"
};
...
const _hoisted_22$2 = { class: "confirm__title" };
const _hoisted_23$2 = { class: "confirm__text" };
const _hoisted_24$2 = {
  key: 0,
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createElementVNode("section", _hoisted_1$9, [
          ...
          createElementVNode("div", {
            ...
            ])) : (openBlock(), createElementBlock("ul", _hoisted_5$8, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(groups.value, (group) => {
                return openBlock(), createElementBlock("li", {
                  ...
                  isOpen(group.uid) ? (openBlock(), createElementBlock("ul", _hoisted_13$2, [
                      ...
                      return openBlock(), createElementBlock("li", {
                        ...
                        createElementVNode("div", {
                          ...
                          createElementVNode("button", {
                            ...
                            createElementVNode("span", _hoisted_17$2, toDisplayString(source.name), 1),
                            createElementVNode("span", _hoisted_18$2, toDisplayString(source.type), 1),
                            ...
                            source.tags.length > TAGS_SHOWN ? (openBlock(), createElementBlock("span", _hoisted_19$2, " +" + toDisplayString(source.tags.length - TAGS_SHOWN), 1)) : createCommentVNode("", true),
                            source.usage ? (openBlock(), createElementBlock("span", _hoisted_20$2, toDisplayString(source.usage), 1)) : createCommentVNode("", true)
                          ], 8, _hoisted_16$2),
                          createVNode(unref(DButton), {
                            intent: "quiet",
                            size: "sm",
                    ...
                    !group.sources.length && !group.orphan ? (openBlock(), createElementBlock("li", _hoisted_21$2, " Keine Datenquelle an dieser Verbindung. ")) : createCommentVNode("", true)
                  ])) : createCommentVNode("", true)
                ]);
              }), 128))
            ]))
        ...
        createVNode(NewConnectionDialog, {
        ...
        createVNode(unref(DModal), {
          ...
          header: withCtx(() => [
            ...
            createElementVNode("h2", _hoisted_22$2, toDisplayString(removing.value?.type === "Connection" ? "Verbindung löschen" : "Datenquelle löschen"), 1)
          ]),
          actions: withCtx(() => [
            createVNode(unref(DButton), {
              intent: "quiet",
          ...
          default: withCtx(() => [
            createElementVNode("p", _hoisted_23$2, " „" + toDisplayString(removingLabel.value) + "“ wird entfernt. Das lässt sich nicht rückgängig machen. ", 1),
            removingUsage.value ? (openBlock(), createElementBlock("p", _hoisted_24$2, " Verwendet in " + toDisplayString(removingUsage.value) + " — die lesen danach ins Leere. ", 1)) : createCommentVNode("", true)
          ]),
          _: 1
        }, 8, ["model-value"])
      ], 64);
...
const DataTree = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-ebb40e1d"]]);
...
const _hoisted_3$7 = { class: "editor__icon" };
const _hoisted_4$7 = {
  class: "editor__icon-preview",
  "aria-hidden": "true"
};
const _hoisted_5$7 = { class: "editor__actions" };
const _hoisted_6$5 = {
  key: 1,
          ...
          createElementVNode("div", _hoisted_2$8, [
            ...
            createElementVNode("div", _hoisted_3$7, [
              createElementVNode("span", _hoisted_4$7, [
                createVNode(unref(DIcon), {
                  name: datasourceProxy.value.icon?.trim() || typeIcon.value,
                  size: "lg"
                }, null, 8, ["name"])
              ]),
              createVNode(unref(DInput), {
...
const DatasourceEditor = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-ec464a45"]]);
const _hoisted_1$7 = { class: "editor" };
const _hoisted_2$7 = { class: "editor__fields" };
const _hoisted_3$6 = { class: "editor__icon" };
const _hoisted_4$6 = {
  class: "editor__icon-preview",
  "aria-hidden": "true"
};
const _hoisted_5$6 = { class: "editor__actions" };
        ...
        createElementVNode("div", _hoisted_2$7, [
          ...
          createElementVNode("div", _hoisted_3$6, [
            createElementVNode("span", _hoisted_4$6, [
              createVNode(unref(DIcon), {
                name: connectionProxy.value.icon?.trim() || typeIcon.value,
                size: "lg"
              }, null, 8, ["name"])
            ]),
            createVNode(unref(DInput), {
...
const ConnectionEditor = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-64772fc8"]]);
